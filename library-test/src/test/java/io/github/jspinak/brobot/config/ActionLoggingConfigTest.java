...
/**
 * Unit tests for ActionLoggingConfig class. Tests Spring configuration for action logging with
 * console output and visual feedback.
 *
 * <p>The duplicate bean issue has been resolved: - GuiAccessMonitor and ConsoleActionReporter are
 * now @Component classes - ActionLoggingConfig no longer defines @Bean methods for them
...
class ActionLoggingConfigTest {
    ...
    @Mock private BrobotLogger mockBrobotLogger;

    @Mock private ConsoleActionConfig mockConsoleActionConfig;

    @Mock private VisualFeedbackConfig mockVisualFeedbackConfig;

    @Mock private GuiAccessConfig mockGuiAccessConfig;

    @Mock private LoggingVerbosityConfig mockLoggingVerbosityConfig;
    ...
    class ConfigurationStructureTests {
        ...
        void testConfigurationAnnotation() {
            assertTrue(
                    ActionLoggingConfig.class.isAnnotationPresent(
        ...
        void testEnableConfigurationProperties() {
            ...
            var annotation =
                    ActionLoggingConfig.class.getAnnotation(
                            org.springframework.boot.context.properties
                                    .EnableConfigurationProperties.class);
        ...
        void testPropertySources() {
            var propertySources =
                    ActionLoggingConfig.class.getAnnotationsByType(
                            org.springframework.context.annotation.PropertySource.class);

            assertTrue(propertySources.length >= 2, "Should have at least 2 property sources");
    ...
    class GuiAccessStartupCheckerTests {
        ...
        @Test
        @DisplayName(
                "Should throw exception when GUI not accessible and continue-on-error is false")
        ...
        @Test
        @DisplayName(
                "Should not throw exception when GUI not accessible but continue-on-error is true")
    ...
    class ComponentIntegrationTests {
        ...
        void testConsoleActionReporterIsComponent() {
            assertTrue(
                    ConsoleActionReporter.class.isAnnotationPresent(
        ...
        void testConsoleActionReporterConditional() {
            ...
            var annotation =
                    ConsoleActionReporter.class.getAnnotation(
                            org.springframework.boot.autoconfigure.condition.ConditionalOnProperty
                                    .class);
        ...
        void testGuiAccessMonitorIsComponent() {
            assertTrue(
                    GuiAccessMonitor.class.isAnnotationPresent(
                            org.springframework.stereotype.Component.class),
    ...
    class BeanCreationTests {
        ...
        void testNoDuplicateBeanMethods() {
            ...
            assertThrows(
                    ...
                    "consoleActionReporter bean method should not exist (component is"
                            + " auto-created)");
    ...
    class DocumentationTests {
        ...
        void testDocumentationPresent() {
            ...
            assertNotNull(actionLoggingConfig, "ActionLoggingConfig should be instantiable");

            // Key insight: Components are now auto-created, not via @Bean methods
            assertTrue(
                    true,
                    "Components (ConsoleActionReporter, GuiAccessMonitor) are auto-created via"

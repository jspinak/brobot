...
/**
 * Updated tests for finding dynamic pixel matches using new ActionConfig API. Demonstrates
 * migration from ActionOptions to DynamicPixelsFindOptions.
 *
 * <p>Key changes: - Uses DynamicPixelsFindOptions instead of generic ActionOptions - ActionResult
...
class FindDynamicPixelMatchesTestUpdated {
    ...
    @Autowired FindDynamicPixelMatches findDynamicPixelMatches;
    ...
    void testDynamicPixelsWithCustomSettings() {
        ...
        DynamicPixelsFindOptions customOptions =
                new DynamicPixelsFindOptions.Builder()
        ...
        if (matches.getActionConfig() instanceof DynamicPixelsFindOptions) {
            DynamicPixelsFindOptions resultOptions =
                    (DynamicPixelsFindOptions) matches.getActionConfig();
    ...
    void testUsingActionService() {
        ...
        DynamicPixelsFindOptions dynamicPixelsOptions =
                new DynamicPixelsFindOptions.Builder().setMaxMovement(3).build();

        ActionResult matches = new ActionResult();
        matches.setActionConfig(dynamicPixelsOptions);

        Optional<ActionInterface> dynamicPixelsFindActionOpt =
                actionService.getAction(dynamicPixelsOptions);
        assertTrue(
                dynamicPixelsFindActionOpt.isPresent(),
                "Dynamic pixels find action should be available");
    ...
    void compareOldAndNewDynamicPixelsAPI() {
        ...
        */
        ...
        // NEW API:
        DynamicPixelsFindOptions newOptions =
                new DynamicPixelsFindOptions.Builder()
                        .setMaxMovement(3)

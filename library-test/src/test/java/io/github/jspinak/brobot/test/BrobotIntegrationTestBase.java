 ...
 *
 * <p>Architectural improvements: - Uses TestConfigurationManager for early environment setup - No
 * circular dependencies or @Lazy annotations - Clear separation of concerns - Follows Single
 * Responsibility Principle
 *
 * <p>Each component has a single responsibility: - TestConfigurationManager: Initialize environment
 * before Spring - TestActionConfig: Provide action framework beans - This base class: Manage test
 * lifecycle and state
 */
...
public abstract class BrobotIntegrationTestBase {
    ...
    /**
     * Check if screen capture is available. Single responsibility: query screen capture capability.
     */
    ...
    /**
     * Check if using real files (not mocked). Single responsibility: query file processing mode.
     */
    ...
    /**
     * Hook for subclasses to add setup logic. Single responsibility: provide extension point for
     * setup.
     */
    ...
    /**
     * Hook for subclasses to add teardown logic. Single responsibility: provide extension point for
     * cleanup.
     */

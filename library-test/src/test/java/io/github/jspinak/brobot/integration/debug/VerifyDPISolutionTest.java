...
/**
 * Verifies that the DPI scaling solution improves pattern matching from ~0.70 similarity to ~0.94
 * similarity.
 */
    ...
    public void testAutoConfiguration() {
        ...
        try (AnnotationConfigApplicationContext context =
            ...
            try {
                ...
                assertTrue(
                        match.getScore() >= 0.85, "Auto-config should achieve >= 0.85 similarity");

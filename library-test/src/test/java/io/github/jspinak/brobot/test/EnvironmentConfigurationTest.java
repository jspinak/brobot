...
/**
 * Demonstrates and tests the different BrobotEnvironment configurations. This test class shows how
 * the environment affects various operations.
 */
    ...
    class CustomConfigurationTests {
        ...
        void testTemporaryEnvironmentSwitch() {
            ...
            try {
                ...
                ExecutionEnvironment newEnv =
                        ExecutionEnvironment.builder().mockMode(!wasInMockMode).build();
        ...
        void testEnvironmentVariableConfiguration() {
            ...
            try {
                ...
                ExecutionEnvironment env = ExecutionEnvironment.builder().fromEnvironment().build();

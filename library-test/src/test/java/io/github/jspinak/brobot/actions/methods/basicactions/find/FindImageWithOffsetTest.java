...
/**
 * Tests find operations with position and offset settings. Uses Brobot's unit testing mode for real
...
public class FindImageWithOffsetTest extends BrobotIntegrationTestBase {
    ...
    /**
     * Test that Position set in ObjectActionOptions overrides the Position in the Pattern. Verifies
     * the priority of ObjectActionOptions settings over Pattern settings.
     */
    @Test
    void findWithPositionAndOffsetInObjectActionOptions() {
                ...
                new StateImage.Builder()
                        .addPattern(
                                new Pattern.Builder()
                                        .setFilename(TestPaths.getImagePath("topLeft"))
                                        .setTargetPosition(
                                                new Position(0, 0)) // This should be overridden
                                        .build())
                        .build();
        ObjectCollection objColl2 = new ObjectCollection.Builder().withImages(topLeft2).build();
                ...
                new StateImage.Builder()
                        .addPattern(
                                new Pattern.Builder()
                                        ...
                                        .build())
                        .build();
        ObjectCollection objColl2Override =
                new ObjectCollection.Builder().withImages(topLeft2Override).build();
        ...
        assertFalse(
                matches2.isEmpty(),
                "Should find pattern with position/offset in ObjectActionOptions");
        ...
        assertTrue(
                Math.abs(loc1.getX() - loc2.getX()) < 5,

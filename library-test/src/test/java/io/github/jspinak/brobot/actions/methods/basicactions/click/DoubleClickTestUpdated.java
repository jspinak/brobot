 ...
 * 1. Double-click actions using ClickOptions
 * 2. Triple-click functionality
 * 3. Custom pause settings
 * 4. Different click types (DOUBLE_LEFT, TRIPLE_LEFT)
 * 
 * Rewritten to use actual available APIs:
 * - ClickOptions with setNumberOfClicks(2) for double-click
 * - MousePressOptions for button and timing configuration
 * - No ClickOptions.Type enum - use numberOfClicks
 * - No ExecutionEnvironment in production API

...
public class TestPatternMatchingWithZoom {
    ...
    @Autowired private ScenePatternMatcher scenePatternMatcher;
    ...
    public void testMatchingWithSavedImages() throws Exception {
        ...
        File patternFile =
                new File(
                        "/mnt/c/Users/jspin/Documents/brobot_parent/claude-automator/history/best-matches/20250810-190508_claude-prompt-3_sim0,387_pattern.png");
        File matchFile =
                new File(
                        "/mnt/c/Users/jspin/Documents/brobot_parent/claude-automator/history/best-matches/20250810-190508_claude-prompt-3_sim0,387_match.png");
    ...
    private void testDirectSikuliMatching(BufferedImage pattern, BufferedImage scene) {
        ...
        for (double threshold : thresholds) {
            ...
            org.sikuli.script.Pattern sikuliPattern =
                    new org.sikuli.script.Pattern(pattern).similar(threshold);
    ...
    public void testCurrentScreenCapture() throws Exception {
        ...
        System.out.println(
                "Screen captured: " + currentScreen.getWidth() + "x" + currentScreen.getHeight());

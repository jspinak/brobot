...
public class MatchSnapshotJsonParserTestUpdated {
    ...
    public void testMatchSnapshotBuilderWithActionConfig() throws Exception {
        ...
        MoveOptions moveOptions = new MoveOptions.Builder()
                .setMoveType(MoveOptions.Type.INSTANT)
                .build();
        ...
        assertNotNull(deserializedSnapshot);
        assertNotNull(deserializedSnapshot.getActionConfig());
        assertTrue(deserializedSnapshot.getActionConfig() instanceof MoveOptions);
        
        MoveOptions deserializedMoveOptions = (MoveOptions) deserializedSnapshot.getActionConfig();
        assertEquals(MoveOptions.Type.INSTANT, deserializedMoveOptions.getMoveType());
    ...
    public void testMixedLegacyAndNewAPI() throws Exception {
        ...
        assertEquals(ActionOptions.Action.FIND, deserialized.getActionOptions().getAction());
        assertEquals(ActionOptions.Find.ALL, deserialized.getActionOptions().getFind());
    }
}
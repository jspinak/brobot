 ...
 *
 * <p>Compares FFmpeg captures with SikuliX captures to verify physical resolution.
 */
@DisabledInCI
@SpringBootTest
...
public class FFmpegCaptureTest extends BrobotTestBase {
    ...
    public void testFFmpegAvailability() {
        ...
        if (available) {
            ...
            assertEquals(
                    CaptureProvider.ResolutionType.PHYSICAL, ffmpegProvider.getResolutionType());
        } else {
    ...
    public void testCaptureComparison() throws IOException {
        ...
        Assumptions.assumeFalse(
                java.awt.GraphicsEnvironment.isHeadless() || System.getenv("CI") != null,
        ...
        System.out.println(
                "FFmpeg capture: "
                        + ffmpegCapture.getWidth()
                        + "x"
                        + ffmpegCapture.getHeight()
                        + " ("
    ...
    public void testProviderSwitching() throws IOException {
        ...
        try {
            ...
            System.out.println("FFmpeg capture: " + capture.getWidth() + "x" + capture.getHeight());
        } catch (Exception e) {
        ...
        try {
            ...
            BufferedImage capture = captureService.captureScreen();
            System.out.println(
                    "SikuliX capture: " + capture.getWidth() + "x" + capture.getHeight());
        } catch (Exception e) {

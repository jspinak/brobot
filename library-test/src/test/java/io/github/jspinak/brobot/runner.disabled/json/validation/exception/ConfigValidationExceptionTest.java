...
class ConfigValidationExceptionTest {
    ...
    void constructor_withMessageAndResult_shouldSetBoth() {
        ...
        result.addError(
                new ValidationError("TestError", "Test error message", ValidationSeverity.ERROR));
    ...
    void constructor_withAllParameters_shouldSetAll() {
        ...
        result.addError(
                new ValidationError(
                        "CriticalError", "Critical failure", ValidationSeverity.CRITICAL));
    ...
    void getValidationResult_withMultipleErrors_shouldReturnAllErrors() {
        ...
        ConfigValidationException exception =
                new ConfigValidationException("Multiple errors", result);
        ...
        assertEquals(
                ...
                actualResult
                        .getErrors()
                        .size()); // getErrors() returns all errors including warnings and info

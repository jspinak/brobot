 ...
 *
 * <p>Key points: - TaskSequence contains a list of ActionStep objects - Each ActionStep has
 * actionConfig and objectCollection - ActionConfig uses @type for polymorphic deserialization
 */
...
class TaskSequenceJsonParserTest {
    ...
    void testTaskSequenceToJson() throws ConfigurationException {
        ...
        findStep.setActionConfig(
                new PatternFindOptions.Builder()
                        .setSearchDuration(3.0)
                        .setStrategy(PatternFindOptions.Strategy.ALL)
                        .build());
        ObjectCollection findObjects = new ObjectCollection();
        StateImage findImage = new StateImage.Builder().setName("SearchTarget").build();
        ...
        clickStep.setActionConfig(new ClickOptions.Builder().setNumberOfClicks(1).build());
        ObjectCollection clickObjects = new ObjectCollection();
        StateImage clickImage = new StateImage.Builder().setName("ClickTarget").build();

...
/**
 * Integration test for search region dependencies. Tests how Brobot resolves dynamic search regions
 * based on other objects.
 */
@SpringBootTest(classes = IntegrationTestMinimalConfig.class)
@Import({SearchRegionDependencyTest.MenuState.class, SearchRegionDependencyTest.DialogState.class})
...
public class SearchRegionDependencyTest extends IntegrationTestBase {
    ...
    @Autowired private SearchRegionDependencyRegistry dependencyRegistry;

    /** Menu state with base elements */
    @Component
    @State(initial = true)
    @Getter
    public static @Disabled("CI failure - needs investigation") class MenuState {
            ...
            menuButton =
                    new StateImage.Builder()
                            ...
                            .setSearchRegionForAllPatterns(
                                    Region.builder().withRegion(100, 50, 100, 30).build())
                            .build();
                                    ...
                                    SearchRegionOnObject.builder()
                                            ...
                                            .setAdjustments(
                                                    MatchAdjustmentOptions.builder()
                                                            ...
                                                            .setAddH(200) // Extended height for
                                                            // dropdown
                                                            .build())
                                            .build())
                            .build();
    ...
    @State
    @Getter
    public static @Disabled("CI failure - needs investigation") class DialogState {
        ...
        public DialogState() {
            ...
            dialogTitle =
                    new StateImage.Builder()
                            .setName("DialogTitle")
                            .setSearchRegionForAllPatterns(
                                    Region.builder().withRegion(200, 150, 400, 40).build())
                            .build();
    ...
    public void testMultipleDependencies() {
        ...
        Set<String> dependentNames =
                titleDependents.stream()
                        .map(dep -> dep.getStateObject().getName())
                        .collect(Collectors.toSet());

        assertTrue(
                dependentNames.contains("DialogCloseButton"),
                "DialogCloseButton should depend on DialogTitle");
        assertTrue(
                dependentNames.contains("DialogContent"),
    ...
    public void testSearchRegionAdjustments() {
        ...
        assertEquals(30, adjustments.getAddY(), "Should add 30 pixels to Y (below button)");
        assertEquals(200, adjustments.getAddH(), "Should add 200 pixels to height");

        log.info(
                "Search region adjustments: Y+{}, H+{}",
                adjustments.getAddY(),
                adjustments.getAddH());
    }
    ...
    public void testCrossStateDependency() {
        ...
        assertEquals("Menu", config.getTargetStateName(), "Should reference Menu state");
        assertEquals("MenuButton", config.getTargetObjectName(), "Should reference MenuButton");
    ...
    public void testDependencyChain() {
        ...
        StateImage baseImage =
                new StateImage.Builder()
                        .setName("BaseImage")
                        .setSearchRegionForAllPatterns(
                                Region.builder().withRegion(50, 50, 100, 100).build())
                        .build();

        StateImage middleImage =
                new StateImage.Builder()
                        .setName("MiddleImage")
                        .setSearchRegionOnObject(
                                SearchRegionOnObject.builder()
        ...
        assertNotNull(middleImage.getSearchRegionOnObject(), "Middle should depend on Base");
        assertNotNull(
                dependentImage.getSearchRegionOnObject(), "Dependent should depend on Middle");
    ...
    public void testDynamicRegionResolution() {
        ...
        ObjectCollection buttonObjects =
                new ObjectCollection.Builder().withImages(menu.getMenuButton()).build();
        ...
        ObjectCollection dropdownObjects =
                new ObjectCollection.Builder().withImages(menu.getMenuDropdown()).build();
    ...
    public void testRegionAdjustmentCalculation() {
        ...
        // Base region
        Region baseRegion = Region.builder().withRegion(100, 100, 200, 50).build();

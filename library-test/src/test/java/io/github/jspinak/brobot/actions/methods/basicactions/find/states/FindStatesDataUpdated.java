...
/**
 * Updated helper class for finding states data using new ActionConfig API. Demonstrates migration
 * from ActionOptions to TextFindOptions for OCR operations.
 */
public class FindStatesDataUpdated {
    ...
    public List<ObjectCollection> getStateObjectCollections(ActionService actionService) {
        ...
        ObjectCollection stateColl1 =
                getStateObjectCollection(testData.getFloranext0(), actionService);
        ObjectCollection stateColl2 =
                getStateObjectCollection(testData.getFloranext1(), actionService);
        ObjectCollection stateColl3 =
                getStateObjectCollection(testData.getFloranext2(), actionService);
        ObjectCollection stateColl4 =
                getStateObjectCollection(testData.getFloranext3(), actionService);
        ObjectCollection stateColl5 =
                getStateObjectCollection(testData.getFloranext4(), actionService);

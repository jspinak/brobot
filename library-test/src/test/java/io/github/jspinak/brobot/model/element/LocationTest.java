...
class LocationTest {
    ...
    private final Location locationDefinedByRegion =
            new Location(region, Positions.Name.BOTTOMLEFT);
    ...
    void getSikuliLocationFromLocationDefinedByRegion() {
        ...
        System.out.format(
                ...
                sikuliLocation.x,
                sikuliLocation.y,
                locationDefinedByRegion.getCalculatedX(),
                locationDefinedByRegion.getCalculatedY());

...
public class ConsoleActionConfigTest extends BrobotTestBase {
    ...
    public void testLevelEnum() {
        ...
        // Test valueOf
        assertEquals(ConsoleActionConfig.Level.QUIET, ConsoleActionConfig.Level.valueOf("QUIET"));
        assertEquals(ConsoleActionConfig.Level.NORMAL, ConsoleActionConfig.Level.valueOf("NORMAL"));
        assertEquals(
                ConsoleActionConfig.Level.VERBOSE, ConsoleActionConfig.Level.valueOf("VERBOSE"));
    }

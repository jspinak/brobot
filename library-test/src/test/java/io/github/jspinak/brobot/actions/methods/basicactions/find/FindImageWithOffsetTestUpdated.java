...
/**
 * Updated tests for find operations with position and offset settings using new
 * ActionConfig API.
 * Demonstrates migration from ActionOptions to PatternFindOptions.
 * Uses Brobot's unit testing mode for real pattern matching without physical
 * actions.
 * 
 * Key changes:
...
public class FindImageWithOffsetTestUpdated extends BrobotIntegrationTestBase {
        ...
        void findImageWithOffsetTestNewAPI() {
                ...
                System.out.println("loc1.getCalculatedX()=" + loc1.getCalculatedX() + ", loc1.getCalculatedY()="
                                + loc1.getCalculatedY());
                System.out.println("loc2.getCalculatedX()=" + loc2.getCalculatedX() + ", loc2.getCalculatedY()="
                                + loc2.getCalculatedY());
        ...
        void findWithDifferentStrategiesAndOffsets() {
                ...
                StateImage imageWithOffset = new StateImage.Builder()
                                .addPattern(new Pattern.Builder()
                                                .setFilename(TestPaths.getImagePath("topLeft"))
                                ...
                                .build();
                ObjectCollection objColl = new ObjectCollection.Builder()
                                .withImages(imageWithOffset)
                                .build();

                // Use BEST strategy
                PatternFindOptions bestFindOptions = new PatternFindOptions.Builder()
                ...
                StateImage imageWithDifferentOffset = new StateImage.Builder()
                                .addPattern(new Pattern.Builder()
                                                .setFilename(TestPaths.getImagePath("topLeft"))
                                                .setTargetOffset(-5, -5)
                                                .build())
                                .build();
                ObjectCollection objColl2 = new ObjectCollection.Builder()
                                .withImages(imageWithDifferentOffset)
                                .build();

                PatternFindOptions allFindOptions = new PatternFindOptions.Builder()
         ...
         * Verifies setPositionForAllPatterns and setOffsetForAllPatterns work
         * correctly.
         */
        @Test
        ...
        void compareOldAndNewAPI() {
                ...
                StateImage imageWithPositionAndOffset = new StateImage.Builder()
                                .addPattern(new Pattern.Builder()

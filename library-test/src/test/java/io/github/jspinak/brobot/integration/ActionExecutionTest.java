...
/**
 * Integration test for Action execution in Brobot. Tests various action types and configurations in
 * mock mode.
 */
...
public class ActionExecutionTest extends IntegrationTestBase {
    ...
    private void setupTestState() {
        ...
        testState = new State.Builder("TestActionState").withImages(buttonImage, iconImage).build();
    ...
    public void testTypeAction() {
        ...
        assertEquals(
                textToType, result.getText().getStrings().get(0), "Typed text should match input");
    ...
    public void testActionWithSearchRegion() {
        ...
        StateImage imageWithRegion =
                new StateImage.Builder()
                        .setName("ImageInRegion")
                        .setSearchRegionForAllPatterns(searchRegion)
                        .build();

        PatternFindOptions findInRegion =
                new PatternFindOptions.Builder()
                        .setStrategy(PatternFindOptions.Strategy.FIRST)
                        .build();

        ObjectCollection objects =
                new ObjectCollection.Builder().withImages(imageWithRegion).build();
    ...
    public void testLocationBasedAction() {
        ...
        StateImage imageAtCenter =
                new StateImage.Builder()
                        .setName("CenterImage")
                        .setSearchRegionForAllPatterns(
                                Region.builder()
                                        .withRegion(
                                                (int) centerScreen.getX() - 25,
                                                (int) centerScreen.getY() - 25,
                                                50,
                                                50)
                                        .build())
                        .build();
        ...
        ObjectCollection objects = new ObjectCollection.Builder().withImages(imageAtCenter).build();

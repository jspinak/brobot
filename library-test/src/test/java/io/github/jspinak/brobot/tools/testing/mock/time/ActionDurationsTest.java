 ...
 * mappings, strategy durations, and BrobotProperties integration.
 */
...
public class ActionDurationsTest extends BrobotTestBase {
    ...
    class ActionTypeDurationTests {
        ...
        void shouldReturnClickDuration() {
            ...
            // Duration depends on configuration
        ...
        void shouldReturnDragDuration() {
            ...
            // Assertion using old BrobotProperties value removed
    ...
    @Nested
    @DisplayName("BrobotProperties Integration")
    class BrobotPropertiesIntegration {

        @Test
        @DisplayName("Should use BrobotProperties values at initialization")
        void shouldUseBrobotPropertiesValuesAtInitialization() {
            // Set custom values
        ...
        @Test
        @DisplayName("Should use BrobotProperties find durations")
        void shouldUseBrobotPropertiesFindDurations() {
            // Set custom values
        ...
        @Test
        @DisplayName("Should not be affected by later BrobotProperties changes")
        void shouldNotBeAffectedByLaterBrobotPropertiesChanges() {
            // Get initial durations
            double initialClick = actionDurations.getActionDuration(ActionType.CLICK);

            // Change BrobotProperties after creation
            // Setting mockTimeClick now handled by BrobotProperties
            ...
            assertEquals(
                    initialClick,
                    afterChangeClick,
                    "Duration should not change after BrobotProperties modification");
    ...
    class EdgeCasesAndBoundaries {
        ...
        @Test
        @DisplayName("Should handle negative duration values from BrobotProperties")

...
class LocationJsonParserTest {
    ...
    void testParseLocationWithXY() throws ConfigurationException {
        ...
        Location location = jsonParser.convertJson(json, Location.class);
    ...
    void testSerializeDeserializeLocationXY() throws ConfigurationException {
        ...
        // Deserialize
        Location deserializedLocation = jsonParser.convertJson(json, Location.class);
    ...
    void testSerializeDeserializeLocationRegion() throws ConfigurationException {
    ...
    void testDefined() {
        ...
        // Create a location with default constructor
        // Note: The behavior of defined() for default constructor may vary
        Location loc2 = new Location();
        // Implementation-dependent: assertFalse(loc2.defined());

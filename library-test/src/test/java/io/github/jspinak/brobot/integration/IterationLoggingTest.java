...
@TestPropertySource(properties = {"claude.automator.monitoring.max-iterations=3"})
...
public class IterationLoggingTest extends BrobotTestBase {
    ...
    public void testIterationLoggingVerbose() throws InterruptedException {
        ...
        try {
            java.lang.reflect.Field field =
                    StateAwareScheduler.class.getDeclaredField("verbosityConfig");
        ...
        StateCheckConfiguration config =
                new StateCheckConfiguration.Builder().withMaxIterations(3).build();
    ...
    public void testIterationLoggingNormal() throws InterruptedException {
        ...
        StateCheckConfiguration config =
                new StateCheckConfiguration.Builder().withMaxIterations(10).build();

...
/**
 * Tests find operations with position settings. Uses Brobot's unit testing mode for real pattern
 * matching without physical actions.
 */
@SpringBootTest
...
public class FindImageWithPositionTest extends BrobotIntegrationTestBase {
    ...
    /**
     * Test that different Positions in Patterns give different results. In the new API, positions
     * are only set on Patterns, not in options.
     */
    @Test
                ...
                new StateImage.Builder()
                        .addPattern(
                                new Pattern.Builder()
                                        .setFilename(TestPaths.getImagePath("topLeft"))
                                        .setTargetPosition(
                                                new Position(50, 50)) // Different position
                                        .build())
                        .build();
        ObjectCollection objColl2 =
                new ObjectCollection.Builder()
                        ...
                        .withScenes(TestPaths.getScreenshotPath("floranext0"))
                        .build();
        PatternFindOptions findOptions3 = new PatternFindOptions.Builder().build();

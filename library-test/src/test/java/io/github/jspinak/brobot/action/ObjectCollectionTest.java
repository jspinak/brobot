...
/**
 * Comprehensive tests for ObjectCollection class.
 * Tests builder patterns, collection operations, and edge cases.
 */
...
public class ObjectCollectionTest extends BrobotIntegrationTestBase {
    ...
    void testWithMatches() {
        ...
        Match match1 = new Match.Builder()
            .setRegion(new Region(0, 0, 50, 50))
            .setSimScore(0.95)
            .build();
    ...
    void testSpecialCharactersInStrings() {
        ...
        // When
        ObjectCollection collection = new ObjectCollection.Builder()
            .withStrings(specialChars, unicode, newlines)
            .build();
    ...
    void testIsEmptyMethod() {
        ...
        ObjectCollection withImage = new ObjectCollection.Builder()
            .withImages(new StateImage.Builder().setName("test").build())
            .build();
        ObjectCollection withRegion = new ObjectCollection.Builder()
            .withRegions(new Region(0, 0, 10, 10))
            .build();
    ...
    void testThreadSafetySimulation() throws InterruptedException {
        ...
        for (int i = 0; i < threads.length; i++) {
            ...
            threads[i] = new Thread(() -> {
                builder.withImages(new StateImage.Builder().setName("thread" + index).build());
    ...
    void testVeryLongStrings() {
        ...
        // When
        ObjectCollection collection = new ObjectCollection.Builder()
            .withStrings(longString.toString())
            .build();

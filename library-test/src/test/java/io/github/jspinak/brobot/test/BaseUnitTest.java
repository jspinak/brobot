...
/**
 * Base class for unit tests that use mock data and don't require real files or screen access.
 *
 * <p>This class configures BrobotEnvironment to:
 *
 * <ul>
 *   <li>Use mock mode for all operations
 *   <li>Return fake data instead of accessing files or screen
 *   <li>Run quickly without external dependencies
 * </ul>
 *
 * <p>Unit tests should extend this class when they don't need real image processing or file access.
 */

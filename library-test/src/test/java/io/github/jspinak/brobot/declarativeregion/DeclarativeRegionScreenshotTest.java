...
/**
 * Test declarative region definition using fixed screenshots. This test uses actual image files
 * from the FloraNext test resources. Can be run from WSL with mock mode enabled.
 *
 * <p>Tests the scenario where topLeft image sets the search region for dependent images.
 */
@SpringBootTest
...
public class DeclarativeRegionScreenshotTest extends BrobotTestBase {
    ...
    private void setupFloraNextImages() {
        ...
        floraState = new State.Builder("FloraNext").withImages(topLeftImage).build();
        ...
        menuState = new State.Builder("MenuState").withImages(menuItemImage).build();
                ...
                new StateImage.Builder()
                        ...
                        .setSearchRegionOnObject(
                                SearchRegionOnObject.builder()
                                        ...
                                        .setTargetObjectName(
                                                "menuItem") // Depends on menuItem, not topLeft
                                        .setAdjustments(
                                                MatchAdjustmentOptions.builder()
                                                        .setAddX(20) // Indented
    ...
    void testRealWorldFloraNextScenario() {
        ...
        assertTrue(
                constrainedArea < fullScreenArea / 10,

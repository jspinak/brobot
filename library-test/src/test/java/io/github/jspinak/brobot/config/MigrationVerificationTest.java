 ...
 *
 * <p>This test ensures: 1. BrobotProperties is properly loaded and configured 2. Mock mode
 * configuration works correctly 3. All property groups are accessible
 */
@SpringBootTest
...
public class MigrationVerificationTest extends BrobotTestBase {
    ...
    public void testMockModeConfiguration() {
        ...
        assertTrue(brobotProperties.getCore().isMock(), "Mock mode should be enabled in test");
    }

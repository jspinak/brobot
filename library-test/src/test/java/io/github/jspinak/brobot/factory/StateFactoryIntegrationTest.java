...
public class StateFactoryIntegrationTest {
    ...
    class StateCreation {
        ...
        void shouldCreateStateWithInitializer() {
            Consumer<State.Builder> initializer = builder -> {
    ...
    class StateImageCreation {
        ...
        void shouldCreateStateImageWithSingleImage() {
            ...
            assertEquals("button.png", pattern.getImgpath(), "Pattern should have correct image path");
        }
    ...
    class StateStringCreation {
        ...
        void shouldCreateStateStringWithNullOwner() {
            ...
            assertTrue(stateString.getOwnerStateName() == null || stateString.getOwnerStateName().isEmpty());
        }
    }
    ...
    class EdgeCases {
        ...
        void shouldHandleInitializerThatThrowsException() {
            Consumer<State.Builder> badInitializer = builder -> {
    ...
    class FactoryPatternVerification {
        ...
        void shouldCreateIndependentStateImageInstances() {
            ...
            assertEquals(image1.getPatterns().get(0).getImgpath(), 
    ...
    class IntegrationScenarios {
        ...
        void shouldCreateCompleteStateHierarchy() {
            ...
            StateString username = stateFactory.createStateString("Username", "admin", "LoginState");
            StateString password = stateFactory.createStateString("Password", "secret", "LoginState");
            
            // Create state with all components
            Consumer<State.Builder> initializer = builder -> {
                builder.withImages(loginButton, usernameField)
                       .setBaseProbabilityExists(95);
        ...
        void shouldSupportFluentStateBuilding() {
            ...
            Consumer<State.Builder> fluentInitializer = builder -> builder
                .withImages(img1, img2)
                .setBaseProbabilityExists(70);
            ...
            int totalPatterns = state.getStateImages().stream()
                .mapToInt(img -> img.getPatterns().size())
                .sum();
            assertEquals(3, totalPatterns, "Total patterns should be 3 (1 from img1 + 2 from img2)");
        }
    }
}
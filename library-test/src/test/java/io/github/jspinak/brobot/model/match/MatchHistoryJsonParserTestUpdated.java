 ...
 *
 * <p>Note: The original test used non-existent methods: - ClickOptions.Type and
 * setClickType/getClickType don't exist - Click type is configured through MousePressOptions -
...
class MatchHistoryJsonParserTestUpdated extends BrobotIntegrationTestBase {
    ...
    void testComplexActionConfig() throws Exception {
        ...
        assertEquals(
                0.1, deserializedOptions.getMousePressOptions().getPauseBeforeMouseDown(), 0.001);
    }
}

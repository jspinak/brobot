...
/**
 * Tests for finding patterns through iteration. Works in headless mode by using real image
 * processing.
 */
@SpringBootTest(
...
class FindPatternsIterationTest extends BrobotIntegrationTestBase {
    ...
    @Autowired IterativePatternFinder iterativePatternFinder;
    ...
    void find_() {
        try {
            ...
            List<Scene> scenes =
                    getScenes.getScenes(
                            testData.getDefineInsideAnchors(),

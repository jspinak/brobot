 ...
 * - Pattern and StateImage builders
 * - ActionConfig classes (PatternFindOptions, ClickOptions)
...
public class SimpleAPITestUpdated extends BrobotIntegrationTestBase {
    ...
    void testVariousActionConfigs() {
        ...
        // Note: Text to type comes from StateString in ObjectCollection, not TypeOptions
    }
    ...
    void testPatternWithOffsets() {
        ...
        Pattern pattern = new Pattern.Builder()
                ...
                .setBufferedImage(new BufferedImage(100, 100, BufferedImage.TYPE_INT_RGB))
                .setTargetPosition(new Position(10, 20)) // Click 10 pixels right, 20 pixels down from center
                .build();

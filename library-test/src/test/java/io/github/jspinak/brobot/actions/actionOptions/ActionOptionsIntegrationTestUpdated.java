 ...
 * - DragOptions only has mousePressOptions, delayBetweenMouseDownAndMove, and delayAfterDrag
 * - PatternFindOptions has Strategy enum and similarity settings
 * - ClickOptions has numberOfClicks and mousePressOptions
 * - No direct location setters on DragOptions (locations come from ObjectCollection)
 */
...
public class ActionOptionsIntegrationTestUpdated extends BrobotIntegrationTestBase {
    ...
    void testDragOptionsCreation() {
         ...
         * The source and target locations come from the ObjectCollection passed to the action.
         */

...
/**
 * Minimal test configuration that provides mocked beans to avoid circular dependencies. This
 * configuration is designed for fast test execution without Spring context issues.
 */
@TestConfiguration
...
public class MinimalTestConfiguration {
    ...
    public ActionService mockActionService() {
        ...
        when(mockService.getAction(any()))
                .thenAnswer(
                        invocation -> {

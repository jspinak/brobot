 ...
 * 1. Clicking with position adjustments
 * 2. Adding X/Y offsets to click location
 * 3. Using target positions on patterns
 * 4. Testing with screenshot operations
 * 
 * Rewritten to use actual available APIs:
 * - ClickOptions with MousePressOptions for button configuration
 * - Pattern.Builder.setTargetPosition() for position adjustments
 * - No ClickOptions.Type enum - use MouseButton
 * - No setOffsetX/setOffsetY on ClickOptions - use Pattern positions
 */

...
/**
 * Tests for ActionChainOptions and ConditionalActionChain.
 * Replaces old MultipleActions and MultipleBasicActions tests.
 * 
 * These tests verify that composite action sequences work correctly with:
 * - ActionChainOptions for sequential actions
 * - ConditionalActionChain for conditional workflows
 * - Pure actions that don't have circular dependencies
 */
...
public class MultipleActionsTestUpdated extends BrobotIntegrationTestBase {
    ...
    void testActionChainWithMultipleActions() {
        ...
        ActionResult result = chainExecutor.executeChain(
            ...
            new ObjectCollection.Builder().build(), // For click (uses previous find result)
            new ObjectCollection.Builder().withStrings("Hello World").build()  // For type with text
        );
        
        assertNotNull(result, "Chain execution should return a result");
        // In mock mode, actions should succeed
        assertTrue(result.isSuccess() || result.getMatchList() != null, 
    ...
    void testEmptyActionChain() {
        ...
        ActionChainOptions emptyChain = new ActionChainOptions.Builder(
    ...
    void testActionChainWithMultipleIterations() {
        ...
        ActionChainOptions clickChain = new ActionChainOptions.Builder(
    ...
    void testComplexChainWithNestedStrategy() {
        ...
        ActionChainOptions nestedChain = new ActionChainOptions.Builder(
            new PatternFindOptions.Builder()
                .setStrategy(PatternFindOptions.Strategy.FIRST)
                .build())
        ...
        // Create test images
        StateImage container = new StateImage.Builder()
            .setName("Container")
            .addPattern("container.png")
            .build();

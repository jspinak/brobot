 ...
 *
 * <p>Verifies that the orchestrator properly manages the initialization phases and provides
 * accurate status information.
 */
@SpringBootTest(
        classes = {InitializationOrchestrator.class, InitializationOrchestrator.PhaseStatus.class})
...
public class BrobotInitializationOrchestratorTest extends BrobotTestBase {
    ...
    @Autowired private InitializationOrchestrator orchestrator;
    ...
    public void testInitializationPhases() {
        ...
        Map<String, InitializationOrchestrator.PhaseStatus> phases =
                orchestrator.getPhaseStatuses();

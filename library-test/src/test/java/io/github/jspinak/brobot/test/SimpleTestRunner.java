...
/**
 * Simple test runner to verify the test configuration works without hanging. This test uses a
 * minimal configuration to bypass components that might block.
 */
@SpringBootTest(classes = {MinimalTestConfig.class, MockScreenCaptureConfig.class})
@TestPropertySource(locations = "classpath:application-test.properties")
@ContextConfiguration(
        initializers = io.github.jspinak.brobot.test.config.TestConfigurationManager.class)

...
public class StateDetectionIntegrationTest extends BrobotTestBase {
    ...
    public static class DashboardState {
        ...
        public DashboardState() {
            dashboardHeader = new StateImage.Builder()
            ...
            welcomeText = new StateString.Builder()
                .setName("WelcomeText")
                .setString("Welcome")
                .build();
        }
    ...
    public static class SettingsState {
        ...
        public SettingsState() {
            settingsIcon = new StateImage.Builder()
    ...
    public void testInitialStateDetection() {
        ...
        assertTrue(activeStateNames.contains("Login"), 
                  "Login should be in initial states");
    }
    ...
    public void testStateProbability() {
        ...
        assertEquals(100, dashboardState.getProbabilityExists(), 
        ...
        assertEquals(0, loginState.getProbabilityExists(), 
    ...
    public void testMultipleActiveStates() {
        ...
        assertTrue(activeStates.contains(dashboardState.getId()), 
                  "Dashboard should be active");
        assertTrue(activeStates.contains(settingsState.getId()), 
                  "Settings should be active");
        assertFalse(activeStates.contains(loginState.getId()), 
                   "Login should not be active");
    ...
    public void testStateDetectionWithMatches() {
        ...
        ObjectCollection objects = new ObjectCollection.Builder()
            .withImages(dashboard.getDashboardHeader())
            .build();
    ...
    public void testStateVisitCounter() {
        ...
        log.info("Initial visit counts - Login: {}, Dashboard: {}", 
                initialLoginVisits, initialDashboardVisits);
        ...
        assertTrue(loginState.getTimesVisited() > initialLoginVisits, 
                  "Login visit count should increase");
        assertTrue(dashboardState.getTimesVisited() > initialDashboardVisits, 
                  "Dashboard visit count should increase");
        
        log.info("Updated visit counts - Login: {}, Dashboard: {}", 
                loginState.getTimesVisited(), dashboardState.getTimesVisited());
    }
    ...
    public void testStateTransitionDetection() {
        ...
        assertEquals(1, stateMemory.getActiveStates().size(), 
                    "Should have only Dashboard active");
        assertTrue(stateMemory.getActiveStates().contains(dashboardState.getId()), 
                  "Dashboard should be active after transition");
        assertFalse(stateMemory.getActiveStates().contains(loginState.getId()), 

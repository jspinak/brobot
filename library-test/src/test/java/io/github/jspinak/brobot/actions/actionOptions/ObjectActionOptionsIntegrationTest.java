...
public class ObjectActionOptionsIntegrationTest {
    ...
    void testCreationInSpringContext() {
        // This test uses the old ObjectActionOptions API which has been replaced by ActionConfig classes
        ...
        // Verifies that a complex ObjectActionOptions object can be built in a Spring test environment.
        ...
        assertNotNull(options, "ObjectActionOptions object should not be null when created in a Spring context.");

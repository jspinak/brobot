...
/**
 * Factory for creating logger components in tests.
 * This factory ensures proper initialization order and follows SRP by
 * separating logger creation from bean wiring.
 * 
...
public class TestLoggerFactory {
    ...
    /**
     * Creates a complete logging system for tests.
     * This method ensures all components are created in the correct order.
     */
    ...
    /**
     * Container for all logging components.
     * This ensures proper lifecycle management and access to all components.
     */
    public static class LoggingSystem {
        ...
        public LoggingSystem(LoggingContext context, LogSink logSink, 
                            ConsoleFormatter formatter, MessageRouter router,
                            BrobotLogger logger, ConsoleReporterInitializer reporterInit) {
        ...
        public LoggingContext getContext() { return context; }
        public LogSink getLogSink() { return logSink; }
        public ConsoleFormatter getFormatter() { return formatter; }
        public MessageRouter getRouter() { return router; }
        public BrobotLogger getLogger() { return logger; }
        public ConsoleReporterInitializer getReporterInit() { return reporterInit; }
    }
}
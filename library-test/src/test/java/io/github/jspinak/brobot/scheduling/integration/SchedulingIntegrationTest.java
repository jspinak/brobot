...
/**
 * Integration tests for scheduling and concurrent execution in Brobot. Tests task execution,
...
class SchedulingIntegrationTest extends BrobotIntegrationTestBase {
    ...
    void setupTestData() {
        ...
        testCollection = new ObjectCollection.Builder().withImages(testImage).build();
    }
        ...
        void shouldExecuteDelayedTask() throws InterruptedException {
            ...
            ScheduledFuture<?> future =
                    scheduledExecutor.schedule(
                            () -> executed.set(true), delayMillis, TimeUnit.MILLISECONDS);
    ...
    class TaskCoordinationTests {
        ...
        void shouldCoordinateDependentTasks() throws InterruptedException, ExecutionException {
            ...
            CompletableFuture<String> secondTask =
                    firstTask.thenApplyAsync(result -> result + " -> Second", executorService);

            CompletableFuture<String> thirdTask =
                    secondTask.thenApplyAsync(result -> result + " -> Third", executorService);
    ...
    class ErrorHandlingTests {
        ...
        void shouldHandleRejectedExecution() {
            // Given
            ExecutorService limitedExecutor =

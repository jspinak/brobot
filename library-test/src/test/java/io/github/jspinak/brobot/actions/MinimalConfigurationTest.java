...
/**
 * Test that uses minimal configuration to avoid circular dependencies. This demonstrates how to
 * test Brobot actions without full Spring context.
 */
...
public class MinimalConfigurationTest {
    ...
    void testClickWithMinimalConfiguration() {
        // Create test objects
        ObjectCollection objColl =
                new ObjectCollection.Builder().withRegions(new Region(200, 200, 30, 30)).build();

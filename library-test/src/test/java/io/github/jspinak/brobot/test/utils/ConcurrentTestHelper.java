...
/**
 * Utility class to help with timing and concurrency issues in tests. Provides methods to wait for
 * conditions with timeout and retry logic.
 */
public class ConcurrentTestHelper {
    ...
    public static boolean waitForCondition(
            BooleanSupplier condition, Duration timeout, Duration pollInterval) {
    ...
    public static boolean retryOperation(
            BooleanSupplier operation, int maxAttempts, Duration delayBetweenAttempts) {

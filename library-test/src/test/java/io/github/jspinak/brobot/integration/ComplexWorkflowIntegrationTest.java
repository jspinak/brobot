...
/**
 * Integration tests for complex workflows without Spring dependency. Tests the interaction between
 * multiple action components in realistic scenarios.
 */
...
public class ComplexWorkflowIntegrationTest extends BrobotTestBase {
    ...
    class ConditionalWorkflowTests {
        ...
        void shouldExecuteConditionalWorkflow() {
            ...
            StateLocation dashboardLoc =
                    new StateLocation.Builder()
                            .setLocation(new Location(400, 300))
                            .setName("dashboard-loc")
                            .build();
            ObjectCollection dashboardColl =
                    new ObjectCollection.Builder().withLocations(dashboardLoc).build();
        ...
        void shouldHandleFallbackActions() {
            ...
            StateLocation primaryLoc =
                    new StateLocation.Builder()
                            .setLocation(new Location(150, 150))
                            .setName("primary-loc")
                            .build();
            ObjectCollection primaryColl =
                    new ObjectCollection.Builder().withLocations(primaryLoc).build();

            StateLocation fallbackLoc =
                    new StateLocation.Builder()
                            .setLocation(new Location(160, 160))
                            .setName("fallback-loc")
                            .build();
            ObjectCollection fallbackColl =
                    new ObjectCollection.Builder().withLocations(fallbackLoc).build();
            ...
            assertTrue(
                    ...
                    "Either primary or fallback should succeed in mock mode");
        }
    }
    ...
    class ErrorRecoveryTests {
        ...
        void shouldRecoverFromFailures() {
            // Given
            StateLocation targetLoc =
                    new StateLocation.Builder()
                            .setLocation(new Location(100, 100))
                            .setName("target-loc")
                            .build();
            ObjectCollection targetColl =
                    new ObjectCollection.Builder().withLocations(targetLoc).build();

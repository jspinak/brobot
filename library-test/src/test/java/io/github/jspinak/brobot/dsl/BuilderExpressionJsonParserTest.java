...
public class BuilderExpressionJsonParserTest {
    ...
    public void testParseActionOptionsBuilder() throws ConfigurationException {
        ...
        assertEquals(0.8, ((Number) ((LiteralExpression) method2.getArguments().getFirst()).getValue()).doubleValue(), 0.001);
    ...
    public void testParseObjectCollectionBuilder() throws ConfigurationException {
        ...
        assertEquals("loginButton", ((VariableExpression) method1.getArguments().getFirst()).getName());

        BuilderMethod method2 = builder.getMethods().get(1);
        assertEquals("withRegions", method2.getMethod());
        assertEquals(1, method2.getArguments().size());
        assertInstanceOf(VariableExpression.class, method2.getArguments().getFirst());
        assertEquals("searchRegion", ((VariableExpression) method2.getArguments().getFirst()).getName());
    }
    ...
    public void testSerializeDeserializeBuilder() throws ConfigurationException {
        ...
        assertEquals("FIND", ((LiteralExpression) deserializedMethod1.getArguments().getFirst()).getValue());
        ...
        assertEquals("FIRST", ((LiteralExpression) deserializedMethod2.getArguments().getFirst()).getValue());
    }

...
/**
 * Integration tests for StateTransitions - testing state transition management with real component
 * interactions.
 */
...
public class StateTransitionsIntegrationTest extends BrobotTestBase {
    ...
    @Mock private TransitionExecutor transitionExecutor;
    ...
    class TransitionFinding {
        ...
        void shouldFindTransitionByActivatedStateId() {
            ...
            Optional<StateTransition> found =
                    stateTransitions.getTransitionFunctionByActivatedStateId(3L);
        ...
        void shouldReturnEmptyForNonExistentTarget() {
            ...
            Optional<StateTransition> found =
                    stateTransitions.getTransitionFunctionByActivatedStateId(99L);
    ...
    class VisibilityManagement {
        ...
        void shouldUseStateLevelVisibility() {
            ...
            when(transition.getStaysVisibleAfterTransition())
        ...
        void shouldOverrideWithTransitionVisibility() {
            ...
            when(transition.getActivate()).thenReturn(new HashSet<>(Arrays.asList(2L)));
            when(transition.getStaysVisibleAfterTransition())
                    .thenReturn(StateTransition.StaysVisible.FALSE); // Transition says don't
            stateTransitions.getTransitions().add(transition);
    ...
    class ActionDefinitionTransitions {
        ...
        void shouldManageActionDefinitionTransitions() {
            ...
            assertEquals(
                    taskTransition1, stateTransitions.getActionDefinitionTransitions().get(2L));
            assertEquals(
                    taskTransition2, stateTransitions.getActionDefinitionTransitions().get(3L));
        }
    ...
    class IntegrationScenarios {
        ...
        void shouldHandleCompleteTransitionFlow() {
            ...
            when(outgoingTransition.getStaysVisibleAfterTransition())
        ...
        void shouldHandleMultiplePathsToSameTarget() {
            ...
            when(multiTargetTransition.getActivate())
        ...
        void shouldHandleComplexNavigationScenario() {
            ...
            when(multiTransition.getActivate())
            ...
            for (long targetId = 2L; targetId <= 5L; targetId++) {
                Optional<StateTransition> found =
                        stateTransitions.getTransitionFunctionByActivatedStateId(targetId);

...
/**
 * Updated tests for ObjectCollection JSON serialization without Spring dependencies.
 * Demonstrates migration from ConfigurationParser to ObjectMapper.
 */
class ObjectCollectionJsonParserTestUpdated {
    ...
    void testRoundTripWithComplexPattern() throws Exception {
        ...
        assertEquals(TestPaths.getImagePath("topLeft"), deserializedPattern.getImgpath());
        assertEquals(2, deserializedPattern.getSearchRegions().size());
    }
}
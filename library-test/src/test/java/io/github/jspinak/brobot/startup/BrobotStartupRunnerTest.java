...
public class BrobotStartupRunnerTest extends BrobotTestBase {
    ...
    @Mock private InitialStateVerifier.VerificationBuilder mockBuilder;

    @Mock private StartupConfiguration mockConfiguration;
    ...
    public void setupTest() {
        ...
        runner = new StartupRunner(mockStateVerifier, mockConfiguration, properties);
    }
    ...
    class InitialStateVerification {
        ...
        void shouldHandleVerificationFailure() throws Exception {
            when(mockConfiguration.getInitialStates()).thenReturn(Arrays.asList("InvalidState"));
            when(mockConfiguration.getStartupDelay()).thenReturn(0);
    ...
    class StartupDelay {
        ...
        void shouldApplyStartupDelay() throws Exception {
            when(mockConfiguration.getInitialStates()).thenReturn(Arrays.asList("State1"));
            ...
            // Note: In test mode (// Mock mode is now enabled via BrobotTestBase), delay is skipped

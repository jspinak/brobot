...
/**
 * Updated Integration test for ActionService using new ActionConfig API. This demonstrates how to
 * update existing integration tests to use the new API.
 *
 * <p>Key changes: - Use specific option classes (PatternFindOptions, ClickOptions) instead of
 * generic ActionOptions - ActionResult now requires setActionConfig() before perform() -
...
class ActionServiceIntegrationTestUpdated extends BrobotIntegrationTestBase {
    ...
    @Autowired private BasicActionRegistry basicActionRegistry;
    ...
    void testPerformClickAction_WithNewAPI() {
        ...
        // Create test objects
        StateImage stateImage = new StateImage.Builder().setName("ClickTarget").build();
    ...
    void testRegisterCustomAction_WithNewAPI() {
        ...
        ActionInterface customAction =
                new ActionInterface() {
                    ...
                    @Override
                    public void perform(
                            ActionResult matches, ObjectCollection... objectCollections) {

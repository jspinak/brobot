...
/**
 * Test configuration that excludes problematic beans from component scanning and provides mock
 * replacements for headless testing.
 */
@TestConfiguration
@ComponentScan(
...
public class TestApplicationConfiguration {
    ...
    public ScreenCaptureService mockScreenCaptureService() {
        ...
        when(mockService.captureRegion(anyInt(), anyInt(), anyInt(), anyInt()))

...
/**
 * Tests for DefineInsideAnchors functionality. Works in headless mode by handling image loading
 * gracefully.
 */
@SpringBootTest(
...
class DefineInsideAnchorsTest extends BrobotIntegrationTestBase {
    ...
    @Autowired DefineInsideAnchors defineInsideAnchors;

    /**
     * It was unable to find the bottom right image until I removed a few columns from the right of
     * the image. Apparently, images that are cut at the very right side of the screenshot are not
     * findable.
     */
    @Test

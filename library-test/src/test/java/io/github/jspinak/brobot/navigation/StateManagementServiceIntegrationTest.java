...
class StateManagementServiceIntegrationTest {
    ...
    @Autowired private StateIdResolver stateManagementService;

    @MockBean private StateService allStatesInProjectService;
    ...
    void testThreadSafety() throws InterruptedException {
        ...
        when(allStatesInProjectService.getStateId(anyString()))
                .thenAnswer(
                        invocation -> {

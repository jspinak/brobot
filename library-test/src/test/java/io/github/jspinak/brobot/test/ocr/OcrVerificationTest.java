...
/**
 * Verification test for OCR functionality using saved FloraNext screenshots.
 * Works in CI/CD environments without requiring live OCR.
 */
public class OcrVerificationTest {
    ...
    static void setupScreenshots() {
        ...
        assertTrue(OcrTestSupport.areScreenshotsAvailable(), "FloraNext screenshots should be available");
    }
    ...
    void testOcrOnFloraNextScreenshot() throws IOException, TesseractException {
        ...
        assertTrue(screenshot.exists(), "floranext0.png should exist at: " + screenshot.getAbsolutePath());
    ...
    void testOcrEnvironmentSetup() {
        ...
        System.out.println("- BROBOT_DISABLE_LIVE_OCR: " + System.getenv("BROBOT_DISABLE_LIVE_OCR"));

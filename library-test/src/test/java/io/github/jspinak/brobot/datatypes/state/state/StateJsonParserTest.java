 ...
 * These tests verify that the @JsonIgnore annotations correctly break circular references.
 */
@SpringBootTest
...
public class StateJsonParserTest {
     ...
     */
    @Test
    public void testParseBasicState() throws ConfigurationException {
        String json = """
                {
                  "id": 1,
                  "name": "TestState",
        ...
        State state = jsonParser.convertJson(jsonNode, State.class);
     ...
     */
    @Test
    public void testSerializeDeserializeState() throws ConfigurationException {
     ...
     */
    @Test
    public void testAddMethods() throws ConfigurationException {

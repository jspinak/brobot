...
/**
 * Base class for integration tests that need to work with real image files but may run in headless
 * environments (like CI/CD).
 *
 * <p>This class configures BrobotEnvironment to:
 *
 * <ul>
 *   <li>Use real files (not mock) for image loading and processing
 *   <li>Skip screen capture operations in headless environments
 *   <li>Provide clear logging of the environment configuration
 * </ul>
 *
...
public abstract class BaseIntegrationTest {
    ...
    /**
     * Helper method for tests that need to temporarily switch to mock mode. Remember to restore the

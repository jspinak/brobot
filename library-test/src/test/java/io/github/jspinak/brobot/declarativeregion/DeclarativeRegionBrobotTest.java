...
/**
 * Test declarative region definition using Brobot's mock mode. This test can be run from WSL or any
 * headless environment.
 *
 * <p>Tests the scenario where ImageA sets the search region for ImageB, and ImageB's fixed region
 * should be cleared when the declarative region is applied.
 */
@SpringBootTest
...
public class DeclarativeRegionBrobotTest extends BrobotTestBase {
    ...
    @MockBean private StateMemory stateMemory;
    ...
    private void setupStates() {
        ...
        stateA = new State.Builder("StateA").withImages(imageA).build();
                                ...
                                SearchRegionOnObject.builder()
                                        ...
                                        .setAdjustments(
                                                MatchAdjustmentOptions.builder()
                                                        .setAddX(100) // Search 100 pixels to the
                                                        // right
        ...
        stateB = new State.Builder("StateB").withImages(imageB).build();
    ...
    void testCircularDependency() {
        ...
        imageA.setSearchRegionOnObject(
                SearchRegionOnObject.builder()
                        .setTargetType(StateObject.Type.IMAGE)

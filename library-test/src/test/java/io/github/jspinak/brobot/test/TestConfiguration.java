 ...
 * This configuration ensures that Spring can find and load all necessary components
...
public class TestConfiguration {
    ...
    /**
     * Provide a primary ExecutionController bean to resolve the conflict
     * between threadSafeExecutionController and reactiveAutomator.
     * For tests, we'll use the thread-safe controller by default.
     */
    @Bean
    @Primary

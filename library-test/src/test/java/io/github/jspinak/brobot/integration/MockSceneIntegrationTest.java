...
/**
 * Integration tests for mock scene interactions. Tests complex UI scenarios using mock mode to
...
public class MockSceneIntegrationTest extends BrobotTestBase {
    ...
    class BasicMockInteractions {
        ...
        public void testMockLoginWorkflow() {
            ...
            assertEquals(
                    1, usernameCollection.getStateImages().size(), "Should have one state image");
            assertEquals(
                    1, usernameCollection.getStateStrings().size(), "Should have one state string");
    ...
    class ComplexMockScenarios {
        ...
        public void testConditionalWorkflowBasedOnMockState() {
            ...
            if (loginCheck.isSuccess()) {
                ...
                ObjectCollection usernameInput =
                        new ObjectCollection.Builder()
                                .withImages(usernameField)
                                .withStrings("admin")
                                .build();
                ...
                ObjectCollection passwordInput =
                        new ObjectCollection.Builder()
                                .withImages(passwordField)
    ...
    class MockErrorRecovery {
        ...
        public void testMockTimeoutScenarios() {
            ...
            ObjectCollection timeout =
                    new ObjectCollection.Builder().withImages(slowLoadingElement).build();
    ...
    class MockPerformanceScenarios {
        ...
        public void testMockBulkOperations() {
            ...
            List<StateImage> bulkElements =
                    Arrays.asList(usernameField, passwordField, loginButton);
        ...
        public void testMockParallelSearches() {
            ...
            assertTrue(duration < 200, "Mock searches should complete very quickly (under 200ms)");
        }
        ...
        public void testMockComplexWorkflow() {
            ...
            ObjectCollection passCollection =
                    new ObjectCollection.Builder()
                            .withImages(passwordField)

...
/**
 * Integration tests for StateService using the actual Brobot API.
 * Tests state management functionality with real Spring context.
 */
...
class StateServiceIntegrationTest extends BrobotIntegrationTestBase {
    ...
    private List<StateImage> createDashboardImages() {
        ...
        StateImage dashboardHeader = new StateImage.Builder()

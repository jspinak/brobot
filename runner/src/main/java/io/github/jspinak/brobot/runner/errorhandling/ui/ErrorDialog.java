...
public class ErrorDialog extends Dialog<ButtonType> {
    ...
    private TitledPane createDetailsPane() {
        ...
        if (context != null) {
            ...
            details.append("  Category: ")
                    .append(context.getCategory().getDisplayName())
                    .append("\n");
    ...
    public static Optional<ButtonType> showError(
            ErrorMessage errorMessage, String technicalDetails, ErrorContext context) {

...
/**
 * Service responsible for collecting performance diagnostic information.
 * Provides garbage collection metrics, CPU usage, and performance profiling data.
 */
@Slf4j
@Service
    ...
    public PerformanceMetrics collectPerformanceMetrics() {
        ...
        try {
            ...
            for (GarbageCollectorMXBean gc : gcBeans) {
                ...
                gcDetails.put(gc.getName(), GCInfo.builder()
                    .name(gc.getName())
            ...
            String performanceReport = performanceProfiler != null ? 
                performanceProfiler.generateReport().toString() : "Performance profiler not available";

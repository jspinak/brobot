...
public class ConfigurationLoaderService {
    ...
    public void loadConfiguration(
            ConfigEntry config, TreeItem<ConfigBrowserPanel.ConfigItem> rootItem)
            throws IOException {
        ...
        rootItem.setValue(
                new ConfigBrowserPanel.ConfigItem(
                        config.getName(), ConfigBrowserPanel.ConfigItemType.ROOT));
     ...
     */
    private TreeItem<ConfigBrowserPanel.ConfigItem> createConfigurationFilesSection(
            ConfigEntry config) {
     ...
     */
    private TreeItem<ConfigBrowserPanel.ConfigItem> createMetadataSection(
        ...
        metadataItem
                ...
                .addAll(
                        ...
                        treeManagementService.createMetadataItem(
                                "Version: "
     ...
     */
    private TreeItem<ConfigBrowserPanel.ConfigItem> createAutomationSection(
            AutomationProject project) {

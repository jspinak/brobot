...
/**
 * Represents the result of a validation operation. Can be success, warning, or error with an
 * optional message.
 */
@Data
...
public class ValidationResult {
    ...
    /** Checks if the validation was successful (no errors). Warnings are considered valid. */

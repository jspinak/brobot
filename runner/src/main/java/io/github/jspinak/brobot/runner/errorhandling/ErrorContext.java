...
public class ErrorContext {
    ...
    @Builder.Default private final String errorId = UUID.randomUUID().toString();
    ...
    public static ErrorContext recoverable(
            String operation, ErrorCategory category, String recoveryHint) {
        return ErrorContext.builder()
                .operation(operation)
                .category(category)

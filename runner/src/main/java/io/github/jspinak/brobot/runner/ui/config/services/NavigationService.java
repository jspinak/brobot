...
public class NavigationService {
     ...
     */
    public boolean navigateToState(
            String stateName, TreeView<ConfigBrowserPanel.ConfigItem> treeView) {
        TreeItem<ConfigBrowserPanel.ConfigItem> stateItem =
                treeManagementService.getStateItem(stateName);
        if (stateItem != null) {
            // Expand parents
     ...
     */
    public boolean navigateToFirstItemOfType(

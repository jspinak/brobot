...
/**
 * Builder for creating configuration forms with consistent styling. Extracts UI building logic from
...
public class ConfigFormBuilder {
    ...
    private Node createBasicInfoSection(ConfigFormModel model) {
        ...
        GridPane grid = new GridBuilder().withLabelValueColumns().withGap(12, 8).build();
        ...
        descriptionArea
                .textProperty()
                .addListener((obs, old, value) -> model.setDescription(value));
    ...
    private Node createAdditionalFieldsSection(ConfigFormModel model) {
        ...
        // Dynamic fields grid
        GridPane fieldsGrid = new GridBuilder().withLabelValueColumns().withGap(12, 8).build();
    ...
    private void addFormRow(
            GridPane grid, int row, String labelText, Node field, boolean required) {
    ...
    private void addDynamicField(
            GridPane grid, int row, String key, String value, ConfigFormModel model) {
        ...
        removeButton
                .getStyleClass()
                .addAll(Styles.BUTTON_ICON, Styles.BUTTON_CIRCLE, Styles.SMALL, Styles.DANGER);

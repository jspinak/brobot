...
/**
 * Factory service for creating UI components for the basic automation panel.
...
public class BasicUIFactory {
    ...
    public Label createTitleLabel() {
        ...
        titleLabel.setStyle(String.format("-fx-font-size: %s; -fx-font-weight: %s;",
    ...
    public AssembledUI assembleUI(
        ...
        return new AssembledUI(mainPanel, titleLabel, statusSection, controlBar, buttonPane, logArea);
    }
    ...
    public static class ControlBarSection {
        ...
        public ControlBarSection(HBox container, Button refreshButton, 
                               Button pauseResumeButton, Button stopAllButton) {
    ...
    public static class ButtonPaneSection {
        ...
        public FlowPane getButtonPane() { return buttonPane; }
    ...
    public static class AssembledUI {
        ...
        public AssembledUI(VBox mainPanel, Label titleLabel, StatusSection statusSection,
                         ControlBarSection controlBar, ButtonPaneSection buttonPane, TextArea logArea) {
        ...
        public VBox getMainPanel() { return mainPanel; }
        public Label getTitleLabel() { return titleLabel; }
        public StatusSection getStatusSection() { return statusSection; }
        public ControlBarSection getControlBar() { return controlBar; }
        public ButtonPaneSection getButtonPane() { return buttonPane; }

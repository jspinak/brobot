...
public class ValidationResultsPanel extends VBox {
    ...
    public ValidationResultsPanel() {
        ...
        rootItem = new TreeItem<>(new ValidationItem("Validation Results", "", ValidationSeverity.INFO));
    ...
    private void addErrorsToTree(String category, List<ValidationError> errors, ValidationSeverity severity) {
        if (errors == null || errors.isEmpty()) {
            return;
        }

        // Create category item
        TreeItem<ValidationItem> categoryItem = new TreeItem<>(
        ...
        for (ValidationError error : errors) {
            TreeItem<ValidationItem> errorItem = new TreeItem<>(
                    new ValidationItem(error.errorCode(), error.message(), error.severity())
            );

 ...
 *
 * <p>This component provides a rich interactive experience for viewing and analyzing action
 * illustrations generated by Brobot's automation engine. Features include:
 *
 * <ul>
 *   <li>Zoom and pan controls with smooth animations
 *   <li>Layer visibility toggles for different illustration elements
 *   <li>Playback controls for action sequences
 *   <li>Interactive tooltips showing action details
 *   <li>Export functionality for sharing and documentation
 * </ul>
 *
...
public class IllustrationViewer extends BorderPane {
    ...
    public void startPlayback() {
        ...
        animationTimeline =
                new Timeline(new KeyFrame(Duration.millis(100), e -> animateNextFrame()));
            ...
            case "DRAG":
                if (metadata.getActionPoints().size() >= 2) {
                    for (int i = 0; i < metadata.getActionPoints().size() - 1; i++) {
                        ...
                        // Draw arrow
                        drawArrow(gc, start.getX(), start.getY(), end.getX(), end.getY());
                    }
                }
                break;
        }

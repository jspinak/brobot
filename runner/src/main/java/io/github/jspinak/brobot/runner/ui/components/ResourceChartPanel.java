...
/**
 * Panel for displaying resource usage charts. Extracted from ResourceMonitorPanel for better
 * modularity.
 */
public class ResourceChartPanel extends VBox {
    ...
    /**
     * Add a new data point to the chart. Automatically removes old data points to maintain
     * performance.
     */

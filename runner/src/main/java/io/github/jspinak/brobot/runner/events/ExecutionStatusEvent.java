...
/**
 * Event representing a change in execution status. Contains the current execution status details.
 */
@Getter
...
public class ExecutionStatusEvent extends BrobotEvent {
    ...
    public ExecutionStatusEvent(
            EventType eventType, Object source, ExecutionStatus status, String message) {
    ...
    public static ExecutionStatusEvent started(
            Object source, ExecutionStatus status, String message) {
    ...
    public static ExecutionStatusEvent progress(
            Object source, ExecutionStatus status, String message) {
    ...
    public static ExecutionStatusEvent completed(
            Object source, ExecutionStatus status, String message) {
    ...
    public static ExecutionStatusEvent failed(
            Object source, ExecutionStatus status, String message) {
    ...
    public static ExecutionStatusEvent paused(
            Object source, ExecutionStatus status, String message) {
    ...
    public static ExecutionStatusEvent resumed(
            Object source, ExecutionStatus status, String message) {
    ...
    public static ExecutionStatusEvent stopped(
            Object source, ExecutionStatus status, String message) {

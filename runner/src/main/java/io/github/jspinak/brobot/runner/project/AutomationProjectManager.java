 ...
 * <ul>
 *   <li>{@link ProjectLifecycleService} - Manages project lifecycle (create, open, close)</li>
 *   <li>{@link ProjectValidationService} - Validates project structure and configuration</li>
 *   <li>{@link ProjectPersistenceService} - Handles project file I/O operations</li>
 *   <li>{@link ProjectDiscoveryService} - Discovers and indexes available projects</li>
 *   <li>{@link ProjectMigrationService} - Handles project version migrations</li>
 * </ul>
 * </p>
 * 
...
public class AutomationProjectManager implements AutoCloseable, DiagnosticCapable {
    ...
    /**
     * Gets the current automation project for UI display.
     * This adapts between ProjectDefinition and AutomationProject.
     * 
    ...
    /**
     * Alias for getActiveProject() to support UI components.
     * Returns the library's AutomationProject for UI compatibility.
     */

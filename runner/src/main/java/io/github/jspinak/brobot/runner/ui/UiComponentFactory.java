...
public class UiComponentFactory {
    ...
    public ConfigurationPanel createConfigurationPanel() {
        return new ConfigurationPanel(
                properties, libraryInitializer, eventBus, allStatesInProjectService);
    }
    ...
    /**
     * Creates a modern AtlantaFX styled configuration panel. This is the new preferred method for
    ...
    public AtlantaConfigPanel createAtlantaConfigPanel() {
        ...
        return new AtlantaConfigPanel(eventBus, properties, libraryInitializer, appConfig);
    }
    ...
    public RefactoredConfigPanel createRefactoredConfigPanel() {
        return new RefactoredConfigPanel(eventBus, properties, libraryInitializer, appConfig);
    }
    ...
    public ImprovedAtlantaConfigPanel createImprovedConfigPanel() {
        return new ImprovedAtlantaConfigPanel(eventBus, properties, libraryInitializer, appConfig);
    }

    /**
     * Creates a unified automation panel that combines features from both AutomationPanel and
    ...
    /**
     * Creates a refactored ResourceMonitorPanel with LabelManager and UIUpdateManager. This is the
     * preferred method for creating resource monitor panels.
     *
    ...
    public RefactoredResourceMonitorPanel createRefactoredResourceMonitorPanel() {
        RefactoredResourceMonitorPanel panel =
                applicationContext.getBean(RefactoredResourceMonitorPanel.class);
    ...
    public AtlantaResourcePanel createAtlantaResourcePanel() {
        return new AtlantaResourcePanel(
                resourceManager, imageResourceManager, cacheManager, sessionManager);
    }
    ...
    /**
     * Creates a refactored AtlantaFX logs panel with centralized resource management. Uses the
     * existing RefactoredAtlantaLogsPanel which has a service-oriented architecture.
     *
     * @return A new RefactoredAtlantaLogsPanel instance
     */
    public RefactoredAtlantaLogsPanel createRefactoredAtlantaLogsPanel() {
        RefactoredAtlantaLogsPanel panel =
                applicationContext.getBean(RefactoredAtlantaLogsPanel.class);
    ...
    public RefactoredConfigDetailsPanel createRefactoredConfigDetailsPanel() {
        RefactoredConfigDetailsPanel panel =
                applicationContext.getBean(RefactoredConfigDetailsPanel.class);
    ...
    public RefactoredExecutionDashboardPanel createRefactoredExecutionDashboardPanel() {
        RefactoredExecutionDashboardPanel panel =
                applicationContext.getBean(RefactoredExecutionDashboardPanel.class);
        componentRegistry.register("executionDashboardPanel", panel);
        return panel;
    }

    /**
     * Convenience method to create all refactored panels for a complete UI. This ensures consistent
     * architecture across all components.
     *
    ...
    /**
     * Creates a performance monitoring panel for development and debugging. This panel displays
     * real-time metrics from LabelManager and UIUpdateManager.
     *

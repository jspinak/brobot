...
/** Panel for log filtering controls. Provides search, type, level, and date range filtering. */
@Getter
public class LogFilterPanel extends VBox {
    ...
    private final ObjectProperty<Predicate<LogEntry>> filterProperty =
            new SimpleObjectProperty<>(entry -> true);
    ...
    private Node createFiltersSection() {
        ...
        typeComboBox
                .getItems()
                .addAll("ALL", "LOG", "ERROR", "EXECUTION", "STATE", "ACTION", "SYSTEM");
        ...
        levelComboBox.setCellFactory(
                lv ->
                        new ListCell<LogEntry.LogLevel>() {
                            @Override
    ...
    private Node createQuickFiltersSection() {
        ...
        // Format the display
        quickFilterCombo.setCellFactory(
                lv ->
                        new ListCell<LogFilterService.QuickFilterType>() {
                            @Override
                            protected void updateItem(
                                    LogFilterService.QuickFilterType item, boolean empty) {
                ...
                .addListener(
                        (obs, old, value) -> {
                            if (value != null
                                    ...
                                    && value.isAfter(endDatePicker.getValue())) {
                ...
                .addListener(
                        (obs, old, value) -> {
                            if (value != null
                                    ...
                                    && value.isBefore(startDatePicker.getValue())) {
    ...
    public void applyFilters() {
        LogFilterService.FilterCriteria criteria =

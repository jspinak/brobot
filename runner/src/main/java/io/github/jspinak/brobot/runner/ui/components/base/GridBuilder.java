...
/**
 * Builder class for creating properly constrained GridPanes
 * that prevent label overlapping and ensure consistent layout.
 */
public class GridBuilder {
    ...
    /**
     * Add column constraints to prevent label overlapping.
     * This is crucial for fixing the label overlap issues.
     */

...
/**
 * Brobot-specific theme manager that extends AtlantaFX with custom styling.
 * This manager automatically applies Brobot-specific CSS overlays on top
 * of the selected AtlantaFX theme.
 */
@Slf4j
@Component
@Primary
public class BrobotThemeManager extends AtlantaFXThemeManager {
    ...
    public void initialize() {
        ...
        log.info("BrobotThemeManager initialized with {} theme", 
            darkMode ? "dark" : "light");
    }
    ...
    public void applyPreset(ThemePreset preset) {
        switch (preset) {
            ...
            case PRESENTATION:
                ...
                break;
            case SYSTEM_DEFAULT:
                setTheme(detectSystemDarkMode() ? AtlantaTheme.PRIMER_DARK : AtlantaTheme.PRIMER_LIGHT);
                break;
        }
    }

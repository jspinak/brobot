...
public class ThemeSelector extends VBox {
    ...
    public ThemeSelector(AtlantaFXThemeManager themeManager) {
        ...
        themeComboBox.setConverter(new StringConverter<AtlantaTheme>() {
            @Override
    ...
    public static ToolBar createToolbarThemeSelector(AtlantaFXThemeManager themeManager) {
        ...
        primerBtn.setOnAction(e -> themeManager.setTheme(
            themeManager.isDarkTheme() ? AtlantaTheme.PRIMER_DARK : AtlantaTheme.PRIMER_LIGHT
        ));
        
        Button nordBtn = new Button("Nord");
        nordBtn.setOnAction(e -> themeManager.setTheme(
            themeManager.isDarkTheme() ? AtlantaTheme.NORD_DARK : AtlantaTheme.NORD_LIGHT
        ));
        
        Button cupertinoBtn = new Button("Cupertino");
        cupertinoBtn.setOnAction(e -> themeManager.setTheme(
            themeManager.isDarkTheme() ? AtlantaTheme.CUPERTINO_DARK : AtlantaTheme.CUPERTINO_LIGHT
        ));

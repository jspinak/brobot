...
public class SearchService {
    ...
    public static class SearchResult {
        ...
        public SearchResult(
                boolean found, List<TreeItem<ConfigBrowserPanel.ConfigItem>> matchingItems) {
            this.found = found;
     ...
     */
    public SearchResult searchTree(
            TreeItem<ConfigBrowserPanel.ConfigItem> rootItem, String searchText) {
     ...
     */
    private boolean searchTreeRecursive(
     ...
     */
    public void highlightFirstMatch(
        ...
        if (searchResult.isFound() && !searchResult.getMatchingItems().isEmpty()) {
            TreeItem<ConfigBrowserPanel.ConfigItem> firstMatch =
                    searchResult.getMatchingItems().get(0);

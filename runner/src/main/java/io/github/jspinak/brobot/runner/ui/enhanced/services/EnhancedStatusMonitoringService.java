...
/**
 * Service for monitoring automation execution status. Runs a background thread to update UI
 * components with current status.
 */
@Slf4j
@Service
public class EnhancedStatusMonitoringService {
    ...
    @Getter @Setter private MonitoringConfiguration configuration;

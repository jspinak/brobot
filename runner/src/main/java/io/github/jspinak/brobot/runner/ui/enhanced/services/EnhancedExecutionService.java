...
/**
 * Service for managing automation execution control.
 * Handles starting, pausing, resuming, and stopping automation tasks.
 */
@Slf4j
@Service
public class EnhancedExecutionService {
    ...
    @Autowired
    public EnhancedExecutionService(AutomationOrchestrator automationOrchestrator, EventBus eventBus) {
    ...
    private boolean showConfirmationDialog(TaskButton buttonDef) {
        ...
        String message = buttonDef.getConfirmationMessage() != null ?

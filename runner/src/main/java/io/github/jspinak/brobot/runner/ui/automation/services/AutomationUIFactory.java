...
/**
 * Factory service for creating automation UI components. Centralizes UI creation logic with
 * consistent styling.
 */
@Slf4j
@Service
    ...
    public HBox createControlBar(
        ...
        controlBar
                ...
                .addAll(
                        ...
                        controls.getStartButton(),
                        controls.getPauseButton(),
                        controls.getStopButton(),
                        new Separator(javafx.geometry.Orientation.VERTICAL),
                        windowControlButton,
                        hotkeyButton,
                        spacer,

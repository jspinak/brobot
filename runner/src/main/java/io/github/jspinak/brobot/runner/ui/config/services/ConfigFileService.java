...
/**
 * Service for handling configuration file operations. Manages reading, writing, and backup of
 * configuration files.
 */
@Slf4j
@Service
...
public class ConfigFileService {
    ...
    /**
     * Loads configuration data from a file. Returns a ConfigData object with the parsed content.
     */
    ...
    /**
     * Saves configuration data to the project configuration file. Creates a backup before
     * overwriting if the file exists.
     */
    public void saveProjectConfigurationData(ConfigEntry config, Map<String, String> updates)
            throws IOException {
    ...
    /**
     * Saves configuration data to the DSL configuration file. Creates a backup before overwriting
     * if the file exists.
     */
    public void saveDslConfigurationData(ConfigEntry config, Map<String, String> updates)
            throws IOException {
    ...
    /**
     * Internal method to save configuration data to a file. Creates a backup before overwriting if
     * the file exists.
     */
    private void saveConfigurationData(Path configPath, Map<String, String> updates)
            throws IOException {
    ...
    public void createNewConfigFile(Path configPath, Map<String, String> defaults)
            throws IOException {
    ...
    /**
     * Watches a configuration file for changes. Returns a WatchKey that can be used to monitor
     * changes.
     */

 ...
 * <p>
 * Layers enable composition of complex illustrations by separating different
 * visual elements (base image, search regions, matches, actions, etc.) into
 * independently controllable components.
 *

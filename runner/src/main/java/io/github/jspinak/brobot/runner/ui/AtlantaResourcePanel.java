...
/**
 * Modern resource monitoring panel with AtlantaFX styling. Provides real-time monitoring of system
 * resources, cache, and sessions.
 */
@Slf4j
public class AtlantaResourcePanel extends VBox {
    ...
    private void initialize() {
        ...
        mainContent.getChildren().addAll(createResourceOverview(), createDetailedView());

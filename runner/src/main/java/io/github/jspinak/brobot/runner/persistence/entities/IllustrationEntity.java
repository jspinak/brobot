 ...
 * <p>
 * This entity tracks all generated illustrations with their metadata,
 * enabling gallery functionality, search, and analytics.
 *
...
public class IllustrationEntity {
     ...
     */
    @ElementCollection
    @CollectionTable(name = "illustration_tags", 
     ...
     */
    @ElementCollection
    @CollectionTable(name = "illustration_metadata", 
                    joinColumns = @JoinColumn(name = "illustration_id"))

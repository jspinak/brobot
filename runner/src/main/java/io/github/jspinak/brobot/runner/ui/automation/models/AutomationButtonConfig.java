...
/**
 * Configuration model for automation buttons. Contains all the properties needed to create and
 * style an automation button.
 */
@Data
@Builder
public class AutomationButtonConfig {
    ...
    @Builder.Default private final double preferredWidth = 150.0;

    /** Action to execute when button is clicked. Receives the automation name as parameter. */
    private final Consumer<String> onAction;

    /** Whether this automation requires confirmation before running. */
    @Builder.Default private final boolean requiresConfirmation = false;
    ...
    @Builder.Default private final int displayOrder = 0;

    /** Tags for filtering/grouping. */
    private final String[] tags;

    /** Creates a simple button config with minimal properties. */
    public static AutomationButtonConfig simple(
            String name, String displayName, Consumer<String> onAction) {
    ...
    public static AutomationButtonConfig forCategory(
            String category, String displayName, Consumer<String> onAction) {
        return AutomationButtonConfig.builder()

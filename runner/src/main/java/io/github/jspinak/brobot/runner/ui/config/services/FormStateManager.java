...
/**
 * Service for managing form state and tracking changes.
 * Monitors form fields for modifications and handles state persistence.
 */
@Slf4j
@Service
public class FormStateManager {
     ...
     */
    public void trackNode(Node node, String key, java.util.function.Supplier<String> valueExtractor) {
        ...
        try {
            for (Map.Entry<String, String> entry : originalValues.entrySet()) {
                ...
                if (node instanceof TextField) {
                    ...
                    log.warn("ComboBox reset may not restore exact original value for key: {}", key);
                }
            }

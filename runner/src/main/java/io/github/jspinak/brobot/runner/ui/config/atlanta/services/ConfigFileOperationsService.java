...
public class ConfigFileOperationsService {
    ...
    public File showImportDialog(Window ownerWindow) {
        ...
        if (selectedFile != null) {
            eventBus.publish(LogEvent.info(this, 
                "Selected configuration file: " + selectedFile.getName(), "Config"));
        }
    ...
    public File showChangePathDialog(Window ownerWindow) {
        ...
        if (selectedDirectory != null) {
            eventBus.publish(LogEvent.info(this, 
                "Selected configuration directory: " + selectedDirectory.getAbsolutePath(), "Config"));
        }
    ...
    public void openConfigFolder() {
        ...
        try {
            if (Desktop.isDesktopSupported()) {
                ...
                eventBus.publish(LogEvent.info(this, 
                    "Opened configuration folder: " + configPath, "Config"));
            } else {
                ...
                pb.start();
                eventBus.publish(LogEvent.info(this, 
                    "Opened configuration folder using system command", "Config"));
            }
        } catch (IOException e) {
            showAlert(Alert.AlertType.ERROR, 
            ...
            eventBus.publish(LogEvent.error(this, 
                "Failed to open configuration folder: " + e.getMessage(), "Config", e));
        }
    }
    ...
    public void updateConfigPath(String newPath) {
        ...
        eventBus.publish(LogEvent.info(this, 
            "Configuration path updated to: " + newPath, "Config"));
    }

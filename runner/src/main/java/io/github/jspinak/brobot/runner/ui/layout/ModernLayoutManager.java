...
public class ModernLayoutManager {
    ...
    @Getter private final BooleanProperty sidebarCollapsed = new SimpleBooleanProperty(false);
    ...
    public void toggleSidebar(Region sidebar) {
        double targetWidth =
                sidebarCollapsed.get() ? SIDEBAR_EXPANDED_WIDTH : SIDEBAR_COLLAPSED_WIDTH;

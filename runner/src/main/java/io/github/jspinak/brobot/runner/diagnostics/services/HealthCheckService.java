...
/**
 * Service responsible for performing health checks on various system components. Provides
...
public class HealthCheckService implements DiagnosticCapable {
    ...
    public HealthCheckItem checkMemoryHealth() {
        try {
            ...
            return new HealthCheckItem(
                    "Memory", HealthStatus.WARNING, "Unable to check memory: " + e.getMessage());
        }
    }
    ...
    public HealthCheckItem checkThreadHealth() {
        try {
            ...
            if (deadlocked != null && deadlocked.length > 0) {
                ...
                message =
                        String.format(
                                "Deadlock detected! %d threads deadlocked", deadlocked.length);
            ...
            return new HealthCheckItem(
                    "Threads", HealthStatus.WARNING, "Unable to check threads: " + e.getMessage());
        }
    }
    ...
    public HealthCheckItem checkDiskSpace() {
        try {
            ...
            if (totalSpace == 0) {
                return new HealthCheckItem(
                        "Disk Space", HealthStatus.WARNING, "Unable to determine disk space");
            }
    ...
    public DiagnosticInfo getDiagnosticInfo() {
        ...
        try {
            ...
            return DiagnosticInfo.builder().component("HealthCheckService").states(states).build();

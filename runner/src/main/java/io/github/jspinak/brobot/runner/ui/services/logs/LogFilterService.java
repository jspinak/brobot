...
public class LogFilterService {
    ...
    private void applyFilters() {
        Predicate<LogEntryViewModel> combinedFilter = entry -> {
            // Search filter
        ...
        log.debug("Filters applied - Search: '{}', Level: {}, Type: {}, Results: {}", 
            searchText, levelFilter, typeFilter, filteredLogs.size());
    }

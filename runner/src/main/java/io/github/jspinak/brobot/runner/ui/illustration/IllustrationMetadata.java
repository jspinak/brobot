 ...
 *
 * <p>This class bridges the gap between the library's illustration data and the Desktop Runner's
...
public class IllustrationMetadata {
    ...
    @Singular private final List<Region> searchRegions;

    /** Matches found during the action. */
    @Singular private final List<Match> matches;

    /** Points involved in the action (click points, drag path, etc.). */
    @Singular private final List<Point> actionPoints;

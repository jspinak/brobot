...
public class ApplicationException extends RuntimeException {
    ...
    public ApplicationException(String userMessage, String technicalDetails, 
    ...
    public ApplicationException(String userMessage, String technicalDetails, 
                              Throwable cause, ErrorContext context) {
     ...
     */
    public static ApplicationException fileError(String message, String filePath, 
                                               Throwable cause) {
        ErrorContext context = ErrorContext.builder()
    ...
    public static ApplicationException automationError(String message, String actionName) {
        ErrorContext context = ErrorContext.builder()
            ...
            .recoverable(true)
            .recoveryHint("Try running the automation again or check the configuration.")

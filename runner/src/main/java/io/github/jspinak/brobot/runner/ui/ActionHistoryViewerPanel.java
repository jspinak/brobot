...
public class ActionHistoryViewerPanel extends VBox {
    ...
    private void initialize() {
        ...
        sessionSelector.setConverter(
                new StringConverter<RecordingSessionEntity>() {
                    @Override
                    ...
                    filter.and(
                            record ->
                                    (record.getStateName() != null
                                            ...
                                            || (record.getObjectName() != null
                                                    && record.getObjectName()
                                                            .toLowerCase()
                                                            .contains(lowerFilter))
                                            || (record.getActionConfigType() != null
                                                    && record.getActionConfigType()
                                                            .toLowerCase()
                                                            .contains(lowerFilter))
                                            || (record.getText() != null
                                                    && record.getText()
    ...
    private void deleteSession() {
        ...
        confirm.setContentText(
                "This will permanently delete the session and all its records. Continue?");

...
/**
 * Toolbar component for screenshot capture functionality.
 * Provides buttons for various screenshot capture operations.
 */
@Component
public class ScreenshotToolbar extends VBox {
    ...
    private void initialize() {
        ...
        setStyle("-fx-background-color: -color-bg-default; -fx-border-color: -color-border-default; -fx-border-width: 0 0 1 0;");
    ...
    private void showSeriesDialog() {
        ...
        dialog.showAndWait().ifPresent(response -> {
            if (response == ButtonType.OK) {
                captureSeries(durationSpinner.getValue(), frequencySpinner.getValue());
            }
        });
    }
    ...
    private void captureSeries(int duration, double frequency) {
        ...
        new Thread(() -> {
            ...
            javafx.application.Platform.runLater(() -> {
                updateStatus(String.format("Series complete: %d screenshots", 
    ...
    private void startRecording() {
        ...
        dialog.showAndWait().ifPresent(response -> {
            if (response == ButtonType.OK) {
                ...
                screenshotService.startRecording(baseNameField.getText(), intervalSpinner.getValue());

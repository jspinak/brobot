...
/**
 * Result of error handling, containing information about the outcome
 * and any recovery actions.
 */
@Getter
@Builder
public class ErrorResult {
     ...
     */
    public static ErrorResult recoverable(String userMessage, String errorId, 

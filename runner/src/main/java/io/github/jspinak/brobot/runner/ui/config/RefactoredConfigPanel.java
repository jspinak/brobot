...
/**
 * Refactored configuration panel that follows single responsibility principle.
 * This panel is just a container that delegates to specialized sub-components.
 */
@Slf4j
public class RefactoredConfigPanel extends VBox {
    ...
    public RefactoredConfigPanel(EventBus eventBus,
    ...
    private void setupInteractions() {
        ...
        listPanel.selectedConfigProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {

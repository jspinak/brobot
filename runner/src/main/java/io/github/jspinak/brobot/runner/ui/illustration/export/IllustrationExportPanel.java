 ...
 *
 * <p>This panel provides a user-friendly interface for:
 *
 * <ul>
 *   <li>Selecting illustrations to export
 *   <li>Choosing export format and options
 *   <li>Configuring export settings
 *   <li>Monitoring export progress
 * </ul>
 *
...
public class IllustrationExportPanel extends BorderPane {
    ...
    @Autowired
    public IllustrationExportPanel(
            IllustrationExportService exportService, IllustrationGalleryService galleryService) {
    ...
    private void setupUI() {
        ...
        bottomSection
                .getChildren()
                .addAll(createExportOptions(), createProgressSection(), createActionButtons());
    ...
    private VBox createIllustrationSelector() {
        ...
        illustrationList
                ...
                .getSelectedItems()
                .addListener(
                        (javafx.collections.ListChangeListener<IllustrationItem>)
                                change -> {
    ...
    private void loadIllustrations() {
        ...
        illustrations.forEach(ill -> illustrationList.getItems().add(new IllustrationItem(ill)));
    }
    ...
    private void updateExportButton() {
        ...
        boolean hasPath =
                outputPathField.getText() != null && !outputPathField.getText().trim().isEmpty();
                            ...
                            case MARKDOWN:
                                ...
                                result =
                                        exportService.exportAsMarkdown(
                                                sessionId,
                                                outputPath,
                                                includeImagesCheck.isSelected());
                                break;

                            case PDF:
                                List<IllustrationEntity> entities =
                                        selected.stream()
        ...
        exportTask.setOnFailed(
                e -> {
                    ...
                    alert.setContentText(
                            "Failed to export: " + exportTask.getException().getMessage());
                    alert.showAndWait();
                });

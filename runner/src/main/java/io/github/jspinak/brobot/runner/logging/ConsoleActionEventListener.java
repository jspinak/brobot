...
/**
 * Event listener that bridges the runner's event system with the console action reporter. Listens
 * for LogEntryEvent instances and forwards them to the console reporter for real-time console
 * output.
 *
 * <p>This component enables console output in the desktop runner application, providing immediate
 * feedback about action execution.
 */
@Component

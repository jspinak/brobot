...
/**
 * Service for monitoring automation execution status. Provides background thread monitoring and UI
...
public class StatusMonitoringService {
    ...
    private String getPauseResumeButtonText(ExecutionStatus status) {
        return status.getState() == ExecutionState.PAUSED ? "Resume Execution" : "Pause Execution";
    }

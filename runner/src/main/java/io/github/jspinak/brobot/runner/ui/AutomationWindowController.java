...
/**
 * Controls window behavior during automation execution.
 * Handles minimizing/restoring the main window when automation starts/stops.
 */
@Component
public class AutomationWindowController {
    ...
    public void minimizeForAutomation() {
        ...
        Platform.runLater(() -> {
            windowManager.getStage(MAIN_WINDOW_ID).ifPresent(stage -> {

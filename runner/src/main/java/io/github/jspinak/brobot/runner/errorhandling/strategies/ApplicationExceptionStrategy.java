 ...
 * Provides detailed error information and recovery actions based on the exception context.
 */
@Slf4j
public class ApplicationExceptionStrategy implements IErrorStrategy {
    ...
    public ErrorResult handle(Throwable error, ErrorContext context) {
        ...
        log.debug("Handling ApplicationException: {} - Recoverable: {}", 
                 appEx.getMessage(), appEx.isRecoverable());

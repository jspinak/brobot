...
public class EnhancedTableUIFactory {
    ...
    public static class UIConfiguration {
        ...
        public String getTablePlaceholder() { return tablePlaceholder; }
    ...
    public static class ToolbarComponents {
        ...
        public ToolbarComponents(TextField searchField, ComboBox<Integer> pageSizeSelector, HBox toolbar) {
        ...
        public ComboBox<Integer> getPageSizeSelector() { return pageSizeSelector; }
     ...
     */
    public <T> VBox assembleTableUI(VBox container, HBox toolbar, TableView<T> tableView, HBox paginationBox) {

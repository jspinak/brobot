...
/**
 * Custom button component that ensures proper styling and prevents overlap detection issues. This
 * button uses a specific structure that the overlap detector can properly handle.
 */

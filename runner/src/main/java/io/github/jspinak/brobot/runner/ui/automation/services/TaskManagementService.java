...
/**
 * Service for managing task buttons and project tasks. Handles task organization, button creation,
...
public class TaskManagementService {
    ...
    public Node createEmptyState() {
        return createEmptyState(
                "No tasks defined", "Add task buttons to your project configuration");
    }
    ...
    private Map<String, List<TaskButton>> groupTasksByCategory(List<TaskButton> tasks) {
        ...
        for (TaskButton task : tasks) {
            String category =
                    task.getCategory() != null ? task.getCategory() : configuration.defaultCategory;
    ...
    public static class ProjectTasksResult {
        ...
        public List<TaskButton> getTasks() {
            return tasks;
        }

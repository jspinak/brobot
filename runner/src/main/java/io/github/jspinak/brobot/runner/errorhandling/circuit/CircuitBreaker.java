 ...
 *
 * <ul>
 *   <li>CLOSED: Normal operation, requests are allowed
 *   <li>OPEN: Failures exceeded threshold, requests are blocked
 *   <li>HALF_OPEN: Testing if the service has recovered
 * </ul>
 *
...
public class CircuitBreaker {
    ...
    private final AtomicReference<Instant> lastStateTransition =
    ...
    private boolean shouldAttemptReset() {
        Duration timeSinceLastTransition =
                Duration.between(lastStateTransition.get(), Instant.now());
    ...
    private void transitionToOpen() {
        ...
        if (previousState != State.OPEN) {
            ...
            log.warn(
                    "Circuit breaker '{}' transitioned to OPEN after {} consecutive failures",
                    name,

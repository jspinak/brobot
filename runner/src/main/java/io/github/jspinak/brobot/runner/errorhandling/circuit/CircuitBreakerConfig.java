...
public class CircuitBreakerConfig {
    ...
    @Builder.Default private final int failureThreshold = 5;

    /** Duration to wait before attempting to close the circuit. Default: 30 seconds */
    @Builder.Default private final Duration resetTimeout = Duration.ofSeconds(30);

    /** Number of successful calls in half-open state before closing. Default: 3 */
    @Builder.Default private final int halfOpenSuccessThreshold = 3;

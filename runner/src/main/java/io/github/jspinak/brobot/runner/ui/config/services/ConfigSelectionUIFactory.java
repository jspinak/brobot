...
/**
 * Factory service for creating UI components for the configuration selection panel.
 * Centralizes UI creation logic for consistent styling and behavior.
 */
@Service
public class ConfigSelectionUIFactory {
    ...
    public static class HeaderSection {
        ...
        private HeaderSection(Label titleLabel, Button importButton, Button browseButton,
                            Button refreshButton, HBox headerActions, HBox container) {
    ...
    public HeaderSection createHeaderSection() {
        ...
        return new HeaderSection(titleLabel, importButton, browseButton, refreshButton, headerActions, header);
    }
     ...
     */
    public SplitPaneSection createSplitPaneSection(io.github.jspinak.brobot.runner.events.EventBus eventBus) {
        // Create table
        ...
        recentConfigsCard.getStyleClass().addAll("recent-configurations-table", configuration.cardElevation);
        ...
        detailsCard.getStyleClass().addAll("configuration-details-card", configuration.cardElevation);
        ...
        return new SplitPaneSection(splitPane, recentConfigsCard, detailsCard, configTable, detailsPanel);
    }
     ...
     */
    public AssembledUI assembleUI(VBox mainPanel, HeaderSection header, SplitPaneSection splitPane) {

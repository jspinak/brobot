...
/**
 * Factory service for creating and configuring log tables.
 * Provides customizable table creation with various column types and styles.
 */
@Slf4j
@Service
public class LogTableFactory {
    ...
    private TableColumn<LogEntry, String> createTimeColumn(TableConfiguration config) {
        ...
        column.setCellValueFactory(param -> 
            new SimpleStringProperty(param.getValue().getTimestamp().format(config.timeFormatter)));
            ...
            protected void updateItem(String time, boolean empty) {
                ...
                if (empty || time == null) {
                    ...
                    if (config.enableTooltips) {
                        ...
                        if (entry != null) {
                            setTooltip(new Tooltip(entry.getTimestamp().format(FULL_TIME_FORMATTER)));
                        }
                    }
                }
            }
    ...
    private TableColumn<LogEntry, LogEntry.LogLevel> createLevelColumn(TableConfiguration config) {
        ...
        column.setCellValueFactory(param -> 
            new javafx.beans.property.SimpleObjectProperty<>(param.getValue().getLevel()));
            ...
            protected void updateItem(LogEntry.LogLevel level, boolean empty) {
                ...
                if (empty || level == null) {
                    ...
                    if (config.enableLevelIndicators) {
                        ...
                        label.getStyleClass().add("level-" + level.name().toLowerCase());
        ...
        column.setCellFactory(col -> new TableCell<>() {
            ...
            protected void updateItem(String type, boolean empty) {
                ...
                if (empty || type == null) {
                    ...
                    getStyleClass().add("type-" + type.toLowerCase().replace("_", "-"));
                }
            }
        });
    ...
    private TableColumn<LogEntry, String> createSourceColumn(TableConfiguration config) {
        ...
        column.setCellValueFactory(param -> 
            new SimpleStringProperty(param.getValue().getSource()));
    ...
    private TableColumn<LogEntry, String> createMessageColumn(TableConfiguration config) {
        ...
        column.setCellValueFactory(param -> 
            new SimpleStringProperty(param.getValue().getMessage()));
        ...
        column.setCellFactory(col -> new TableCell<>() {
            ...
            protected void updateItem(String message, boolean empty) {
                ...
                if (empty || message == null) {
                    ...
                    String display = message.length() > 200 ? 
    ...
    public <T> TableColumn<LogEntry, T> createCustomColumn(
            String title, 
            java.util.function.Function<LogEntry, javafx.beans.value.ObservableValue<T>> valueFactory,
            int prefWidth) {
    ...
    public void configureColumnResizing(TableView<LogEntry> table) {
        ...
        for (TableColumn<LogEntry, ?> column : table.getColumns()) {
            ...
            column.prefWidthProperty().bind(
                table.widthProperty().multiply(percentage)
            );
        }
    }
    ...
    public void applyTheme(TableView<LogEntry> table, TableTheme theme) {
        table.getStyleClass().removeAll("log-table-light", "log-table-dark", "log-table-high-contrast");

...
/**
 * Factory service for creating UI components for the improved automation panel. Provides consistent
 * styling using AtlantaFX components.
 */
@Slf4j
@Service
public class ImprovedUILayoutFactory {
    ...
    public ExecutionControls createExecutionControls() {
        ...
        startButton
                .getStyleClass()
                .addAll("button", configuration.primaryButtonClass, "control-button");

        Button pauseButton = new Button("Pause");
        pauseButton
                .getStyleClass()
                .addAll("button", configuration.secondaryButtonClass, "control-button");
        pauseButton.setDisable(true);

        Button stopButton = new Button("Stop");
        stopButton
                .getStyleClass()
                .addAll("button", configuration.dangerButtonClass, "control-button");
    ...
    public LogPanel createLogPanel() {
        ...
        clearLogButton
                .getStyleClass()
                .addAll("button", configuration.secondaryButtonClass, "small");
    ...
    public static class ExecutionControls {
        ...
        public ExecutionControls(
                HBox container, Button startButton, Button pauseButton, Button stopButton) {
            this.container = container;
    ...
    public static class WindowControls {
        ...
        public Button getWindowControlButton() {
            return windowControlButton;
        }

        public Button getHotkeyButton() {
            return hotkeyButton;
        }
    }
    ...
    public static class TaskPanel {
        ...
        public FlowPane getTaskButtonsPane() {
            return taskButtonsPane;
        }
    }
    ...
    public static class LogPanel {
        ...
        public CheckBox getAutoScrollCheck() {

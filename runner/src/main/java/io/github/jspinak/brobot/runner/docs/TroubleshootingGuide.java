...
public class TroubleshootingGuide {
    ...
    public Optional<TroubleshootingEntry> getTroubleshooting(
            String errorType, ErrorContext context) {
                ...
                .filter(
                        entry ->
                                entry.getTitle().toLowerCase().contains(lowerKeyword)
                                        ...
                                        || entry.getSymptoms().stream()
                                                .anyMatch(
                                                        s -> s.toLowerCase().contains(lowerKeyword))
    ...
    public List<TroubleshootingEntry> getCommonIssues() {
        return troubleshootingDatabase.values().stream()
                .filter(
                        entry ->
                                entry.getSeverity() == ErrorContext.ErrorSeverity.HIGH
    ...
    private void initializeTroubleshootingDatabase() {
                        ...
                        .solutions(
                                List.of(
                                        new Solution(
                                                ...
                                                "Check that the full path to the configuration file"
                                                        + " is correct"),
                                        new Solution(
                                                "Check file permissions",
                                                "Ensure the application has read access to the"
                                                        + " file"),
                                        new Solution(
                                                "Use File > Open to browse for the file",
                        ...
                        .solutions(
                                List.of(
                                        new Solution(
                                                ...
                                                "Paste your JSON into an online validator like"
                                                        + " jsonlint.com"),
                                        new Solution(
                                                "Check the error line number",
                                                "Look at the specific line mentioned in the error"
                                                        + " message"),
                                        new Solution(
                                                "Use a JSON-aware editor",
                                                "Edit the file in VS Code or another editor with"
                                                        + " JSON support")))
                        .preventionTips(
                                List.of(
                        ...
                        .solutions(
                                List.of(
                                        new Solution(
                                                ...
                                                "Add the required fields listed in the error"
                                                        + " message"),
                                        new Solution(
                                                "Use a template",
                ...
                TroubleshootingEntry.builder()
                        ...
                        .solutions(
                                List.of(
                                        new Solution(
                                                "Increase heap size",
                                                "Add -Xmx2G to JVM arguments to increase memory to"
                                                        + " 2GB"),
                                        new Solution(
        ...
        addEntry(
                TroubleshootingEntry.builder()
                        ...
                        .severity(ErrorContext.ErrorSeverity.HIGH)
                        .description(
                                "Network operation timed out while connecting to remote service.")
                        .symptoms(
                                List.of(
                        ...
                        .solutions(
                                List.of(
                                        ...
                                        new Solution(
                                                "Check firewall",
                                                "Ensure the application is allowed through"
                                                        + " firewall")))
                        .preventionTips(
                                List.of(
                        ...
                        .solutions(
                                List.of(
                                        new Solution(
                                                ...
                                                "Some operations may take time, check the progress"
                                                        + " bar"),
                                        new Solution(
                ...
                TroubleshootingEntry.builder()
                        ...
                        .solutions(
                                List.of(
                                        ...
                                        new Solution(
                                                "Check file permissions",
                                                "Ensure you have write access to the working"
                                                        + " directory"),
                                        new Solution(
                        ...
                        .solutions(
                                List.of(
                                        new Solution(
                                                ...
                                                "Free up system resources by closing unnecessary"
                                                        + " programs"),
                                        new Solution(

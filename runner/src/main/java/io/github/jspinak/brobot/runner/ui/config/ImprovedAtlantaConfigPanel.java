...
/**
 * Improved configuration panel with better spacing and layout.
 * Extends AtlantaBasePanel for consistent styling.
 */
@Slf4j
public class ImprovedAtlantaConfigPanel extends AtlantaBasePanel {
    ...
    public ImprovedAtlantaConfigPanel(EventBus eventBus,
    ...
    private void setupActionBar() {
        ...
        HBox configPathGroup = createButtonGroup(configPathLabel, configPathValue, changePathBtn, openFolderBtn);
    ...
    private void loadRecentConfigurations() {
        ...
        // Add sample data
        configData.addAll(
            new ConfigEntry("production-config", "Production", LocalDateTime.now().minusDays(1), "Active"),
            new ConfigEntry("staging-config", "Staging", LocalDateTime.now().minusDays(3), "Active"),
            new ConfigEntry("test-config", "Test", LocalDateTime.now().minusDays(7), "Inactive"),
            new ConfigEntry("dev-config", "Development", LocalDateTime.now().minusDays(14), "Active"),
            new ConfigEntry("backup-config", "Backup", LocalDateTime.now().minusDays(30), "Archived")
        );

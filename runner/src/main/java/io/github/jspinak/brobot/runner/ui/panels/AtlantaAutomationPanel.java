...
/**
 * Modern automation panel with AtlantaFX styling.
 * Provides a clean, card-based interface for running automations.
 */
@Slf4j
@Component
public class AtlantaAutomationPanel extends VBox {
    ...
    private void refreshProjectTasks() {
        Platform.runLater(() -> {
            ...
            if (currentProject == null) {
                ...
                logArea.appendText("No project loaded. Please configure a project first.\n");
                return;
            }
            ...
            for (Map.Entry<String, List<TaskButton>> entry : tasksByCategory.entrySet()) {
                ...
                for (TaskButton taskButton : entry.getValue()) {
                    ...
                    String buttonKey = taskButton.getLabel() != null ? taskButton.getLabel() : taskButton.getId();
            ...
            logArea.appendText("Loaded project: " + currentProject.getName() + 
                             " with " + taskButtons.size() + " tasks\n");
        });
    }
        ...
        if (styling != null) {
            ...
            if (styling.getBackgroundColor() != null && !styling.getBackgroundColor().isEmpty()) {
                try {
                    ...
                    log.warn("Invalid background color for task button: {}", styling.getBackgroundColor());
                }
            }
    ...
    private void executeTask(TaskButton taskButton) {
        ...
        String taskName = taskButton.getLabel() != null ? taskButton.getLabel() : taskButton.getId();
    ...
    private void runTask(TaskButton taskButton) {
        ...
        if (functionName != null && !functionName.isEmpty()) {
            try {
                ...
                logToUI("Would execute function: " + functionName + " with parameters: " + taskButton.getParametersAsMap());
        ...
        Platform.runLater(() -> {
            switch (state) {
                case RUNNING:
                    ...
                    statusLabel.getStyleClass().removeAll("status-paused", "status-stopped");

...
/**
 * Refactored ConfigMetadataEditor using extracted services.
...
public class RefactoredConfigMetadataEditor extends BorderPane {
    ...
    public void loadConfiguration(ConfigEntry configEntry) {
        ...
        Task<ConfigData> loadTask = new Task<>() {
            @Override
            protected ConfigData call() throws Exception {
                return fileService.loadConfigurationData(configEntry.getProjectConfigPath());
            }
        };
    ...
    private void exportConfiguration() {
        ...
        try {
            Path exportPath = Paths.get(currentConfig.getProjectConfigPath().toString() + ".properties");

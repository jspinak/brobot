 ...
 * <p>
 * This class provides a high-level interface for starting, pausing, resuming,
 * and stopping automation scripts. It manages the execution thread and handles
 * the lifecycle of automation runs, making it easy for UI components to
 * control automation execution.
 * </p>
 * 
 * <p>Key features:
 * <ul>
 *   <li>Asynchronous execution of automation tasks</li>
 *   <li>Thread management for automation scripts</li>
 *   <li>Integration with ExecutionController for pause/resume/stop</li>
 *   <li>Event callbacks for execution state changes</li>
...
public class AutomationExecutor {
     ...
     * <p>
     * This method runs the provided task asynchronously in a dedicated thread.
     * The task should contain the automation logic to be executed.
     * </p>
     * 
    ...
    public void startExecution(Runnable automationTask) {
        ...
        currentExecution = executorService.submit(() -> {
            try {
                automationTask.run();
     ...
     * <p>
     * This is a convenience method that starts the provided AutomationScript
     ...
     * <p>
     * The execution will pause at the next checkpoint. This method returns
     * immediately; the actual pause happens asynchronously.
     * </p>
     */
    public void pause() {
     ...
     * <p>
     * This method signals the execution to stop and optionally waits for it
     * to complete. The execution will stop at the next checkpoint.
     * </p>
     * 
     ...
     * <p>
     * This is a convenience method that calls stop(false, 0).
     * </p>
     */
    public void stop() {
        stop(false, 0);
     ...
     * <p>
     * Should be called when the application is shutting down to clean up resources.
     * </p>
     */

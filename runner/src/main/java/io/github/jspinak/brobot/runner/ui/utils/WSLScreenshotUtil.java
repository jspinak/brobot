...
/**
 * Screenshot utility specifically for WSL2 environments.
 * WSL2 with WSLg uses Wayland, which prevents traditional Java screenshot methods.
 * This utility provides workarounds and clear error messages.
 */
public class WSLScreenshotUtil {
    ...
    public static boolean isWSL() {
        try {
            ...
            try (BufferedReader reader = new BufferedReader(new InputStreamReader(process.getInputStream()))) {
                ...
                boolean isWSL = line != null && (line.contains("microsoft") || line.contains("WSL"));
    ...
    /**
     * Attempts to take a screenshot using Windows tools through WSL interop.
     * This requires PowerShell to be accessible from WSL.
     */
            ...
            try {
                ...
                if (completed && process.exitValue() == 0) {
                    ...
                    if (outputFile.exists() && outputFile.length() > 0) {
                        logger.info("Screenshot captured successfully using Windows PowerShell");
                        return outputPath;
                    }
                }

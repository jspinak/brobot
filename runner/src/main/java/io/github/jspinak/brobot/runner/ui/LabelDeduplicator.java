...
/**
 * Utility class to detect and fix duplicate labels in the UI. This is a temporary fix until proper
    ...
    public static void deduplicateLabels(Parent parent) {
        ...
        if (!toRemove.isEmpty()) {
            ...
            if (parent instanceof javafx.scene.layout.Pane) {
                ...
                logger.warn(
                        "Cannot remove duplicates from {} - not a modifiable container",

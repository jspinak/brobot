...
/**
 * Service for managing task button categories and preventing duplicate rendering. Maintains state
 * of rendered categories and buttons for efficient updates.
 */
@Slf4j
@Service
...
public class ButtonCategoryService {
    ...
    /**
     * Updates categories with new button definitions. Returns a CategoryUpdate object describing
     * what changed.
     */
    ...
    public CategoryUpdate clearAllCategories() {
        ...
        return new CategoryUpdate(
                removed, Collections.emptyList(), Collections.emptyList(), Collections.emptyList());
    }

...
public class ErrorEvent extends BrobotEvent {
    ...
    public static ErrorEvent low(
            Object source, String errorMessage, Exception exception, String componentName) {
    ...
    public static ErrorEvent medium(
            Object source, String errorMessage, Exception exception, String componentName) {

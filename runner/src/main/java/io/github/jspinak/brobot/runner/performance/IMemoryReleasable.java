...
/**
 * Interface for components that can release memory when requested. Used by the MemoryOptimizer to
...
public interface IMemoryReleasable {
    ...
    /**
     * Gets the priority of this releasable component. Lower values indicate higher priority
     * (released first).
     *

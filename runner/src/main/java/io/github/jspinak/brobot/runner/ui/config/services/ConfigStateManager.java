...
/**
 * Service for managing configuration state and tracking changes.
 * Handles undo/redo, change tracking, and confirmation dialogs.
 */
@Slf4j
@Service
public class ConfigStateManager {
     ...
     * Returns true if the user wants to proceed (discard changes).
     */
    ...
    public Map<String, String> getChangeSummary() {
        ...
        compareField(changes, "description", originalModel.getDescription(), currentModel.getDescription());
     ...
     */
    private void compareField(Map<String, String> changes, String fieldName, 

 ...
 *
 * <p>The Brobot Runner is a JavaFX-based GUI application that provides a visual interface for
 * configuring and executing Brobot automation scripts. It manages automation configurations, state
 * transitions, and provides real-time monitoring of automation execution.
 *
 * <p>This class configures the Spring application context with:
 *
 * <ul>
 *   <li>JPA repositories for persistence
 *   <li>Component scanning for both runner and library packages
 *   <li>Essential beans for resource management, caching, and session handling
 * </ul>
 *
 * @author jspinak
...
public class BrobotRunnerApplication {
    ...
    // SessionManager is now created automatically via @Component annotation and dependency
    // injection
}

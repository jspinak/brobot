...
public class UserFriendlyErrorMessages {
    ...
    private final Map<Class<? extends Throwable>, MessageTemplate> errorTypeMessages = new HashMap<>();
    private final Map<ErrorContext.ErrorCategory, CategoryMessages> categoryMessages = new HashMap<>();
    ...
    private void initializeCategoryMessages() {
        ...
        categoryMessages.put(ErrorContext.ErrorCategory.CONFIGURATION, new CategoryMessages(
            "Configuration Error",
        ...
        // File I/O errors
        categoryMessages.put(ErrorContext.ErrorCategory.FILE_IO, new CategoryMessages(
            "File Access Error",
        ...
        // Network errors
        categoryMessages.put(ErrorContext.ErrorCategory.NETWORK, new CategoryMessages(
            "Network Error",
        ...
        // Validation errors
        categoryMessages.put(ErrorContext.ErrorCategory.VALIDATION, new CategoryMessages(
            "Validation Error",
        ...
        // Automation errors
        categoryMessages.put(ErrorContext.ErrorCategory.AUTOMATION, new CategoryMessages(
            "Automation Error",
    ...
    private static class CategoryMessages {
        ...
        CategoryMessages(String defaultTitle, String defaultDescription, 

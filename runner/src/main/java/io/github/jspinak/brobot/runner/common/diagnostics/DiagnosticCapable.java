 ...
 * 
 * This interface enables AI-friendly debugging by providing a standard way
 * to extract runtime state and diagnostic information from components.
 * 
 * @since 1.0.0
 */
public interface DiagnosticCapable {
    ...
    /**
     * Enables or disables diagnostic mode for this component.
     * When enabled, the component may collect additional diagnostic data.
     * 

 ...
 * <p>
 * This panel provides a live view of actions as they execute, with features:
 * <ul>
 * <li>Auto-updating illustration display</li>
 * <li>Queue status and performance metrics</li>
 * <li>Filtering and pause controls</li>
...
public class IllustrationStreamPanel extends BorderPane {
    ...
    private void setupStreamConsumer() {
        streamService.setStreamConsumer(event -> {
            if (!isPaused) {
    ...
    private static class StreamHistoryItem {
        ...
        public StreamHistoryItem(IllustrationStreamEvent event) {
            ...
            String action = event.getMetadata() != null ? 
                event.getMetadata().getActionType() : "Unknown";
            String status = event.getMetadata() != null && event.getMetadata().isSuccess() ? 
                "✓" : "✗";

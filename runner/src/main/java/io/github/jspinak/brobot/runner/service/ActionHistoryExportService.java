...
public class ActionHistoryExportService {
    ...
    public void exportToFile(ActionHistory history, File file, ExportFormat format)
            throws IOException {
        switch (format) {
            case JSON:
    ...
    public void exportSessionToFile(Long sessionId, File file, ExportFormat format)
            throws IOException {
    ...
    public RecordingSessionEntity importToSession(File file, String sessionName)
            throws IOException {

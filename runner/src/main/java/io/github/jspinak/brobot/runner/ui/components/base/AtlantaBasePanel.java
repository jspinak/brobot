...
/**
 * Base panel class for all Atlanta-styled panels.
 * Provides consistent padding, spacing, and layout structure.
 */
public abstract class AtlantaBasePanel extends VBox {
    ...
    /**
     * Returns the action bar for adding controls.
     * The action bar is automatically shown when controls are added.
     */
     ...
     */
    protected HBox createSplitLayout(AtlantaCard leftCard, AtlantaCard rightCard, double leftWidth) {

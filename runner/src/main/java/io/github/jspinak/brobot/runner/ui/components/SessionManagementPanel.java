...
/** Panel for managing sessions. Extracted from ResourceMonitorPanel to improve modularity. */
public class SessionManagementPanel extends VBox {
    ...
    private TableView<SessionSummary> createSessionsTable() {
        ...
        idColumn.setCellValueFactory(
                data -> new SimpleStringProperty(data.getValue().getId().substring(0, 8) + "..."));
        idColumn.setPrefWidth(80);

        // Project Column
        TableColumn<SessionSummary, String> projectColumn = new TableColumn<>("Project");
        projectColumn.setCellValueFactory(
                data -> new SimpleStringProperty(data.getValue().getProjectName()));
        ...
        durationColumn.setCellValueFactory(
                data -> new SimpleStringProperty(data.getValue().getFormattedDuration()));
        ...
        // Add all columns
        table.getColumns()
                .addAll(idColumn, projectColumn, startTimeColumn, durationColumn, statusColumn);

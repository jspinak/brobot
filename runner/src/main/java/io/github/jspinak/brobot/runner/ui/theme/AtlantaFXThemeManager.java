...
/**
 * Theme manager using AtlantaFX themes for modern, professional styling.
 * AtlantaFX provides flat interface themes inspired by web component frameworks.
 */
@Component
@Data
public class AtlantaFXThemeManager {
    ...
    private final ObjectProperty<AtlantaTheme> currentTheme = new SimpleObjectProperty<>(AtlantaTheme.PRIMER_LIGHT);
    ...
    /**
     * Sets the application theme globally.
     * This affects all JavaFX applications in the current JVM.
     */
    ...
    public void toggleLightDark() {
        ...
        AtlantaTheme newTheme = switch (current) {

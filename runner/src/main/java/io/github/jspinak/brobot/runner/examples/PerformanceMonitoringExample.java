...
/**
 * Example application demonstrating how to use the PerformanceMonitorPanel during development to
 * monitor UI performance metrics.
 *
 * <p>This example shows: 1. How to integrate the performance monitor into your application 2. How
 * to add it as a developer tool menu item 3. How to export performance reports
 */
...
public class PerformanceMonitoringExample extends Application {
    ...
    private void exportPerformanceReport() {
        ...
        alert.setContentText(
                "Report has been printed to console. In production, this would save to a file.");
        alert.showAndWait();
    }

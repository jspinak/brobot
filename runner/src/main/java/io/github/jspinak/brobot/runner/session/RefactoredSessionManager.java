 ...
 *
 * <ul>
 *   <li>SessionLifecycleService - Manages session lifecycle (create, end, restore)
 *   <li>SessionPersistenceService - Handles file I/O operations
 *   <li>SessionAutosaveService - Manages automatic periodic saves
 *   <li>SessionStateService - Captures and restores application state
 * </ul>
 *
...
public class RefactoredSessionManager implements AutoCloseable {
    ...
    /**
     * Creates a session summary for the current session. Useful for UI display without exposing the
     * full session object.
     */

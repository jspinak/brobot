...
public class ActionRecordMapper {
            ...
            try {
                ActionConfig config =
                        deserializeActionConfig(
                                entity.getActionConfigType(), entity.getActionConfigJson());
    ...
    private Match fromMatchEntity(MatchEntity entity) {
        ...
        // Set region
        builder.setRegion(entity.getX(), entity.getY(), entity.getWidth(), entity.getHeight());
    ...
    private Class<?> getActionConfigClass(String simpleName) {
        switch (simpleName) {
            ...
            case "ColorFindOptions":
                try {
                    return Class.forName(
                            "io.github.jspinak.brobot.action.basic.find.ColorFindOptions");
            ...
            case "MotionFindOptions":
                try {
                    return Class.forName(
                            "io.github.jspinak.brobot.action.basic.find.MotionFindOptions");
                } catch (ClassNotFoundException e) {
            ...
            case "MouseMoveOptions":
                try {
                    return Class.forName(
                            "io.github.jspinak.brobot.action.basic.mouse.MouseMoveOptions");
                } catch (ClassNotFoundException e) {
            ...
            case "DefineRegionOptions":
                try {
                    return Class.forName(
                            "io.github.jspinak.brobot.action.basic.region.DefineRegionOptions");
                } catch (ClassNotFoundException e) {
            ...
            case "HighlightOptions":
                try {
                    return Class.forName(
                            "io.github.jspinak.brobot.action.basic.highlight.HighlightOptions");
                } catch (ClassNotFoundException e) {

...
/**
 * Improved automation panel with better spacing and layout.
    ...
    private void refreshProjectTasks() {
        Platform.runLater(() -> {
            ...
            if (taskButtons.isEmpty()) {
                ...
                Label helpLabel = new Label("Add task buttons to your project configuration");
            ...
            logToUI("Loaded project: " + currentProject.getName() + 

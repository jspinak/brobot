...
/**
 * Factory class for creating buttons with programmatic icons.
 * This ensures consistent icon usage across the application.
 */
public class IconButton {
    
    /**
     * Creates a button with a programmatic icon based on the label.
     * If the label contains an emoji, it will be cleaned and replaced with a programmatic icon.
     * 

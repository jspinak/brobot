...
/**
 * Base panel class that ensures consistent styling across all panels. Extends VBox and provides
 * common functionality for all Brobot panels.
 */
public abstract class BrobotPanel extends VBox {
    ...
    /**
     * Initialize the panel. Subclasses should override this method to set up their specific
     * content.
     */

...
/**
 * Model representing the current status of automation execution. Immutable snapshot of automation
...
public class AutomationStatus {
    ...
    @Builder.Default private final double progress = 0.0;

    /** Elapsed time in milliseconds. */
    @Builder.Default private final long elapsedTime = 0;

    /** Number of completed actions/steps. */
    @Builder.Default private final int completedCount = 0;

    /** Total number of actions/steps. */
    @Builder.Default private final int totalCount = 0;

    /** Whether an error has occurred. */
    @Builder.Default private final boolean hasError = false;

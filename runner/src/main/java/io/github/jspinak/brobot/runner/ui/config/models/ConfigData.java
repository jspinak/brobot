...
/**
 * Model class representing configuration data loaded from a file. Contains both the raw JSON data
 * and a flattened key-value representation.
 */
@Data
public class ConfigData {
    ...
    /**
     * Flattened key-value pairs from the JSON. Nested objects use dot notation (e.g.,
     * "app.version").
     */
    ...
    /** Gets all keys that start with a given prefix. Useful for getting all values in a section. */
    ...
    /** Resets the unsaved changes flag. Should be called after successful save. */

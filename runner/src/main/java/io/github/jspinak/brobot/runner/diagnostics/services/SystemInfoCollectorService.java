 ...
 * 
 * This service gathers information about the operating system, JVM,
 * runtime environment, and system properties. It provides a comprehensive
 * view of the system configuration and state.
 * 
...
public class SystemInfoCollectorService implements DiagnosticCapable {
    ...
    public SystemInfo collectSystemInfo() {
        ...
        if (diagnosticMode.get()) {
            log.info("[DIAGNOSTIC] System info refreshed - OS: {}, Java: {}, Processors: {}",
                    cachedSystemInfo.osName(), cachedSystemInfo.javaVersion(), 
    ...
    public void enableDiagnosticMode(boolean enabled) {
        ...
        log.info("Diagnostic mode {} for SystemInfoCollectorService", 

...
/**
 * Factory for creating automation-related buttons with consistent styling and behavior.
 * Follows the Factory pattern to centralize button creation logic.
 */
@Slf4j
@Component
public class AutomationButtonFactory {
     ...
     */
    public Map<String, Button> createAutomationButtons(Map<String, AutomationButtonConfig> configs) {

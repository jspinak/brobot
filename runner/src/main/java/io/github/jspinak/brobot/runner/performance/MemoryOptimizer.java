...
public class MemoryOptimizer {
    ...
    private final ScheduledExecutorService scheduler =
            Executors.newSingleThreadScheduledExecutor(r -> new Thread(r, "memory-optimizer"));
    ...
    /**
     * Inner interface for backward compatibility. New code should use IMemoryReleasable instead.
     */
                    ...
                    if (releasable.getMemoryPriority().ordinal() >= minPriority.ordinal()) {
                        ...
                        if (freedBytes > 0) {
                            ...
                            log.debug(
                                    "Released {} bytes from {}",
                                    freedBytes,
                                    releasable.getClass().getSimpleName());
                        }
                    }
                } catch (Exception e) {
    ...
    public void reportMemoryStatus() {
        if (log.isDebugEnabled()) {
            ...
            report.append(
                    String.format(" | GC: %d collections, %d ms total", totalGcCount, totalGcTime));
    ...
    public interface IMemoryReleasable {
        ...
        /**
         * Get the priority of this component's memory. Lower priority memory will be released
         * first.
         */
    ...
    private static class MemoryPool {
        ...
        private final List<WeakReference<MemoryAllocation>> allocations =

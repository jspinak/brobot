...
/**
 * Service responsible for managing the lifecycle of sessions. Handles session creation, activation,
...
public class SessionLifecycleService {
    ...
    public boolean restoreSession(String sessionId) {
        return persistenceService.loadSession(sessionId).map(this::activateSession).orElse(false);
    }

 ...
 *
 * <p>This class provides a snapshot of a component's state at a specific point in time, useful for
...
public class DiagnosticInfo {
    ...
    @Builder.Default private final Map<String, Object> states = new HashMap<>();
    ...
    @Builder.Default private final List<String> errors = new ArrayList<>();

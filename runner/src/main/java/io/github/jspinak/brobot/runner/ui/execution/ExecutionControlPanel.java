 ...
 *
 * <p>This panel provides play, pause, and stop buttons for controlling the execution flow of
 * automation scripts. It automatically updates button states based on the current execution state.
 */
public class ExecutionControlPanel extends BrobotCard {
    ...
    @Getter private Button playButton;
    @Getter private Button pauseButton;
    @Getter private Button stopButton;

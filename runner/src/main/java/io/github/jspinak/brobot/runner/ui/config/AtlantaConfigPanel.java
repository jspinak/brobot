...
/**
 * Modern configuration panel styled according to AtlantaFX design principles. Provides a clean,
 * card-based interface for managing configurations.
 */
@Slf4j
public class AtlantaConfigPanel extends VBox {
    ...
    private void importConfiguration() {
        ...
        if (file != null) {
            eventBus.publish(
                    LogEvent.info(this, "Importing configuration: " + file.getName(), "Config"));
    ...
    private void importSelectedConfiguration() {
        ...
        if (selected != null) {
            eventBus.publish(
                    LogEvent.info(
                            this, "Importing configuration: " + selected.getName(), "Config"));
    ...
    private void loadConfiguration(ConfigEntry entry) {
        eventBus.publish(
                LogEvent.info(this, "Loading configuration: " + entry.getName(), "Config"));
                        ...
                        response -> {
                            if (response == ButtonType.OK) {
                                ...
                                eventBus.publish(
                                        LogEvent.info(
                                                this,
                                                "Deleted configuration: " + entry.getName(),
                                                "Config"));
                            }
                        });
    }

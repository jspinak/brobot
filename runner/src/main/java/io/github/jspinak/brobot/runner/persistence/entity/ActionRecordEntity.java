...
/**
 * Entity for persisting ActionRecord data from brobot library execution.
 * Captures the complete execution context of an action including configuration,
 * results, timing, and match information.
 */
@Entity
...
public class ActionRecordEntity {
     ...
     */
    @OneToMany(mappedBy = "actionRecord", cascade = CascadeType.ALL, 

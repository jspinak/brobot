...
/**
 * Comprehensive diagnostic tool for troubleshooting application issues. Acts as an orchestrator for
...
public class DiagnosticTool implements DiagnosticCapable {
    ...
    public DiagnosticInfo getDiagnosticInfo() {
        ...
        try {
            ...
            return DiagnosticInfo.builder().component("DiagnosticTool").states(states).build();

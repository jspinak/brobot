...
/**
 * Service for managing automation buttons in the enhanced panel. Handles button loading, creation,
 * styling, and organization by category.
 */
@Slf4j
@Service
public class EnhancedButtonService {
    ...
    @Getter @Setter private ButtonConfiguration configuration;
    ...
    public ButtonLoadResult loadProjectButtons() {
        if (projectManager == null || projectManager.getCurrentProject() == null) {
            return ButtonLoadResult.failure(
                    "No project loaded. Please load a configuration first.");
        }
        ...
        if (automation == null
                || automation.getButtons() == null
                || automation.getButtons().isEmpty()) {
            return ButtonLoadResult.failure(
                    "No automation buttons defined in the current project.");
        }

...
/**
 * UI component for automation execution controls.
 * Provides play, pause, resume, and stop functionality.
 */
@Slf4j
@Component
public class AutomationControlPanel extends BrobotPanel {
    ...
    private void setupStatusListener() {
        statusService.addStatusListener(status -> {
     ...
     */
    private void updateUI(io.github.jspinak.brobot.runner.ui.automation.models.AutomationStatus status) {
        // Update status label
     ...
     */
    private void updateButtonStates(io.github.jspinak.brobot.runner.ui.automation.models.AutomationStatus status) {
    ...
    private void showError(String errorMessage) {
        ...
        content.getChildren().removeIf(node -> node.getUserData() != null && node.getUserData().equals("error"));

...
/**
 * Service for loading configurations and initializing the Brobot library.
 * Handles the actual loading process and error handling.
 */
@Slf4j
@Service
public class ConfigLoadingService {
    ...
    public static class LoadingResult {
        ...
        private LoadingResult(boolean success, ConfigEntry configEntry, String message, Exception error) {
        ...
        public static LoadingResult failure(ConfigEntry configEntry, String message, Exception error) {

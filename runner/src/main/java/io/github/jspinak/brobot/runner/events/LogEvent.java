...
public class LogEvent extends BrobotEvent {
    ...
    public static LogEvent warning(Object source, String message, String category) {
        return new LogEvent(
                EventType.LOG_WARNING, source, message, LogLevel.WARNING, category, null);
    }

    /** Factory method to create an error log event */
    public static LogEvent error(
            Object source, String message, String category, Exception exception) {
        return new LogEvent(
                EventType.LOG_ERROR, source, message, LogLevel.ERROR, category, exception);
    }

    /** Factory method to create a critical log event */
    public static LogEvent critical(
            Object source, String message, String category, Exception exception) {
        return new LogEvent(
                EventType.LOG_ERROR, source, message, LogLevel.CRITICAL, category, exception);
    }
}

 ...
 * 
 * This record provides a snapshot of a thread pool's current state
 * including size, activity, and performance metrics.
 * 
 * @since 1.0.0
 */
public record ThreadPoolHealth(
    ...
    public boolean isUnderLoad() {
        return utilization > 0.8 || 
               (queueSize > 0 && activeThreads == poolSize);
    }
    ...
    public String toString() {
        return String.format(
            ...
            name, getStatus(), poolSize, activeThreads, queueSize, 
            completedTasks, totalTasks, rejectedTasks, 
            utilization * 100, avgTaskDuration
        );
    }

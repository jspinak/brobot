...
/**
 * Factory service for creating UI components for the unified automation panel.
...
public class UnifiedUIFactory {
    ...
    public Label createTitleLabel() {
        ...
        titleLabel.setStyle(String.format("-fx-font-size: %d; -fx-font-weight: bold;", 
    ...
    public ControlBar createControlBar() {
        ...
        return new ControlBar(controlBar, refreshButton, pauseResumeButton, 
                            stopAllButton, configureHotkeysBtn, autoMinimizeCheck);
    }
    ...
    public static class ControlBar {
        ...
        public ControlBar(HBox container, Button refreshButton, Button pauseResumeButton,
                         Button stopAllButton, Button configureHotkeysButton, 
        ...
        public Button getConfigureHotkeysButton() { return configureHotkeysButton; }
        public CheckBox getAutoMinimizeCheckBox() { return autoMinimizeCheckBox; }
    }
     ...
     */
    public AutomationStatusPanel createEnhancedStatusPanel(io.github.jspinak.brobot.runner.hotkeys.HotkeyManager hotkeyManager) {
    ...
    public AssembledPanel assembleMainPanel(
        ...
        return new AssembledPanel(mainContainer, titleLabel, statusPanel, 
                                progressSection, controlBar, buttonPane, logArea);
    }
    ...
    public static class AssembledPanel {
        ...
        public AssembledPanel(VBox mainContainer, Label titleLabel, 
                            AutomationStatusPanel statusPanel, ProgressSection progressSection,
                            ControlBar controlBar, ButtonPane buttonPane, TextArea logArea) {
        ...
        public AutomationStatusPanel getStatusPanel() { return statusPanel; }
        public ProgressSection getProgressSection() { return progressSection; }
        public ControlBar getControlBar() { return controlBar; }

 ...
 *
 * <p>The PerformanceProfiler provides comprehensive performance monitoring capabilities including
 * operation timing, memory usage tracking, thread analysis, and garbage collection statistics. It
 * helps identify performance bottlenecks and optimize application behavior.
 *
 * <p>Key features:
 *
 * <ul>
 *   <li>Operation timing with automatic metrics collection
 *   <li>Memory usage monitoring and analysis
 *   <li>Thread contention and CPU usage tracking
 *   <li>Garbage collection statistics
 *   <li>Performance snapshots for trend analysis
 *   <li>Hot spot detection for performance bottlenecks
 * </ul>
 *
 * <p>Usage example:
 *
 ...
 *
 * <ul>
 *   <li>Operation execution times (min, max, average, percentiles)
 *   <li>Operation invocation counts
 *   <li>Memory allocation rates
 *   <li>Thread states and CPU usage
 *   <li>GC pause times and frequencies
 * </ul>
 *
 * @see OperationTimer
...
public class PerformanceProfiler {
    ...
    private final ScheduledExecutorService scheduler =
            Executors.newSingleThreadScheduledExecutor(r -> new Thread(r, "performance-profiler"));
    ...
    private String analyzeMemory() {
        ...
        analysis.append(
                String.format(
                        "Heap used: %d MB / %d MB\n",
                        latest.heapUsed / (1024 * 1024), latest.heapMax / (1024 * 1024)));
    ...
    private String analyzeThreads() {
        ...
        if (latest.deadlockedThreads > 0) {
            analysis.append(
                    String.format(
                            "WARNING: %d deadlocked threads detected!\n",

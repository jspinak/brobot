 ...
 *
 * <p>This class follows the Adapter pattern to provide a unified interface for UI components that
 * need to work with both project management (file paths, persistence) and automation concepts
 * (states, transitions, buttons).
 *
 * <p>Single Responsibility: Adapt between ProjectDefinition and AutomationProject
 */
@Data
@Builder
public class ProjectContext {
    ...
    /**
     * The library's automation project containing states and transitions. This may be null if the
     * project hasn't loaded an automation yet.
     */

...
class AutomationButtonServiceTest extends ImprovedJavaFXTestBase {
    ...
    @Mock private ProjectDefinition projectDefinition;

    @Mock private AutomationProject project;

    @Mock private RunnerInterface automation;
    ...
    void testButtonSizeStyling() {
        ...
        // When
        service.populateButtonPane(
                buttonPane, Arrays.asList(smallButton, largeButton, defaultButton));

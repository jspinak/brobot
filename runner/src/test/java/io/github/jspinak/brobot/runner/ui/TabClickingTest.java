...
public class TabClickingTest {
    ...
    public void testMultipleTabClicksWork(FxRobot robot) throws InterruptedException {
        ...
        System.out.println(
                "Current tab after click: "
                        + getTabText(tabPane.getSelectionModel().getSelectedItem()));
        assertEquals(tab2, tabPane.getSelectionModel().getSelectedItem());
    ...
    public void testRapidTabClicksAllRegister(FxRobot robot) throws InterruptedException {
        ...
        // Should have registered at least 10 tab changes (some might be skipped due to rapid
        // clicking)
                ...
                () -> {
                    ...
                    MouseEvent clickEvent =
                            new MouseEvent(
                                    ...
                                    100,
                                    20, // coordinates within tab header
                                    100,
                                    20,
                                    MouseButton.PRIMARY,
                                    1,

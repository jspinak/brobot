...
class RefactoredResourceMonitorPanelTest extends JavaFXTestBase {
    ...
    void setUp() throws InterruptedException {
        ...
        runAndWait(() -> {
            panel = new RefactoredResourceMonitorPanel(
                resourceManager,
    ...
    void testLabelsCreatedWithLabelManager() throws InterruptedException {
        runAndWait(() -> {
            ...
            Label memoryLabel = labelManager.getOrCreateLabel(
                panel,
    ...
    void testScheduledUpdatesRegistered() {
        ...
        UIUpdateManager.UpdateMetrics metrics = uiUpdateManager.getMetrics("resource-monitor-update");
    ...
    void testSessionInfoFormatting() throws InterruptedException {
        ...
        io.github.jspinak.brobot.runner.session.Session mockSession = new io.github.jspinak.brobot.runner.session.Session();

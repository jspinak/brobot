...
public class TabClickingTestSimple {
    ...
    public void testBasicTabSelection(FxRobot robot) {
        ...
        System.out.println("Initial selection: " + tabPane.getSelectionModel().getSelectedItem().getText());
        ...
        System.out.println("After click, selected: " + tabPane.getSelectionModel().getSelectedItem().getText());

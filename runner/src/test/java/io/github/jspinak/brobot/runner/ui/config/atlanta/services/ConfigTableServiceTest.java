...
class ConfigTableServiceTest {
    ...
    void testColumnConfiguration() {
        ...
        TableColumn<ConfigEntry, String> nameCol =
                (TableColumn<ConfigEntry, String>) table.getColumns().get(0);
        assertTrue(nameCol.getMinWidth() >= 150);

        TableColumn<ConfigEntry, String> projectCol =
                (TableColumn<ConfigEntry, String>) table.getColumns().get(1);
        assertTrue(projectCol.getMinWidth() >= 150);

        TableColumn<ConfigEntry, String> pathCol =
                (TableColumn<ConfigEntry, String>) table.getColumns().get(3);

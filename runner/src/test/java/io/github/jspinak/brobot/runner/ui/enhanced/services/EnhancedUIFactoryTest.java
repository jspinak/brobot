...
class EnhancedUIFactoryTest {
    ...
    void testAssembleUI() {
        ...
        // When
        EnhancedUIFactory.AssembledUI assembled = factory.assembleUI(
    ...
    void testCustomBorderStroke() {
        // Given
        BorderStroke customStroke = new BorderStroke(
            Color.BLUE, BorderStrokeStyle.DASHED, new CornerRadii(10), new BorderWidths(2)
        );

...
class ConfigSelectionUIFactoryTest {
    ...
    void testCreateSplitPaneSection() {
        // When
        ConfigSelectionUIFactory.SplitPaneSection splitPaneSection = factory.createSplitPaneSection(eventBus);
        ...
        // Verify cards
        assertTrue(splitPaneSection.getRecentConfigsCard().getStyleClass().contains("recent-configurations-table"));
        assertTrue(splitPaneSection.getRecentConfigsCard().getStyleClass().contains(Styles.ELEVATED_1));
        assertEquals(300, splitPaneSection.getRecentConfigsCard().getMinWidth());
        
        assertTrue(splitPaneSection.getDetailsCard().getStyleClass().contains("configuration-details-card"));
    ...
    void testCreateSplitPaneSectionWithCustomConfiguration() {
        ...
        assertTrue(splitPaneSection.getRecentConfigsCard().getStyleClass().contains(Styles.ELEVATED_2));
    ...
    void testAssembleUI() {
        ...
        VBox mainPanel = factory.createMainPanel();
        ConfigSelectionUIFactory.HeaderSection header = factory.createHeaderSection();
        ConfigSelectionUIFactory.SplitPaneSection splitPane = factory.createSplitPaneSection(eventBus);
        
        // When
        ConfigSelectionUIFactory.AssembledUI assembled = factory.assembleUI(mainPanel, header, splitPane);
    ...
    void testCreateAlert() {
        // When
        Alert infoAlert = factory.createAlert(

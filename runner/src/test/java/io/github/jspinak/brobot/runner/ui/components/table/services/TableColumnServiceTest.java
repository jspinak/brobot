...
class TableColumnServiceTest {
    ...
    void testAddStringColumn() throws InterruptedException {
        ...
        Platform.runLater(
                () -> {
                    TableColumn<TestItem, String> column =
                            columnService.addStringColumn(tableView, "Name", "name");
    ...
    void testAddColumnWithCellValueFactory() throws InterruptedException {
        ...
        Platform.runLater(
                () -> {
                    Callback<
                                    TableColumn.CellDataFeatures<TestItem, String>,
                                    javafx.beans.value.ObservableValue<String>>
                            cellValueFactory = param -> param.getValue().nameProperty();

                    TableColumn<TestItem, String> column =
                            columnService.addColumn(tableView, "Custom", cellValueFactory);
        ...
        Platform.runLater(
                () -> {
                    Callback<
                                    TableColumn.CellDataFeatures<TestItem, String>,
                                    javafx.beans.value.ObservableValue<String>>
                            cellValueFactory = param -> param.getValue().valueProperty();

                    Callback<TableColumn<TestItem, String>, TableCell<TestItem, String>>
                            cellFactory =
                                    column ->
                                            new TableCell<TestItem, String>() {
                                                @Override
                    ...
                    TableColumn<TestItem, String> column =
                            columnService.addColumn(
                                    tableView, "Value", cellValueFactory, cellFactory);
    ...
    void testSetColumnTitle() throws InterruptedException {
        ...
        Platform.runLater(
                () -> {
                    TableColumn<TestItem, String> column =
                            columnService.addStringColumn(tableView, "Original", "name");
    ...
    void testRemoveColumn() throws InterruptedException {
        ...
        Platform.runLater(
                () -> {
                    TableColumn<TestItem, String> column1 =
                            columnService.addStringColumn(tableView, "Col1", "name");
                    TableColumn<TestItem, String> column2 =
        ...
        Platform.runLater(
                () -> {
                    TableColumn<TestItem, String> column1 =
                            columnService.addStringColumn(tableView, "Name", "name");
                    TableColumn<TestItem, String> column2 =
                            columnService.addStringColumn(tableView, "Name", "value");

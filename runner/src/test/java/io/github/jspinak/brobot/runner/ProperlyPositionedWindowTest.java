...
public class ProperlyPositionedWindowTest {
    ...
    public static class TestApp extends Application {
        ...
        public void start(Stage primaryStage) {
            ...
            Label infoLabel = new Label("Screen: " + screenBounds.getWidth() + "x" + screenBounds.getHeight() + 
                                       " at (" + screenBounds.getMinX() + ", " + screenBounds.getMinY() + ")");
            ...
            testButton.setOnAction(e -> {
                ...
                label.setStyle("-fx-font-size: 24px; -fx-text-fill: blue; -fx-font-weight: bold;");
            ...
            new Thread(() -> {
                try {
                    for (int i = 10; i > 0; i--) {
                        final int count = i;
                        Platform.runLater(() -> timerLabel.setText("Window will close in " + count + " seconds..."));
                        Thread.sleep(1000);
                    }
                    Platform.runLater(() -> {
                        primaryStage.close();
    ...
    public void testJavaFxWindowAppearsOnScreen() throws InterruptedException {
        ...
        System.out.println("Please look for the window on your screen and click the button if you see it!");
        ...
        if (windowShown) {
            ...
            if (TestApp.wasButtonClicked()) {
                ...
                System.out.println("ℹ Button was not clicked - window may not have been visible or interactive");
            }
        } else {

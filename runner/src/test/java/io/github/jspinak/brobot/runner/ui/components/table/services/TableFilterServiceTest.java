    ...
    void testSearchProviderFiltering() throws InterruptedException {
        ...
        Platform.runLater(
                () -> {
                    ...
                    assertTrue(
                            filteredList.stream()
                                    .allMatch(item -> item.getName().toLowerCase().contains("a")));
    ...
    void testCustomFilter() throws InterruptedException {
        ...
        Platform.runLater(
                () -> {
                    ...
                    Predicate<TestItem> vegetableFilter =
                            item -> "Vegetable".equals(item.getCategory());
                    ...
                    assertTrue(
                            filteredList.stream()
                                    .allMatch(item -> "Vegetable".equals(item.getCategory())));

 ...
 *
 * <p>Tests thread management, task submission, cancellation, and diagnostics.
 */
...
class ExecutionThreadManagerTest {
    ...
    void shouldHandleNullParameters() {
        ...
        assertThrows(IllegalArgumentException.class, () -> threadManager.submit(() -> {}, null));
    }
    ...
    void shouldRespectThreadPriority() throws Exception {
        ...
        ExecutionOptions options = ExecutionOptions.builder().priority(Thread.MAX_PRIORITY).build();

        ExecutionContext context =
                ExecutionContext.builder().taskName("HighPriorityTask").options(options).build();

...
class UIUpdateManagerTest {
    ...
    void testExecuteUpdate() throws InterruptedException {
        ...
        // Act
        updateManager.executeUpdate("testUpdate", () -> {
    ...
    void testQueueUpdate() throws InterruptedException {
        ...
        for (int i = 0; i < 3; i++) {
            updateManager.queueUpdate("queuedUpdate", () -> {
                counter.incrementAndGet();
                latch.countDown();
            });
        }
    ...
    void testSchedulePeriodicUpdate() throws InterruptedException {
        ...
        // Act
        boolean scheduled = updateManager.schedulePeriodicUpdate(
            "periodicTask",
            () -> {
                counter.incrementAndGet();
                latch.countDown();
    ...
    void testSchedulePeriodicUpdate_DuplicateId() {
        // Arrange
        updateManager.schedulePeriodicUpdate("duplicateTask", () -> {}, 0, 100, TimeUnit.MILLISECONDS);
        
        // Act
        boolean scheduled = updateManager.schedulePeriodicUpdate("duplicateTask", () -> {}, 0, 100, TimeUnit.MILLISECONDS);
    ...
    void testScheduleDelayedUpdate() throws InterruptedException {
        ...
        // Act
        boolean scheduled = updateManager.scheduleDelayedUpdate(
            "delayedTask",
            () -> {
                counter.incrementAndGet();
                latch.countDown();
    ...
    void testMetrics() throws InterruptedException {
        ...
        for (int i = 0; i < 5; i++) {
            updateManager.executeUpdate("metricsTest", () -> {
                try {

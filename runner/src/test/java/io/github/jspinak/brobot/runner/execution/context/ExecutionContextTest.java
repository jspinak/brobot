 ...
 *
 * <p>Tests immutability, builder pattern, and timeout calculations.
 */
...
class ExecutionContextTest {
    ...
    void shouldGenerateUniqueIdByDefault() {
        // When
        ExecutionContext context1 = ExecutionContext.builder().taskName("Task1").build();
        ExecutionContext context2 = ExecutionContext.builder().taskName("Task2").build();
    ...
    void shouldCalculateElapsedTimeCorrectly() throws InterruptedException {
        // Given
        ExecutionContext context = ExecutionContext.builder().taskName("TestTask").build();
    ...
    void shouldDetectTimeoutCorrectly() throws InterruptedException {
        ...
        ExecutionContext context =
                ExecutionContext.builder().taskName("TestTask").options(options).build();
    ...
    void shouldHandleNullOptionsGracefully() {
        // Given
        ExecutionContext context =
                ExecutionContext.builder().taskName("TestTask").options(null).build();
    ...
    void shouldHandleNullTimeoutInOptions() {
        // Given
        ExecutionOptions options = ExecutionOptions.builder().timeout(null).build();

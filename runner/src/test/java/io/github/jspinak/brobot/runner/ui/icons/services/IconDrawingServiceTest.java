...
class IconDrawingServiceTest {
    ...
    @Mock private GraphicsContext mockGraphicsContext;
    ...
    void testIconDrawersRegistered() {
        ...
        for (String iconName : expectedIcons) {
            assertTrue(drawingService.hasDrawer(iconName), "Should have drawer for: " + iconName);
            assertNotNull(
                    drawingService.getDrawer(iconName),
    ...
    void testIconAliases() {
        ...
        assertEquals(
                drawingService.getDrawer("settings"), drawingService.getDrawer("configuration"));

        assertEquals(drawingService.getDrawer("play"), drawingService.getDrawer("automation"));

        assertEquals(drawingService.getDrawer("chart"), drawingService.getDrawer("resources"));

        assertEquals(drawingService.getDrawer("list"), drawingService.getDrawer("logs"));
    }
    ...
    void testDrawPlayIcon() {
        ...
        verify(mockGraphicsContext).fillPolygon(any(double[].class), any(double[].class), eq(3));
    }
    ...
    void testDrawChartIcon() {
        ...
        verify(mockGraphicsContext, times(4))
                .fillRect(anyDouble(), anyDouble(), anyDouble(), anyDouble());
    }
    ...
    void testDrawListIcon() {
        ...
        verify(mockGraphicsContext, times(3)).fillOval(anyDouble(), anyDouble(), eq(3.0), eq(3.0));
        verify(mockGraphicsContext, times(3))
                .strokeLine(anyDouble(), anyDouble(), anyDouble(), anyDouble());
    }
    ...
    void testDrawInfoIcon() {
        ...
        verify(mockGraphicsContext).strokeOval(anyDouble(), anyDouble(), anyDouble(), anyDouble());

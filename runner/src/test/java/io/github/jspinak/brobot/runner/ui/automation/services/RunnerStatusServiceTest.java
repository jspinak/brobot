...
class RunnerStatusServiceTest {
    ...
    void testIsActive() {
        ...
        ExecutionState[] activeStates = {
            ExecutionState.RUNNING, ExecutionState.PAUSED, ExecutionState.STARTING, ExecutionState.STOPPING
        };
        ...
        ExecutionState[] inactiveStates = {
            ExecutionState.IDLE, ExecutionState.COMPLETED, ExecutionState.FAILED, ExecutionState.ERROR
        };
    ...
    void testStateChangeNotification() throws InterruptedException {
        ...
        service.addStateChangeListener((oldState, newState) -> {
    ...
    void testRemoveListeners() {
        ...
        RunnerStatusService.StatusUpdateListener statusListener = status -> statusUpdateCount.incrementAndGet();
        RunnerStatusService.StateChangeListener stateListener = (old, newer) -> stateChangeCount.incrementAndGet();

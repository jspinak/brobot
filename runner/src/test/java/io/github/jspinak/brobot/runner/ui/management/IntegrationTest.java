...
/**
 * Integration tests for LabelManager and UIUpdateManager working together across multiple UI
 * components.
 */
class IntegrationTest extends ImprovedJavaFXTestBase {
    ...
    void testMultiplePanelsShareLabelManager() throws InterruptedException {
        ...
        runAndWait(
                () -> {
                    ...
                    ExampleLabelManagedPanel panel1 =
                            TestHelper.createExamplePanel(labelManager, uiUpdateManager);
                    panel1.initialize();

                    RefactoredConfigDetailsPanel panel2 =
                    ...
                    assertEquals(
                            1,
                            labelManager
                                    .getComponentCount()); // Only panel1 creates component-specific
                    // labels
    ...
    void testLabelUpdatesAcrossPanels() throws InterruptedException {
        // Create panel
        final ExampleLabelManagedPanel panel =
                TestHelper.createExamplePanel(labelManager, uiUpdateManager);
        runAndWait(
                () -> {
                    panel.initialize();
        ...
        runAndWait(
                () -> {
                    ...
                    uiUpdateManager.executeUpdate(
                            ...
                            () -> {
                                ConfigEntry config =
                                        TestHelper.createTestConfigEntry(
                                                "Test Config", "Test Project");
    ...
    void testPanelCleanupDoesNotAffectOthers() throws InterruptedException {
        // Create panels
        final ExampleLabelManagedPanel panel1 =
                TestHelper.createExamplePanel(labelManager, uiUpdateManager);
        final RefactoredConfigDetailsPanel panel2 =
    ...
    void testPerformanceMetricsAggregation() throws InterruptedException {
        runAndWait(
                () -> {
                    ...
                    RefactoredResourceMonitorPanel panel3 =
                            new RefactoredResourceMonitorPanel(
                                    resourceManager,
                                    imageResourceManager,
                                    cacheManager,

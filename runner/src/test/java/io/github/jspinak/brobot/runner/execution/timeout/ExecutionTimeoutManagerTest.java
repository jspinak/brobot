 ...
 *
 * <p>Tests timeout monitoring, handler callbacks, and diagnostic capabilities.
 */
...
class ExecutionTimeoutManagerTest {
    ...
    void shouldUseDefaultTimeoutWhenNotSpecified() throws Exception {
        ...
        ExecutionContext context =
                ExecutionContext.builder().taskName("DefaultTimeoutTask").options(options).build();
    ...
    private ExecutionContext createContext(String taskName, Duration timeout) {
        ExecutionOptions options = ExecutionOptions.builder().timeout(timeout).build();

...
class EnhancedStatusMonitoringServiceTest {
    ...
    void testStatusUpdateNotification() throws InterruptedException {
        ...
        AtomicReference<EnhancedStatusMonitoringService.StatusUpdate> updateRef = new AtomicReference<>();
        
        service.addStatusListener(update -> {
    ...
    void testRemoveListener() throws InterruptedException {
        ...
        EnhancedStatusMonitoringService.StatusUpdateListener listener = update -> {
            updateCount.incrementAndGet();
            latch.countDown();
        };

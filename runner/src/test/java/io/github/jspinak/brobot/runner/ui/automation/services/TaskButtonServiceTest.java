...
class TaskButtonServiceTest {
    ...
    @Mock private AutomationProject mockProject;

    @Mock private RunnerInterface mockRunner;
    ...
    void testLoadProjectTasks() {
        ...
        taskButtonService.setTaskLoadListener(
    ...
    void testValidateTaskButton() {
        ...
        TaskButtonService.TaskValidationResult validResult =
                taskButtonService.validateTask(validTask);
        ...
        TaskButtonService.TaskValidationResult noFunctionResult =
                taskButtonService.validateTask(noFunctionTask);
        ...
        TaskButtonService.TaskValidationResult noIdResult =
                taskButtonService.validateTask(noIdentifierTask);
        assertFalse(noIdResult.isValid());
        assertTrue(
                noIdResult.getIssues().stream()
                        .anyMatch(issue -> issue.contains("No label or ID")));
    }

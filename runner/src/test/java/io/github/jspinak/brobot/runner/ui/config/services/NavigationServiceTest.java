...
class NavigationServiceTest {
    ...
    void testNavigateToStateSuccess() {
        ...
        TreeItem<ConfigBrowserPanel.ConfigItem> stateItem = rootItem.getChildren().get(0).getChildren().get(0);
    ...
    void testNavigateToItem() {
        ...
        TreeItem<ConfigBrowserPanel.ConfigItem> targetItem = rootItem.getChildren().get(1); // config.json
    ...
    void testNavigateToFirstItemOfTypeFound() {
        ...
        // When
        boolean result = service.navigateToFirstItemOfType(
    ...
    void testNavigateToDeepItem() {
        ...
        TreeItem<ConfigBrowserPanel.ConfigItem> deepFolder = new TreeItem<>(
            new ConfigBrowserPanel.ConfigItem("Deep", ConfigBrowserPanel.ConfigItemType.FOLDER)
        );
        TreeItem<ConfigBrowserPanel.ConfigItem> deeperFolder = new TreeItem<>(
            new ConfigBrowserPanel.ConfigItem("Deeper", ConfigBrowserPanel.ConfigItemType.FOLDER)
        );
        TreeItem<ConfigBrowserPanel.ConfigItem> deepestItem = new TreeItem<>(
            new ConfigBrowserPanel.ConfigItem("Deepest", ConfigBrowserPanel.ConfigItemType.METADATA)
        );

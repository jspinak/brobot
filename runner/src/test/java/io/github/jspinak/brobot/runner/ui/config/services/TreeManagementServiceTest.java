...
class TreeManagementServiceTest {
    ...
    void testCreateFolderItem() {
        // When
        TreeItem<ConfigBrowserPanel.ConfigItem> folderItem = service.createFolderItem("Test Folder");
    ...
    void testCreateConfigFileItem() {
        ...
        // When
        TreeItem<ConfigBrowserPanel.ConfigItem> fileItem = service.createConfigFileItem(
            "config.json",
        ...
        assertEquals(ConfigBrowserPanel.ConfigItemType.PROJECT_CONFIG, fileItem.getValue().getType());
    ...
    void testCreateStateImageItem() {
        ...
        // When
        TreeItem<ConfigBrowserPanel.ConfigItem> imageItem = service.createStateImageItem(mockStateImage);
    ...
    void testCreateAutomationButtonItem() {
        ...
        // When
        TreeItem<ConfigBrowserPanel.ConfigItem> buttonItem = service.createAutomationButtonItem(mockButton);
        
        // Then
        assertNotNull(buttonItem);
        assertEquals("Test Button", buttonItem.getValue().getName());
        assertEquals(ConfigBrowserPanel.ConfigItemType.AUTOMATION_BUTTON, buttonItem.getValue().getType());
    ...
    void testCreateMetadataItem() {
        // When
        TreeItem<ConfigBrowserPanel.ConfigItem> metadataItem = service.createMetadataItem("Version: 1.0.0");

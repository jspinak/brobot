...
class TablePaginationServiceTest {
    ...
    void testGoToLastPage() throws InterruptedException {
        ...
        Platform.runLater(() -> {
            ...
            assertEquals(3, pagination.getCurrentPageIndex()); // 0-indexed, so 3 is the 4th page
    ...
    void testGoToSpecificPage() throws InterruptedException {
        ...
        Platform.runLater(() -> {
            ...
            assertEquals(2, pagination.getCurrentPageIndex()); // Should stay on current page
    ...
    void testGoToNextPage() throws InterruptedException {
        ...
        Platform.runLater(() -> {
            ...
            paginationService.goToNextPage();
            assertEquals(lastPage, pagination.getCurrentPageIndex()); // Should stay on last page
    ...
    void testPageSizeProperty() throws InterruptedException {
        ...
        Platform.runLater(() -> {
            ...
            paginationService.pageSizeProperty().addListener((obs, oldVal, newVal) -> {

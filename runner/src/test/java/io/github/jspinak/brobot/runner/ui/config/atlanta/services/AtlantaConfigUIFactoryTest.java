...
class AtlantaConfigUIFactoryTest extends ImprovedJavaFXTestBase {
    ...
    void testCreateActionBarComponents() throws InterruptedException {
        final AtlantaConfigUIFactory.ActionBarComponents[] components =
                new AtlantaConfigUIFactory.ActionBarComponents[1];
        runAndWait(
                () -> {
                    // When
        ...
        assertEquals(
                "Config Path: /test/config/path", components[0].getConfigPathLabel().getText());

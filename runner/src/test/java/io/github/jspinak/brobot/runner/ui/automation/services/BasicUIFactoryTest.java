...
class BasicUIFactoryTest {
    ...
    void testAssembleUI() {
        ...
        // When
        BasicUIFactory.AssembledUI assembled = factory.assembleUI(
        ...
        assertEquals("Available Automation Functions:", ((Label) mainPanel.getChildren().get(4)).getText());
    ...
    void testComponentAccessors() {
        ...
        assertSame(controlBar.getPauseResumeButton(), assembled.getControlBar().getPauseResumeButton());

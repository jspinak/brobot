...
class PanelVisualRegressionTest extends ImprovedJavaFXTestBase {
    ...
    void testRefactoredConfigDetailsPanelVisual() throws Exception {
        runAndWait(() -> {
            ...
            ConfigEntry testConfig = TestHelper.createTestConfigEntry("Test Configuration", "Test Project");
    ...
    void testResponsiveLayout() throws Exception {
        runAndWait(() -> {
            ...
            // Set test data
            ConfigEntry testConfig = TestHelper.createTestConfigEntry("Responsive Test", "Test Project");

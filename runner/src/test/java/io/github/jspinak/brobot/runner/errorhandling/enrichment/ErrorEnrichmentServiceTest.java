...
class ErrorEnrichmentServiceTest {
    ...
    void testCategorizeFileIOError() {
        // Act
        ErrorContext.ErrorCategory category =
                service.categorizeError(new IOException("File not found"));
    ...
    void testCategorizeDatabaseError() {
        // Act
        ErrorContext.ErrorCategory category =
                service.categorizeError(new SQLException("Connection failed"));
    ...
    void testCategorizeValidationError() {
        // Act
        ErrorContext.ErrorCategory category =
                service.categorizeError(new IllegalArgumentException("Invalid input"));
    ...
    void testCategorizeUnknownError() {
        // Act
        ErrorContext.ErrorCategory category =
                service.categorizeError(new RuntimeException("Random error"));

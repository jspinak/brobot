...
class ButtonCategoryServiceTest {
    ...
    void testUpdateCategoriesWithEmptyList() {
        // When
        ButtonCategoryService.CategoryUpdate update =
                service.updateCategories(Collections.emptyList());
    ...
    void testUpdateCategoriesWithDefaultCategory() {
        ...
        // When
        ButtonCategoryService.CategoryUpdate update =
                service.updateCategories(Arrays.asList(buttonNoCategory));
    ...
    void testUpdateCategoriesWithChanges() {
        ...
        ButtonCategoryService.CategoryUpdate update =
                service.updateCategories(Arrays.asList(button3, button4));

...
/**
 * Base class for tests that require JavaFX runtime. Ensures JavaFX Platform is initialized before
 * tests run.
 */
public abstract class JavaFXTestBase {
    ...
    /**
     * Waits for any JavaFX animations to complete. This is a simplified version that just waits a
     * fixed time for animations.
     */

...
class SessionAutosaveServiceTest {
    ...
    void testEnableAutosave_SchedulesPeriodicSave() throws InterruptedException {
                ...
                SessionContext.builder()
                        ...
                        .options(
                                SessionOptions.builder()
                                        ...
                                        .autosaveInterval(
                                                Duration.ofMillis(
                                                        100)) // Quick interval for testing
                                        .build())
                        .build();

        Consumer<Session> saveHandler =
                session -> {
        ...
        SessionAutosaveService.AutosaveStatus status =
                autosaveService.getStatus(context.getSessionId());
    ...
    void testEnableAutosave_WithDisabledOption_DoesNotSchedule() {
        ...
        SessionContext context =
                SessionContext.builder()
                        ...
                        .configPath("/config.json")
                        .imagePath("/images")
                        .options(SessionOptions.builder().autosaveEnabled(false).build())
                        .build();
    ...
    void testDisableAutosave_StopsScheduledSaves() throws InterruptedException {
        ...
        await().atMost(Duration.ofSeconds(1)).until(() -> saveCount.get() > 0);
    ...
    void testTriggerAutosave_ManuallyInvokesHandler() {
        ...
        boolean triggered =
                autosaveService.triggerAutosave(
                        context.getSessionId(), session -> saveCount.incrementAndGet());
    ...
    void testGetAllAutosaveStatuses() {
        ...
        // When
        Map<String, SessionAutosaveService.AutosaveStatus> statuses =
                autosaveService.getAllAutosaveStatuses();
    ...
    void testDiagnosticInfo() {
        ...
        assertThat(diagnosticInfo.getStates())
                .containsKeys("activeSessions", "totalAutosaves", "failedAutosaves", "successRate");
        assertThat(diagnosticInfo.getStates().get("activeSessions")).isEqualTo(1);
        assertThat((Integer) diagnosticInfo.getStates().get("totalAutosaves"))

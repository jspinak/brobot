...
class TableSelectionServiceTest {
    ...
    void setUp() throws InterruptedException {
        ...
        Platform.runLater(() -> {
            ...
            items = FXCollections.observableArrayList("Item 1", "Item 2", "Item 3", "Item 4", "Item 5");
    ...
    void testInitialize() throws InterruptedException {
        ...
        Platform.runLater(() -> {
            ...
            assertEquals(SelectionMode.SINGLE, tableView.getSelectionModel().getSelectionMode());
    ...
    void testSetSelectionMode() throws InterruptedException {
        ...
        Platform.runLater(() -> {
            ...
            assertEquals(SelectionMode.MULTIPLE, tableView.getSelectionModel().getSelectionMode());
    ...
    void testMultiSelectionListeners() throws InterruptedException {
        ...
        Platform.runLater(() -> {
            ...
            Consumer<List<String>> listener = items -> notifications.add(new ArrayList<>(items));
    ...
    void testSelectionModeProperty() throws InterruptedException {
        ...
        Platform.runLater(() -> {
            ...
            selectionService.selectionModeProperty().addListener((obs, oldVal, newVal) -> {
            ...
            assertEquals(SelectionMode.MULTIPLE, selectionService.selectionModeProperty().get());

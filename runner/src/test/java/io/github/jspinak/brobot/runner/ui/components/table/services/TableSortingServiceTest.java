    ...
    void testSetSortOrder() throws InterruptedException {
        ...
        Platform.runLater(
                () -> {
                    ...
                    assertEquals(
                            1, tableView.getSortOrder().size()); // Should replace previous sort
    ...
    void testSetCustomComparator() throws InterruptedException {
        ...
        Platform.runLater(
                () -> {
                    ...
                    Comparator<TestItem> customComparator =
    ...
    void testGetSortType() throws InterruptedException {
        ...
        Platform.runLater(
                () -> {
                    ...
                    sortingService.setSortOrder(nameColumn, true);
                    assertEquals(
                            TableColumn.SortType.ASCENDING, sortingService.getSortType(nameColumn));

                    // Change to descending
                    sortingService.setSortOrder(nameColumn, false);
                    assertEquals(
                            TableColumn.SortType.DESCENDING,
                            sortingService.getSortType(nameColumn));

...
class EnhancedTableUIFactoryTest {
    ...
    void testCreateTableView() throws InterruptedException {
        ...
        Platform.runLater(() -> {
            ...
            assertEquals("No data available", ((Label) tableView.getPlaceholder()).getText());
    ...
    void testCreateToolbar() throws InterruptedException {
        ...
        Platform.runLater(() -> {
            ...
            // Should contain search label, search field, spacer, page size label, and selector
            ...
            assertEquals("Items per page:", ((Label) toolbar.getChildren().get(3)).getText());
    ...
    void testCreateToolbarComponents() throws InterruptedException {
        CountDownLatch latch = new CountDownLatch(1);
        Platform.runLater(() -> {
            EnhancedTableUIFactory.ToolbarComponents components = uiFactory.createToolbarComponents();
            ...
            assertTrue(components.getToolbar().getChildren().contains(components.getSearchField()));
            assertTrue(components.getToolbar().getChildren().contains(components.getPageSizeSelector()));
    ...
    void testAssembleTableUI() throws InterruptedException {
        ...
        Platform.runLater(() -> {
            ...
            VBox result = uiFactory.assembleTableUI(container, toolbar, tableView, paginationBox);
    ...
    void testCustomConfiguration() throws InterruptedException {
        ...
        Platform.runLater(() -> {
            ...
            EnhancedTableUIFactory.UIConfiguration config = EnhancedTableUIFactory.UIConfiguration.builder()
                .searchPrompt("Find...")
                .toolbarSpacing(20)

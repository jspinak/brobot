...
public class TransitionExecutorTest extends BrobotTestBase {
    ...
    @Mock
    private StateVisibilityManager stateVisibilityManager;
    ...
    @Mock
    private TransitionConditionPackager transitionConditionPackager;
    ...
    public void setupTest() {
        ...
        executor = new TransitionExecutor(
    ...
    class StateActivationAndCascading {
        ...
        public void testCascadingTransition() {
            ...
            setupBasicTransition(fromState, toState);
            when(mockTransition.getCascadeAction()).thenReturn(StateTransition.CascadeAction.ACTIVATE);
            ...
            when(transitionConditionPackager.packageTransition(cascadeTransition, toState, cascadeState))
        ...
        public void testAlreadyActiveStateNotReactivated() {
            ...
            setupBasicTransition(fromState, toState);
            when(mockTransition.getCascadeAction()).thenReturn(StateTransition.CascadeAction.ACTIVATE);
            when(mockTransition.getActivate()).thenReturn(Set.of(toState)); // Try to activate already active state
    ...
    class ComplexTransitionScenarios {
        ...
        public void testMultiLevelCascading() {
            ...
            when(transitionFetcher.getTransitionToActivate(stateB, stateC))
                .thenReturn(Optional.of(cascadeTransition));
            when(cascadeTransition.getCascadeAction()).thenReturn(StateTransition.CascadeAction.NONE);
        ...
        public void testCascadeFailureHandling(boolean coreSuccess, boolean cascadeSuccess, 

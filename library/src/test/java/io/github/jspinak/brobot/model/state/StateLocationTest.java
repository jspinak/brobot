...
/**
 * Comprehensive test suite for StateLocation - represents meaningful screen coordinates. Tests
 * positioning, state association, interaction tracking, and anchoring.
 */
...
public class StateLocationTest extends BrobotTestBase {
    ...
    @Mock private SearchRegionOnObject mockSearchRegion;
    ...
    class StateAssociation {
        ...
        @ParameterizedTest
        @CsvSource({"LoginState, 1", "MainMenu, 2", "Settings, 3", "Dialog, 4"})

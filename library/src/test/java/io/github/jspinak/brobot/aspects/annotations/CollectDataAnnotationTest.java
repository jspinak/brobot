...
/**
 * Comprehensive test suite for @CollectData annotation.
 * Tests data collection configuration, sampling, feature selection, and format options.
 */
...
public class CollectDataAnnotationTest extends BrobotTestBase {
    ...
    class DataFormatTests {
        ...
        void shouldSupportParquetFormat() throws NoSuchMethodException {
            Method method = DataCollectionTestClass.class.getMethod("complexDataMethod", String.class);
            CollectData annotation = method.getAnnotation(CollectData.class);
    ...
    class AnnotationMetadataTests {
        ...
        void shouldHaveProperAnnotationMethods() throws NoSuchMethodException {
            ...
            assertEquals(boolean.class, CollectData.class.getMethod("captureScreenshots").getReturnType());
            ...
            assertEquals(CollectData.DataFormat.class, CollectData.class.getMethod("format").getReturnType());
        }

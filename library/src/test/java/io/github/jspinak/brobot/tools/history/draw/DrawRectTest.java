...
/**
 * Comprehensive test class for DrawRect functionality. Tests rectangle drawing operations on OpenCV
 * Mat images.
 */
...
public class DrawRectTest extends BrobotTestBase {
    ...
    void shouldDrawRectAroundMatchWithPadding() {
        ...
        assertDoesNotThrow(() -> drawRect.drawRectAroundMatch(mockMat, mockMatch, testColor));
    ...
    void shouldDrawRectOnMatchWithoutPadding() {
        ...
        assertDoesNotThrow(() -> drawRect.drawRectOnMatch(mockMat, mockMatch, testColor));
    ...
    void shouldDrawRectangleWithOpenCVRect() {
        ...
        // Just verify no exception is thrown
        assertDoesNotThrow(() -> drawRect.drawRect(mockMat, testRect, testColor));
    ...
    void shouldDrawRectangleAroundOpenCVRectWithPadding() {
        ...
        // Just verify no exception is thrown
        assertDoesNotThrow(() -> drawRect.drawRectAroundMatch(mockMat, testRect, testColor));
    ...
    void shouldDrawRectanglesAroundMultipleRegions() {
        ...
        // Just verify no exception is thrown
        assertDoesNotThrow(() -> drawRect.drawRectAroundRegions(mockMat, regions, testColor));
    ...
    void shouldHandleNullMatGracefully() {
        ...
        assertDoesNotThrow(() -> drawRect.drawRectAroundRegions(null, regions, testColor));
    ...
    void shouldDrawRectangleAroundSingleRegion() {
        ...
        // Just verify no exception is thrown
        assertDoesNotThrow(() -> drawRect.drawRectAroundRegion(mockMat, region, testColor));
    ...
    void shouldHandleEmptyRegionList() {
        ...
        assertDoesNotThrow(() -> drawRect.drawRectAroundRegions(mockMat, emptyRegions, testColor));

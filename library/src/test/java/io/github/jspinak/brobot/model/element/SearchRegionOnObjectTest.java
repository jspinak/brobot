...
/**
 * Comprehensive tests for the SearchRegionOnObject class which configures search regions derived
 * from other state objects' matches.
 */
...
public class SearchRegionOnObjectTest extends BrobotTestBase {
    ...
    public void setupTest() {
        super.setupTest();
        testAdjustments = MatchAdjustmentOptions.builder().setAddX(10).setAddY(-20).build();
    }
    ...
    void testBuilderMinimalProperties() {
        // When
        searchRegionOnObject =
                SearchRegionOnObject.builder().setTargetObjectName("MinimalObject").build();
    ...
    void testAllStateObjectTypes(StateObject.Type type) {
        // When
        searchRegionOnObject = SearchRegionOnObject.builder().setTargetType(type).build();
    ...
    void testToBuilderPattern() {
        ...
        SearchRegionOnObject modified =
                searchRegionOnObject.toBuilder().setTargetStateName("ModifiedState").build();
    ...
    void testNullAndEmptyStateNames(String stateName) {
        // When
        searchRegionOnObject = SearchRegionOnObject.builder().setTargetStateName(stateName).build();
    ...
    void testComplexAdjustments() {
        // Given
        MatchAdjustmentOptions complexAdjustments =
        ...
        // When
        searchRegionOnObject =
                SearchRegionOnObject.builder().setAdjustments(complexAdjustments).build();
    ...
    Stream<DynamicTest> testDynamicSearchRegionScenarios() {
        return Stream.of(
                dynamicTest(
                        "Search relative to menu item",
                        () -> {
                            SearchRegionOnObject config =
                                    SearchRegionOnObject.builder()
                                            .setTargetStateName("MainMenu")
                                    ...
                                    SearchRegionOnObject.builder()
                                            ...
                                            .setAdjustments(
                                                    MatchAdjustmentOptions.builder()
                                                            ...
                                                            .setAddH(-60) // Remove title and button
                                                            // areas
                                                            .build())
                                            .build();
                ...
                dynamicTest(
                        "Search adjacent to found element",
                        () -> {
                            SearchRegionOnObject config =
                                    SearchRegionOnObject.builder()
    ...
    void testAdjustmentsReferenceImmutability() {
        // Given
        MatchAdjustmentOptions original = MatchAdjustmentOptions.builder().setAddX(10).build();

        searchRegionOnObject = SearchRegionOnObject.builder().setAdjustments(original).build();

        // When - Modify through setter
        MatchAdjustmentOptions modified = MatchAdjustmentOptions.builder().setAddX(20).build();

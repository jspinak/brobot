...
class ActionOptionsRegionProviderTest extends BrobotTestBase {
    ...
    @Mock
    private PatternFindOptions mockPatternFindOptions;
    ...
    void testHasSearchRegions_True() {
        when(mockPatternFindOptions.getSearchRegions()).thenReturn(mockSearchRegions);
        when(mockSearchRegions.getRegions(true)).thenReturn(Arrays.asList(new Region(0, 0, 10, 10)));
    ...
    void testMergeWithExistingRegions() {
        ...
        List<Region> result = regionProvider.mergeWithExistingRegions(mockPatternFindOptions, existingRegions);
    ...
    void testMergeWithExistingRegions_EmptyExisting() {
        ...
        List<Region> result = regionProvider.mergeWithExistingRegions(mockPatternFindOptions, new ArrayList<>());

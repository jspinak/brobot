...
/**
 * Comprehensive test suite for Text - represents OCR-extracted text with variability.
 * Tests stochastic OCR results, multiple readings, and collection operations.
 */
...
public class TextTest extends BrobotTestBase {
    ...
    class OCRVariability {
        ...
        public void testMultipleOCRReadings() {
            ...
            long submitCount = readings.stream()
                .filter(s -> "Submit".equals(s))
                .count();
    ...
    class RealWorldScenarios {
        ...
        public void testButtonTextVariations() {
            ...
            // Most common reading
            long okCount = text.getAll().stream()
        ...
        public void testEmailVariations() {
            ...
            long correctCount = text.getAll().stream()
                .filter(s -> "user@example.com".equals(s))
                .count();
    ...
    class StatisticalAnalysis {
        ...
        public void testCalculateVariationRate() {
            ...
            // Count unique values
            long uniqueCount = text.getAll().stream()
                .distinct()
                .count();

...
class AnchorRegionTest {
    ...
    @Test
    public void testFitRegionToAnchors() throws Exception {
        ...
        StateRegion reg2 = new StateRegion.Builder()
                ...
                .build();
        MatchObject m1 = new MatchObject(reg1.getSearchRegion().toMatch(), reg1, 0);
        MatchObject m2 = new MatchObject(reg2.getSearchRegion().toMatch(), reg2, 0);
        matches.add(m1);
        matches.add(m2);

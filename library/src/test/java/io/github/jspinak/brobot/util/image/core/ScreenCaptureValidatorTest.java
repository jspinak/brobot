...
/**
 * Test suite for ScreenCaptureValidator.
 * Tests screen capture validation and headless detection functionality
 * in a way that works in headless environments.
 */
...
public class ScreenCaptureValidatorTest extends BrobotTestBase {
    ...
    class EdgeCases {
        ...
        void shouldHandleTransparentImages() {
            ...
            assertTrue(result, "Image with non-black pixels should return true regardless of alpha");
        }
    ...
    class HeadlessModeDetection {
        ...
        void shouldDetectCurrentEnvironmentHeadlessState() {
            ...
            if (GraphicsEnvironment.isHeadless()) {
                assertTrue(isHeadless, "Should detect headless when GraphicsEnvironment.isHeadless() is true");
            }
        }

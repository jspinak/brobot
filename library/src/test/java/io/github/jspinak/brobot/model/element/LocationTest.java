...
/**
 * Comprehensive test suite for Location - represents a point on the screen. Tests absolute and
 * relative positioning, offsets, and conversions.
 */
...
public class LocationTest extends BrobotTestBase {
    ...
    class AbsolutePositioning {
        ...
        @ParameterizedTest
        @CsvSource({"0, 0", "100, 200", "-50, -100", "1920, 1080", "9999, 9999"})
    ...
    class RelativePositioning {
        ...
        public void testVariousRelativePositions(
                double percentW, double percentH, int expectedX, int expectedY) {
            location.setRegion(mockRegion);
        ...
        public void testBuilderRelative() {
            ...
            Location loc =
                    new Location.Builder()
                            .setRegion(region)
                            .setPosition(
                                    75, 25) // Using percentOfW, percentOfH (converts to 0.75, 0.25)

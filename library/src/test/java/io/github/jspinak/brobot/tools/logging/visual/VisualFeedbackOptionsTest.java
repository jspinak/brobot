...
public class VisualFeedbackOptionsTest extends BrobotTestBase {
    ...
    @Mock
    private VisualFeedbackConfig globalConfig;
    
    @Mock
    private VisualFeedbackConfig.FindHighlightConfig findConfig;
    
    @Mock
    private VisualFeedbackConfig.SearchRegionHighlightConfig searchRegionConfig;
    ...
    public void testEqualsAndHashCode() {
        VisualFeedbackOptions options1 = VisualFeedbackOptions.builder()
            .highlightEnabled(true)
            .highlightFinds(true)
            .highlightLabel("Test")
            .build();
        
        VisualFeedbackOptions options2 = VisualFeedbackOptions.builder()
            .highlightEnabled(true)
            .highlightFinds(true)
            .highlightLabel("Test")
            .build();
        
        VisualFeedbackOptions options3 = VisualFeedbackOptions.builder()
            .highlightEnabled(false)
            .highlightFinds(true)
            .highlightLabel("Test")
            .build();

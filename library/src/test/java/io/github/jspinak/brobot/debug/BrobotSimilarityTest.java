...
public class BrobotSimilarityTest extends BrobotTestBase {
    ...
    public void testBrobotPatternMatching() {
        ...
        try {
            ...
            System.out.println("\n3. GLOBAL SETTINGS:");
            System.out.println(
                    "   Settings.MinSimilarity: " + org.sikuli.basics.Settings.MinSimilarity);
            System.out.println(
                    "   Settings.AlwaysResize: " + org.sikuli.basics.Settings.AlwaysResize);
            System.out.println(
                    "   Settings.CheckLastSeen: " + org.sikuli.basics.Settings.CheckLastSeen);
            ...
            for (double threshold : thresholds) {
                ...
                if (finder.hasNext()) {
                    ...
                    System.out.println(
                            "   Threshold " + String.format("%.2f", threshold) + ": No match");
                }
                finder.destroy();
            }
            ...
            // Get fresh SikuliX pattern from Brobot (simulating what happens in
            // ScenePatternMatcher)
            ...
            if (Math.abs(sikuliPattern.getSimilar() - globalSimilarity) > 0.01) {
                ...
                System.out.println(
                        "   Updated pattern similarity to: " + sikuliPattern.getSimilar());
            }

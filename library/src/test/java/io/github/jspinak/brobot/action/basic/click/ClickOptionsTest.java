...
/**
 * Comprehensive test suite for ClickOptions - configuration for click actions. Tests builder
 * pattern, default values, and serialization.
 */
...
public class ClickOptionsTest extends BrobotTestBase {
    ...
    class ClickCountConfiguration {
        ...
        public void testSingleClick() {
            ClickOptions options = builder.setNumberOfClicks(1).build();
        ...
        public void testDoubleClick() {
            ClickOptions options = builder.setNumberOfClicks(2).build();
        ...
        public void testTripleClick() {
            ClickOptions options = builder.setNumberOfClicks(3).build();
        ...
        public void testVariousClickCounts(int clicks) {
            ClickOptions options = builder.setNumberOfClicks(clicks).build();
    ...
    class MouseButtonConfiguration {
        ...
        public void testLeftClick() {
            ...
            ClickOptions options = builder.setPressOptions(pressOptions).build();
    ...
    class VerificationConfiguration {
        ...
        public void testClickUntilVanish() {
            ...
            assertEquals(
                    VerificationOptions.Event.OBJECTS_VANISH,
    ...
    class RepetitionConfiguration {
        ...
        @ParameterizedTest
        @CsvSource({"1, 0.0", "3, 0.5", "5, 1.0", "10, 2.0"})
    ...
    class BuilderCopyConstructor {
        ...
        public void testCopyConstructor() {
            ...
            assertEquals(
                    original.getMousePressOptions().getButton(),
        ...
        public void testModifyCopiedOptions() {
            ClickOptions original = builder.setNumberOfClicks(1).build();

            ClickOptions modified = new ClickOptions.Builder(original).setNumberOfClicks(3).build();
    ...
    class ComplexClickScenarios {
        ...
        public void testDoubleClickWithVerification() {
            ...
            assertEquals(2, options.getNumberOfClicks());
            assertEquals(
                    VerificationOptions.Event.TEXT_APPEARS,
                    options.getVerificationOptions().getEvent());
        }
    ...
    class ActionConfigInheritance {
        ...
        public void testSetPauseBeforeBegin() {
            ClickOptions options = builder.setPauseBeforeBegin(1.5).build();
        ...
        public void testSetPauseAfterEnd() {
            ClickOptions options = builder.setPauseAfterEnd(2.0).build();
        ...
        public void testSetIllustrate() {
            ClickOptions options = builder.setIllustrate(ActionConfig.Illustrate.YES).build();
        ...
        public void testChainActions() {
            ClickOptions nextClick = builder.setNumberOfClicks(2).build();

            ClickOptions options = builder.then(nextClick).build();
    ...
    class JsonSerialization {
        ...
        // @Test - Disabled due to Jackson/OpenCV Mat serialization conflict - needs
        // BrobotObjectMapper
        ...
        public void testRoundTripSerialization() throws Exception {
            ...
            assertEquals(
                    original.getTimesToRepeatIndividualAction(),
    ...
    class EdgeCases {
        ...
        public void testZeroClicks() {
            ClickOptions options = builder.setNumberOfClicks(0).build();
        ...
        public void testVeryLargeClickCount() {
            ClickOptions options = builder.setNumberOfClicks(Integer.MAX_VALUE).build();
        ...
        public void testNullMousePressOptions() {
            ClickOptions options = builder.setPressOptions(null).build();

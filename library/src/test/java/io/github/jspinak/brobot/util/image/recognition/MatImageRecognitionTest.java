...
/**
 * Comprehensive test suite for MatImageRecognition. Tests OpenCV-based template matching
 * functionality.
 */
...
public class MatImageRecognitionTest extends BrobotTestBase {
    ...
    class BasicTemplateMatching {
        ...
        void shouldFindExactTemplateMatch() {
            Optional<Match> result =
                    matImageRecognition.findTemplateMatch(template, searchImage, 0.9);
        ...
        void shouldNotFindMatchBelowThreshold() {
            ...
            Optional<Match> result =
                    matImageRecognition.findTemplateMatch(differentTemplate, searchImage, 0.99);
        ...
        void shouldFindPartialMatchWithLowerThreshold() {
            ...
            Optional<Match> result =
                    matImageRecognition.findTemplateMatch(partialTemplate, searchImage, 0.5);
    ...
    class ThresholdVariations {
        ...
        void shouldRespectDifferentThresholds(double threshold) {
            Optional<Match> result =
                    matImageRecognition.findTemplateMatch(template, searchImage, threshold);
        ...
        void shouldHandleThresholdOne() {
            ...
            Optional<Match> result =
                    matImageRecognition.findTemplateMatch(template, searchImage, 1.0);
    ...
    class TemplateSizeValidation {
        ...
        void shouldRejectTemplateLargerThanSearch() {
            ...
            Optional<Match> result =
                    matImageRecognition.findTemplateMatch(largeTemplate, searchImage, 0.7);
        ...
        void shouldHandleTemplateSameSizeAsSearch() {
            ...
            Optional<Match> result =
                    matImageRecognition.findTemplateMatch(sameSizeTemplate, searchImage, 0.99);
        ...
        void shouldHandleSinglePixelTemplate() {
            ...
            Optional<Match> result =
                    matImageRecognition.findTemplateMatch(pixelTemplate, searchImage, 0.8);
    ...
    class DifferentImageTypes {
        ...
        void shouldMatchGrayscaleImages() {
            ...
            Optional<Match> result =
                    matImageRecognition.findTemplateMatch(grayTemplate, graySearch, 0.9);
        ...
        void shouldMatchMultiChannelImages() {
            ...
            Optional<Match> result =
                    matImageRecognition.findTemplateMatch(bgraTemplate, bgraSearch, 0.9);
    ...
    class MatchPositionAccuracy {
        ...
        @ParameterizedTest
        @CsvSource({"10, 10", "0, 0", "160, 170", "100, 50", "75, 125"})
        ...
        void shouldFindTemplateAtVariousPositions(int x, int y) {
            ...
            Optional<Match> result =
                    matImageRecognition.findTemplateMatch(template, positionedSearch, 0.9);
        ...
        void shouldFindBestMatchAmongMultiple() {
            ...
            rectangle(
                    ...
                    new Point(50, 150),
                    new Point(90, 180),
                    new Scalar(180, 180, 180, 0));

            Optional<Match> result =
                    matImageRecognition.findTemplateMatch(template, multiSearch, 0.5);
    ...
    class PerformanceAndScalability {
        ...
        void shouldHandleVariousImageSizes(int size) {
            ...
            rectangle(
                    ...
                    new Point(size / 2 + 20, size / 2 + 20),
                    new Scalar(255, 255, 255, 0));

            long startTime = System.currentTimeMillis();
            Optional<Match> result =
                    matImageRecognition.findTemplateMatch(smallTemplate, largeSearch, 0.9);
            ...
            assertTrue(
                    ...
                    "Template matching should complete within 1 second for "
                            + size
                            + "x"
                            + size
                            + " image");
        ...
        void shouldHandleComplexPatternsEfficiently() {
            ...
            long startTime = System.currentTimeMillis();
            Optional<Match> result =
                    matImageRecognition.findTemplateMatch(complexTemplate, complexSearch, 0.9);
            long endTime = System.currentTimeMillis();

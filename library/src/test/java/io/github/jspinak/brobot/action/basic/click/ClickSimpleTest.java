...
/**
 * Simple tests for Click action that work within mock mode constraints.
 * These tests verify the basic structure and flow without requiring
...
public class ClickSimpleTest extends BrobotTestBase {
    ...
    void testObjectCollectionWithLocations() {
        ...
        StateLocation stateLocation1 = new StateLocation.Builder()
            .setLocation(location1)
            .setName("loc1")
            .build();
        
        StateLocation stateLocation2 = new StateLocation.Builder()

...
/**
 * Simplified test suite for BufferedImageUtilities that works with Brobot's mock mode. Extends
 * BrobotTestBase for proper mock configuration.
 */
    ...
    class Base64Conversions {
        ...
        public void testInvalidBase64String() {
            ...
            BufferedImage result =
                    BufferedImageUtilities.base64StringToImage("not-a-valid-base64!");
            assertNull(result, "Should return null for invalid base64");

            // Test with partially valid base64 that doesn't decode to an image
            result =
                    BufferedImageUtilities.base64StringToImage(
                            "YWJjZGVmZw=="); // "abcdefg" in base64

...
/**
 * Comprehensive test suite for MovementAnalyzer - movement pattern detection utility.
 * Tests displacement calculation, voting algorithm, and measurement tolerance.
 */
...
public class MovementAnalyzerTest extends BrobotTestBase {
    ...
    class BasicMovementDetection {
        ...
        public void testRightwardMovement() {
            List<Match> firstMatches = Arrays.asList(
                createMatch(100, 100),
                createMatch(200, 200)
            );
            
            List<Match> secondMatches = Arrays.asList(
            ...
            assertEquals(-50, movement.get(0).getCalculatedX()); // Negative because displacement is first - second
        ...
        public void testDownwardMovement() {
            ...
            assertEquals(-50, movement.get(0).getCalculatedY()); // Negative because displacement is first - second
        }
    ...
    class VotingAlgorithm {
        ...
        public void testMostFrequentWins() {
            ...
            boolean found20Movement = movement.stream()
                .anyMatch(loc -> loc.getCalculatedX() == -20 && loc.getCalculatedY() == 0);
        ...
        public void testConsensusBuilding() {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                secondMatches.add(createMatch(i * 100 + 25, i * 100 + 15)); // All moved 25 right, 15 down
            }
    ...
    class EdgeCases {
        ...
        public void testLargeMovements() {
            ...
            List<Match> secondMatches = Arrays.asList(
                createMatch(10000, 5000),
                createMatch(10100, 5100)
            );
    ...
    class RealWorldScenarios {
        ...
        public void testGameMapScrolling() {
            ...
            List<Match> beforeScroll = Arrays.asList(
            ...
            List<Match> afterScroll = Arrays.asList(
        ...
        public void testParallaxScrolling() {
            // Foreground objects
            List<Match> foregroundBefore = Arrays.asList(
                createMatch(100, 300),
                createMatch(200, 300),
                createMatch(300, 300)
            );
            ...
            List<Match> foregroundAfter = Arrays.asList(
        ...
        public void testCameraPan() {
            ...
            List<Match> frameBefore = Arrays.asList(
            ...
            List<Match> frameAfter = Arrays.asList(
        ...
        public void testNoisyDetection() {
            ...
            for (int i = 0; i < 8; i++) {
                ...
                secondMatches.add(createMatch(i * 100 + 30, i * 50)); // Consistent 30 pixel movement
            }
            ...
            boolean foundConsistentMovement = movement.stream()
                .anyMatch(loc -> Math.abs(loc.getCalculatedX() + 30) <= 5 && 
    ...
    class ComplexMovementPatterns {
        ...
        public void testRotationDetection() {
            ...
            List<Match> before = Arrays.asList(
            ...
            List<Match> after = Arrays.asList(

...
/**
 * Comprehensive test suite for @Recoverable annotation. Tests retry logic configuration, exception
 * handling, backoff strategies, and fallback methods.
 */
...
public class RecoverableAnnotationTest extends BrobotTestBase {
    ...
    static class RecoverableTestClass {
        ...
        @Recoverable(
                strategy = Recoverable.RecoveryStrategy.CUSTOM,
                fallbackMethod = "customHandler")
    ...
    class AnnotationPresenceTests {
        ...
        void shouldDetectRecoverableOnMethods() throws NoSuchMethodException {
            ...
            Method unrecoverableMethod =
                    RecoverableTestClass.class.getMethod("unrecoverableMethod");
    ...
    class FallbackMethodTests {
        ...
        void shouldVerifyFallbackMethodExists() throws NoSuchMethodException {
            Method recoverableMethod =
                    RecoverableTestClass.class.getMethod("complexRecoverableMethod");
    ...
    class EnumStrategyTests {
        ...
        void shouldHaveAllRecoveryStrategies() {
            ...
            assertTrue(
                    Arrays.asList(strategies).contains(Recoverable.RecoveryStrategy.FIXED_DELAY));
            assertTrue(
                    Arrays.asList(strategies)
                            .contains(Recoverable.RecoveryStrategy.EXPONENTIAL_BACKOFF));
            assertTrue(
                    Arrays.asList(strategies)
                            .contains(Recoverable.RecoveryStrategy.FIBONACCI_BACKOFF));
    ...
    class AnnotationMetadataTests {
        ...
        void shouldHaveProperAnnotationMethods() throws NoSuchMethodException {
            ...
            assertEquals(
                    String.class, Recoverable.class.getMethod("fallbackMethod").getReturnType());
        }

...
/**
 * Comprehensive test suite for StateTransitionVerification. Tests validation of state transition
...
class StateTransitionVerificationTest extends BrobotTestBase {
    ...
    class BuilderTests {
        ...
        void shouldCreateSimpleTransitionVerification() {
            ...
            StateTransitionVerification verification =
                    builder.fromState("LOGIN").toState("DASHBOARD").verify();
            ...
            StateTransitionVerification.TransitionStep step =
                    verification.getExpectedSteps().get(0);
        ...
        void shouldCreateMultiStepTransitionSequence() {
            ...
            // Act
            StateTransitionVerification verification =
                    builder.transition("START", "LOADING", false)
            ...
            List<StateTransitionVerification.TransitionStep> steps =
                    verification.getExpectedSteps();
    ...
    class EventCheckingTests {
        ...
        void setup() {
            verification =
                    new StateTransitionVerification.Builder("test", mockVerifier)
                            .fromState("A")
                            .toState("B")
                            .verify();
        }
        ...
        void shouldFailWhenWrongTransitionOccurs() {
            // Arrange
            MockBehaviorVerifier.ExecutionEvent wrongEvent =
                    MockBehaviorVerifier.ExecutionEvent.builder()
                            .timestamp(LocalDateTime.now())
                            .fromState("A")
            ...
            assertTrue(
                    verification
                            .getErrors()
                            .get(0)
                            .contains("Expected transition A -> B but got A -> C"));
        }
    ...
    class MultiStepSequenceTests {
        ...
        void shouldVerifyCompleteMultiStepSequence() {
            ...
            MockBehaviorVerifier.ExecutionEvent event3 =
                    MockBehaviorVerifier.ExecutionEvent.builder()

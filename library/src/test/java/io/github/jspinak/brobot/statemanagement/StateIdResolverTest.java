...
public class StateIdResolverTest extends BrobotTestBase {
    ...
    class JavaStateTransitionConversion {
        ...
        public void testConvertActivateNamesToIds() {
            ...
            javaTransition.setActivateNames(new HashSet<>(Arrays.asList("Dashboard", "Menu", "Footer")));
        ...
        public void testSkipNullActivateIds() {
            ...
            JavaStateTransition javaTransition = new JavaStateTransition();
            javaTransition.setActivateNames(new HashSet<>(Arrays.asList("ValidState", "InvalidState", "AnotherValid")));
            javaTransition.setActivate(new HashSet<>());
    ...
    class BatchConversion {
        ...
        public void testBatchConversion() {
            ...
            List<StateTransitions> allTransitions = Arrays.asList(transitions1, transitions2, transitions3);
    ...
    class ComplexScenarios {
        ...
        public void testDeepTransitionHierarchy() {
            ...
            level2.setActivateNames(new HashSet<>(Arrays.asList("GrandChild1", "GrandChild2", "GrandChild3")));
        ...
        public void testDuplicateStateNames() {
            ...
            transition.setActivateNames(new HashSet<>(Arrays.asList("DupState", "DupState", "DupState")));

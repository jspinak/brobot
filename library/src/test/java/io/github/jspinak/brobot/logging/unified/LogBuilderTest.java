...
/** Tests for LogBuilder. Tests fluent API for building and dispatching log events. */
...
public class LogBuilderTest extends BrobotTestBase {
    ...
    @Mock private LoggingContext mockContext;

    @Captor private ArgumentCaptor<LogEvent> logEventCaptor;
    ...
    void testBasicLogEvent() {
        // Act
        logBuilder.message("Test message").log();
    ...
    void testAddMetadata() {
        // Act
        logBuilder.metadata("key1", "value1").metadata("key2", 123).metadata("key3", true).log();
    ...
    void testEmptyMetadata() {
        // Act
        logBuilder.metadata(new HashMap<>()).log();
    ...
    void testStateObjectTarget() {
        ...
        // Act
        logBuilder.target(mockStateObject).action("CLICK").log();
    ...
    void testStateTransitions() {
        // Act
        logBuilder.transition("StartState", "EndState").duration(300L).log();
    ...
    void testObservations() {
        // Act
        logBuilder.observation("System is running normally").log();
    ...
    void testActionResult() {
        ...
        // Act
        logBuilder.result(mockResult).action("FIND").log();
    ...
    void testScreenshot() {
        // Act
        logBuilder.screenshot("/tmp/test-screenshot.png").message("Screenshot captured").log();
    ...
    void testColors() {
        // Act
        logBuilder.color("RED", "BOLD").message("Colored message").log();

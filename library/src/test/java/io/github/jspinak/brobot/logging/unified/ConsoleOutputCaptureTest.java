...
/**
 * Tests for ConsoleOutputCapture. Tests console output capture and routing to BrobotLogger.
...
public class ConsoleOutputCaptureTest extends BrobotTestBase {
    ...
    @Mock private LoggingContext mockLoggingContext;

    @Mock private MessageRouter mockMessageRouter;
                        ...
                        .anyMatch(
                                event ->
                                        event.getMessage() != null
                                                && event.getMessage().contains("Test output line")),
                        ...
                        .anyMatch(
                                event ->
                                        event.getMetadata() != null
                                                && "console.out"
                                                        .equals(event.getMetadata().get("source"))),
        ...
        assertTrue(
                eventCaptor.getAllValues().stream()
                        .anyMatch(
                                event ->
                                        event.getMessage() != null
                                                && event.getMessage().contains("Error message")),
        ...
        assertTrue(
                eventCaptor.getAllValues().stream()
                        .anyMatch(
                                event ->
                                        event.getMessage() != null
                                                && event.getMessage().contains("Output message")),
        ...
        assertTrue(
                eventCaptor.getAllValues().stream()
                        .anyMatch(
                                event ->
                                        event.getMessage() != null
                                                && event.getMessage().contains("Cycle 2")),
        ...
        assertEquals(
                ...
                eventCaptor.getAllValues().stream()
                        .filter(
                                event ->
                                        event.getMessage() != null
                                                && event.getMessage().equals("Normal log message"))
                        .count(),
                "Only 'Normal log message' should be captured");
        ...
        assertFalse(
                eventCaptor.getAllValues().stream()
                        .anyMatch(
                                event ->
                                        event.getMessage() != null
                                                && event.getMessage().contains("SikuliX")),
    ...
    void testLogLevelDetermination() throws InterruptedException {
        ...
        assertTrue(
                eventCaptor.getAllValues().stream()
                        .anyMatch(e -> e.getLevel() == LogEvent.Level.ERROR));
        assertTrue(
                eventCaptor.getAllValues().stream()
                        .anyMatch(e -> e.getLevel() == LogEvent.Level.WARNING));
        assertTrue(
                eventCaptor.getAllValues().stream()
                        .anyMatch(e -> e.getLevel() == LogEvent.Level.DEBUG));
        assertTrue(
                eventCaptor.getAllValues().stream()
                        .anyMatch(e -> e.getLevel() == LogEvent.Level.INFO));
    }
        ...
        assertTrue(
                eventCaptor.getAllValues().stream()
                        .anyMatch(
                                event ->
                                        event.getMessage() != null
                                                && event.getMessage().contains("Before exception")),
        ...
        assertTrue(
                eventCaptor.getAllValues().stream()
                        .anyMatch(
                                event ->
                                        event.getMessage() != null
                                                && event.getMessage().contains("Caught exception")),
        ...
        assertTrue(
                eventCaptor.getAllValues().stream()
                        .anyMatch(
                                event ->
                                        event.getMessage() != null
                                                && event.getMessage().contains("finally block")),
                ...
                eventCaptor.getAllValues().stream()
                        .anyMatch(
                                event ->
                                        event.getMessage() != null
                                                && event.getMessage()
                                                        .contains("Partial line without newline")),

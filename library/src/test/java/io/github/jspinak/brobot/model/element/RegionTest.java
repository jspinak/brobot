...
/**
 * Comprehensive test suite for Region - represents a rectangular area on the screen. Tests
 * constructors, geometric operations, conversions, and region arithmetic.
 */
...
public class RegionTest extends BrobotTestBase {
    ...
    @Mock private org.sikuli.script.Match mockSikuliMatch;

    @Mock private org.sikuli.script.Region mockSikuliRegion;

    @Mock private org.sikuli.script.Location mockSikuliLocation;
    ...
    class BuilderPattern {
        ...
        public void testBuilder() {
            Region r = Region.builder().withRegion(10, 20, 100, 50).build();

...
/**
 * Comprehensive test suite for FindAndClick composite action. Tests configuration combinations for
 * find and click operations.
 */
...
public class FindAndClickTest extends BrobotTestBase {
    ...
    class ConstructorTests {
        ...
        public void testConstructorWithBothOptions() {
            ...
            ClickOptions customClick = new ClickOptions.Builder().setNumberOfClicks(2).build();
            ...
            assertEquals(
                    PatternFindOptions.Strategy.BEST, findAndClick.getFindOptions().getStrategy());
    ...
    class FindOptionsConfiguration {
        ...
        public void testConfigureFindType() {
            ...
            assertEquals(
                    PatternFindOptions.Strategy.ALL, findAndClick.getFindOptions().getStrategy());
        }
        ...
        public void testConfigureTimeout() {
            PatternFindOptions findOptions =
                    new PatternFindOptions.Builder().setSearchDuration(30.0).build();
    ...
    class CombinedConfigurations {
        ...
        public void testQuickFindAndClick() {
            ...
            assertEquals(
                    PatternFindOptions.Strategy.FIRST, findAndClick.getFindOptions().getStrategy());
    ...
    class BuilderPatternTests {
        ...
        public void testBuilderWithFindOptions() {
            ...
            FindAndClick findAndClick =
                    new FindAndClick.Builder().withFindOptions(customFind).build();
        ...
        public void testBuilderWithClickOptions() {
            ClickOptions customClick = new ClickOptions.Builder().setNumberOfClicks(3).build();

            FindAndClick findAndClick =
                    new FindAndClick.Builder().withClickOptions(customClick).build();
    ...
    class EdgeCases {
        ...
        public void testMinSimilarityMaxClicks() {
            ...
            ClickOptions clickOptions =
                    new ClickOptions.Builder().setNumberOfClicks(Integer.MAX_VALUE).build();
        ...
        public void testMaximumWaitTime() {
            PatternFindOptions findOptions =
                    new PatternFindOptions.Builder().setSearchDuration(Double.MAX_VALUE).build();
        ...
        public void testZeroWaitTime() {
            PatternFindOptions findOptions =
                    new PatternFindOptions.Builder().setSearchDuration(0.0).build();

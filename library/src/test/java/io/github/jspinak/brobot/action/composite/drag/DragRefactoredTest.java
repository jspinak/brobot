...
/**
 * Test for refactored Drag class that no longer depends on ActionChainExecutor. This verifies the
 * pure action implementation works correctly.
 */
@DisabledInCI
public class DragRefactoredTest extends BrobotTestBase {
    ...
    public void testDragBetweenLocations() {
        ...
        assertEquals(
                2, actionResult.getMatchList().size(), "Should have source and target matches");

...
/**
 * Comprehensive test suite for MatchAdjustmentOptions. Tests configuration for adjusting match
...
public class MatchAdjustmentOptionsTest extends BrobotTestBase {
    ...
    class TargetPositionConfiguration {
        ...
        public void testCenterPosition() {
            ...
            MatchAdjustmentOptions options =
                    MatchAdjustmentOptions.builder().setTargetPosition(center).build();
        ...
        public void testCornerPosition() {
            ...
            MatchAdjustmentOptions options =
                    MatchAdjustmentOptions.builder().setTargetPosition(topLeft).build();
        ...
        public void testNullTargetPosition() {
            MatchAdjustmentOptions options =
                    MatchAdjustmentOptions.builder().setTargetPosition(null).build();
    ...
    class TargetOffsetConfiguration {
        ...
        public void testPositiveOffset() {
            ...
            MatchAdjustmentOptions options =
                    MatchAdjustmentOptions.builder().setTargetOffset(offset).build();
    ...
    class SizeAdjustmentConfiguration {
        ...
        public void testAddToSize() {
            MatchAdjustmentOptions options =
                    MatchAdjustmentOptions.builder().setAddW(20).setAddH(15).build();
        ...
        public void testSubtractFromSize() {
            MatchAdjustmentOptions options =
                    MatchAdjustmentOptions.builder().setAddW(-10).setAddH(-5).build();
        ...
        public void testAbsoluteSize() {
            MatchAdjustmentOptions options =
                    MatchAdjustmentOptions.builder().setAbsoluteW(200).setAbsoluteH(150).build();
        ...
        public void testDisableAbsoluteSize() {
            MatchAdjustmentOptions options =
                    MatchAdjustmentOptions.builder().setAbsoluteW(-1).setAbsoluteH(-1).build();
    ...
    class PositionAdjustmentConfiguration {
        ...
        public void testAddToPosition() {
            MatchAdjustmentOptions options =
                    MatchAdjustmentOptions.builder().setAddX(30).setAddY(40).build();
        ...
        public void testSubtractFromPosition() {
            MatchAdjustmentOptions options =
                    MatchAdjustmentOptions.builder().setAddX(-20).setAddY(-30).build();
        ...
        @ParameterizedTest
        @CsvSource({"0, 0", "10, 20", "-10, -20", "100, -100", "-50, 50"})
        @DisplayName("Various position adjustments")
        public void testVariousPositionAdjustments(int x, int y) {
            MatchAdjustmentOptions options =
                    MatchAdjustmentOptions.builder().setAddX(x).setAddY(y).build();
    ...
    class BuilderPattern {
        ...
        public void testToBuilder() {
            MatchAdjustmentOptions original =
                    MatchAdjustmentOptions.builder().setAddW(10).setAddH(20).build();

            MatchAdjustmentOptions modified = original.toBuilder().setAddX(30).setAddY(40).build();
    ...
    class JsonSerialization {
        ...
        public void testDefaultSerialization() throws JsonProcessingException {
            ...
            MatchAdjustmentOptions deserialized =
                    objectMapper.readValue(json, MatchAdjustmentOptions.class);
    ...
    class UseCases {
        ...
        public void testClickButtonEdge() {
            ...
            MatchAdjustmentOptions options =
                    MatchAdjustmentOptions.builder().setTargetPosition(rightEdge).build();
        ...
        public void testFixedSizeRegion() {
            ...
            MatchAdjustmentOptions options =
                    MatchAdjustmentOptions.builder().setAbsoluteW(100).setAbsoluteH(50).build();

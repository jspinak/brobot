...
public class ScalingAnalysisTest extends DebugTestBase {
    ...
    public void analyzeScaling() {
        ...
        try {
            ...
            System.out.println("\nORIGINAL PATTERN:");
            System.out.println(
                    "  Size: " + originalPattern.getWidth() + "x" + originalPattern.getHeight());
            ...
            if (finder.hasNext()) {
                ...
                BufferedImage matchedRegion =
                        screenImage.getSubimage(match.x, match.y, match.w, match.h);
    ...
    private void testScaledPatterns(
            BufferedImage screenImage, BufferedImage originalPattern, File outputDir) {
        try {
    ...
    private void testUpscaledMatch(
            BufferedImage originalPattern, BufferedImage matchedRegion, File outputDir) {
        try {
            ...
            BufferedImage upscaledMatch =
                    new BufferedImage(origWidth, origHeight, BufferedImage.TYPE_INT_RGB);
            ...
            if (differentPixels > 0) {
                System.out.println(
                        "    Average difference: " + (totalDiff / differentPixels) + "/765");
            }

            // Create a side-by-side comparison
            BufferedImage comparison =
                    new BufferedImage(origWidth * 3, origHeight, BufferedImage.TYPE_INT_RGB);

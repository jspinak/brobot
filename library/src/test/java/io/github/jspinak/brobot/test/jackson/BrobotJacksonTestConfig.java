...
/**
 * Provides properly configured ObjectMapper for Brobot tests.
 * Handles serialization issues with:
 * - OpenCV/JavaCV Mat objects
 * - SikuliX objects (Pattern, Region, Match)
 * - BufferedImage
 * - LocalDateTime
 * - Missing constructors/builders
 */
public class BrobotJacksonTestConfig {
    ...
    /**
     * Creates an ObjectMapper configured for Brobot model serialization/deserialization.
     * This mapper handles all the special cases and problematic types.
     */
    ...
    private static void registerBrobotModule(ObjectMapper mapper) {
        ...
        brobotModule.addSerializer(Mat.class, new JsonSerializer<Mat>() {
            @Override
            public void serialize(Mat value, JsonGenerator gen, SerializerProvider provider) throws IOException {
                gen.writeNull();
            }
        });
        brobotModule.addDeserializer(Mat.class, new JsonDeserializer<Mat>() {
            @Override
        ...
        brobotModule.addSerializer(BufferedImage.class, new JsonSerializer<BufferedImage>() {
            @Override
        ...
        brobotModule.addDeserializer(BufferedImage.class, new JsonDeserializer<BufferedImage>() {
            @Override
        ...
        brobotModule.addSerializer(Pattern.class, new JsonSerializer<Pattern>() {
            @Override
        ...
        brobotModule.addDeserializer(Pattern.class, new JsonDeserializer<Pattern>() {
            @Override
        ...
        brobotModule.addSerializer(Region.class, new JsonSerializer<Region>() {
            @Override
        ...
        brobotModule.addDeserializer(Region.class, new JsonDeserializer<Region>() {
            @Override
        ...
        brobotModule.addSerializer(Location.class, new JsonSerializer<Location>() {
            @Override
        ...
        brobotModule.addDeserializer(Location.class, new JsonDeserializer<Location>() {
            @Override
        ...
        brobotModule.addSerializer(Match.class, new JsonSerializer<Match>() {
            @Override
        ...
        brobotModule.addDeserializer(Match.class, new JsonDeserializer<Match>() {
            @Override
        ...
        // Handle Screen
        brobotModule.addSerializer(Screen.class, new JsonSerializer<Screen>() {
            @Override
            public void serialize(Screen value, JsonGenerator gen, SerializerProvider provider) throws IOException {
                if (value != null) {
                    gen.writeStartObject();
        ...
        brobotModule.addDeserializer(Screen.class, new JsonDeserializer<Screen>() {
            @Override
            public Screen deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
                p.skipChildren();
    ...
    /**
     * Creates a minimal ObjectMapper for simple serialization tests.
     * This mapper only handles the most basic cases.
     */

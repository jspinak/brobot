...
public class StateStoreTest extends BrobotTestBase {
    ...
    public void setupTest() {
        ...
        testState3 = new State.Builder("state3").build();
    }

    @Test
    @DisplayName("Should create empty StateStore")
    void testCreateEmptyStateStore() {
        // Then
        assertNotNull(stateStore);
        assertNotNull(stateStore.getAllStates());
    ...
    @Test
    @DisplayName("Should save multiple states")

...
/**
 * Comprehensive test suite for FilenameUtils - filename manipulation utility.
 * Tests extension handling, filename extraction, and edge cases.
 */
...
public class FilenameUtilsTest extends BrobotTestBase {
    ...
    class PerformanceCharacteristics {
        ...
        public void testManyOperations() {
            ...
            assertTrue(endTime - startTime < 1000, "Operations took " + (endTime - startTime) + "ms");
        }

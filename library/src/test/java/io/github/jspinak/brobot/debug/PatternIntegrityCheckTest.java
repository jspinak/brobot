    ...
    public void checkPatternIntegrity() {
        ...
        try {
            ...
            for (String patternPath : patterns) {
                ...
                System.out.println(
                        "  Color model: " + img.getColorModel().getClass().getSimpleName());
                ...
                System.out.println(
                        "  Size difference: " + (copyFile.length() - file.length()) + " bytes");

                // Reload and compare
                BufferedImage reloaded = ImageIO.read(copyFile);
                System.out.println("\nReloaded copy:");
                System.out.println(
                        "  Dimensions: " + reloaded.getWidth() + "x" + reloaded.getHeight());

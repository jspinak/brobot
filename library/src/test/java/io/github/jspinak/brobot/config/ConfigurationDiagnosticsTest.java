...
/** Test suite for ConfigurationDiagnostics. Tests configuration validation and diagnostics. */
...
public class ConfigurationDiagnosticsTest extends BrobotTestBase {
    ...
    public void setupTest() {
        ...
        BrobotConfiguration.EnvironmentConfig envConfig =
                mock(BrobotConfiguration.EnvironmentConfig.class);
        ...
        BrobotConfiguration.SikuliConfig sikuliConfig =
                mock(BrobotConfiguration.SikuliConfig.class);

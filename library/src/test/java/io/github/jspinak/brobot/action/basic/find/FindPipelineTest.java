...
/**
 * Tests for the FindPipeline class which orchestrates the find operation workflow.
 * The pipeline is responsible for coordinating various find strategies, match processing,
...
class FindPipelineTest extends BrobotTestBase {
    ...
    class StrategyHandling {
        ...
        void testBestStrategySelectsHighestScore() {
            ...
            objectCollection.getStateImages().add(
                new StateImage.Builder().setName("target").build()
            );
        ...
        void testEachStrategyOnePerImage() {
            ...
            objectCollection.getStateImages().add(new StateImage.Builder().setName("image2").build());
    ...
    class MatchProcessing {
        ...
        void testSimilarityThresholdFiltering() {
            ...
            for (Match match : result.getMatchList()) {
                assertTrue(match.getScore() >= 0.9 || match.getScore() == -1); // -1 for unscored matches
            }
        }
        ...
        void testMatchAdjustments() {
            ...
            PatternFindOptions options = new PatternFindOptions.Builder()
                .setMatchAdjustment(adjustmentOptions)
                .build();
            ActionResult result = new ActionResult(options);
    ...
    class ErrorHandling {
        ...
        void testExceptionHandling() {
            ...
            StateImage problematicImage = new StateImage.Builder()
    ...
    class PerformanceOptimization {
        ...
        void testDefinedRegionOptimization() {
            ...
            StateImage imageWithDefinedRegion = new StateImage.Builder()

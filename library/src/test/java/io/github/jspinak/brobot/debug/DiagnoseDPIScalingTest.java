...
public class DiagnoseDPIScalingTest extends DebugTestBase {
    ...
    public void diagnoseDPIScaling() throws Exception {
        ...
        System.out.println(
                "   Transform scale: " + transform.getScaleX() + "x" + transform.getScaleY());
        ...
        if (transform.getScaleX() > 1.0) {
            ...
            System.out.println(
                    "   Windows DPI scaling: " + (int) (transform.getScaleX() * 100) + "%");
        }
        ...
        String[] patterns = {"images/prompt/claude-prompt-1.png", "images/working/working-1.png"};
        ...
        if (testPattern.exists()) {
            ...
            for (float factor : testFactors) {
                ...
                System.out.println(
                        "   Expected search size: " + expectedWidth + "x" + expectedHeight);

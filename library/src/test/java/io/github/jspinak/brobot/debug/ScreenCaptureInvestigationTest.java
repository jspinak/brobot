...
/**
 * Investigates why screenshots are blurry compared to SikuliX IDE patterns. Tests different capture
 * methods and DPI/scaling behavior.
 */
@DisabledInCI
public class ScreenCaptureInvestigationTest extends DebugTestBase {
    ...
    public void investigateScreenCapture() throws Exception {
        ...
        System.out.println(
                "   Robot captured: " + robotCapture.getWidth() + "x" + robotCapture.getHeight());
        ...
        System.out.println(
                "   GD Robot captured: " + gdCapture.getWidth() + "x" + gdCapture.getHeight());
        ...
        System.out.println(
                "   GD Robot:     " + gdCapture.getWidth() + "x" + gdCapture.getHeight());
        System.out.println(
                "   Screen:       " + screenCapture.getWidth() + "x" + screenCapture.getHeight());

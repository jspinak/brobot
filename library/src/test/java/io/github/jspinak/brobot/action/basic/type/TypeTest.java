...
/**
 * Comprehensive tests for the Type action. Tests keyboard input functionality including: - Simple
 * text typing - Special characters and keys - StateString handling - Location-based typing -
...
public class TypeTest extends BrobotTestBase {
    ...
    class BasicTypeOperations {
        ...
        void testCustomTypeOptions() {
            // Act
            TypeOptions options =
                    new TypeOptions.Builder().setTypeDelay(0.1).setModifiers("ctrl+").build();
        ...
        void testStateStringCreation() {
            ...
            StateString stateString =
                    new StateString.Builder().setString(text).setName("greeting").build();
        ...
        void testObjectCollectionWithStrings() {
            // Arrange
            StateString string1 = new StateString.Builder().setString("First text").build();

            StateString string2 = new StateString.Builder().setString("Second text").build();

            // Act
            ObjectCollection collection =
                    new ObjectCollection.Builder().withStrings(string1, string2).build();
    ...
    class TextInputVariations {
        ...
        void testSimpleText() {
            // Arrange
            StateString text = new StateString.Builder().setString("Simple text input").build();
        ...
        void testSpecialCharacters() {
            ...
            StateString text = new StateString.Builder().setString(specialText).build();
        ...
        void testEmptyString() {
            // Arrange
            StateString empty = new StateString.Builder().setString("").build();

            ObjectCollection collection = new ObjectCollection.Builder().withStrings(empty).build();
    ...
    class TypingWithLocations {
        ...
        void testTypeAtLocation() {
            ...
            StateString text = new StateString.Builder().setString("Text at location").build();
        ...
        void testTypeInRegion() {
            ...
            StateRegion stateRegion =
                    new StateRegion.Builder().setSearchRegion(region).setName("text-area").build();

            StateString text = new StateString.Builder().setString("Text in region").build();
    ...
    class PasteMode {
        ...
        void testPasteModeEnabled() {
            // Act
            TypeOptions options = new TypeOptions.Builder().setModifiers("ctrl+v").build();
        ...
        void testPasteLargeText() {
            ...
            StateString text = new StateString.Builder().setString(largeText.toString()).build();
    ...
    class TypingDelays {
        ...
        void testTypingDelays(double delay) {
            // Act
            TypeOptions options = new TypeOptions.Builder().setTypeDelay(delay).build();
        ...
        void testModifiers() {
            // Act
            TypeOptions options = new TypeOptions.Builder().setModifiers("shift+").build();
    ...
    class MultipleStateStrings {
        ...
        void testStringOrder() {
            // Arrange
            StateString first = new StateString.Builder().setString("First").build();
            StateString second = new StateString.Builder().setString("Second").build();
            StateString third = new StateString.Builder().setString("Third").build();

            // Act
            ObjectCollection collection =
                    new ObjectCollection.Builder().withStrings(first, second, third).build();
    ...
    class ErrorHandling {
        ...
        void testNullString() {
            ...
            StateString nullString = new StateString.Builder().setString(null).build();
        ...
        void testNoStrings() {
            ...
            // Act
            ObjectCollection collection =
                    new ObjectCollection.Builder().withLocations(stateLocation).build();
    ...
    class PerformanceTests {
        ...
        @ParameterizedTest
        @CsvSource({"10, 10", "100, 20", "1000, 50", "10000, 100"})
        ...
        void testTextLengthPerformance(int length, int maxMs) {
            ...
            StateString stateString = new StateString.Builder().setString(text.toString()).build();

            ObjectCollection collection =
                    new ObjectCollection.Builder().withStrings(stateString).build();
            ...
            assertTrue(
                    duration < maxMs,
                    String.format(
                            "Processing %d chars should take < %dms, was: %dms",

...
/**
 * Comprehensive test suite for FilenameExtractor - utility for extracting filenames.
 * Tests various path formats, extensions, and edge cases.
 */
...
public class FilenameExtractorTest extends BrobotTestBase {
    ...
    class BasicFilenameExtraction {
        ...
        public void testSimplePath() {
            String result = FilenameExtractor.getFilenameWithoutExtensionAndDirectory("/path/to/file.txt");
        ...
        public void testFilenameOnly() {
            String result = FilenameExtractor.getFilenameWithoutExtensionAndDirectory("document.pdf");
        ...
        public void testWindowsPath() {
            String result = FilenameExtractor.getFilenameWithoutExtensionAndDirectory("C:\\Users\\test\\file.doc");
            assertEquals("file", result);
        }
        ...
        public void testUnixPath() {
            String result = FilenameExtractor.getFilenameWithoutExtensionAndDirectory("/home/user/documents/report.xlsx");
    ...
    class MultipleExtensions {
        ...
        public void testManyDots() {
            String result = FilenameExtractor.getFilenameWithoutExtensionAndDirectory("my.file.with.many.dots.txt");
    ...
    class HiddenFiles {
        ...
        public void testHiddenFileWithExtension() {
            String result = FilenameExtractor.getFilenameWithoutExtensionAndDirectory(".gitignore.bak");
        ...
        public void testHiddenFileInPath() {
            String result = FilenameExtractor.getFilenameWithoutExtensionAndDirectory("/home/user/.config/settings.conf");
    ...
    class SpecialCases {
        ...
        public void testTrailingSlash() {
            String result = FilenameExtractor.getFilenameWithoutExtensionAndDirectory("/path/to/directory/");
            assertEquals("", result);
        }
        ...
        public void testTrailingBackslash() {
            String result = FilenameExtractor.getFilenameWithoutExtensionAndDirectory("C:\\path\\to\\directory\\");
            assertEquals("", result);
        }
    }
    ...
    class PathVariations {
        ...
        public void testRelativePath() {
            String result = FilenameExtractor.getFilenameWithoutExtensionAndDirectory("../relative/path/file.txt");
            assertEquals("file", result);
        }
        ...
        public void testCurrentDirectoryPath() {
            String result = FilenameExtractor.getFilenameWithoutExtensionAndDirectory("./current/file.txt");
            assertEquals("file", result);
        }
        ...
        public void testMixedSeparators() {
            String result = FilenameExtractor.getFilenameWithoutExtensionAndDirectory("C:\\path/to\\file.txt");
            assertEquals("file", result);
        }
        ...
        public void testUNCPath() {
            String result = FilenameExtractor.getFilenameWithoutExtensionAndDirectory("\\\\server\\share\\file.doc");
            assertEquals("file", result);
        }
        ...
        public void testPathWithSpaces() {
            String result = FilenameExtractor.getFilenameWithoutExtensionAndDirectory("/path with spaces/file name.txt");
    ...
    class SpecialCharacters {
        ...
        public void testDashes() {
            String result = FilenameExtractor.getFilenameWithoutExtensionAndDirectory("my-file-name.txt");
        ...
        public void testUnderscores() {
            String result = FilenameExtractor.getFilenameWithoutExtensionAndDirectory("my_file_name.txt");
        ...
        public void testNumbers() {
            String result = FilenameExtractor.getFilenameWithoutExtensionAndDirectory("file123.txt");
        ...
        public void testParentheses() {
            String result = FilenameExtractor.getFilenameWithoutExtensionAndDirectory("file(1).txt");
        ...
        public void testBrackets() {
            String result = FilenameExtractor.getFilenameWithoutExtensionAndDirectory("file[backup].txt");

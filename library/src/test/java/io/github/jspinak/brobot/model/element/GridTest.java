...
/**
 * Comprehensive tests for the Grid class which divides a screen region into a matrix of cells for
...
public class GridTest extends BrobotTestBase {
    ...
    void testCreateGridByRowsAndColumns() {
        // When
        Grid grid = new Grid.Builder().setRegion(testRegion).setRows(2).setColumns(2).build();
    ...
    void testCreateGridByCellDimensions() {
        // When
        Grid grid =
                new Grid.Builder().setRegion(testRegion).setCellWidth(25).setCellHeight(20).build();
    ...
    void testPerfectGridDivision() {
        ...
        // When
        Grid grid = new Grid.Builder().setRegion(perfectRegion).setRows(5).setColumns(5).build();
    ...
    void testLargeRemainderHandling() {
        ...
        Grid grid = new Grid.Builder().setRegion(region).setCellWidth(30).setCellHeight(30).build();
    ...
    void testAdjustRegionToGrids() {
        ...
        Grid gridDefault =
                new Grid.Builder().setRegion(region).setCellWidth(20).setCellHeight(20).build();
    ...
    void testSingleCellGrid() {
        // When
        Grid grid = new Grid.Builder().setRegion(testRegion).setRows(1).setColumns(1).build();
    ...
    void testNullRegion() {
        // When
        Grid grid = new Grid.Builder().setRows(2).setColumns(2).build();
    ...
    void testCommonGridPatterns(int cols, int rows, int expectedCells) {
        ...
        // When
        Grid grid = new Grid.Builder().setRegion(region).setColumns(cols).setRows(rows).build();
    ...
    Stream<DynamicTest> testCellPositioning() {
        return Stream.of(
                ...
                dynamicTest(
                        "Cell indexing follows row-major order",
                        () -> {
                            Grid grid =
                                    new Grid.Builder()
    ...
    void testVerySmallCells() {
        ...
        // When - 1x1 cells
        Grid grid = new Grid.Builder().setRegion(region).setCellWidth(1).setCellHeight(1).build();
    ...
    void testRegionOffsetPreservation() {
        ...
        // When
        Grid grid = new Grid.Builder().setRegion(offsetRegion).setRows(2).setColumns(3).build();
    ...
    void testCompleteRegionCoverage() {
        ...
        // When
        Grid grid = new Grid.Builder().setRegion(region).setRows(4).setColumns(5).build();

        // Then - Last cell should reach the region boundaries
        List<Region> cells = grid.getGridRegions();

        // Find rightmost cell
        int maxRight = cells.stream().mapToInt(cell -> cell.x() + cell.w()).max().orElse(0);
        assertEquals(110, maxRight); // 10 + 100

        // Find bottom cell
        int maxBottom = cells.stream().mapToInt(cell -> cell.y() + cell.h()).max().orElse(0);

...
class ActionExecutionTest {
    ...
    void setUp() {
        ...
        // ActionExecution has overloaded methods for both ActionOptions and ActionConfig
    ...
    void perform_shouldExecuteActionOnceWhenMoreSequencesNotAllowedAfterFirstRun() {
        // Testing deprecated ActionOptions API for backward compatibility
        ...
        ActionResult result = actionExecution.perform(actionInterface, "test action", actionOptions, objectCollection);

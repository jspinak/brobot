...
/**
 * Comprehensive test suite for ActionLoggingEnhancer.
 * Tests fluent API for adding logging capabilities to ActionConfig objects.
 */
...
public class ActionLoggingEnhancerTest extends BrobotTestBase {
    ...
    class MessageTemplateTests {
        ...
        public void testSetMessageTemplate() {
            // Act
            ActionConfig result = enhancer.withMessageTemplate(actionConfig, 
                "Action {name} completed in {duration}ms");
            
            // Assert
            assertSame(actionConfig, result);
            ActionLoggingEnhancer.LoggingConfiguration config = 
                enhancer.getLoggingConfiguration(actionConfig);
            assertEquals("Action {name} completed in {duration}ms", 
    ...
    class FluentAPIChainingTests {
        ...
        public void testMethodChaining() {
            ...
            ActionConfig result = enhancer
                .withBeforeActionLog(actionConfig, beforeLog);

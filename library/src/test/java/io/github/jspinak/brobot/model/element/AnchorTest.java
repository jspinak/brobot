...
/**
 * Comprehensive tests for the Anchor class which defines relative positioning constraints between
 * visual elements in Brobot.
 */
...
public class AnchorTest extends BrobotTestBase {
    ...
    void testJacksonSerialization() throws JsonProcessingException {
        ...
        assertEquals(
                original.getAnchorInNewDefinedRegion(), deserialized.getAnchorInNewDefinedRegion());
    ...
    Stream<DynamicTest> testGettersAndSetters() {
        return Stream.of(
                dynamicTest(
                        "Set and get anchorInNewDefinedRegion",
                        () -> {
                            Anchor anchor = new Anchor();
                            anchor.setAnchorInNewDefinedRegion(Positions.Name.TOPLEFT);
                            assertEquals(
                                    Positions.Name.TOPLEFT, anchor.getAnchorInNewDefinedRegion());
                        }),
                dynamicTest(
                        "Set and get positionInMatch",
                        () -> {
                            Anchor anchor = new Anchor();
                            Position position = new Position(10, 20);
                ...
                dynamicTest(
                        "Modify anchorInNewDefinedRegion after creation",
                        () -> {
                ...
                dynamicTest(
                        "Modify positionInMatch after creation",
                        () -> {

    ...
    public void extractMatchedRegions() {
        ...
        try {
            ...
            for (String patternPath : patterns) {
                ...
                File origPatternFile =
                        new File(outputDir, patternName + "_ORIGINAL_" + timestamp + ".png");
                ...
                for (double threshold : thresholds) {
                    ...
                    if (finder.hasNext()) {
                        ...
                        System.out.println(
                                "  Matched region file size: " + matchFile.length() + " bytes");
                        ...
                        BufferedImage diffImage =
                                createDifferenceImage(patternImage, matchedRegion);
                        File diffFile =
                                new File(outputDir, patternName + "_DIFF_" + timestamp + ".png");
                        ...
                        File regionFile =
                                new File(
                                        outputDir,
                                        patternName + "_SCREEN_REGION_" + timestamp + ".png");
                        ImageIO.write(regionImage, "png", regionFile);
                        System.out.println(
                                "  Screen.capture region saved to: " + regionFile.getName());

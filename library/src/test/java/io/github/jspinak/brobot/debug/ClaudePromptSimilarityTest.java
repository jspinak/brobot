...
public class ClaudePromptSimilarityTest extends BrobotTestBase {
    ...
    public void analyzeClaudePromptSimilarity() {
        ...
        try {
            ...
            System.out.println(
                    "  Size: " + patternImage.getWidth() + "x" + patternImage.getHeight());
            ...
            if (bestMatch != null) {
                ...
                BufferedImage matchedRegion =
                        screenImage.getSubimage(bestMatch.x, bestMatch.y, bestMatch.w, bestMatch.h);
    ...
    private void testWithFinder(BufferedImage screenImage, BufferedImage patternImage) {
        ...
        for (double threshold : thresholds) {
            ...
            if (finder.hasNext()) {
                ...
                System.out.printf(
                        "  Threshold %.2f: FOUND - Score: %.3f at (%d, %d)\n",
    ...
    private void testWithScreenExists(Screen screen, BufferedImage patternImage) {
        ...
        for (double threshold : thresholds) {
            ...
            if (match != null) {
                System.out.printf(
                        "  Threshold %.2f: FOUND - Score: %.3f at %s\n",
    ...
    private void testWithDifferentResize(Screen screen, BufferedImage patternImage) {
        ...
        for (float resize : resizeValues) {
            ...
            if (match != null) {
                System.out.printf(
                        "  AlwaysResize=%.1f: FOUND - Score: %.3f\n", resize, match.getScore());
            } else {
    ...
    private void createVisualComparison(
            BufferedImage pattern, BufferedImage matched, File outputDir, String timestamp) {
        try {
            int width = pattern.getWidth();
            int height = pattern.getHeight();
            ...
            BufferedImage comparison =
                    new BufferedImage(width * 3, height, BufferedImage.TYPE_INT_RGB);
    ...
    private void testScaledPatterns(
            BufferedImage screenImage, BufferedImage patternImage, File outputDir) {
    ...
    private String getImageTypeName(int type) {
        switch (type) {
            case BufferedImage.TYPE_INT_RGB:
                return "TYPE_INT_RGB (24-bit)";
            case BufferedImage.TYPE_INT_ARGB:
                return "TYPE_INT_ARGB (32-bit)";
            case BufferedImage.TYPE_INT_ARGB_PRE:
                return "TYPE_INT_ARGB_PRE";
            case BufferedImage.TYPE_INT_BGR:
                return "TYPE_INT_BGR";
            case BufferedImage.TYPE_3BYTE_BGR:
                return "TYPE_3BYTE_BGR (24-bit)";
            case BufferedImage.TYPE_4BYTE_ABGR:
                return "TYPE_4BYTE_ABGR (32-bit)";

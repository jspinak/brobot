...
public class TransitionExecutorTest extends BrobotTestBase {
    ...
    class HiddenStateManagement {
        ...
        public void testHiddenStatesUpdate() {
            ...
            // Override stateMemory to ensure state is not initially active when doTransitionTo is called
            when(stateMemory.getActiveStates())
            ...
            when(stateTransitionService.getTransitions(toState)).thenReturn(Optional.of(toStateTransitions));
            ...
            when(transitionConditionPackager.toBooleanSupplier(toTransition)).thenReturn(toTransitionFunction);
    ...
    class ComplexScenarios {
        ...
        public void testSourceStateExit() {
            ...
            StateTransitions stateTransitions = mock(StateTransitions.class);
            when(mockFetcher.getFromTransitions()).thenReturn(stateTransitions);
            when(stateTransitions.stateStaysVisible(toState)).thenReturn(false); // Source should exit

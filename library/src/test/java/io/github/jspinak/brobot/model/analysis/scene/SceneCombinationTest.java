...
/**
 * Comprehensive test suite for SceneCombination. Tests scene combination management, image
 * associations, and dynamic pixel tracking.
 */
...
public class SceneCombinationTest extends BrobotTestBase {
    ...
    class ConstructorTests {
        ...
        @ParameterizedTest
        @CsvSource({"0, 0", "1, 2", "5, 10", "100, 200"})

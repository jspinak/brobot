...
public class DirectPatternMatchTest extends BrobotTestBase {
    ...
    public void testPatternMatching() throws IOException {
        ...
        String patternPath =
                "/mnt/c/Users/jspin/Documents/brobot_parent/claude-automator/debug_images/pattern_claude-prompt-3.png";
        String scenePath =
                "/mnt/c/Users/jspin/Documents/brobot_parent/claude-automator/debug_images/scene_current.png";
        ...
        System.out.println(
                "Pattern: "
                        ...
                        + " type="
                        + getImageTypeName(patternImg.getType()));
        System.out.println(
                "Scene: "
                        + sceneImg.getWidth()
                        + "x"
                        + sceneImg.getHeight()
                        + " type="
                        + getImageTypeName(sceneImg.getType()));
        ...
        if (sceneIsBlack) {
            ...
            System.out.println(
                    "This suggests the screenshot was taken in WSL2, which cannot capture Windows"
                            + " screens.");
            System.out.println(
                    "However, we can still test pattern matching if you provide a valid"
                            + " screenshot.\n");
        }
        ...
        for (double threshold : thresholds) {
            ...
            while (finder.hasNext()) {
                ...
                if (count <= 3) {
                    System.out.printf(
                            "  Match %d: score=%.4f at (%d,%d) size=%dx%d\n",
    ...
    private static String getImageTypeName(int type) {
        switch (type) {
            ...
            case BufferedImage.TYPE_BYTE_GRAY:
                return "TYPE_BYTE_GRAY (10)";
            case BufferedImage.TYPE_BYTE_BINARY:
                return "TYPE_BYTE_BINARY (12)";
            case BufferedImage.TYPE_BYTE_INDEXED:
                return "TYPE_BYTE_INDEXED (13)";
            case BufferedImage.TYPE_USHORT_GRAY:
                return "TYPE_USHORT_GRAY (11)";
            case BufferedImage.TYPE_USHORT_565_RGB:
                return "TYPE_USHORT_565_RGB (8)";
            case BufferedImage.TYPE_USHORT_555_RGB:
                return "TYPE_USHORT_555_RGB (9)";
            case BufferedImage.TYPE_CUSTOM:
                return "TYPE_CUSTOM (0)";
            default:

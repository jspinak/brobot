...
/**
 * Comprehensive tests for the Find action. Tests pattern matching functionality including: - Basic
 * find operations - Multiple pattern matching - Similarity thresholds - Search region constraints -
...
public class FindComprehensiveTest extends BrobotTestBase {
    ...
    class BasicFindOperations {
        ...
        void testObjectCollectionWithImages() {
            // Arrange
            StateImage image1 = new StateImage.Builder().setName("button.png").build();

            StateImage image2 = new StateImage.Builder().setName("icon.png").build();
    ...
    class SimilarityThresholdTests {
        ...
        void testExactMatch() {
            // Act
            PatternFindOptions options =
                    new PatternFindOptions.Builder().setSimilarity(1.0).build();
        ...
        void testLooseMatching() {
            // Act
            PatternFindOptions options =
                    new PatternFindOptions.Builder().setSimilarity(0.5).build();
    ...
    class SearchRegionTests {
        ...
        void testSearchRegionsInOptions() {
            ...
            // Act
            PatternFindOptions options =
                    new PatternFindOptions.Builder().setSearchRegions(searchRegions).build();
    ...
    class StateImageHandling {
        ...
        void testStateImageWithPattern() {
            // Act
            StateImage image = new StateImage.Builder().setName("pattern.png").build();
        ...
        void testMultipleStateImages() {
            ...
            for (int i = 0; i < 5; i++) {
                StateImage img = new StateImage.Builder().setName("image" + i + ".png").build();
                images.add(img);
            }
    ...
    class FindOptionsAdvanced {
        ...
        void testWaitTime() {
            // Act
            PatternFindOptions options =
                    new PatternFindOptions.Builder().setSearchDuration(5.0).build();
    ...
    class PerformanceTests {
        ...
        @ParameterizedTest
        @CsvSource({"1, 10", "10, 20", "50, 50", "100, 100"})
        ...
        void testPatternCountPerformance(int patternCount, int maxMs) {
            ...
            for (int i = 0; i < patternCount; i++) {
                StateImage img = new StateImage.Builder().setName("pattern" + i + ".png").build();
                images.add(img);
            }
            ...
            assertTrue(
                    duration < maxMs,
                    String.format(
                            "Processing %d patterns should take < %dms, was: %dms",
        ...
        void testOptionsCreationSpeed() {
            ...
            for (int i = 0; i < 1000; i++) {
                PatternFindOptions options =
                        new PatternFindOptions.Builder().setSimilarity(0.7 + i * 0.0001).build();
                assertNotNull(options);
            }
    ...
    class ErrorHandling {
        ...
        void testNullSearchRegions() {
            // Act
            PatternFindOptions options =
                    new PatternFindOptions.Builder().setSearchRegions(null).build();
        ...
        void testInvalidSimilarity() {
            ...
            PatternFindOptions options1 =
                    new PatternFindOptions.Builder().setSimilarity(0.0).build();

...
/**
 * Comprehensive test suite for BrobotProperties - centralized configuration properties.
 * Tests property binding, defaults, and configuration validation.
 */
...
public class BrobotPropertiesTest extends BrobotTestBase {
    ...
    class SpringPropertyBinding {
        ...
        public void testBindPropertiesFromMap() {
            ...
            BrobotProperties boundProperties = binder.bind("brobot", BrobotProperties.class).orElse(new BrobotProperties());
    ...
    class PropertyInheritanceAndOverrides {
        ...
        public void testCopyProperties() {
            ...
            assertEquals(properties.getCore().getImagePath(), newProperties.getCore().getImagePath());
            assertEquals(properties.getCore().isMock(), newProperties.getCore().isMock());
            assertEquals(properties.getMouse().getMoveDelay(), newProperties.getMouse().getMoveDelay());
        }

...
public class ClickUntilTest extends BrobotTestBase {
    ...
    class BasicConfiguration {
        ...
        public void testConfigBuilder() {
            ...
            config =
                    new ModernRepeatUntilConfig.Builder()
    ...
    class ClickUntilPatterns {
        ...
        public void testClickUntilVanish() {
            StateImage closeButton = new StateImage.Builder().build();
            actionCollection.getStateImages().add(closeButton);

            StateImage dialogBox = new StateImage.Builder().build();
            conditionCollection.getStateImages().add(dialogBox);

            ClickOptions clickOptions =
                    new ClickOptions.Builder()
                            .setNumberOfClicks(1)
                            // .setPauseAfterClick(0.5)
                            .build();
        ...
        public void testClickUntilAppears() {
            StateImage nextButton = new StateImage.Builder().build();
            actionCollection.getStateImages().add(nextButton);

            StateImage finishButton = new StateImage.Builder().build();
            conditionCollection.getStateImages().add(finishButton);

            ClickOptions clickOptions = new ClickOptions.Builder().setNumberOfClicks(1).build();

            PatternFindOptions findOptions =
                    new PatternFindOptions.Builder().setSearchDuration(2.0).build();
        ...
        public void testClickMultipleTargets() {
            StateImage button1 = new StateImage.Builder().build();
            StateImage button2 = new StateImage.Builder().build();
            StateLocation location =
                    new StateLocation.Builder().setLocation(new Location(100, 100)).build();

            actionCollection.getStateImages().add(button1);
            actionCollection.getStateImages().add(button2);
            actionCollection.getStateLocations().add(location);

            StateImage successMessage = new StateImage.Builder().build();
            conditionCollection.getStateImages().add(successMessage);
            ...
            assertEquals(
                    3,
                    actionCollection.getStateImages().size()
                            + actionCollection.getStateLocations().size());
        }
    }
    ...
    class ResultManagement {
        ...
        public void testActionMatchesStorage() {
            ...
            Match match = new Match.Builder().setRegion(new Region(100, 100, 50, 50)).build();

            ActionResult actionResult = new ActionResult(new PatternFindOptions.Builder().build());
        ...
        public void testConditionMatchesStorage() {
            ...
            Match match = new Match.Builder().setRegion(new Region(200, 200, 60, 60)).build();

            ActionResult conditionResult =
                    new ActionResult(new PatternFindOptions.Builder().build());
            conditionResult.setSuccess(true);
            conditionResult.add(match);
    ...
    class ResetFunctionality {
        ...
        public void testResetTimesActedOn() {
            StateImage image1 = new StateImage.Builder().build();
            StateImage image2 = new StateImage.Builder().build();
            actionCollection.getStateImages().add(image1);
            actionCollection.getStateImages().add(image2);
        ...
        public void testSelectiveReset() {
            StateImage actionImage = new StateImage.Builder().build();
            StateImage conditionImage = new StateImage.Builder().build();
            actionCollection.getStateImages().add(actionImage);
            conditionCollection.getStateImages().add(conditionImage);
    ...
    class CommonUseCases {
        ...
        public void testDismissPopupsPattern() {
            StateImage closeButton = new StateImage.Builder().build();
            StateImage popupWindow = new StateImage.Builder().build();

            actionCollection.getStateImages().add(closeButton);
            conditionCollection.getStateImages().add(popupWindow);

            ClickOptions dismissClick =
                    new ClickOptions.Builder()
                            .setNumberOfClicks(1)
                            // .setPauseAfterClick(0.2)
                            .build();

            PatternFindOptions checkPopup =
                    new PatternFindOptions.Builder().setSearchDuration(0.5).build();
        ...
        public void testWizardNavigationPattern() {
            ...
            ClickOptions clickNext =
                    new ClickOptions.Builder()
                            .setNumberOfClicks(1)
                            // .setPauseAfterClick(1.0)
                            .build();

            PatternFindOptions findFinish =
                    new PatternFindOptions.Builder()
                            .setSimilarity(0.9)
        ...
        public void testClearListItemsPattern() {
            StateImage deleteIcon = new StateImage.Builder().build();
            StateRegion listArea =
                    new StateRegion.Builder()
                            .setSearchRegion(new Region(100, 100, 400, 300))
                            .build();

            actionCollection.getStateImages().add(deleteIcon);
            conditionCollection.getStateRegions().add(listArea);

            ClickOptions deleteClick =
                    new ClickOptions.Builder()
                            // .setClickType(ClickOptions.ClickType.RIGHT)
                            .setNumberOfClicks(1)
                            .build();

            PatternFindOptions checkEmpty =
                    new PatternFindOptions.Builder()
            ...
            // assertEquals(ClickOptions.ClickType.RIGHT,
            // ((ClickOptions)config.getDoAction()).getClickType());

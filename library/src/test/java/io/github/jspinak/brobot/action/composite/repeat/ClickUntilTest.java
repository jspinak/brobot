...
public class ClickUntilTest extends BrobotTestBase {
    ...
    class ResultManagement {
        ...
        public void testConditionMatchesStorage() {
            ...
            ActionResult conditionResult = new ActionResult(new PatternFindOptions.Builder().build());
    ...
    class ParameterizedTests {
        ...
        static Stream<Arguments> provideActionConfigPairs() {
            return Stream.of(
                ...
                Arguments.of(
                    new ClickOptions.Builder().build(),
                    new PatternFindOptions.Builder().setStrategy(PatternFindOptions.Strategy.ALL).build()
                )
            );
        }
    }

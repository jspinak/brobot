...
/**
 * Comprehensive test suite for StateAwareScheduler. Tests state-aware scheduling capabilities with
 * various configurations. Uses ConcurrentTestBase for thread-safe parallel execution.
 */
...
class StateAwareSchedulerTest extends ConcurrentTestBase {
    ...
    class StateCheckConfigurationTests {
        ...
        void testDefaultConfiguration() {
            var config = new StateAwareScheduler.StateCheckConfiguration.Builder().build();
            ...
            assertEquals(
                    StateAwareScheduler.StateCheckConfiguration.CheckMode.CHECK_INACTIVE_ONLY,
                    config.getCheckMode());
        ...
        void testCustomConfiguration() {
            ...
            var config =
                    new StateAwareScheduler.StateCheckConfiguration.Builder()
                            ...
                            .withCheckMode(
                                    StateAwareScheduler.StateCheckConfiguration.CheckMode.CHECK_ALL)
    ...
    class SchedulingTests {
        ...
        void testScheduleWithFixedDelay() throws InterruptedException {
            ...
            // Act
            ScheduledFuture<?> future =
                    scheduler.scheduleWithFixedDelayAndStateCheck(
                            executorService, task, config, 0, 50, TimeUnit.MILLISECONDS);

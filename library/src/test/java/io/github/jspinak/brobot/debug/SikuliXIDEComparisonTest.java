...
/**
 * Compare EXACTLY what SikuliX IDE does vs what Brobot does Both running on Windows, searching VS
 * Code in WSL2
 */
@DisabledInCI
public class SikuliXIDEComparisonTest extends BrobotTestBase {
    ...
    private void testPreprocessing(BufferedImage pattern) {
        ...
        try {
            ...
            System.out.println(
                    "  Original: " + (m1 != null ? "Score " + m1.getScore() : "Not found"));

            // Test 2: Convert to RGB (remove alpha if present)
            BufferedImage rgbPattern =
                    new BufferedImage(
            ...
            System.out.println(
                    "  RGB converted: " + (m2 != null ? "Score " + m2.getScore() : "Not found"));

            // Test 3: Convert to BGR
            BufferedImage bgrPattern =
                    new BufferedImage(
            ...
            System.out.println(
                    "  BGR converted: " + (m3 != null ? "Score " + m3.getScore() : "Not found"));

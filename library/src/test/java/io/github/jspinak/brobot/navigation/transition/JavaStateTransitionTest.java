...
/**
 * Comprehensive test suite for JavaStateTransition.
 * Tests all aspects of Java-based state transitions including builder,
 * execution, state management, and edge cases.
 */
...
class JavaStateTransitionTest extends BrobotTestBase {
    ...
    class ToStringMethod {
        ...
        void testToStringSpecialCharacters() {
            transition.setActivateNames(new HashSet<>(Arrays.asList(
                "State-1", "State_2", "State.3", "State 4")));
    ...
    class BuilderPatternExtended {
        ...
        void testCompleteBuilder() {
            JavaStateTransition built = new JavaStateTransition.Builder()
            ...
            assertEquals(StateTransition.StaysVisible.TRUE, 
                built.getStaysVisibleAfterTransition());
        ...
        void testBooleanVisibilitySetter() {
            JavaStateTransition built1 = new JavaStateTransition.Builder()
                .setStaysVisibleAfterTransition(true)
                .build();
            assertEquals(StateTransition.StaysVisible.TRUE, 
                built1.getStaysVisibleAfterTransition());
            
            JavaStateTransition built2 = new JavaStateTransition.Builder()
                .setStaysVisibleAfterTransition(false)
                .build();
            assertEquals(StateTransition.StaysVisible.FALSE, 
                built2.getStaysVisibleAfterTransition());
        }
        ...
        void testAccumulateStates() {
            ...
            assertTrue(built.getActivateNames().containsAll(
                Arrays.asList("S1", "S2", "S3", "S4")));
            assertTrue(built.getExitNames().containsAll(
        ...
        void testBuilderDuplicates() {
            ...
            assertEquals(3, built.getActivateNames().size());
            assertTrue(built.getActivateNames().containsAll(
                Arrays.asList("State1", "State2", "State3")));
        }
        ...
        void testBuilderReuse() {
            ...
            JavaStateTransition t1 = builder
                .addToActivate("S1")
                .build();
            
            JavaStateTransition t2 = builder
                .addToActivate("S2")
                .build();

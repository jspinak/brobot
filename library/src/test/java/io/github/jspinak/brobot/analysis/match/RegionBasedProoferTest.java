...
/**
 * Comprehensive test suite for RegionBasedProofer.
 * Tests validation of matches within designated search regions.
 */
...
public class RegionBasedProoferTest extends BrobotTestBase {
    ...
    class BasicRegionValidation {
        ...
        void shouldAcceptMatchWithinRegion() {
            ...
            boolean isValid = regionBasedProofer.isInSearchRegions(match, 

...
/**
 * Simple framework test that doesn't extend BrobotTestBase to avoid initialization issues. This
 * test validates basic framework functionality without complex setup.
 */

...
/**
 * Comprehensive test suite for @Monitored annotation.
 * Tests performance monitoring attributes, thresholds, sampling, and metadata.
 */
...
public class MonitoredAnnotationTest extends BrobotTestBase {
    ...
    class AnnotationPresenceTests {
        ...
        void shouldSupportBothTargets() {
            ...
            boolean hasMonitored = Arrays.stream(classAnnotations)
                .anyMatch(a -> a instanceof Monitored);
    ...
    class CustomConfigurationTests {
        ...
        void shouldReadComplexConfiguration() throws NoSuchMethodException {
            Method method = MonitoredTestClass.class.getMethod("complexMonitoredMethod", String.class);
            Monitored annotation = method.getAnnotation(Monitored.class);

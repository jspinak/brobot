...
/**
 * Comprehensive test suite for KeyDown - presses and holds keyboard keys.
 * Tests key press operations, modifier handling, and timing control.
 */
@DisplayName("KeyDown Tests")
public class KeyDownTest extends BrobotTestBase {
    
    @Mock
    private KeyDownWrapper mockKeyDownWrapper;
    ...
    class BasicKeyPressOperations {
        ...
        public void testPressMultipleKeys() {
            ...
            KeyDownOptions options = new KeyDownOptions.Builder()
    ...
    class ModifierKeyHandling {
        ...
        public void testEmptyModifiers() {
            ...
            KeyDownOptions options = new KeyDownOptions.Builder()
                .setModifiers(Collections.emptyList())
                .build();
            when(mockActionResult.getActionConfig()).thenReturn(options);
    ...
    class ErrorHandling {
        ...
        public void testNullObjectCollections() {
            assertDoesNotThrow(() ->
                keyDown.perform(mockActionResult, (ObjectCollection[]) null));
        ...
        public void testEmptyObjectCollectionsArray() {
            assertDoesNotThrow(() ->
                keyDown.perform(mockActionResult));

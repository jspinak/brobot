...
/**
 * Comprehensive test suite for Movement - represents directed movement from start to end. Tests
 * immutability, null safety, delta calculations, and equality/hashcode contracts.
 */
...
public class MovementTest extends BrobotTestBase {
    ...
    class DeltaCalculations {
        ...
        public void testVariousDeltas(
                int x1, int y1, int x2, int y2, int expectedDx, int expectedDy) {
    ...
    class EqualsHashCode {
        ...
        public void testEqualsEquivalent() {
            Movement equivalent = new Movement(new Location(100, 200), new Location(300, 500));
        ...
        public void testNotEqualsDifferentStart() {
            Movement different = new Movement(new Location(50, 200), new Location(300, 500));
        ...
        public void testNotEqualsDifferentEnd() {
            Movement different = new Movement(new Location(100, 200), new Location(300, 600));
        ...
        public void testHashCodeDifferent() {
            Movement different = new Movement(new Location(0, 0), new Location(100, 100));

...
public class DPIAwarenessDisablerTest extends BrobotTestBase {
    ...
    public void testDPIAwarenessIsDisabled() {
        ...
        assertTrue(
                DPIAwarenessDisabler.isDPIAwarenessDisabled(),
        ...
        assertEquals(
                "1.0",
                System.getProperty("sun.java2d.win.uiScale"),
    ...
    public void testCaptureResolution() throws AWTException {
        ...
        System.out.println(
                "Robot Capture: " + robotCapture.getWidth() + "x" + robotCapture.getHeight());
        ...
        System.out.println(
                "SikuliX Capture: " + sikuliCapture.getWidth() + "x" + sikuliCapture.getHeight());
        ...
        System.out.println(
                "Captures are at: " + sikuliCapture.getWidth() + "x" + sikuliCapture.getHeight());
    }

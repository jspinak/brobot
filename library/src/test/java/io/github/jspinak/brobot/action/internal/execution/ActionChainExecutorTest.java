...
/**
 * Comprehensive test suite for ActionChainExecutor - chain execution orchestration. Tests nested
 * and confirm strategies, error handling, and result accumulation.
 */
...
class ActionChainExecutorTest extends BrobotTestBase {
    ...
    public void setupTest() {
        ...
        when(actionService.getAction(any(PatternFindOptions.class)))
                .thenReturn(Optional.of(findAction));
    ...
    class BasicChainExecutionTests {
        ...
        void shouldExecuteSingleActionChain() {
            ...
            ActionChainOptions chainOptions =
                    new ActionChainOptions.Builder(findOptions)
        ...
        void shouldExecuteMultiActionChain() {
            ...
            verify(actionExecution).perform(eq(findAction), anyString(), eq(findOptions), any());
            verify(actionExecution)
                    .perform(eq(clickAction), anyString(), any(ClickOptions.class), any());
        }
    ...
    class NestedStrategyTests {
        ...
        void shouldSearchWithinPreviousResultsInNestedMode() {
            ...
            ActionChainOptions chainOptions =
                    new ActionChainOptions.Builder(find1)
                            .setStrategy(ActionChainOptions.ChainingStrategy.NESTED)
                            .then(find2)
                            .build();
            ...
            verify(actionExecution, times(2))
                    .perform(any(), anyString(), configCaptor.capture(), any());
        ...
        void shouldModifyConfigForNestedSearch() {
            ...
            when(actionService.getAction(any(ColorFindOptions.class)))
                    .thenReturn(Optional.of(findAction));
    ...
    class ConfirmStrategyTests {
        ...
        void shouldFilterUnconfirmedMatches() {
            ...
            // When no matches are confirmed, the result should have empty match list and be
            // unsuccessful
            assertFalse(result.isSuccess());
    ...
    class ResultAccumulationTests {
        ...
        void shouldAccumulateExecutionHistory() {
            ...
            ActionChainOptions chainOptions =
                    new ActionChainOptions.Builder(find).then(click).then(type).build();
            ...
            assertTrue(
                    result.getExecutionHistory().size() >= 3
                            || result.getExecutionHistory().isEmpty());
        }
        ...
        void shouldPreserveFinalStateInResult() {
            ...
            ActionChainOptions chainOptions =
                    new ActionChainOptions.Builder(find).then(click).build();
    ...
    class ErrorHandlingTests {
        ...
        void shouldHandleNullStrategyWithDefaultBehavior() {
            ...
            ActionChainOptions chainOptions =
                    new ActionChainOptions.Builder(find).setStrategy(null).build();
            ...
            assertThrows(
                    ...
                    () ->
                            chainExecutor.executeChain(
                                    chainOptions, initialResult, objectCollection));
        }
    ...
    class NonFindActionTests {
        ...
        void shouldHandleNonFindActionsInNestedMode() {
            ...
            ActionChainOptions chainOptions =
                    new ActionChainOptions.Builder(find)
                            .setStrategy(ActionChainOptions.ChainingStrategy.NESTED)
                            .then(click)
                            .build();
            ...
            verify(actionExecution, times(2))
                    .perform(any(), anyString(), any(), collectionCaptor.capture());
    ...
    class ComplexChainTests {
        ...
        void shouldHandleMixedStrategiesAppropriately() {
            ...
            ActionResult nestedResult =
                    chainExecutor.executeChain(nestedChain, initialResult, objectCollection);
            ...
            ActionResult confirmResult =
                    chainExecutor.executeChain(confirmChain, initialResult, objectCollection);

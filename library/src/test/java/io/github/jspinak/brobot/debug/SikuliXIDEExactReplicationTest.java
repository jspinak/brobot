...
/**
 * Exact replication of what SikuliX IDE does when finding patterns This test aims to achieve the
 * same 0.99 similarity that IDE shows
 */
@DisabledInCI
public class SikuliXIDEExactReplicationTest extends BrobotTestBase {
    ...
    public void replicateIDEExactly() {
        ...
        try {
            ...
            System.out.println(
                    "!!! MAKE SURE THE SCREEN LOOKS EXACTLY AS IT DOES IN SIKULIX IDE !!!");
            ...
            for (String patternPath : patterns) {
                ...
                if (f.exists()) {
                    ...
                    System.out.println(
                            "    Last modified: " + new java.util.Date(f.lastModified()));
                }
            }

...
public class ScreenCaptureComparisonTest extends BrobotTestBase {
    ...
    public void compareScreenCaptures() {
        ...
        try {
            ...
            System.out.println(
                    "   SikuliX captured: "
                            + sikuliImage.getWidth()
                            + "x"
                            + sikuliImage.getHeight());
            ...
            System.out.println(
                    "\n   SikuliX capture(Rectangle): "
                            + sikuliImage2.getWidth()
                            + "x"
                            + sikuliImage2.getHeight());
            ...
            BufferedImage brobotStatic =
                    BufferedImageUtilities.getBufferedImageFromScreen(fullRegion);
            System.out.println(
                    "   Brobot static capture: "
                            + brobotStatic.getWidth()
                            + "x"
                            + brobotStatic.getHeight());
            ...
            System.out.println(
                    "\n   Brobot instance capture: "
                            + brobotInstance.getWidth()
                            + "x"
                            + brobotInstance.getHeight());
            ...
            System.out.println(
                    "   Robot captured: " + robotImage.getWidth() + "x" + robotImage.getHeight());
            ...
            System.out.println(
                    "Please visually compare these images to see if there are any differences!");
            ...
            for (int x = 0; x < w; x += 100) {
                ...
                if (rgb1 != rgb2) {
                    ...
                    if (differences <= 3) { // Show first few differences
                        System.out.printf(
                                "     Diff at (%d,%d): RGB1(%d,%d,%d) vs RGB2(%d,%d,%d)\n",

...
class RobotCaptureProviderTest {
    ...
    private void testScalingScenario(int width, int height, double expectedScale, String scenario) {
        ...
        try {
            ...
            java.lang.reflect.Method needsScaling = provider.getClass()
                .getDeclaredMethod("needsScaling", BufferedImage.class);
    ...
    void testResolutionType() {
        ...
        assertEquals(CaptureProvider.ResolutionType.PHYSICAL, provider.getResolutionType(),
        ...
        if (javaVersion.startsWith("1.8")) {
            ...
            assertEquals(CaptureProvider.ResolutionType.LOGICAL, provider.getResolutionType(),
    ...
    void testImageScaling() {
        ...
        try {
            java.lang.reflect.Method scaleImage = provider.getClass()
                .getDeclaredMethod("scaleImage", BufferedImage.class, int.class, int.class);

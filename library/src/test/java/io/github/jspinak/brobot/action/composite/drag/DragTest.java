...
/**
 * Comprehensive test suite for refactored Drag composite action - drag-and-drop operations.
 * Tests the orchestration of MouseDown, MoveMouse, and MouseUp actions.
 */
...
class DragTest extends BrobotTestBase {
    ...
    class BasicDragOperations {
        ...
        void shouldUsePreviousActionResultMatches() {
            ...
            ObjectCollection sourceCollection = new ObjectCollection.Builder()
                    .withMatches(sourceResult)
                    .build();
            ObjectCollection targetCollection = new ObjectCollection.Builder()
                    .withMatches(targetResult)
                    .build();
    ...
    class ConfigurationOptions {
        ...
        void shouldApplyCustomDragOptions() {
            ...
            MousePressOptions customPressOptions = MousePressOptions.builder()
                    .build();
            ...
            ArgumentCaptor<ActionResult> mouseDownCaptor = ArgumentCaptor.forClass(ActionResult.class);
            ...
            ArgumentCaptor<ActionResult> mouseUpCaptor = ArgumentCaptor.forClass(ActionResult.class);

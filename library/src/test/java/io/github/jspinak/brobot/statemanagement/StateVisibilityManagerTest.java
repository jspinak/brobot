...
public class StateVisibilityManagerTest extends BrobotTestBase {
    ...
    class BasicHidingOperations {
        ...
        public void testHideStates() {
            ...
            when(stateMemory.getActiveStates()).thenReturn(new HashSet<>(Arrays.asList(2L, 3L, 4L)));
    ...
    class PartialHidingScenarios {
        ...
        public void testPartialHiding() {
            ...
            when(stateService.getState(1L)).thenReturn(Optional.of(newState));
            when(stateMemory.getActiveStates()).thenReturn(new HashSet<>(Arrays.asList(2L, 3L, 4L, 5L)));
        ...
        public void testOverlappingHideRelationships() {
            ...
            when(stateMemory.getActiveStates()).thenReturn(new HashSet<>(Arrays.asList(10L, 11L, 12L)));
    ...
    class ComplexUIScenarios {
        ...
        public void testModalDialogScenario() {
            ...
            when(modalDialog.getCanHideIds()).thenReturn(new HashSet<>(Arrays.asList(mainPageId, sidebarId)));
            when(stateService.getState(200L)).thenReturn(Optional.of(modalDialog));
            when(stateMemory.getActiveStates()).thenReturn(new HashSet<>(Arrays.asList(mainPageId, sidebarId)));
        ...
        public void testDropdownMenuScenario() {
            ...
            when(dropdownMenu.getCanHideIds()).thenReturn(new HashSet<>(Collections.singletonList(contentAreaId)));
            when(stateService.getState(60L)).thenReturn(Optional.of(dropdownMenu));
            when(stateMemory.getActiveStates()).thenReturn(new HashSet<>(Arrays.asList(contentAreaId, 51L, 52L)));
        ...
        public void testNavigationDrawerScenario() {
            ...
            when(navDrawer.getCanHideIds()).thenReturn(new HashSet<>(Collections.singletonList(mainContentId)));
            when(stateService.getState(400L)).thenReturn(Optional.of(navDrawer));
            when(stateMemory.getActiveStates()).thenReturn(new HashSet<>(Arrays.asList(mainContentId, headerBarId)));
        ...
        public void testTabSwitchingScenario() {
            ...
            when(newTab.getCanHideIds()).thenReturn(new HashSet<>(Collections.singletonList(oldTabId)));
            when(stateService.getState(502L)).thenReturn(Optional.of(newTab));
            when(stateMemory.getActiveStates()).thenReturn(new HashSet<>(Arrays.asList(oldTabId, tabBarId)));
    ...
    class EdgeCases {
        ...
        public void testSelfHiding() {
            State newState = mock(State.class);
            when(newState.getCanHideIds()).thenReturn(new HashSet<>(Arrays.asList(1L))); // Can hide itself
    ...
    class IntegrationScenarios {
        ...
        public void testBackNavigationSetup() {
            ...
            when(dialog.getCanHideIds()).thenReturn(new HashSet<>(Collections.singletonList(previousPageId)));
            when(dialog.getHiddenStateIds()).thenReturn(new HashSet<>());
            
            when(stateService.getState(20L)).thenReturn(Optional.of(dialog));
            when(stateMemory.getActiveStates()).thenReturn(new HashSet<>(Collections.singletonList(previousPageId)));

...
/**
 * Comprehensive test suite for StateTransitions class. Tests container functionality for state
 * transitions including transition management, visibility control, and builder patterns.
 */
...
class StateTransitionsTest extends BrobotTestBase {
    ...
    @Mock private StateTransition mockTransitionFinish;
    ...
    class TransitionManagement {
        ...
        void testAddTaskSequenceTransition() {
            ...
            // Verify mapping
            assertEquals(
                    mockTaskSequenceTransition,
                    stateTransitions.getActionDefinitionTransitions().get(1L));
            assertEquals(
                    mockTaskSequenceTransition,
                    stateTransitions.getActionDefinitionTransitions().get(2L));
            assertEquals(
                    mockTaskSequenceTransition,
                    stateTransitions.getActionDefinitionTransitions().get(3L));
        }
    ...
    class TransitionRetrieval {
        ...
        void testGetTransitionByActivatedStateId() {
            ...
            Optional<StateTransition> result =
        ...
        void testGetTransitionFinishForOwnStateId() {
            ...
            Optional<StateTransition> result =
                    stateTransitions.getTransitionFunctionByActivatedStateId(100L);
            assertTrue(result.isPresent());
        ...
        void testGetTransitionForNullStateId() {
            Optional<StateTransition> result =
                    stateTransitions.getTransitionFunctionByActivatedStateId(null);
            assertFalse(result.isPresent());
        }
        ...
        void testGetTransitionAmongMultiple() {
            ...
            assertEquals(
                    transition2,
                    stateTransitions.getTransitionFunctionByActivatedStateId(3L).get());
            assertEquals(
                    transition3,
                    stateTransitions.getTransitionFunctionByActivatedStateId(6L).get());
            assertEquals(
                    transition1,
                    stateTransitions.getTransitionFunctionByActivatedStateId(1L).get());
        }
    }
    ...
    class BuilderPattern {
        ...
        void testBuilderMinimal() {
            StateTransitions transitions = new StateTransitions.Builder("TestState").build();
        ...
        void testBuilderWithTransitionFinishJava() {
            JavaStateTransition finish =
                    new JavaStateTransition.Builder().setFunction(() -> false).build();

            StateTransitions transitions =
                    new StateTransitions.Builder("TestState").addTransitionFinish(finish).build();
        ...
        void testBuilderWithJavaTransition() {
            ...
            StateTransitions transitions =
                    new StateTransitions.Builder("TestState").addTransition(transition).build();
        ...
        void testBuilderComplete() {
            JavaStateTransition finish =
                    new JavaStateTransition.Builder().setFunction(() -> true).build();

            JavaStateTransition transition1 =
                    new JavaStateTransition.Builder()
                            .setFunction(() -> false)
                            .addToActivate("State1")
                            .build();
            ...
            StateTransitions transitions =
                    new StateTransitions.Builder("CompleteState")
        ...
        void testBuilderMethodChaining() {
            StateTransitions transitions =
                    new StateTransitions.Builder("ChainState")
    ...
    class EdgeCases {
        ...
        void testNullTransitionFinishInVisibility() {
            ...
            assertThrows(
                    NullPointerException.class, () -> stateTransitions.stateStaysVisible(100L));
        }
        ...
        void testVeryLargeStateId() {
            ...
            Optional<StateTransition> result =
                    stateTransitions.getTransitionFunctionByActivatedStateId(largeId);
            assertTrue(result.isPresent());
            assertEquals(mockTransitionFinish, result.get());
        }
    }

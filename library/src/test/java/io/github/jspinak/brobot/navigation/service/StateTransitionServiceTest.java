...
public class StateTransitionServiceTest extends BrobotTestBase {
    ...
    public void setupTest() {
        ...
        service = new StateTransitionService(stateTransitionsRepository, stateTransitionsJointTable);
    }
    ...
    class ConstructorAndInitialization {
        ...
        public void testConstructor() {
            // Execute
            StateTransitionService newService = new StateTransitionService(
    ...
    class RepositoryAccessMethods {
        ...
        public void testGetAllStateTransitionsInstances() {
            // Setup
            List<StateTransitions> expectedList = Arrays.asList(
                mock(StateTransitions.class),
                mock(StateTransitions.class)
            );
            when(stateTransitionsRepository.getAllStateTransitionsAsCopy()).thenReturn(expectedList);
        ...
        public void testGetAllIndividualTransitions() {
            // Setup
            List<StateTransition> expectedList = Arrays.asList(
                mock(StateTransition.class),
                mock(StateTransition.class)
            );
    ...
    class TransitionResolution {
        ...
        public void testGetTransitionToEnum_Scenarios(Long from, Long to, 
                                                      boolean isDirect, boolean isHidden) {
            // Setup
    ...
    class EdgeCasesAndErrorHandling {
        ...
        public void testGetTransitions_NullStateId() {
            // Setup
            when(stateTransitionsRepository.get(null))
                .thenReturn(Optional.empty());
    ...
    class PerformanceAndThreadSafety {
        ...
        public void testLargeTransitionSet() {
            ...
            assertTrue((endTime - startTime) < 1000, 
                "Resetting 1000 transitions took too long");

...
/**
 * Simple test to verify DPI scaling theory without Spring dependencies. Tests that screen capture
 * and pattern matching use compatible pixel dimensions.
 */
@DisabledInCI
public class SimpleDPIVerificationTest extends BrobotTestBase {
    ...
    public void verifyCriticalAssumption_ScreenCapturePixelDimensions() {
        ...
        System.out.println(
                "   Expected Physical: " + expectedPhysical_width + "x" + expectedPhysical_height);
        ...
        if (isLogical) {
            ...
            System.out.println(
                    "   This means patterns and captures use THE SAME coordinate system.");
            ...
            System.out.println(
                    "   ❓ UNEXPECTED: Capture dimensions don't match logical OR physical!");
        ...
        if (isLogical) {
            System.out.println(
                    "   - Patterns captured with SikuliX IDE should match WITHOUT scaling");
    ...
    public void captureMatchedRegionAndCompare() {
        ...
        try {
            ...
            System.out.println(
                    "  Original pattern: " + original.getWidth() + "x" + original.getHeight());
            System.out.println(
                    "  Captured region: " + captured.getWidth() + "x" + captured.getHeight());
            ...
            if (reverseMatch != null) {
                System.out.println(
                        "  Captured region found with similarity: "

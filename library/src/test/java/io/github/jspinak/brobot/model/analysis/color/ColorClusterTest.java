...
public class ColorClusterTest extends BrobotTestBase {
    ...
    class ColorSchemaManagement {
        ...
        void shouldHandleAllSchemaTypes(ColorCluster.ColorSchemaName schemaName) {
            ColorSchema schema = schemaName == ColorCluster.ColorSchemaName.BGR ? bgrSchema : hsvSchema;
    ...
    class MatGeneration {
        ...
        void shouldGetMatWithSpecifiedSize() {
            ...
            Mat result = colorCluster.getMat(ColorCluster.ColorSchemaName.BGR, ColorInfo.ColorStat.MEAN, size);
        ...
        void shouldGetMatWithDefaultSize() {
            Mat result = colorCluster.getMat(ColorCluster.ColorSchemaName.BGR, ColorInfo.ColorStat.MEAN, new Size(10, 10));
        ...
        void shouldGetMatWithDifferentStats(String schemaNameStr, String statStr) {
            ColorCluster.ColorSchemaName schemaName = ColorCluster.ColorSchemaName.valueOf(schemaNameStr);
        ...
        void shouldHandleMissingSchemaGracefully() {
            ...
            Mat result = emptyCluster.getMat(ColorCluster.ColorSchemaName.BGR, ColorInfo.ColorStat.MEAN, new Size(10, 10));
    ...
    class ColorSchemaIntegration {
        ...
        void shouldWorkWithBGRColorSchema() {
            ColorSchema bgr = new ColorSchema(
        ...
        void shouldWorkWithHSVColorSchema() {
            ColorSchema hsv = new ColorSchema(

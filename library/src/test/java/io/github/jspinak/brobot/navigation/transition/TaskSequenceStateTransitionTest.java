...
/**
 * Comprehensive test suite for TaskSequenceStateTransition. Tests all aspects of task
 * sequence-based state transitions.
 */
...
class TaskSequenceStateTransitionTest extends BrobotTestBase {
    ...
    class ComplexScenarios {
        ...
        void testOverlappingStates() {
            ...
            // Since they're the same reference with @Data, modifying one affects both if same
            // object was passed

...
/**
 * Test suite for HistogramFindOptions following Brobot testing guidelines. All tests extend
...
public class HistogramFindOptionsTest extends BrobotTestBase {
    ...
    class BuilderTests {
        ...
        void shouldCreateFromExistingOptions() {
            ...
            HistogramFindOptions original =
                    new HistogramFindOptions.Builder()
                            .setBinOptions(
                                    HSVBinOptions.builder()
                                            .hueBins(180)
                                            .saturationBins(256)
                                            .valueBins(256)
                                            .build())
    ...
    class HSVBinTests {
        ...
        void shouldSetCustomHSVBins() {
            HistogramFindOptions options =
                    builder.setBinOptions(
                                    HSVBinOptions.builder()
                                            .hueBins(90)
                                            .saturationBins(128)
                                            .valueBins(64)
    ...
    class InheritedFeaturesTests {
        ...
        void shouldInheritSimilarity() {
            HistogramFindOptions options = builder.setSimilarity(0.95).build();
        ...
        void shouldInheritSearchDuration() {
            HistogramFindOptions options = builder.setSearchDuration(10.0).build();
        ...
        void shouldInheritCaptureImage() {
            HistogramFindOptions options = builder.setCaptureImage(false).build();
        ...
        void shouldInheritSearchRegions() {
            ...
            HistogramFindOptions options = builder.setSearchRegions(searchRegions).build();
        ...
        void shouldInheritMaxMatchesToActOn() {
            HistogramFindOptions options = builder.setMaxMatchesToActOn(10).build();
        ...
        void shouldInheritUseDefinedRegion() {
            HistogramFindOptions options = builder.setUseDefinedRegion(true).build();
        ...
        void shouldInheritMatchAdjustmentOptions() {
            ...
            HistogramFindOptions options = builder.setMatchAdjustment(matchAdjustment).build();
    ...
    class StrategyTests {
        ...
        void shouldAlwaysReturnHistogramStrategy() {
            ...
            HistogramFindOptions customOptions =
                    builder.setBinOptions(
                                    HSVBinOptions.builder()
                                            .hueBins(1)
                                            .saturationBins(1)
            ...
            HistogramFindOptions copiedOptions =
                    new HistogramFindOptions.Builder(defaultOptions).build();
    ...
    class EdgeCaseTests {
        ...
        void shouldHandleEmptySearchRegions() {
            ...
            HistogramFindOptions options = builder.setSearchRegions(emptyRegions).build();

...
/**
 * Comprehensive test suite for PatternFindOptions - configuration for pattern-matching find
 * operations. Tests builder pattern, strategies, factory methods, JSON serialization, and edge
 * cases.
 */
...
public class PatternFindOptionsTest extends BrobotTestBase {
    ...
    class DefaultConfiguration {
        ...
        public void testDefaultMatchFusionOptions() {
            ...
            assertEquals(
                    MatchFusionOptions.FusionMethod.NONE,
    ...
    class StrategyConfiguration {
        ...
        public void testStrategyFirst() {
            PatternFindOptions options =
                    builder.setStrategy(PatternFindOptions.Strategy.FIRST).build();
        ...
        public void testStrategyBest() {
            PatternFindOptions options =
                    builder.setStrategy(PatternFindOptions.Strategy.BEST).build();
        ...
        public void testStrategyAll() {
            PatternFindOptions options =
                    builder.setStrategy(PatternFindOptions.Strategy.ALL).build();
        ...
        public void testStrategyEach() {
            PatternFindOptions options =
                    builder.setStrategy(PatternFindOptions.Strategy.EACH).build();
        ...
        public void testDoOnEachFirst() {
            PatternFindOptions options =
                    builder.setStrategy(PatternFindOptions.Strategy.EACH)
        ...
        public void testAllStrategies(PatternFindOptions.Strategy strategy) {
            PatternFindOptions options = builder.setStrategy(strategy).build();
    ...
    class SimilarityConfiguration {
        ...
        public void testExactMatch() {
            PatternFindOptions options = builder.setSimilarity(1.0).build();
        ...
        public void testFuzzyMatch() {
            PatternFindOptions options = builder.setSimilarity(0.7).build();
    ...
    class SearchDurationConfiguration {
        ...
        public void testCustomSearchDuration() {
            PatternFindOptions options = builder.setSearchDuration(10.0).build();
        ...
        public void testZeroSearchDuration() {
            PatternFindOptions options = builder.setSearchDuration(0.0).build();
        ...
        public void testVariousSearchDurations(double duration) {
            PatternFindOptions options = builder.setSearchDuration(duration).build();
        ...
        public void testNegativeSearchDuration() {
            ...
            PatternFindOptions options = builder.setSearchDuration(-1.0).build();
    ...
    class SearchRegionConfiguration {
        ...
        public void testCustomSearchRegions() {
            ...
            PatternFindOptions options = builder.setSearchRegions(regions).build();
        ...
        public void testNullSearchRegions() {
            PatternFindOptions options = builder.setSearchRegions(null).build();
    ...
    class MatchAdjustmentConfiguration {
        ...
        public void testMatchAdjustment() {
            io.github.jspinak.brobot.action.basic.find.MatchAdjustmentOptions adjustment =
                    io.github.jspinak.brobot.action.basic.find.MatchAdjustmentOptions.builder()
                            .setAddW(10)
                            .setAddH(10)
                            .build();

            PatternFindOptions options = builder.setMatchAdjustment(adjustment).build();
        ...
        public void testNoMatchAdjustmentByDefault() {
            ...
            io.github.jspinak.brobot.action.basic.find.MatchAdjustmentOptions adjustment =
                    options.getMatchAdjustmentOptions();
    ...
    class MatchFusionConfiguration {
        ...
        public void testMatchFusion() {
            ...
            PatternFindOptions options = builder.setMatchFusion(fusion).build();

            assertNotNull(options.getMatchFusionOptions());
            assertEquals(
                    MatchFusionOptions.FusionMethod.ABSOLUTE,
                    options.getMatchFusionOptions().getFusionMethod());
        }
    ...
    class ComplexFindScenarios {
        ...
        public void testFindAllHighSimilarity() {
            PatternFindOptions options =
                    builder.setStrategy(PatternFindOptions.Strategy.ALL)
                            .setSimilarity(0.95)
        ...
        public void testFindBestWithAdjustments() {
            PatternFindOptions options =
                    builder.setStrategy(PatternFindOptions.Strategy.BEST)
                            .setMatchAdjustment(
            ...
            PatternFindOptions options =
                    builder.setStrategy(PatternFindOptions.Strategy.ALL)
                            .setMatchFusion(
                                    MatchFusionOptions.builder()
                                            .setFusionMethod(
                                                    MatchFusionOptions.FusionMethod.RELATIVE)
                                            .build())
                            .setMatchAdjustment(
                                    io.github.jspinak.brobot.action.basic.find
                                            .MatchAdjustmentOptions.builder()
    ...
    class BuilderCopyConstructor {
        ...
        public void testModifyCopiedOptions() {
            ...
            PatternFindOptions modified =
                    new PatternFindOptions.Builder(original)
    ...
    class PerformanceConsiderations {
        ...
        public void testQuickFind() {
            PatternFindOptions options =
                    builder.setStrategy(PatternFindOptions.Strategy.FIRST)
    ...
    class EdgeCases {
        ...
        public void testNullStrategy() {
            PatternFindOptions options = builder.setStrategy(null).build();
    ...
    class JsonSerialization {
        ...
        public void testBasicSerialization() throws JsonProcessingException {
            ...
            PatternFindOptions deserialized =
                    objectMapper.readValue(json, PatternFindOptions.class);
        ...
        public void testDeserializeWithUnknownProperties() throws JsonProcessingException {
            String json =
                    "{\"@type\":\"PatternFindOptions\",\"strategy\":\"FIRST\",\"similarity\":0.8,\"unknownField\":\"value\"}";
        ...
        public void testSerializeFactoryMethods() throws JsonProcessingException {
            ...
            PatternFindOptions quickDeserialized =
                    objectMapper.readValue(quickJson, PatternFindOptions.class);
            PatternFindOptions preciseDeserialized =
                    objectMapper.readValue(preciseJson, PatternFindOptions.class);
            PatternFindOptions allDeserialized =
                    objectMapper.readValue(allJson, PatternFindOptions.class);
    ...
    class IntegrationTests {
        ...
        public void testCopyConstructorCompleteness() {
            ...
            assertEquals(
                    original.getMatchFusionOptions().getFusionMethod(),
                    copy.getMatchFusionOptions().getFusionMethod());
            assertEquals(
                    original.getMatchFusionOptions().getMaxFusionDistanceX(),

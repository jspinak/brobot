...
/**
 * Tests for PerformanceMetrics class. Verifies performance tracking and metric calculations. Uses
...
public class PerformanceMetricsTest extends ConcurrentTestBase {
    ...
    class ResetSnapshotTests {
        ...
        public void testSnapshot() {
            ...
            assertEquals(
                    metrics.getTotalIllustrationsGenerated().get(),
            ...
            assertEquals(
                    ...
                    0.01);
            assertEquals(
                    metrics.getIllustrationsSkipped().get(), snapshot.getIllustrationsSkipped());
    ...
    class TimeBasedMetricsTests {
        ...
        public void testUptimeDuration() throws Exception {
            ...
            boolean success =
                    waitFor(
                            () -> metrics.getTotalUptime().toMillis() >= 100,
        ...
        public void testTimeSinceLastIllustration() throws Exception {
            ...
            boolean success =
                    waitFor(
                            () -> metrics.getTimeSinceLastIllustration().toMillis() >= 100,
                            Duration.ofMillis(150));

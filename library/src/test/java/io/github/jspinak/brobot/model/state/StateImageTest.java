...
public class StateImageTest extends BrobotTestBase {
    ...
    @Mock private KmeansProfilesAllSchemas mockKmeansProfiles;

    @Mock private Mat mockMat;

    @Mock private ActionHistory mockActionHistory;
    ...
    class BuilderPattern {
        ...
        public void testBuilderWithOwnerState() {
            StateImage image = new StateImage.Builder().setOwnerStateName("MainState").build();
        ...
        public void testBuilderWithIndex() {
            StateImage image = new StateImage.Builder().setIndex(5).build();
    ...
    class PatternMethods {
        ...
        public void testGetFirstPattern() {
            ...
            Pattern first =
                    stateImage.getPatterns().isEmpty() ? null : stateImage.getPatterns().get(0);

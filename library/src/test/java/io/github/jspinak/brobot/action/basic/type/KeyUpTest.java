...
/**
 * Comprehensive test suite for KeyUp - releases previously pressed keyboard keys. Tests key release
 * operations, modifier handling, and batch processing.
 */
@DisplayName("KeyUp Tests")
@DisabledInCI
public class KeyUpTest extends BrobotTestBase {

    @Mock private KeyUpWrapper mockKeyUpWrapper;
    ...
    class ModifierKeyHandling {
        ...
        public void testReleaseModifierAfterKeys() {
            ...
            KeyUpOptions options = new KeyUpOptions.Builder().setModifiers(List.of("CTRL")).build();
        ...
        public void testReleaseMultipleModifiers() {
            ...
            KeyUpOptions options =
                    new KeyUpOptions.Builder().setModifiers(Arrays.asList("CTRL", "SHIFT")).build();
            when(mockActionResult.getActionConfig()).thenReturn(options);
        ...
        public void testReleaseOnlyModifiers() {
            ...
            KeyUpOptions options =
                    new KeyUpOptions.Builder().setModifiers(Arrays.asList("CTRL", "ALT")).build();
            when(mockActionResult.getActionConfig()).thenReturn(options);
    ...
    class MultipleObjectCollections {
        ...
        public void testOnlyFirstCollectionUsed() {
            ...
            // collection1.getStateStrings() is called twice: once in nothingToRelease() and once in
            // perform()

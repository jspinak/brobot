...
/**
 * Simple test to demonstrate declarative region behavior. When a declarative region is set as a
 * search region on an image, the image's fixed region should be deleted.
 */
...
public class SimpleDeclarativeRegionTest extends BrobotTestBase {
    ...
    void testFixedRegionClearingBehavior() {
        ...
        // 2. DynamicRegionResolver calculates new region for imageB based on
        // ReferenceImage location

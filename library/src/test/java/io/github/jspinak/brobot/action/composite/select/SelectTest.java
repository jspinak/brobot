...
public class SelectTest extends BrobotTestBase {
    ...
    @Mock private StateImage mockConfirmImage;
    ...
    public void setupTest() {
        ...
        findCollection = new ObjectCollection.Builder().withImages(mockStateImage).build();

        confirmCollection = new ObjectCollection.Builder().withImages(mockConfirmImage).build();

        swipeFromCollection =
                new ObjectCollection.Builder().withLocations(new Location(100, 500)).build();
        ...
        public void testSwipeWhenNotFound() {
            ...
            verify(mockAction, times(1))
                    .perform(
                            ...
                            eq(swipeFromCollection),
                            eq(swipeToCollection));
        }
    }

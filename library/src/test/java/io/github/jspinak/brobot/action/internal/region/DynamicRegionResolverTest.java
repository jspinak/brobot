...
class DynamicRegionResolverTest extends BrobotTestBase {
    ...
    @Mock private SearchRegionDependencyRegistry dependencyRegistry;
    ...
    @Mock private SearchRegionOnObject searchRegionConfig;

    @Mock private MatchAdjustmentOptions adjustmentOptions;

    @Mock private ActionHistory matchHistory;
    ...
    void testUpdateStateLocationSearchRegion() {
        ...
        verify(stateLocation)
                .setLocation(
                        argThat(loc -> loc.getCalculatedX() == 80 && loc.getCalculatedY() == 80));
    }

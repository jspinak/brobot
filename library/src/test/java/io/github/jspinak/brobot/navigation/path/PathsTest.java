...
/**
 * Comprehensive test suite for Paths - manages collections of navigation paths.
 * Tests path collection operations, sorting, cleaning, and scoring.
 */
...
class PathsTest extends BrobotTestBase {
    ...
    class PathCleaning {
        ...
        void testCleanPaths() {
            ...
            when(mockPath1.cleanPath(activeStates, failedTransition))
                .thenReturn(cleanedPath1);
            when(mockPath2.cleanPath(activeStates, failedTransition))
                .thenReturn(cleanedPath2);
        ...
        void testFilterEmptyCleanedPaths() {
            ...
            when(mockPath2.isEmpty()).thenReturn(false);
            when(mockPath1.cleanPath(activeStates, failedTransition))
                .thenReturn(cleanedPath);
            when(mockPath2.cleanPath(activeStates, failedTransition))
                .thenReturn(emptyPath);
        ...
        void testCleanPathsEmptyActiveStates() {
            ...
            Path cleanedPath = mock(Path.class);
            when(mockPath1.isEmpty()).thenReturn(false);
            when(mockPath1.cleanPath(emptyStates, failedTransition))
                .thenReturn(cleanedPath);
            when(cleanedPath.isEmpty()).thenReturn(false);

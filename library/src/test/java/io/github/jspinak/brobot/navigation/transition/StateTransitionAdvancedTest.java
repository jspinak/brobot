...
/**
 * Advanced test suite for StateTransition implementations and StateTransitions container.
 * Tests transition types, execution, conditions, and complex navigation scenarios.
 */
...
class StateTransitionAdvancedTest extends BrobotTestBase {
    ...
    @Mock
    private BooleanSupplier mockTransitionFunction;
    ...
    class StateTransitionsContainer {
        ...
        void testNoTransitionFound() {
            // Act
            Optional<StateTransition> found = stateTransitions.getTransitionFunctionByActivatedStateId(999L);
    ...
    class VisibilityBehavior {
        ...
        void testVisibilityOverride() {
            ...
            taskSequenceTransition.setStaysVisibleAfterTransition(StateTransition.StaysVisible.TRUE);

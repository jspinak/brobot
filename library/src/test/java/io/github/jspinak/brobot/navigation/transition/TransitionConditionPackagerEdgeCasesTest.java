...
/**
 * Edge case and boundary tests for TransitionConditionPackager.
 * Supplements the main test suite with additional scenarios.
 */
...
class TransitionConditionPackagerEdgeCasesTest extends BrobotTestBase {
    ...
    @Mock
    private StateTransition mockStateTransition;
    ...
    class ExceptionScenarios {
        ...
        void testActionPerformException() {
            ...
            when(mockStateTransition.getTaskSequenceOptional()).thenReturn(Optional.of(taskSequence));
    ...
    class TaskSequenceBoundaries {
        ...
        void testLargeTaskSequence() {
            ...
            assertTrue(success);
            verify(mockAction, times(100)).perform(any(ActionConfig.class), any(ObjectCollection.class));
        }
    ...
    class MixedSuccessPatterns {
        ...
        void testAlternatingResults() {
            ...
            verify(mockAction, times(5)).perform(any(ActionConfig.class), any(ObjectCollection.class));
        }
        ...
        void testAllFailExceptLast() {
            ...
            when(mockAction.perform(any(ActionConfig.class), any(ObjectCollection.class)))
                .thenReturn(failResult, failResult, failResult, failResult, 
                           failResult, failResult, failResult, failResult, 
        ...
        void testAllSucceedExceptLast() {
            ...
            when(mockAction.perform(any(ActionConfig.class), any(ObjectCollection.class)))
                .thenReturn(successResult, successResult, successResult, successResult, failResult);
    ...
    class StateTransitionTypeHandling {
        ...
        void testInstanceOfPriority() {
            ...
            when(hybridTransition.getTaskSequenceOptional()).thenReturn(Optional.of(mockTaskSequence));
    ...
    class SupplierReusability {
        ...
        void testSupplierReusability() {
            ...
            verify(mockAction, times(3)).perform(any(ActionConfig.class), any(ObjectCollection.class));
        }

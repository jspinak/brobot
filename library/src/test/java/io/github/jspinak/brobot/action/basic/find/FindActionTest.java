...
public class FindActionTest extends BrobotTestBase {
    ...
    @Mock private FindPipeline mockFindPipeline;

    @Mock private FindStrategy mockFindStrategy;

    @Mock private ImageFinder mockImageFinder;

    @Mock private FindText mockFindText;

    @Mock private FindColor mockFindColor;
            ...
            List<Match> matches =
                    Arrays.asList(
                            ...
                            new Match.Builder()
                                    ...
                                    .build(),
                            new Match.Builder()
                                    .setRegion(new Region(300, 300, 50, 50))
                                    .setSimScore(0.88)
                                    .build());
    ...
    class MultipleObjectHandling {
        ...
        public void testMixedObjectTypes() {
            ...
            StateRegion stateRegion =
                    new StateRegion.Builder().setSearchRegion(new Region(0, 0, 800, 600)).build();
    ...
    class SearchRegions {
        ...
        public void testMultipleSearchRegions() {
            StateRegion region1 =
                    new StateRegion.Builder().setSearchRegion(new Region(0, 0, 400, 300)).build();
            StateRegion region2 =
                    new StateRegion.Builder().setSearchRegion(new Region(400, 0, 400, 300)).build();
            StateImage stateImage = new StateImage.Builder().build();
    ...
    class ParameterizedTests {
        ...
        public void testSearchTimeAndResults(
                double searchTime, boolean shouldFind, int expectedMatches) {
            StateImage stateImage = new StateImage.Builder().build();
            objectCollection.getStateImages().add(stateImage);

            PatternFindOptions options =
                    new PatternFindOptions.Builder().setSearchDuration(searchTime).build();

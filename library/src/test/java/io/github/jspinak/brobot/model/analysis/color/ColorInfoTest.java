...
/** Comprehensive test suite for ColorInfo. Tests color information storage and manipulation. */
...
public class ColorInfoTest extends BrobotTestBase {
    ...
    class BuilderPattern {
        ...
        void shouldBuildWithRGBValues() {
            ColorInfo color = ColorInfo.builder().red(128).green(64).blue(192).build();
        ...
        void shouldBuildWithHSVValues() {
            ColorInfo color = ColorInfo.builder().hue(240.0).saturation(0.75).value(0.5).build();

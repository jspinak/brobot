...
/**
 * Comprehensive test suite for StateService - manages states within the automation project. Tests
 * CRUD operations, name/ID resolution, bulk operations, and state validation.
 */
...
public class StateServiceTest extends BrobotTestBase {
    ...
    @Mock private State mockUnknownState;
    ...
    class StateNameResolution {
        ...
        @ParameterizedTest
        @CsvSource({"1, MainMenu", "2, LoginScreen", "3, Dashboard", "0, unknown"})
    ...
    class StateIdResolution {
        ...
        @ParameterizedTest
        @CsvSource({"MainMenu, 1", "LoginScreen, 2", "Dashboard, 3", "unknown, 0"})

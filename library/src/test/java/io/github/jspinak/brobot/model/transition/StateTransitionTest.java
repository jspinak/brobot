...
/**
 * Comprehensive tests for the StateTransition interface and its implementations
 * which represent edges in the state graph for GUI automation.
 */
...
public class StateTransitionTest extends BrobotTestBase {
    ...
    Stream<DynamicTest> testTransitionScenarios() {
        return Stream.of(
            dynamicTest("Simple navigation transition", () -> {
            ...
            dynamicTest("Modal dialog transition", () -> {
                StateTransition transition = new TaskSequenceStateTransition();
            ...
            dynamicTest("Multi-state activation", () -> {
                StateTransition transition = new TaskSequenceStateTransition();
            ...
            dynamicTest("High-reliability transition", () -> {
                StateTransition transition = new TaskSequenceStateTransition();

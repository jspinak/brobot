...
/**
 * Test class for MatrixUtilities operations.
 * Tests OpenCV Mat utilities in mock mode.
 */
public class MatrixUtilitiesTest extends BrobotTestBase {
    ...
    void shouldHandleOutOfBoundsAccess() {
        ...
        assertDoesNotThrow(() -> 
            MatrixUtilities.putInt(testMat, 100, 100, (short)1)
        );
    }
    ...
    void shouldPrintPartialMatrix() {
        ...
        assertDoesNotThrow(() -> 
            MatrixUtilities.printPartOfMat(testMat, 5, 5)
        );
        
        // Test with larger limit
        assertDoesNotThrow(() -> 
            MatrixUtilities.printPartOfMat(testMat, 10, 10)
        );
    }
    ...
    void shouldPrintMatrixWithTitle() {
        assertDoesNotThrow(() -> 
            MatrixUtilities.printPartOfMat(testMat, 5, 5, "Test Matrix")
        );
        
        // Test with null title
        assertDoesNotThrow(() -> 
            MatrixUtilities.printPartOfMat(testMat, 5, 5, null)
        );
    }
    ...
    void shouldPrintMultiChannel() {
        assertDoesNotThrow(() -> 
            MatrixUtilities.printPartOfMat(multiChannelMat, 5, 5, 3)
        );
    }
    ...
    void shouldHandleZeroLimitForPrint() {
        assertDoesNotThrow(() -> 
            MatrixUtilities.printPartOfMat(testMat, 0, 0)
        );
    }
    ...
    void shouldHandleNegativeLimitForPrint() {
        assertDoesNotThrow(() -> 
            MatrixUtilities.printPartOfMat(testMat, -1, -1)
        );
    }
    ...
    void shouldWorkWithDifferentMatTypes() {
        ...
        assertThrows(ClassCastException.class, () -> 
            MatrixUtilities.putInt(floatMat, 2, 2, (short)3)
        );
        assertThrows(ClassCastException.class, () -> 
            MatrixUtilities.putInt(intMat, 2, 2, (short)42)
        );
        assertDoesNotThrow(() -> 
            MatrixUtilities.putInt(byteMat, 2, 2, (short)100)
        );
    ...
    void shouldHandleNullMat() {
        ...
        assertThrows(NullPointerException.class, () -> 
            MatrixUtilities.printPartOfMat(null, 5, 5)
        );
        
        // printPartOfMat with 3 params doesn't throw NPE, it passes channels directly
        assertDoesNotThrow(() -> 
            MatrixUtilities.printPartOfMat(null, 5, 5, 3)
        );
        ...
        assertThrows(NullPointerException.class, () -> 
            MatrixUtilities.getDouble(0, 0, 0, null)
        );
        
        // putInt with null will throw NullPointerException
        assertThrows(NullPointerException.class, () -> 
            MatrixUtilities.putInt(null, 0, 0, (short)1)
        );

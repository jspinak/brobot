...
/**
 * Comprehensive test suite for RelativeSizeFusionDecider. Tests fusion strategy using size-relative
...
public class RelativeSizeFusionDeciderTest extends BrobotTestBase {
    ...
    class BasicRelativeFusionLogic {
        ...
        void shouldCalculateFusionDistanceBasedOnSmallerHeight() {
            ...
            verify(absoluteSizeFusionDecider)
                    .isSameMatchGroup(eq(smallMatch), eq(largeMatch), eq(10), eq(10));
        }
        ...
        void shouldHandleEqualSizedMatches() {
            ...
            verify(absoluteSizeFusionDecider)
                    .isSameMatchGroup(eq(match1), eq(match2), eq(10), eq(10));
        }
        ...
        void shouldUseMinimumHeightWhenSizesDiffer() {
            ...
            verify(absoluteSizeFusionDecider)
                    .isSameMatchGroup(eq(tallMatch), eq(shortMatch), eq(30), eq(30));
        }
    }
    ...
    class PercentageCalculations {
        ...
        void shouldHandleZeroPercentThreshold() {
            ...
            verify(absoluteSizeFusionDecider)
                    .isSameMatchGroup(eq(match1), eq(match2), eq(0), eq(0));
        }
        ...
        void shouldHandleOneHundredPercentThreshold() {
            ...
            verify(absoluteSizeFusionDecider)
                    .isSameMatchGroup(eq(match1), eq(match2), eq(40), eq(40));
        }
        ...
        void shouldHandlePercentagesGreaterThan100() {
            ...
            verify(absoluteSizeFusionDecider)
                    .isSameMatchGroup(eq(match1), eq(match2), eq(60), eq(45));
        }
        ...
        void shouldHandleDifferentXAndYPercentages() {
            ...
            verify(absoluteSizeFusionDecider)
                    .isSameMatchGroup(eq(match1), eq(match2), eq(10), eq(40));
        }
    }
    ...
    class SizeVariationScenarios {
        ...
        void shouldHandleVerySmallMatches() {
            ...
            verify(absoluteSizeFusionDecider).isSameMatchGroup(eq(tiny1), eq(tiny2), eq(2), eq(2));
        }
        ...
        void shouldHandleVeryLargeMatches() {
            ...
            // 10% of 400px = 40px
            verify(absoluteSizeFusionDecider)
                    .isSameMatchGroup(eq(large1), eq(large2), eq(40), eq(40));
        }
        ...
        void shouldHandleExtremeSizeDifferences() {
            ...
            verify(absoluteSizeFusionDecider).isSameMatchGroup(eq(tiny), eq(huge), eq(5), eq(5));
        }
        ...
        void shouldHandleMatchesWithDifferentAspectRatios() {
            ...
            verify(absoluteSizeFusionDecider)
                    .isSameMatchGroup(eq(wideMatch), eq(tallMatch), eq(15), eq(15));
        }
    }
    ...
    class DelegationBehavior {
        ...
        void shouldDelegateToAbsoluteDecider() {
            ...
            verify(absoluteSizeFusionDecider)
                    .isSameMatchGroup(eq(match1), eq(match2), eq(30), eq(15));
        }
    ...
    class EdgeCases {
        ...
        void shouldHandleMatchesWithHeightOf1() {
            ...
            // 100% of 1px = 1px
            verify(absoluteSizeFusionDecider)
                    .isSameMatchGroup(eq(match1), eq(match2), eq(1), eq(1));
        }
        ...
        void shouldHandleNegativePercentages() {
            ...
            verify(absoluteSizeFusionDecider)
                    .isSameMatchGroup(eq(match1), eq(match2), eq(-25), eq(-25));
        }
        ...
        void shouldHandleFractionalPercentageResults() {
            ...
            verify(absoluteSizeFusionDecider)
                    .isSameMatchGroup(eq(match1), eq(match2), eq(9), eq(9));
        }
    }
    ...
    class RealWorldScenarios {
        ...
        void shouldHandleButtonGrouping() {
            ...
            // 20% of 25px = 5px
            verify(absoluteSizeFusionDecider)
                    .isSameMatchGroup(eq(button1), eq(button2), eq(5), eq(5));
        }
        ...
        void shouldHandleMixedSizeUIElements() {
            ...
            verify(absoluteSizeFusionDecider).isSameMatchGroup(eq(icon), eq(panel), eq(4), eq(4));
        }
    }
    ...
    class AlgorithmVerification {
        ...
        void shouldCorrectlyCalculateMinimumHeight() {
            ...
            verify(absoluteSizeFusionDecider)
                    .isSameMatchGroup(eq(match1), eq(match2), eq(30), eq(45));
        }
        ...
        void shouldUseIntegerDivisionForPercentageCalculation() {
            ...
            verify(absoluteSizeFusionDecider)
                    .isSameMatchGroup(eq(match1), eq(match2), eq(5), eq(5));
        }
    }

...
/**
 * Comprehensive test suite for RegexPatterns - utility for regular expression patterns. Tests
 * numeric validation and pattern matching functionality.
 */
...
public class RegexPatternsTest extends BrobotTestBase {
    ...
    class IsNumericTests {
        ...
        class ValidNumericStrings {
            ...
            @ParameterizedTest
            @ValueSource(strings = {"0", "1", "123", "999999999", "00000", "0123456789"})
            ...
            @ParameterizedTest
            @ValueSource(strings = {"0.0", "1.5", "123.456", "0.123", "999.999", "3.14159"})
            ...
            @ParameterizedTest
            @ValueSource(strings = {".5", ".123", ".0", ".999"})
            ...
            @ParameterizedTest
            @ValueSource(strings = {"1.2.3", "1.2.3.4", "0.0.0", "...", "1..2", ".1.2."})
        ...
        class InvalidNumericStrings {
            ...
            @ParameterizedTest
            @ValueSource(strings = {"abc", "xyz", "hello", "test"})
            ...
            @ParameterizedTest
            @ValueSource(strings = {"123abc", "abc123", "12a34", "1.2a", "a.123"})
            ...
            @ParameterizedTest
            @ValueSource(strings = {"-123", "-1", "-0.5", "-.5", "-123.456"})
            ...
            @ParameterizedTest
            @ValueSource(strings = {"1,234", "1,234.56", "1,000,000", "12,34"})
            ...
            @ParameterizedTest
            @ValueSource(strings = {"1.23e10", "1E5", "3.14E-10", "2e3", "1.5E+2"})
            ...
            @ParameterizedTest
            @ValueSource(strings = {" 123", "123 ", " 123 ", "1 2 3", "12\t34", "12\n34"})
            ...
            @ParameterizedTest
            @ValueSource(strings = {"$123", "€100", "£50.50", "¥1000", "123$", "100%"})
            ...
            @ParameterizedTest
            @ValueSource(strings = {"(123)", "[123]", "{123}", "123!", "123?", "#123", "123*"})
        ...
        class EdgeCases {
            ...
            @ParameterizedTest
            @ValueSource(strings = {"Infinity", "NaN", "null", "undefined", "true", "false"})

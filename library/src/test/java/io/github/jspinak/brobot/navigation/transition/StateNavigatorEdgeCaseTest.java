...
/**
 * Edge case and boundary tests for StateNavigator.
 * Tests complex scenarios, error conditions, and boundary behaviors.
 */
...
class StateNavigatorEdgeCaseTest extends BrobotTestBase {
    ...
    class StateEnumNavigation {
        ...
        void testCustomStateEnum() {
            // Arrange
            StateEnum customEnum = new StateEnum() {
                @Override
        ...
        void testStateEnumNullToString() {
            // Arrange
            StateEnum nullEnum = new StateEnum() {
                @Override
                public String toString() {
                    return null;
                }

...
public class ColorMatrixUtilitiesTest extends BrobotTestBase {
    ...
    @InjectMocks private ColorMatrixUtilities colorMatrixUtilities;
    ...
    class ConcatenationOperations {
        ...
        void shouldHandleEmptyListConcatenation() {
            Mat result =
                    colorMatrixUtilities.vConcatToSingleColumnPerChannel(Collections.emptyList());
    ...
    class KMeansClustering {
        ...
        void shouldPerformChannelWiseKMeans() {
            ...
            TermCriteria termCriteria =
                    new TermCriteria(TermCriteria.EPS + TermCriteria.COUNT, 100, 0.001);

            double[] compactness =
                    colorMatrixUtilities.kMeans(testMat3C, 3, labels, termCriteria, 3, centers);
        ...
        void shouldHandleDifferentClusterCounts(int numClusters) {
            Mat labels = new Mat();
            Mat centers = new Mat();
            TermCriteria termCriteria = new TermCriteria(TermCriteria.COUNT, 10, 0);

            double[] compactness =
                    colorMatrixUtilities.kMeans(

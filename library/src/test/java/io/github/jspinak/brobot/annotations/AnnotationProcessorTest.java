...
/**
 * Test suite for AnnotationProcessor.
 * Tests the runtime processing of @State and @Transition annotations.
 */
...
public class AnnotationProcessorTest extends BrobotTestBase {
    ...
    @Mock
    private AnnotatedStateBuilder stateBuilder;
    ...
    class StateProcessingTests {
        ...
        void shouldProcessStatesWithAnnotation() {
            ...
            io.github.jspinak.brobot.model.state.State mockState = mock(io.github.jspinak.brobot.model.state.State.class);
            ...
            // Verify
            verify(stateBuilder).buildState(testStateBean, TestState.class.getAnnotation(io.github.jspinak.brobot.annotations.State.class));
    ...
    class ErrorHandlingTests {
        ...
        void shouldHandleMissingTransitionMethod() {
            ...
            @Transition(from = TestState.class, to = SimpleState.class, method = "nonExistentMethod")

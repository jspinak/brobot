...
/**
 * Comprehensive tests for AnsiColor ANSI escape code constants. Tests color codes, formatting,
 * terminal output, and usage patterns.
 */
...
public class AnsiColorTest extends BrobotTestBase {
    ...
    class ColorCodeFormatTests {
        ...
        void shouldStartWithEscCharacter(String colorName, String colorCode) {
            assertTrue(colorCode.startsWith("\033["), colorName + " should start with ESC[");
        }
        ...
        void shouldEndWithMCharacter(String colorName, String colorCode) {
            assertTrue(colorCode.endsWith("m"), colorName + " should end with 'm'");
        }
    }
    ...
    class UsagePatternTests {
        ...
        void shouldFormatErrorMessage() {
            String message =
                    AnsiColor.RED_BOLD + "✗ Error: " + AnsiColor.RESET + "Something went wrong";
            System.out.print(message);
    ...
    class FieldPropertyTests {
        ...
        void allColorFieldsShouldBePublicStaticFinal() {
            ...
            for (Field field : fields) {
                if (field.getType() == String.class) {
                    ...
                    assertTrue(Modifier.isPublic(modifiers), field.getName() + " should be public");
        ...
        void allColorConstantsShouldBeUnique() throws IllegalAccessException {
            ...
            assertTrue(duplicates.isEmpty(), "Found duplicate color codes: " + duplicates);
        }
    }
        ...
        void allColorNamesShouldBeUppercase() {
            ...
            for (Field field : fields) {
                if (field.getType() == String.class) {
                    ...
                    assertEquals(
                            name.toUpperCase(), name, "Field " + name + " should be all uppercase");
                }
            }
        }
    }

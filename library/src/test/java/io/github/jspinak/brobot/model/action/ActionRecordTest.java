...
/**
 * Comprehensive test suite for ActionRecord - records match results and context.
 * Tests data capture, timing, state tracking, and mock support functionality.
 */
...
public class ActionRecordTest extends BrobotTestBase {
    ...
    @Mock
    private PatternFindOptions mockFindOptions;
    ...
    class MockSupport {
        ...
        public void testMultipleRecordsForDistribution() {
            ...
            long successCount = history.stream()
                .filter(ActionRecord::isResultSuccess)
                .count();
    ...
    class TimingPerformance {
        ...
        public void testTimestampFormatting() {
            ...
            String formatted = actionRecord.getTimeStamp()

...
public class CaptureTargetRegionTest extends BrobotTestBase {
    ...
    public void captureAndCompareTargetRegions() {
        ...
        try {
            ...
            System.out.println(
                    "Screen captured: " + fullScreen.getWidth() + "x" + fullScreen.getHeight());
            ...
            BufferedImage lowerLeftRegion =
                    fullScreen.getSubimage(lowerLeftX, lowerLeftY, lowerLeftW, lowerLeftH);
            ...
            if (promptPatternFile.exists()) {
                ...
                System.out.println("\n2. PROMPT PATTERN:");
                System.out.println(
                        "   Size: " + promptPattern.getWidth() + "x" + promptPattern.getHeight());
                    ...
                    if (finder.hasNext()) {
                        ...
                        System.out.println(
                                "   Threshold "
                                        ...
                                        + ", "
                                        + match.y
                                        + ") in lower-left region");

                        // Save the matched region
                        BufferedImage matchedRegion =
                                lowerLeftRegion.getSubimage(match.x, match.y, match.w, match.h);
                        File matchedFile =
                                new File(
                                        outputDir,
                                        String.format(
                                                "matched_in_lowerleft_t%.2f_s%.3f.png",
            ...
            BufferedImage bottomStrip =
                    fullScreen.getSubimage(0, screenHeight - 100, screenWidth, 100);
            ...
            samplePixels(
                    fullScreen,
                    "Lower left quarter center",
                    lowerLeftW / 2,
                    lowerLeftY + lowerLeftH / 2);
            ...
            System.out.println(
                    "\n=== Analysis complete. Check folder: "
    ...
    private String getImageTypeName(int type) {
        switch (type) {
            ...
            case BufferedImage.TYPE_INT_ARGB_PRE:
                return "ARGB_PRE (Type 3)";
            case BufferedImage.TYPE_INT_BGR:
                return "BGR (Type 4)";
            case BufferedImage.TYPE_3BYTE_BGR:
                return "3BYTE_BGR (Type 5)";
            case BufferedImage.TYPE_4BYTE_ABGR:
                return "4BYTE_ABGR (Type 6)";
            default:
                return "Type " + type;
        }
    }

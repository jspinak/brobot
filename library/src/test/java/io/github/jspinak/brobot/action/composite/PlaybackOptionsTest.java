...
public class PlaybackOptionsTest extends BrobotTestBase {
    ...
    class BuilderConstruction {
        ...
        public void testSetStartPlayback() {
            PlaybackOptions options = new PlaybackOptions.Builder()
    ...
    class Immutability {
        ...
        public void testImmutability() {
            ...
            PlaybackOptions options2 = new PlaybackOptions.Builder()
                .setStartPlayback(8.0)
        ...
        public void testBuilderIndependence() {
            PlaybackOptions.Builder builder1 = new PlaybackOptions.Builder()
                .setStartPlayback(5.0);
            
            PlaybackOptions.Builder builder2 = new PlaybackOptions.Builder()
    ...
    class BuilderReuse {
        ...
        public void testBuilderModificationBetweenBuilds() {
            ...
            PlaybackOptions options1 = builder
                .setStartPlayback(5.0)
                .build();
            
            PlaybackOptions options2 = builder
                .setStartPlayback(10.0)
                .build();

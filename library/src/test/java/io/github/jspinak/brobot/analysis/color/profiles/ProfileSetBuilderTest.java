...
public class ProfileSetBuilderTest extends BrobotTestBase {
    ...
    @Mock
    private ColorClusterFactory colorClusterFactory;
    
    @Mock
    private ProfileMatrixBuilder profileMatrixBuilder;
    
    @Mock
    private ProfileMatrixInitializer profileMatrixInitializer;
    ...
    public void setUp() {
        super.setupTest();
        profileSetBuilder = new ProfileSetBuilder(
            colorClusterFactory,
    ...
    public void testConstructor() {
        // Execute
        ProfileSetBuilder builder = new ProfileSetBuilder(
            colorClusterFactory,
            profileMatrixBuilder,
            profileMatrixInitializer
        );
    ...
    public void testSetMatsAndColorProfiles() {
        ...
        InOrder inOrder = inOrder(profileMatrixInitializer, colorClusterFactory, 
            stateImage, profileMatrixBuilder);
    ...
    public void testColorClusterSetBeforeProfileMatrices() {
        ...
        doAnswer(invocation -> {
            ...
            verify(stateImage).setColorCluster(mockColorCluster);
            return null;
        }).when(profileMatrixBuilder).setMats(stateImage);
    ...
    public void testSetMatsAndColorProfiles_ExceptionInInitializer() {
        ...
        doThrow(new RuntimeException("Initialization failed"))
            .when(profileMatrixInitializer).setOneColumnMats(stateImage);

...
/**
 * Comprehensive test suite for StateRegion - represents meaningful screen areas.
 * Tests region definition, state association, interaction tracking, and anchoring.
 */
...
public class StateRegionTest extends BrobotTestBase {
    ...
    class AnchorConfiguration {
        ...
        public void testAddMultipleAnchors() {
            ...
            anchors.getAnchorList().add(new Anchor(Positions.Name.TOPRIGHT, new Position(1.0, 0.0)));
            anchors.getAnchorList().add(new Anchor(Positions.Name.BOTTOMLEFT, new Position(0.0, 1.0)));
        ...
        public void testCrossStateAnchors() {
            ...
            assertEquals("RelatedState", 
                stateRegion.getCrossStateAnchors().get(0).getSourceStateName());
        }
    }

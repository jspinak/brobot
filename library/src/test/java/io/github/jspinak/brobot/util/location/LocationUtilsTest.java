...
/**
 * Comprehensive test suite for LocationUtils - utilities for Location manipulation.
 * Tests conversions, calculations, and transformations of Location objects.
 */
...
public class LocationUtilsTest extends BrobotTestBase {
    ...
    class SikuliLocationConversions {
        ...
        public void testGetSikuliLocationFromXY() {
            org.sikuli.script.Location sikuliLoc = LocationUtils.getSikuliLocationFromXY(100, 200, 10, 20);
        ...
        public void testGetSikuliLocationFromXYNoOffset() {
            org.sikuli.script.Location sikuliLoc = LocationUtils.getSikuliLocationFromXY(100, 200, 0, 0);
        ...
        public void testGetSikuliLocationFromRegion() {
            org.sikuli.script.Location sikuliLoc = LocationUtils.getSikuliLocationFromRegion(
                mockRegion, mockPosition, 5, 10);
    ...
    class ConversionsToOtherTypes {
        ...
        public void testAsObjectCollection() {
            ...
            assertEquals(expectedPosition.getPercentW(), stateLocation.getPosition().getPercentW(), 0.001);
            assertEquals(expectedPosition.getPercentH(), stateLocation.getPosition().getPercentH(), 0.001);
        }
    }
    ...
    class RegionAdjustment {
        ...
        public void testAdjustVariousPositions(double inW, double inH, double expectedW, double expectedH) {

...
/**
 * Comprehensive tests for Click action covering all variations and edge cases.
...
public class ClickTest extends BrobotTestBase {
    ...
    class MixedObjectTests {
        ...
        void testMixedLocationAndRegion() {
            ...
            // Add locations
            collection.getStateLocations().add(
            ...
            // Add regions
            collection.getStateRegions().add(
        ...
        void testMultipleObjectCollections() {
            ...
            collection1.getStateLocations().add(
                new StateLocation.Builder()
                    .setLocation(new Location(100, 100))
                    .build()
            );
            ...
            collection2.getStateLocations().add(
                new StateLocation.Builder()
            ...
            collection3.getStateRegions().add(
                new StateRegion.Builder()
    ...
    class EdgeCaseTests {
        ...
        void testNegativeCoordinates() {
            ...
            collection.getStateLocations().add(
                new StateLocation.Builder()
                    .setLocation(new Location(-10, -10))
                    .build()
            );
        ...
        void testMaxValueCoordinates() {
            ...
            collection.getStateLocations().add(
                new StateLocation.Builder()
                    .setLocation(new Location(Integer.MAX_VALUE - 100, Integer.MAX_VALUE - 100))
                    .build()
            );

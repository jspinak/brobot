...
/**
 * Unit tests for StateStructureBuilder.
 * Tests state structure creation and transition setup.
 */
...
class StateStructureBuilderTest extends BrobotTestBase {
    ...
    @Mock
    private StateTransitionStore mockTransitionStore;
    ...
    class StateInitialization {
        ...
        void testInitCreatesTransitions() {
            ...
            ArgumentCaptor<StateTransitions> transitionsCaptor = ArgumentCaptor.forClass(StateTransitions.class);
    ...
    class TransitionManagement {
        ...
        void testAddTransitionImage() {
            ...
            builder.init("FromState")
                  .addTransitionImage("button.png", "ToState")
                  .build();
        ...
        void testTransitionFunction() {
            ...
            StateTransitions transitions = transitionsCaptor.getValue();
            JavaStateTransition javaTransition = (JavaStateTransition) transitions.getTransitions().get(0);
    ...
    class FluentInterface {
        ...
        void testMethodChaining() {
            ...
            StateStructureBuilder result = builder
                .init("ChainState")
                .addImage("image1.png")
    ...
    class ErrorScenarios {
        ...
        void testMultipleInitCalls() {
            builder.init("FirstState")
                  .addImage("first.png");
            
            // Second init should reset
            builder.init("SecondState")
                  .addImage("second.png")
                  .build();

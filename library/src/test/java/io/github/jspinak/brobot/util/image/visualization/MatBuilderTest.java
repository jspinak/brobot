...
/**
 * Test class for MatBuilder - builder pattern for creating OpenCV Mat objects.
 * Tests various Mat creation scenarios in mock mode.
 */
...
public class MatBuilderTest extends BrobotTestBase {
    ...
    class SubMatOperations {
        ...
        void shouldAddHorizontalSubmats() {
            ...
            Mat result = matBuilder
                .addHorizontalSubmats(mat1, mat2)
                .build();
        ...
        void shouldAddVerticalSubmatsFromList() {
            List<Mat> mats = Arrays.asList(
                new Mat(20, 40, CV_8UC1),
                new Mat(20, 40, CV_8UC1)
            );
            
            Mat result = matBuilder
                .addVerticalSubmats(mats)
                .build();
        ...
        void shouldConcatSubmatsHorizontally() {
            List<Mat> submats = Arrays.asList(
            ...
            Mat result = matBuilder
                .concatSubmatsHorizontally(submats)
                .build();
        ...
        void shouldConcatSubmatsVertically() {
            ...
            Mat result = matBuilder
                .concatSubmatsVertically(submats)
                .build();

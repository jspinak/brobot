...
public class ConditionalActionWrapperTest extends BrobotTestBase {
    ...
    class FindAndClickOperations {
        ...
        public void testFindAndClickStateImage() {
            try (MockedStatic<ConditionalActionChain> chainMock = mockStatic(ConditionalActionChain.class)) {
                ...
                chainMock.when(() -> ConditionalActionChain.find(any(PatternFindOptions.class)))
    ...
    class ChainBuilderTests {
        ...
        public void testSimpleChain() {
            try (MockedStatic<ConditionalActionChain> chainMock = mockStatic(ConditionalActionChain.class)) {
                ...
                ActionResult result = wrapper.createChain()
                    .find(mockStateImage)

...
/**
 * Performance benchmark utility for measuring test execution times
 * and tracking performance metrics.
 */
public class PerformanceBenchmark {
    
    private static final Map<String, List<BenchmarkResult>> benchmarkResults = new ConcurrentHashMap<>();
    ...
    private static void recordResult(String name, long durationNanos) {
        ...
        if (threshold != null) {
            ...
            if (!threshold.isWithinError(durationMillis)) {
                System.err.printf("PERFORMANCE ERROR: %s took %d ms (threshold: %d ms)%n",
    ...
    public static class BenchmarkStatistics {
        ...
        public BenchmarkStatistics(String name, List<BenchmarkResult> results) {
            ...
            if (count % 2 == 0) {
                ...
                this.medianMillis = TimeUnit.NANOSECONDS.toMillis(durations.get(count / 2)) / 1000.0;
            }
        ...
        public String toString() {
            return String.format(
                ...
                name, count, avgMillis / 1000.0, minMillis, maxMillis, medianMillis, stdDevMillis
            );
        }

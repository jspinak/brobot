...
/**
 * Unit tests for MatchFilter utility class.
 * Tests various filtering operations on match collections.
 */
...
public class MatchFilterTest extends BrobotTestBase {
    ...
    class CustomFilters {
        ...
        public void testCustomFilter() {
            ...
            List<Match> filtered = MatchFilter.byPredicate(testMatches, 
                m -> m.getName() != null && m.getName().contains("1"));
    ...
    class EdgeCases {
        ...
        public void testMatchesWithNullProperties() {
            Match nullMatch = new Match.Builder()
    ...
    class AdditionalFilters {
        ...
        public void testUniqueByStateObject() {
            ...
            Match duplicate = new Match.Builder()

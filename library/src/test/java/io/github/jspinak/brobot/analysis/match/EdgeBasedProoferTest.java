...
/**
 * Comprehensive test suite for EdgeBasedProofer.
 * Tests edge-based validation of matches within search regions.
 */
...
public class EdgeBasedProoferTest extends BrobotTestBase {
    ...
    class BasicEdgeValidation {
        ...
        void shouldAcceptMatchWithAllCornersInRegion() {
            ...
            boolean isValid = edgeBasedProofer.isInSearchRegions(match, 
                Collections.singletonList(searchRegion));
    ...
    class MultipleRegionSpanning {
        ...
        void shouldAcceptMatchInGapIfCornersInRegions() {
            ...
            assertTrue(isValid, "Match with corners in regions should be valid even if center is in gap");
        }
    }
    ...
    class CornerPositionCalculations {
        ...
        void shouldHandleMatchAtRegionBoundary() {
            ...
            boolean exactValid = edgeBasedProofer.isInSearchRegions(exactMatch, 
                Collections.singletonList(searchRegion));
            // This may fail as bottom-right corner at (200,200) is outside region ending at (199,199)

...
/**
 * Comprehensive tests for ActionVisualizer class. Tests drawing operations for matches, clicks,
 * drags, and regions using real Mat operations.
 */
public class ActionVisualizerTest extends BrobotTestBase {
    ...
    class RectangleDrawingTests {
        ...
        public void testDrawRectWithPadding() {
            Match match = new Match.Builder().setRegion(100, 100, 50, 50).build();
        ...
        public void testDrawRectAtOrigin() {
            Match match = new Match.Builder().setRegion(0, 0, 20, 20).build();
    ...
    class PointDrawingTests {
        ...
        public void testDrawPoint() {
            Match match = new Match.Builder().setRegion(480, 380, 40, 40).build();
    ...
    class ClickVisualizationTests {
        ...
        public void testDrawClick() {
            ...
            double sum =
                    sumElems(matchesOnSceneMat).get(0)
    ...
    class ArrowDrawingTests {
        ...
        public void testDrawArrowSameLocation() {
            ...
            assertDoesNotThrow(
                    () -> actionVisualizer.drawArrow(testMat, location, location, color));
        }
    }
    ...
    class DefinedRegionTests {
        ...
        public void testDrawDefinedRegion() {
            ...
            verify(mockDrawRect)
                    .drawRectAroundRegion(
                            eq(sceneMat),
                            any(io.github.jspinak.brobot.model.element.Region.class),
                            any(Scalar.class));
    ...
    private Match createMatchWithTarget(int x, int y) {
        ...
        Match match = new Match.Builder().setRegion(x - 10, y - 10, 20, 20).build();

...
/**
 * Comprehensive test suite for @State annotation.
 * Tests annotation attributes, inheritance, Spring integration, and runtime behavior.
 */
...
public class StateAnnotationTest extends BrobotTestBase {
    ...
    @State(initial = true, profiles = {"test", "dev"})
    ...
    class SpringIntegrationTests {
        ...
        void shouldMakeClassSpringComponent() {
            ...
            boolean hasComponent = AnnotationUtils.findAnnotation(SimpleState.class, Component.class) != null;
    ...
    class AnnotationValidationTests {
        ...
        void shouldValidateAnnotationTarget() {
            ...
            for (Method method : methods) {
                assertFalse(method.isAnnotationPresent(State.class),
    ...
    class DocumentationTests {
        ...
        void shouldHaveProperAnnotationType() {
            ...
            assertEquals("io.github.jspinak.brobot.annotations.State", 
                State.class.getName());
        }

...
/**
 * Comprehensive tests for the EmptyMatch class which represents the absence of a match 
 * in the Brobot model-based GUI automation framework.
 */
...
public class EmptyMatchTest extends BrobotTestBase {
    ...
    void testBuilderWithCustomName() {
        // When
        Match match = new EmptyMatch.Builder()
            .setName("custom empty match")
            .build();
    ...
    void testScoreAlwaysZero() {
        ...
        Match match2 = new EmptyMatch.Builder()
            .setName("test")
            .setRegion(new Region(100, 100, 100, 100))
            .build();
        Match match3 = new EmptyMatch.Builder()
            .setSearchImage(testImage)
            .setScene(testScene)
            .build();
    ...
    Stream<DynamicTest> testNullObjectPattern() {
        return Stream.of(
            dynamicTest("Can be used in collections", () -> {
                EmptyMatch emptyMatch = new EmptyMatch();
            ...
            dynamicTest("Can be compared without null checks", () -> {
                EmptyMatch emptyMatch = new EmptyMatch();
            ...
            dynamicTest("Can access all properties safely", () -> {
                EmptyMatch emptyMatch = new EmptyMatch();
            ...
            dynamicTest("Can be used as default value", () -> {
    ...
    void testDebuggingContext() {
        ...
        Match failedMatch = new EmptyMatch.Builder()
    ...
    void testEmptyMatchComparison() {
        ...
        Match configured1 = new EmptyMatch.Builder()
            .setName("empty1")
            .build();
        Match configured2 = new EmptyMatch.Builder()
            .setName("empty1")
            .build();

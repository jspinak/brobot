...
/**
 * Comprehensive test suite for Pair - generic immutable container for two values.
 * Tests immutability, equality, factory methods, and various use cases.
 */
...
public class PairTest extends BrobotTestBase {
    ...
    class HashCodeTests {
        ...
        public void testHashCodeDistribution() {
            ...
            // Should have reasonable distribution (Objects.hash produces ~3000 unique values for this test)
    ...
    class TypeSafety {
        ...
        public void testWildcardTypes() {
            Pair<? extends Number, ? extends CharSequence> wildcardPair = 
                Pair.of(42, "text");
    ...
    public void testParameterizedEquality(Pair<?, ?> pair1, Pair<?, ?> pair2, boolean shouldBeEqual) {
        if (shouldBeEqual) {
            assertEquals(pair1, pair2);
        } else {
            assertNotEquals(pair1, pair2);

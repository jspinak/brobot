...
/**
 * Comprehensive test suite for the Click action. Tests all aspects of click functionality
 * including: - Single and multiple clicks - Different click options - Various object types
 * (locations, regions, matches) - Edge cases and error handling - Performance characteristics in
 * mock mode
 */
...
public class ClickComprehensiveTest extends BrobotTestBase {
    ...
    private void setupMockClick() {
        ...
        org.mockito.Mockito.doAnswer(
                        invocation -> {
                            ...
                            for (StateLocation stateLoc : collection.getStateLocations()) {
                                ...
                                if (stateLoc.getOwnerStateName() != null) {
                                    io.github.jspinak.brobot.model.state.StateObjectMetadata
                                            metadata =
                                                    new io.github.jspinak.brobot.model.state
                                                            .StateObjectMetadata();
                ...
                .when(click)
                .perform(
                        org.mockito.Mockito.any(ActionResult.class),
    ...
    class ClickOptionsTests {
        ...
        void testMultipleClicks(int numberOfClicks) {
            ...
            ClickOptions options =
                    new ClickOptions.Builder().setNumberOfClicks(numberOfClicks).build();
    ...
    class MixedObjectTypes {
        ...
        void testMixedLocationsAndRegions() {
            ...
            assertTrue(actionResult.isSuccess());
            assertEquals(
                    2, actionResult.getMatchList().size(), "Should click both location and region");
        }
    }
    ...
    class PerformanceTests {
        ...
        void testMockModePerformance() {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                StateLocation stateLoc = new StateLocation.Builder().setLocation(loc).build();
                locations.add(stateLoc);
            }
        ...
        void testPerformanceScaling(int numberOfLocations, int maxDurationMs) {
            ...
            assertTrue(
                    ...
                    String.format(
                            "Should complete %d clicks in < %dms, was: %dms",
    ...
    class ErrorHandling {
        ...
        void testInvalidLocations() {
            ...
            StateLocation stateLocation =
                    new StateLocation.Builder().setLocation(invalidLocation).build();

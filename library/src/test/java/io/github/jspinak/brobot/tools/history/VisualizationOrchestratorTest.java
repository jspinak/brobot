 ...
 * Verifies illustration orchestration and drawing coordination.
 */
public class VisualizationOrchestratorTest extends BrobotTestBase {
    
    @Mock
    private AnalysisSidebar mockSidebar;
    
    @Mock
    private HistoryFileNamer mockFileNamer;
    
    @Mock
    private DrawMatch mockDrawMatch;
    
    @Mock
    private DrawRect mockDrawRect;
    
    @Mock
    private DrawClassesLegend mockDrawClassesLegend;
    ...
    @Mock
    private DrawContours mockDrawContours;
    
    @Mock
    private Visualization mockVisualization;
    
    @Mock
    private SceneAnalysis mockSceneAnalysis;
    
    @Mock
    private SceneAnalyses mockSceneAnalysisCollection;
    ...
    public void setupTest() {
        ...
        orchestrator = new VisualizationOrchestrator(
            mockSidebar, mockFileNamer, mockDrawMatch, mockDrawRect,
            mockDrawClassesLegend, mockImageUtils, mockActionVisualizer, mockDrawContours
        );
    }
    ...
    class BasicDrawingTests {
        ...
        public void testDrawSingleScene() {
            ...
            when(mockVisualization.getFinishedMats()).thenReturn(Collections.singletonList(new Mat()));
            when(mockVisualization.getFilenames()).thenReturn(Collections.singletonList("test.png"));
            
            // Execute
            orchestrator.draw(result, searchRegions, config);
            
            // Verify drawing sequence
            verify(mockDrawRect).drawRectAroundMatch(eq(mockVisualization), eq(searchRegions), any(Scalar.class));
    ...
    class SearchRegionDrawingTests {
        ...
        public void testDrawSearchRegionsInBlue() {
            ActionResult result = createActionResultWithScene();
            List<Region> searchRegions = Arrays.asList(
            ...
            verify(mockDrawRect).drawRectAroundMatch(
    ...
    private ActionResult createActionResultWithScene() {
        ActionResult result = new ActionResult();
        result.setSceneAnalysisCollection(mockSceneAnalysisCollection);
        result.setMatchList(Arrays.asList(

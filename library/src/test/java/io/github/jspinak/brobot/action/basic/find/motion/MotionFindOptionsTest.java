...
/**
 * Test suite for MotionFindOptions following Brobot testing guidelines. All tests extend
 * BrobotTestBase for proper mock mode and CI/CD compatibility.
 */
...
public class MotionFindOptionsTest extends BrobotTestBase {
    ...
    class MaxMovementTests {
        ...
        void shouldSetMaxMovement() {
            MotionFindOptions options = builder.setMaxMovement(600).build();
        ...
        void shouldHandleEdgeCaseValues() {
            // Zero movement
            MotionFindOptions zeroMovement = builder.setMaxMovement(0).build();
            assertEquals(0, zeroMovement.getMaxMovement());

            // Large movement
            MotionFindOptions largeMovement = builder.setMaxMovement(10000).build();
            assertEquals(10000, largeMovement.getMaxMovement());

            // Negative movement (edge case - implementation dependent)
            MotionFindOptions negativeMovement = builder.setMaxMovement(-100).build();
    ...
    class InheritedFeaturesTests {
        ...
        void shouldInheritSimilarity() {
            MotionFindOptions options = builder.setSimilarity(0.95).build();
        ...
        void shouldInheritSearchDuration() {
            MotionFindOptions options = builder.setSearchDuration(10.0).build();
        ...
        void shouldInheritCaptureImage() {
            MotionFindOptions options = builder.setCaptureImage(false).build();
        ...
        void shouldInheritSearchRegions() {
            ...
            MotionFindOptions options = builder.setSearchRegions(searchRegions).build();
        ...
        void shouldInheritMaxMatchesToActOn() {
            MotionFindOptions options = builder.setMaxMatchesToActOn(5).build();
        ...
        void shouldInheritUseDefinedRegion() {
            MotionFindOptions options = builder.setUseDefinedRegion(true).build();
        ...
        void shouldInheritMatchAdjustmentOptions() {
            MatchAdjustmentOptions matchAdjustment =
            ...
            MotionFindOptions options = builder.setMatchAdjustment(matchAdjustment).build();

            assertNotNull(options.getMatchAdjustmentOptions());
            assertNotNull(options.getMatchAdjustmentOptions().getTargetPosition());
            assertEquals(
                    0.5,
                    options.getMatchAdjustmentOptions().getTargetPosition().getPercentW(),
                    0.001);
            assertEquals(
                    0.5,
                    options.getMatchAdjustmentOptions().getTargetPosition().getPercentH(),
                    0.001);
    ...
    class StrategyTests {
        ...
        void shouldAlwaysReturnMotionStrategy() {
            ...
            MotionFindOptions customOptions = builder.setMaxMovement(0).setSimilarity(1.0).build();

...
class FindTest extends BrobotTestBase {
    ...
    class FindStrategyTests {
        ...
        void testPatternBasedStrategies(PatternFindOptions.Strategy strategy) {
            ...
            PatternFindOptions options =
                    new PatternFindOptions.Builder().setStrategy(strategy).build();
            ...
            // Assert
            ArgumentCaptor<BaseFindOptions> optionsCaptor =
                    ArgumentCaptor.forClass(BaseFindOptions.class);
            verify(findPipeline)
                    .execute(optionsCaptor.capture(), eq(actionResult), eq(objectCollection));
    ...
    class AdvancedFindOptions {
        ...
        void testTextFindOptions() {
            // Arrange
            TextFindOptions textOptions = new TextFindOptions.Builder().build();
        ...
        void testHistogramFindOptions() {
            // Arrange
            HistogramFindOptions histOptions = new HistogramFindOptions.Builder().build();
    ...
    class PatternMatchingOptions {
        ...
        void testSearchRegions() {
            ...
            StateRegion stateRegion =
                    new StateRegion.Builder().setSearchRegion(searchRegion).build();
    ...
    class ObjectCollectionHandling {
        ...
        void testStateImagesHandling() {
            // Arrange
            StateImage stateImage1 = new StateImage.Builder().setName("test1").build();
            StateImage stateImage2 = new StateImage.Builder().setName("test2").build();
        ...
        void testExistingActionResultsHandling() {
            // Arrange
            Match match1 = new Match.Builder().setRegion(new Region(0, 0, 100, 100)).build();
            Match match2 = new Match.Builder().setRegion(new Region(200, 200, 100, 100)).build();
            ...
            result2.add(match2);
            when(objectCollection.getMatches()).thenReturn(Arrays.asList(result1, result2));
            ActionResult actionResult = new ActionResult(patternFindOptions);
        ...
        void testStateLocationsHandling() {
            ...
            StateLocation location2 =
                    new StateLocation.Builder().setLocation(new Location(200, 200)).build();
    ...
    class ErrorHandlingAndEdgeCases {
        ...
        void testNullActionResult() {
            assertThrows(NullPointerException.class, () -> find.perform(null, objectCollection));
        }
        ...
        void testPipelineException() {
            ...
            // Act & Assert
            assertThrows(
                    RuntimeException.class, () -> find.perform(actionResult, objectCollection));
        }
    }
    ...
    class PerformanceOptimization {
        ...
        void testSearchTimeLimits() {
            // Arrange
            PatternFindOptions options =
                    new PatternFindOptions.Builder().setSearchDuration(2.5).build();
            ActionResult actionResult = new ActionResult(options);

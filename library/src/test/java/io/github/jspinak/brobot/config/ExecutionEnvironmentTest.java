...
/**
 * Comprehensive test suite for ExecutionEnvironment. Tests environment detection, mock mode, and
...
public class ExecutionEnvironmentTest extends BrobotTestBase {
    ...
    class SingletonManagement {
        ...
        void shouldAllowSettingNewInstance() {
            ...
            ExecutionEnvironment newInstance =
                    ExecutionEnvironment.builder().mockMode(true).build();
    ...
    class DisplayDetection {
        ...
        void shouldDetectDisplayWhenNotHeadless() {
            ...
            try {
                ...
                ExecutionEnvironment env =
                        ExecutionEnvironment.builder().mockMode(false).forceHeadless(false).build();
                ...
                if (originalTestMode != null)
                    System.setProperty("brobot.test.mode", originalTestMode);
                if (originalTestType != null)
                    System.setProperty("brobot.test.type", originalTestType);
            }
        }
        ...
        void shouldRefreshDisplayCacheOnDemand() {
            ...
            try {
                ...
                ExecutionEnvironment env =
                        ExecutionEnvironment.builder().forceHeadless(true).build();

                // Initial check
                assertFalse(env.hasDisplay());

                // Change configuration
                env = ExecutionEnvironment.builder().forceHeadless(false).build();
        ...
        void shouldRespectForceHeadlessSetting(boolean forceHeadless) {
            ...
            try {
                ...
                ExecutionEnvironment env =
                        ExecutionEnvironment.builder().forceHeadless(forceHeadless).build();
    ...
    class SikuliXIntegration {
        ...
        void shouldSkipSikuliXWhenNoDisplay() {
            ExecutionEnvironment env =
                    ExecutionEnvironment.builder().mockMode(false).forceHeadless(true).build();
    ...
    class ScreenCaptureConfiguration {
        ...
        void shouldSkipScreenCaptureWhenDisabled() {
            ExecutionEnvironment env =
                    ExecutionEnvironment.builder().allowScreenCapture(false).build();
    ...
    class BuilderPattern {
        ...
        void shouldCreateIndependentInstances() {
            ExecutionEnvironment env1 = ExecutionEnvironment.builder().mockMode(true).build();

            ExecutionEnvironment env2 = ExecutionEnvironment.builder().mockMode(false).build();
    ...
    class LoggingConfiguration {
        ...
        void shouldConfigureVerboseLogging() {
            ...
            ExecutionEnvironment env = ExecutionEnvironment.builder().verboseLogging(false).build();
        ...
        void shouldEnableVerboseLoggingViaBuilder() {
            ExecutionEnvironment env = ExecutionEnvironment.builder().verboseLogging(true).build();
    ...
    class EdgeCases {
        ...
        void shouldHandleEnvironmentChanges() {
            ...
            try {
                ...
                env = ExecutionEnvironment.builder().mockMode(false).forceHeadless(false).build();
                ExecutionEnvironment.setInstance(env);
        ...
        void shouldHandleMockModeTransition() {
            ...
            env = ExecutionEnvironment.builder().mockMode(true).build();
            ExecutionEnvironment.setInstance(env);

...
public class ScreenshotCaptureTest extends BrobotTestBase {
    ...
    void shouldSaveScreenshotWithDate() {
        ...
        verify(saveToFile, times(1)).saveImageWithDate(any(Image.class), eq("testScreenshot"));
    }
    ...
    void shouldSaveScreenshotWithEmptyName() {
        ...
        verify(saveToFile, times(1)).saveImageWithDate(any(Image.class), eq(""));
    }
    ...
    void shouldSaveScreenshotWithNullName() {
        ...
        verify(saveToFile, times(1)).saveImageWithDate(any(Image.class), isNull());
    }
    ...
    void shouldHandleSaveFailure() {
        ...
        when(saveToFile.saveImageWithDate(any(Image.class), anyString())).thenReturn(null);

        // Should not throw exception even if save fails
        assertDoesNotThrow(() -> screenshotCapture.saveScreenshotWithDate("failedSave"));

        verify(saveToFile, times(1)).saveImageWithDate(any(Image.class), eq("failedSave"));
    }
    ...
    void shouldCaptureScreenshot() throws Exception {
        ...
        assertDoesNotThrow(() -> screenshotCapture.captureScreenshot(filename));
    }
    ...
    void shouldHandleInvalidPath() {
        ...
        assertDoesNotThrow(() -> screenshotCapture.captureScreenshot(invalidPath));
    }
    ...
    void shouldHandleNullFilename() {
        ...
        assertDoesNotThrow(() -> screenshotCapture.captureScreenshot(null));
    }
    ...
    void shouldSaveMultipleScreenshots() {
        ...
        verify(saveToFile, times(5)).saveImageWithDate(any(Image.class), anyString());
    }
    ...
    void shouldHandleLongFilenames() {
        ...
        assertDoesNotThrow(() -> screenshotCapture.saveScreenshotWithDate(longName));

        verify(saveToFile).saveImageWithDate(any(Image.class), eq(longName));
    }
    ...
    void shouldHandleRelativePaths() {
        ...
        assertDoesNotThrow(() -> screenshotCapture.captureScreenshot(relativePath));
    }
}

...
/**
 * Comprehensive tests for ReactiveAutomator class.
 * Tests continuous state monitoring, transition execution, and error handling.
 */
public class ReactiveAutomatorTest extends BrobotTestBase {
    
    @Mock
    private StateDetector mockStateDetector;
    
    @Mock
    private StateTransitionStore mockStateTransitionStore;
    ...
    public void setupTest() {
        ...
        reactiveAutomator = new ReactiveAutomator(
            mockStateDetector,
    ...
    class StartStopTests {
        ...
        public void testStartAutomation() {
            ...
            verify(mockMonitoringService).startContinuousTask(
                taskCaptor.capture(),
    ...
    class AutomationLoopTests {
        ...
        public void setupCapture() {
            ...
            doAnswer(invocation -> {
                ...
                return null;
            }).when(mockMonitoringService).startContinuousTask(any(), any(), anyLong());
        }
        ...
        public void testNoExecutionWhenNotRunning() {
            ...
            reactiveAutomator.start();
            verify(mockMonitoringService).startContinuousTask(
                taskCaptor.capture(), any(), anyLong()
            );
    ...
    class IntegrationTests {
        ...
        public void testMonitoringServiceIntegration() {
            ...
            doAnswer(invocation -> {
                ...
                new Thread(() -> {
                    while (condition.getAsBoolean() && executionCount.get() < 3) {
                        task.run();
        ...
        public void testSearchIntervalConfiguration() {
            ...
            verify(mockMonitoringService).startContinuousTask(
                any(), any(), intervalCaptor.capture()
            );

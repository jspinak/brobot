 ...
 * 
 * Usage:
 * - Add @Benchmark to individual test methods
 * - Add @ExtendWith(BenchmarkExtension.class) to test class
 * - Or use @Benchmark at class level to benchmark all tests
 */
public class BenchmarkExtension implements BeforeTestExecutionCallback, AfterTestExecutionCallback {
    ...
    public void afterTestExecution(ExtensionContext context) {
        if (shouldBenchmark(context)) {
            Instant startTime = context.getStore(ExtensionContext.Namespace.create(getClass()))
    ...
    private void recordBenchmark(ExtensionContext context, long durationNanos) {
        ...
        String benchmarkName = benchmark.name().isEmpty() 

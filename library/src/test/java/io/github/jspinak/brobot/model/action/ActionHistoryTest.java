...
/**
 * Comprehensive test suite for ActionHistory - maintains historical match data for pattern
 * learning. Tests snapshot management, mock execution support, and statistical tracking.
 */
...
public class ActionHistoryTest extends BrobotTestBase {
    ...
    class BasicStatistics {
        ...
        public void testSuccessRate() {
            ...
            double successRate =
                    (double) actionHistory.getTimesFound() / actionHistory.getTimesSearched();
    ...
    class RandomSnapshotSelection {
        ...
        public void testGetRandomSnapshotMultipleStates() {
            ...
            Optional<ActionRecord> snapshot =
                    actionHistory.getRandomSnapshot(findOptions, 1L, 2L, 3L);
    ...
    class MatchListAndText {
        ...
        public void testGetRandomMatchList() {
            ...
            multiMatchRecord.setActionConfig(
                    new PatternFindOptions.Builder()
                            .setStrategy(PatternFindOptions.Strategy.ALL)
                            .build());

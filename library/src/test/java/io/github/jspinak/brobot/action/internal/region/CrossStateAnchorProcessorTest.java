...
class CrossStateAnchorProcessorTest extends BrobotTestBase {
    ...
    @Mock private AnchorRegion anchorRegion;

    @Mock private DefineInsideAnchors defineInsideAnchors;

    @Mock private DefineOutsideAnchors defineOutsideAnchors;
    ...
    public void setupTest() {
        ...
        processor =
                new CrossStateAnchorProcessor(
                        stateStore, anchorRegion, defineInsideAnchors, defineOutsideAnchors);
    }
    ...
    void testProcessAnchors_ValidConfiguration() {
        ...
        Match match = new Match.Builder().setRegion(new Region(60, 60, 20, 20)).build();
    ...
    void testProcessAnchors_OutsideAnchorsStrategy() {
        Region originalRegion = new Region(0, 0, 200, 200);
        CrossStateAnchor anchor = mock(CrossStateAnchor.class);
        Match match = new Match.Builder().setRegion(new Region(30, 30, 40, 40)).build();
    ...
    void testProcessAnchors_MultipleAnchors() {
        ...
        Match match1 = new Match.Builder().setRegion(new Region(10, 10, 20, 20)).build();

        Match match2 = new Match.Builder().setRegion(new Region(100, 100, 50, 50)).build();

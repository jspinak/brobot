...
public class SceneCombinationGeneratorTest extends BrobotTestBase {
    ...
    public void setupTest() {
        super.setupTest();
        sceneCombinationGenerator = new SceneCombinationGenerator(findDynamicPixelMatches, actionResultFactory);
    ...
    void shouldGenerateAllCombinationsForTwoCollections() {
        ...
        when(actionResultFactory.init(any(), anyString(), any()))
    ...
    void shouldFindSceneCombinationWithDifferentScenes() {
        ...
        try {
            ...
            SceneCombination result = sceneCombinationGenerator.getSceneCombinationWithDifferentScenes(combinations);

...
/**
 * Validates and fixes common serialization issues in test objects.
 * Provides diagnostic information about what fields are missing or problematic.
 */
public class SerializationTestValidator {
    ...
    /**
     * Validates that an object can be serialized and deserialized.
    ...
    public <T> T fixCommonIssues(T object) {
        ...
        if (object instanceof io.github.jspinak.brobot.model.action.ActionRecord) {
            ...
            if (record.getActionConfig() == null) {
                record.setActionConfig(new io.github.jspinak.brobot.action.basic.find.PatternFindOptions.Builder().build());
            }
        }
        ...
        try {
            ...
            if (targetClass == io.github.jspinak.brobot.model.action.ActionRecord.class) {
                ...
                if (!node.has("actionConfig")) {
                    ...
                    config.put("@class", "io.github.jspinak.brobot.action.basic.find.PatternFindOptions");
                }
            }
    ...
    public static class ValidationReport {
        ...
        public boolean isDeserializable() { return deserializable; }
        public void setDeserializable(boolean deserializable) { this.deserializable = deserializable; }
        
        public String getSerializedJson() { return serializedJson; }
        public void setSerializedJson(String json) { this.serializedJson = json; }

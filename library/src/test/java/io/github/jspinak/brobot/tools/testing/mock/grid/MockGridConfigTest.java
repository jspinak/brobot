...
public class MockGridConfigTest extends BrobotTestBase {
    ...
    class ConfigurationTests {
        ...
        public void testValidatesPositiveDimensions() {
            assertThrows(IllegalArgumentException.class, () -> MockGridConfig.setDefaultGrid(0, 3));
            assertThrows(IllegalArgumentException.class, () -> MockGridConfig.setDefaultGrid(3, 0));
            assertThrows(
                    IllegalArgumentException.class, () -> MockGridConfig.setDefaultGrid(-1, 3));
        }

...
/** Unit tests for ImageFinder class. Tests various image finding strategies and operations. */
@DisplayName("ImageFinder Tests")
@DisabledInCI
public class ImageFinderTest extends BrobotTestBase {

    @Mock private DefinedRegionConverter mockDefinedRegionConverter;
    @Mock private ActionLifecycleManagement mockActionLifecycleManagement;
    @Mock private SceneProvider mockSceneProvider;
    @Mock private IterativePatternFinder mockIterativePatternFinder;
    @Mock private FindImage mockLegacyFindImage;
    ...
    class FindBestStrategy {
        ...
        public void testFindBest() {
            // Arrange
            StateImage stateImage = new StateImage.Builder().setName("image").build();
    ...
    class LegacyDelegation {
        ...
        public void testParametersPassedUnmodified() {
            ...
            // Assert
            verify(mockLegacyFindImage).findAll(same(actionResult), same(collections));
        }
    }
}

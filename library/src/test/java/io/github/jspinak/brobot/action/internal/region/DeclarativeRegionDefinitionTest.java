...
/**
 * Tests for the declarative region definition feature introduced in Brobot 1.1.0. Tests
 * SearchRegionOnObject configuration and basic functionality.
 */
...
class DeclarativeRegionDefinitionTest extends BrobotTestBase {
    ...
    void setUp() {
        ...
        baseImage =
                new StateImage.Builder()
                        .setName("BaseImage")
                        .addPattern(new Pattern.Builder().setFilename("base.png").build())
                        .build();
    }
    ...
    class BasicDeclarativeRegionTests {
        ...
        void testBasicSearchRegionOnObject() {
            ...
            SearchRegionOnObject searchRegionConfig =
                    ...
                    new StateImage.Builder()
                            ...
                            .setSearchRegionOnObject(
                                    SearchRegionOnObject.builder()
                                            ...
                                            .setTargetObjectName("BaseImage")
                                            .build())
                            .addPattern(new Pattern.Builder().setFilename("dependent.png").build())
                            .build();

            // Verify SearchRegionOnObject is set
            assertNotNull(dependentImage.getSearchRegionOnObject());
            assertEquals(
                    "BaseImage", dependentImage.getSearchRegionOnObject().getTargetObjectName());
            assertEquals(
                    StateObject.Type.IMAGE,
                    dependentImage.getSearchRegionOnObject().getTargetType());
        }
    ...
    class CrossStateDependencyTests {
        ...
        void testCrossStateDependencies() {
            ...
            StateImage crossStateDependentImage =
                    new StateImage.Builder()
            ...
            assertEquals(
                    "AnotherState",
                    crossStateDependentImage.getSearchRegionOnObject().getTargetStateName());
            assertEquals(
                    "AnotherImage",
                    crossStateDependentImage.getSearchRegionOnObject().getTargetObjectName());
        }
    }
    ...
    class ComplexDependencyChainTests {
        ...
        void testComplexAdjustmentChains() {
            ...
            assertEquals(
                    "BaseImage", firstDependent.getSearchRegionOnObject().getTargetObjectName());

            assertNotNull(secondDependent.getSearchRegionOnObject());
            assertEquals(
                    "FirstDependent",
                    secondDependent.getSearchRegionOnObject().getTargetObjectName());
        }
        ...
        void testMultipleDependentsOnSameTarget() {
            ...
            for (int i = 0; i < dependents.size(); i++) {
                ...
                assertEquals(
                        "BaseImage", dependent.getSearchRegionOnObject().getTargetObjectName());
                assertEquals(
                        i * 10, dependent.getSearchRegionOnObject().getAdjustments().getAddX());
                assertEquals(
                        i * 10, dependent.getSearchRegionOnObject().getAdjustments().getAddY());
            }
        }
    }
    ...
    class StateIntegrationTests {
        ...
        void testDeclarativeRegionsInState() {
            ...
            // Add to state
            testState =
                    new State.Builder("TestState").withImages(baseImage, dependentImage).build();
                    ...
                    new StateImage.Builder()
                            ...
                            .setSearchRegionOnObject(
                                    SearchRegionOnObject.builder()
                                            ...
                                            .build())
                            .addPattern(new Pattern.Builder().setFilename("dependent2.png").build())
                            .build();

            State state2 = new State.Builder("State2").withImages(dependentInState2).build();

...
/**
 * Analyzes captured images and patterns to debug matching issues. This test doesn't require a
 * display - it analyzes existing files.
 */
@DisabledInCI
        ...
        try {
            ...
            if (historyDir.exists() && historyDir.isDirectory()) {
                ...
                if (matchImages != null && matchImages.length > 0) {
                    ...
                    System.out.println(
                            "  Size: " + matchImg.getWidth() + "x" + matchImg.getHeight());
                    ...
                    System.out.println("\nSize Comparison:");
                    System.out.println(
                            "  Width ratio (match/pattern): " + String.format("%.3f", widthRatio));
                    System.out.println(
                            "  Height ratio (match/pattern): "

...
public class SikuliXDirectComparisonTest extends BrobotTestBase {
        ...
        try {
            ...
            System.out.println(
                    "   Loaded image: "
                            ...
                            + " type="
                            + getImageTypeName(patternImage.getType()));
    ...
    private void testWithSikuliXPattern(String patternPath) {
        ...
        try {
            ...
            if (internalImage != null) {
                System.out.println(
                        "   SikuliX loaded image: "
                                + internalImage.getWidth()
                                + "x"
                                + internalImage.getHeight()
                                + " type="
                                + getImageTypeName(internalImage.getType()));
            }
    ...
    public void compareImageLoadingMethods() {
        ...
        try {
            ...
            System.out.println(
                    "   Size: " + imageIOImage.getWidth() + "x" + imageIOImage.getHeight());
            ...
            System.out.println(
                    "   Size: " + sikuliImage.getWidth() + "x" + sikuliImage.getHeight());
            ...
            System.out.println(
                    "   Size: " + sikuliFromBI.getWidth() + "x" + sikuliFromBI.getHeight());
            ...
            System.out.println(
                    "   SikuliX(BufferedImage) pixel: " + String.format("0x%08X", pixel3));

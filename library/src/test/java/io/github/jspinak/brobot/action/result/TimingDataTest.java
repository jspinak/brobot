...
/**
 * Comprehensive test suite for TimingData - manages timing information for action execution. Tests
 * start/stop operations, duration calculations, and time segment management. Uses
 * ConcurrentTestBase for thread-safe parallel execution.
 */
...
public class TimingDataTest extends ConcurrentTestBase {
    ...
    class StartStopOperations {
        ...
        public void testStart() throws Exception {
            ...
            assertTrue(
                    timingData.getStartTime().isAfter(initialStart)
        ...
        public void testStop() throws Exception {
            ...
            assertTrue(
                    timingData.getEndTime().isAfter(timingData.getStartTime())
    ...
    class TimeSegmentManagement {
        ...
        public void testAddSegment() {
            timingData = new TimingData();
            TimingData.TimeSegment segment =
                    new TimeSegment("Find Operation", Duration.ofMillis(500));
        ...
        public void testGetSegmentByName() {
            ...
            TimeSegment retrieved =
                    timingData.getSegments().stream()
    ...
    class InstantBasedTiming {
        ...
        public void testElapsedWithInstant() throws Exception {
            ...
            boolean success =
                    waitFor(
                            () -> timingData.getElapsed().toMillis() >= 100,

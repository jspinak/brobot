...
/**
 * Enhanced test suite for StateTransitions to improve coverage.
 * Tests builder patterns, transition management, and utility methods.
 */
...
class StateTransitionsEnhancedTest extends BrobotTestBase {
    ...
    @Mock
    private BooleanSupplier mockSupplier;
    ...
    class BuilderPatternTests {
        ...
        void testCompleteBuilder() {
            ...
            // Act
            StateTransitions built = new StateTransitions.Builder("MainState")
        ...
        void testBuilderWithJavaStateTransition() {
            ...
            // Act
            StateTransitions built = new StateTransitions.Builder("TestState")
    ...
    class TransitionAdditionMethods {
        ...
        void testAddTaskSequenceStateTransition() {
            ...
            // Assert
            assertEquals(3, stateTransitions.getTransitions().size()); // One for each activated state
    ...
    class ActionDefinitionRetrieval {
        ...
        void testGetActionDefinitionForTransitionFinish() {
            ...
            // Act
            Optional<TaskSequence> result = stateTransitions.getActionDefinition(1L); // Same as state ID

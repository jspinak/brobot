...
public class ActionLoggingServiceTest extends BrobotTestBase {
    ...
    @Mock
    private ActionLogFormatter quietFormatter;
    
    @Mock
    private ActionLogFormatter normalFormatter;
    
    @Mock
    private ActionLogFormatter verboseFormatter;
    ...
    public void setUp() {
        ...
        List<ActionLogFormatter> formatters = Arrays.asList(
            quietFormatter, normalFormatter, verboseFormatter
        );
    ...
    void shouldUseCorrectFormatterForVerbosityLevel(ActionLogFormatter.VerbosityLevel level) {
        ...
        ActionLogFormatter expectedFormatter = switch (level) {
    ...
    void shouldHandleFormatterExceptions() {
        when(normalFormatter.shouldLog(actionResult)).thenReturn(true);
        when(normalFormatter.format(actionResult)).thenThrow(new RuntimeException("Test exception"));
    ...
    void shouldParseVerbosityConfig(String verbosityLevel) {
        ...
        ActionLogFormatter expectedFormatter = switch (verbosityLevel) {
            case "QUIET" -> quietFormatter;
            case "NORMAL" -> normalFormatter;
            case "VERBOSE" -> verboseFormatter;

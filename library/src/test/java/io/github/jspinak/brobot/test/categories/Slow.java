 ...
 *
 * <p>Slow tests: - Can be excluded during rapid development cycles - Should be run in CI/CD
 * pipelines - May involve file I/O, network calls, or complex computations
 *
 * <p>Can be combined with other categories:
 *
 * <pre>{@code
 * @Integration
 * @Slow

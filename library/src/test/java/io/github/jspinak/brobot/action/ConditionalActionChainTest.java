...
/**
 * Comprehensive test suite for ConditionalActionChain - conditional workflow execution. Tests
 * chaining, conditional logic, convenience methods, and control flow.
 */
...
class ConditionalActionChainTest extends BrobotTestBase {
    ...
    class SequentialChainingTests {
        ...
        void shouldExecuteSequentialActionsWithThen() {
            ...
            // When
            ConditionalActionChain chain =
                    ConditionalActionChain.find(findOptions).then(clickOptions);
        ...
        void shouldChainMultipleThenCalls() {
            ...
            // When
            ConditionalActionChain chain =
                    ConditionalActionChain.find(find1).then(click).then(find2);

            chain.perform(action, defaultCollection);

            // Then
            verify(action, times(2))
                    .perform(any(PatternFindOptions.class), any(ObjectCollection[].class));
        ...
        void shouldChainWithStateImageUsingThen() {
            // When
            ConditionalActionChain chain = ConditionalActionChain.find(stateImage).then(stateImage);
    ...
    class ConditionalExecutionTests {
        ...
        void shouldExecuteIfFoundWhenPreviousSucceeded() {
            ...
            // When
            ConditionalActionChain chain =
                    ConditionalActionChain.find(stateImage).ifFound(clickOptions);
        ...
        void shouldExecuteIfNotFoundWhenPreviousFailed() {
            ...
            // When
            ConditionalActionChain chain =
                    ConditionalActionChain.find(stateImage).ifNotFound(clickOptions);
        ...
        void shouldAlwaysExecuteWithAlways() {
            ...
            // When
            ConditionalActionChain chain =
                    ConditionalActionChain.find(stateImage).always(clickOptions);
    ...
    class ConvenienceMethodTests {
        ...
        void shouldAddClickAction() {
            // When
            ConditionalActionChain chain = ConditionalActionChain.find(stateImage).click();
        ...
        void shouldAddConditionalClickWithIfFoundClick() {
            ...
            // When
            ConditionalActionChain chain = ConditionalActionChain.find(stateImage).ifFoundClick();
        ...
        void shouldTypeText() {
            // When
            ConditionalActionChain chain =
                    ConditionalActionChain.find(stateImage).type("test text");
        ...
        void shouldScrollDown() {
            // When
            ConditionalActionChain chain = ConditionalActionChain.find(stateImage).scrollDown();

            chain.perform(action, defaultCollection);

            // Then
            ArgumentCaptor<ActionConfig> configCaptor = ArgumentCaptor.forClass(ActionConfig.class);
            verify(action, atLeast(2))
                    .perform(configCaptor.capture(), any(ObjectCollection[].class));
        ...
        void shouldScrollUp() {
            // When
            ConditionalActionChain chain = ConditionalActionChain.find(stateImage).scrollUp();
        ...
        void shouldHighlightElement() {
            // When
            ConditionalActionChain chain = ConditionalActionChain.find(stateImage).highlight();
        ...
        void shouldWaitForVanish() {
            ...
            // When
            ConditionalActionChain chain =
                    ConditionalActionChain.find(stateImage).waitVanish(vanishImage);
    ...
    class KeyboardActionTests {
        ...
        void shouldPressEscapeKey() {
            // When
            ConditionalActionChain chain = ConditionalActionChain.find(stateImage).pressEscape();

            chain.perform(action, defaultCollection);

            // Then
            verify(action, atLeast(1))
                    .perform(any(KeyDownOptions.class), any(ObjectCollection[].class));
            verify(action, atLeast(1))
                    .perform(any(KeyUpOptions.class), any(ObjectCollection[].class));
        }
        ...
        void shouldPressEnterKey() {
            // When
            ConditionalActionChain chain = ConditionalActionChain.find(stateImage).pressEnter();
        ...
        void shouldPressTabKey() {
            // When
            ConditionalActionChain chain = ConditionalActionChain.find(stateImage).pressTab();
        ...
        void shouldPressSpecificKey() {
            // When
            ConditionalActionChain chain =
                    ConditionalActionChain.find(stateImage).pressKey(KeyEvent.VK_SPACE);
        ...
        void shouldPressKeyCombination() {
            // When
            ConditionalActionChain chain =
                    ConditionalActionChain.find(stateImage)
        ...
        void shouldClearAndTypeText() {
            // When
            ConditionalActionChain chain =
                    ConditionalActionChain.find(stateImage).clearAndType("new text");
    ...
    class CustomHandlerTests {
        ...
        void shouldExecuteCustomHandlerOnSuccess() {
            ...
            // When
            ConditionalActionChain chain =
                    ConditionalActionChain.find(stateImage).ifFoundDo(handler);
        ...
        void shouldExecuteCustomHandlerOnFailure() {
            ...
            // When
            ConditionalActionChain chain =
                    ConditionalActionChain.find(stateImage).ifNotFoundDo(handler);
        ...
        void shouldExecuteChainHandlerOnSuccess() {
            ...
            // When
            ConditionalActionChain chain =
                    ConditionalActionChain.find(stateImage).ifFound(chainHandler);
    ...
    class ControlFlowTests {
        ...
        void shouldThrowErrorWhenConfigured() {
            // When/Then
            ConditionalActionChain chain =
                    ConditionalActionChain.find(stateImage).throwError("Test error");

            assertThrows(RuntimeException.class, () -> chain.perform(action, defaultCollection));
        }
    ...
    class ComplexWorkflowTests {
        ...
        void shouldExecuteLoginWorkflow() {
            ...
            // Then
            verify(action, atLeast(4))
                    .perform(any(PatternFindOptions.class), any(ObjectCollection[].class));
            verify(action, atLeast(3))
                    .perform(any(ClickOptions.class), any(ObjectCollection[].class));
                    ...
                    ConditionalActionChain.find(stateImage)
                            .ifNotFound(
                                    new PatternFindOptions.Builder()
                                            .build()) // Try again if first fails
        ...
        void shouldExecuteMultiBranchWorkflow() {
            ...
            // When
            ConditionalActionChain chain =
                    ConditionalActionChain.find(primaryButton)
                            .ifFoundClick()
            ...
            // Then - Only one find is executed since find fails and ifNotFoundLog doesn't add
            // another find

...
public class ActionSuccessCriteriaTest extends BrobotTestBase {
    ...
    class AlwaysSucceedActions {
        ...
        @EnumSource(
                value = ActionType.class,
                names = {"SCROLL_MOUSE_WHEEL", "MOUSE_DOWN", "MOUSE_UP", "KEY_DOWN", "KEY_UP"})
    ...
    class ComplexSuccessScenarios {
        ...
        public void testChainOfCriteria() {
            ...
            Predicate<ActionResult> complexCriteria =
                    result ->
                            !result.isEmpty()
                                    && result.size() > 2
                                    && result.getDuration().toMillis() < 5000;

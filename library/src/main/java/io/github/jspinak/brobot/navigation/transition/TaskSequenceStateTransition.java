 ...
 * 
 * <p>TaskSequenceStateTransition represents transitions defined declaratively through 
 * TaskSequence objects. This implementation enables configuration-based state navigation 
 ...
 * <ol>
 *   <li>TaskSequence steps are executed sequentially</li>
 ...
 * </p>
 * 
 * <p>In the model-based approach, TaskSequenceStateTransition enables a declarative 
...
public class TaskSequenceStateTransition implements StateTransition {
    ...
    public String toString() {
        return "TaskSequenceStateTransition{" +
                ", activate=" + activate +
                ", exit=" + exit +
                '}';
    }

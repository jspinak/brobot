...
/**
 * Diagnostic tool to compare pattern matching between SikuliX and Brobot. This helps identify why
 * patterns match at 0.99 similarity in SikuliX IDE but only 50-69% in Brobot despite correct DPI
 * scaling.
 */
@Slf4j
@Component
public class SikuliXBrobotComparisonDiagnostic {
    ...
    private void compareLoadingMethods(Image brobotImage, String patternName) {
        ...
        try {
            ...
            log.info(
                    "  Type: {} ({})",
                    brobotBuffered.getType(),
                    getImageTypeName(brobotBuffered.getType()));
            ...
            log.info(
                    "  Type: {} ({})",
                    sikuliBuffered.getType(),
                    getImageTypeName(sikuliBuffered.getType()));
    ...
    private void testWithPureSikuliX(BufferedImage image, String patternName) {
        ...
        try {
            ...
            for (double similarity : similarities) {
                ...
                if (match != null) {
                    log.info(
                            "  ✓ Found at similarity {}: score = {}", similarity, match.getScore());
                    break;
    ...
    private void testWithFinder(Screen screen, BufferedImage patternImage, String patternName) {
        ...
        try {
            ...
            log.info(
                    "  Type: {} ({})",
                    screenImage.getType(),
                    getImageTypeName(screenImage.getType()));

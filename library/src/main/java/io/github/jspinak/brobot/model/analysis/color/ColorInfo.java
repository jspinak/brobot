 ...
 *
 * <p>ColorInfo encapsulates statistical properties (minimum, maximum, mean, and standard deviation)
 * for a single color channel within a color space. Each ColorInfo instance represents one component
 * of a color schema, such as Hue in HSV or Blue in BGR.
 *
 * <p>Statistical properties stored:
 *
 * <ul>
 *   <li><b>MIN</b>: Minimum value found in the color channel
 *   <li><b>MAX</b>: Maximum value found in the color channel
 *   <li><b>MEAN</b>: Average value across all pixels in the channel
 *   <li><b>STDDEV</b>: Standard deviation indicating color variance
 * </ul>
 *
 * <p>Role in color matching:
 *
 * <ul>
 *   <li>Defines acceptable color ranges for pattern matching
 *   <li>Enables tolerance-based matching using statistical distributions
 *   <li>Supports multi-channel color analysis when combined in ColorSchema
 *   <li>Provides metrics for color similarity calculations
 * </ul>
 *
 * <p>Usage patterns:
 *
 * <ul>
 *   <li>Created and populated during color profile analysis
 *   <li>Used by matching algorithms to determine color similarity
 *   <li>Combined with other ColorInfos to form complete color profiles
 *   <li>Enables debugging through formatted statistical output
 * </ul>
 *
 * <p>Value ranges depend on the color space and channel:
 *
 * <ul>
 *   <li>BGR channels: 0-255
 *   <li>HSV Hue: 0-179 (OpenCV convention)
 *   <li>HSV Saturation/Value: 0-255
 * </ul>
 *
 * @see ColorSchema
 * @see ColorCluster
...
public class ColorInfo implements Comparable<ColorInfo> {
    ...
    @Builder.Default private Map<ColorStat, Double> stats = new HashMap<>();
     ...
     *
     * <p>Output format: "[ColorValue] min.max.mean.stddev = [min] [max] [mean] [stddev]"
     *
     ...
     *
     * <p>Updates the internal statistics map with all four statistical measures in a single
     * operation. Typically called during color profile generation.
     *
    ...
    public boolean equals(Object o) {
        ...
        return red == colorInfo.red && green == colorInfo.green && blue == colorInfo.blue;
    }

...
/**
 * Verifies the actual resolution that SikuliX uses for screen capture and tests how
 * Settings.AlwaysResize affects capture dimensions.
 */
public class ScreenResolutionVerifier {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (float resize : resizeValues) {
            ...
            System.out.println(
                    "   Capture dimensions: " + capture.getWidth() + "x" + capture.getHeight());
            ...
            System.out.println(
                    "   Ratio to display mode: " + String.format("%.3f", ratioToDisplay));
            System.out.println(
                    "   Ratio to SikuliX bounds: " + String.format("%.3f", ratioToSikuli));
        ...
        System.out.println(
                "   Captured size: " + regionCapture.getWidth() + "x" + regionCapture.getHeight());
        ...
        try {
            ...
            System.out.println(
                    "   Robot capture: "
                            + robotCapture.getWidth()
                            + "x"
                            + robotCapture.getHeight());
            ...
            System.out.println(
                    "   AWT Robot: " + robotCapture.getWidth() + "x" + robotCapture.getHeight());
            ...
            if (sikuliCapture.getWidth() == robotCapture.getWidth()) {
                ...
                System.out.println(
                        "   ⚠️ Different resolution! Ratio: " + String.format("%.3f", ratio));

 ...
 *
 * <p>This component ensures that all console output, including from third-party libraries, is
 * captured and properly logged through Brobot's unified logging system. It prevents direct console
 * output and maintains logging consistency.
 *
 * @since 2.0
 */
@Component
public class ConsoleOutputCapture {
    ...
    /** Gets the original stdout PrintStream. Used by MessageRouter to avoid recursive logging. */
    public static PrintStream getOriginalOut() {
        return originalOut;
    }

    /** Gets the original stderr PrintStream. Used by MessageRouter to avoid recursive logging. */

...
/**
 * Ensures compatibility between SikuliX and JavaCV by configuring
 * SikuliX to use its bundled OpenCV libraries instead of JavaCV's.
 * 
 * This prevents version conflicts between SikuliX (OpenCV 4.3.0) 
 * and JavaCV (which we've downgraded to match).
 */
@Slf4j
@Component

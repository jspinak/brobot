 ...
 * <p>
 * This is a control flow exception used to gracefully exit execution loops
 * when the user or system requests a stop. It should be caught at the
 * appropriate level to perform cleanup operations.
 * </p>
 * 
 * <p>This exception is part of the normal control flow and should not be
 * treated as an error condition. It allows for clean termination of
 * nested execution contexts.</p>
 */

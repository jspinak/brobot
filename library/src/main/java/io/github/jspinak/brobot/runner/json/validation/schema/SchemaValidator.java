 ...
 * 
 * <p>This class provides a unified interface for validating JSON configurations
 * against their respective schemas. It delegates to specialized validators for
 * project and DSL schemas, making it easy to validate either or both types of
 * configuration files.</p>
 * 
 * <h2>Schema Validation Purpose:</h2>
 * <p>Schema validation ensures that configuration files have the correct structure
 * and data types before attempting to parse them into domain objects. This catches
 * syntax errors, missing required fields, and type mismatches early in the loading
 * process.</p>
 * 
 * <h2>Validation Types:</h2>
 * <ul>
 *   <li><b>Project Schema</b> - Validates state definitions, transitions, and UI elements</li>
 *   <li><b>DSL Schema</b> - Validates automation function syntax and structure</li>
 *   <li><b>Combined Validation</b> - Validates both schemas in one operation</li>
 * </ul>
 * 
 * <h2>Usage Example:</h2>
 * <pre>{@code
...
public class SchemaValidator {
     ...
     * 
     * <p>This method delegates to the ProjectSchemaValidator to check that the
     * provided JSON conforms to the expected project configuration structure.
     * It validates required fields, data types, and structural constraints.</p>
     * 
     ...
     * 
     * <p>This method delegates to the AutomationDSLValidator to verify that
     * automation functions are properly structured with valid syntax for
     * statements, expressions, and function declarations.</p>
     * 
     ...
     * 
     * <p>This convenience method validates both configuration files and merges
     * the results. It's useful when loading a complete Brobot configuration
     * where both files must be valid for the system to function.</p>
     * 
     * <h3>Validation Order:</h3>
     * <ol>
     *   <li>Project schema validation</li>
     *   <li>DSL schema validation</li>
     *   <li>Results are merged into a single ValidationResult</li>
     * </ol>
     * 
     * <p>Note that this only performs schema validation. For complete validation
     * including cross-references and business rules, use ConfigValidator.</p>
     * 
     ...
     * @return Combined ValidationResult containing all schema violations from both
     *         configurations
     */

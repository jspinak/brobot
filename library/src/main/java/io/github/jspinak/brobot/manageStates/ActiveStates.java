 ...
 * 
 * <p>ActiveStates provides a lightweight container for tracking which states are currently 
 ...
 *   <li><b>Merge Support</b>: Can combine multiple ActiveStates instances</li>
 * </ul>
 * </p>
 * 
 * <p>Use cases:
 ...
 * </p>
 * 
 * <p>In the model-based approach, ActiveStates provides a foundation for tracking the 

 ...
 *
 * <p>This class provides convenience methods for creating ActionRecord instances with common
 * configurations, making it easier to set up test data and initialize states with mock action
 * history.
 *
...
public class ActionRecordTestUtils {
    ...
    /**
     * Creates an ActionRecord with a successful find operation at the specified location. Uses
     * default PatternFindOptions with BEST strategy.
     *
        ...
        return new ActionRecord.Builder()
                .setActionConfig(
                        new PatternFindOptions.Builder()
                                ...
                                .build())
                .addMatch(new Match.Builder().setRegion(x, y, w, h).setSimScore(similarity).build())
                .setActionSuccess(true)
                .build();
    }

    /**
     * Creates an ActionRecord with a successful find operation at the specified location using
     * custom ActionConfig.
     *
     ...
     * @return a new ActionRecord configured for testing
     */
    public static ActionRecord createActionRecord(
            ActionConfig actionConfig, double similarity, int x, int y, int w, int h) {
        return new ActionRecord.Builder()
        ...
        return new ActionRecord.Builder()
                .setActionConfig(
                        new PatternFindOptions.Builder()
                                ...
                                .build())
                .setText(text)
                .addMatch(new Match.Builder().setRegion(x, y, w, h).setText(text).build())
                .setActionSuccess(true)
                .build();
    }
     ...
     */
    public static ActionRecord createTimedRecord(
            double similarity, int x, int y, int w, int h, double durationSeconds) {
        return new ActionRecord.Builder()
                .setActionConfig(
                        new PatternFindOptions.Builder()
                                .setStrategy(PatternFindOptions.Strategy.BEST)

 ...
 *
 * <p>LogEvent encapsulates all information about a logged event in the Brobot framework. It uses
 * the builder pattern for construction and is immutable once created. This design ensures thread
 * safety and prevents accidental modification of log data as it flows through the logging pipeline.
 *
 * <p>Event types:
 *
 * <ul>
 *   <li>ACTION - User actions like clicks, types, hovers
 *   <li>TRANSITION - State transitions in the application
 *   <li>OBSERVATION - General observations about application state
 *   <li>PERFORMANCE - Performance metrics and timings
 *   <li>ERROR - Error conditions and exceptions
 * </ul>
 *
 * @since 2.0
 * @see BrobotLogger
...
public class LogEvent {
    ...
    private LogEvent(Builder builder) {
        ...
        this.metadata =
                builder.metadata != null ? new HashMap<>(builder.metadata) : new HashMap<>();
    }
    ...
    /**
     * Formats the event as a human-readable string. Used for console output.
     *
    ...
    public String toString() {
        return String.format(
                "LogEvent[type=%s, level=%s, message=%s, session=%s, state=%s, timestamp=%d]",

 ...
 * <p>
 * RepeatUntilConfigV2 is the modern replacement for RepeatUntilConfig, using the new
 * ActionConfig hierarchy instead of ActionOptions. It encapsulates the complete configuration 
 * needed to execute a pattern where one action is repeatedly performed until a condition is met.
 * It separates the configuration of the primary action (do) from the termination
 * condition (until), providing more flexibility than simpler composite actions.
 * This separation allows different ActionConfig implementations for each phase of the operation.
 * 
 * <p>Key components:</p>
 * <ul>
 *   <li><b>Action configuration:</b> Separate ActionConfig and ObjectCollections
...
public class RepeatUntilConfigV2 {
     ...
     * have limits on how many times they can act on the same object. Only the action 
     * collection is reset, not the condition collection, as conditions are typically 
     * evaluated without modification.
     * 
     * <p>Common scenarios for using this method:</p>
     * <ul>
     *   <li>Reusing a RepeatUntilConfigV2 for multiple executions</li>
     ...
     * <p>
     * This builder ensures that RepeatUntilConfigV2 instances are created with all
    ...
    public static class Builder {
         ...
         * <p>
         * This ActionConfig defines what action is executed in the loop (e.g.,
         ...
         * <p>
         * This ActionConfig defines how to check the termination condition (e.g.,

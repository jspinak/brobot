 ...
 *
 * <ol>
 *   <li>Checks the current execution mode via {@link
 *       io.github.jspinak.brobot.config.environment.ExecutionMode}
 ...
 * <h2>Configuration:</h2>
 *
 * <p>The execution mode is determined by {@link
 * io.github.jspinak.brobot.config.environment.ExecutionMode#isMock()} and can be configured
 * through:
 *
 * <ul>

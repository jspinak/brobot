 ...
 *
 * <p>This composite action provides a convenient way to configure the common pattern of finding a
 * text field, clicking on it, and then typing text. It's designed for users who prefer the
 * simplicity of the old embedded-find approach.
 *
 * <p>Usage:
 *
 * <pre>{@code
...
public class FindAndType extends ActionConfig {
     ...
     */
    public FindAndType(
            PatternFindOptions findOptions, ClickOptions clickOptions, TypeOptions typeOptions) {
        super(new Builder());

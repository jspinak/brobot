...
/**
 * Metadata about the motion detection process and parameters used. Provides detailed information
 * about how the motion analysis was performed.
 *
 * <p>This class captures all the configuration and statistical data from a motion detection
 * operation, enabling debugging, optimization, and reproducibility of results.
 */
@Value
...
public class MotionMetadata implements Serializable {
    ...
    /**
     * Threshold value used for motion detection (0-255). Pixels with difference above this value
     * are considered changed.
     */
    private final int threshold;

    /**
     * Whether grayscale conversion was applied before analysis. Grayscale processing is faster and
     * often sufficient for motion detection.
     */
    private final boolean grayscaleUsed;

    /**
     * Gaussian blur radius if blur was applied (0 = no blur). Blur helps reduce noise in motion
     * detection.
     */
    ...
    /**
     * Additional statistics as key-value pairs. Allows for extensibility without changing the
     * structure.
     */
    ...
    /**
     * Creates empty metadata with default values. Used when no motion is detected or for
     * initialization.
     *

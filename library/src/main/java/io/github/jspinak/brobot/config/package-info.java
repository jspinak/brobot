 ...
 * 
 * <p>This package provides the foundational configuration system for Brobot,
 * managing framework initialization, runtime environment detection, and execution
 * mode control. It implements the separation of concerns between domain-specific
 * knowledge (State Structure Ω) and strategic framework capabilities (Framework F)
 * as defined in the formal model.</p>
 * 
 ...
 *   <li>{@link io.github.jspinak.brobot.config.FrameworkSettings} - 
 *       Global settings controlling framework behavior</li>
 *   <li>{@link io.github.jspinak.brobot.config.ExecutionEnvironment} - 
 *       Runtime environment detection and configuration</li>
 *   <li>{@link io.github.jspinak.brobot.config.ExecutionMode} - 
 *       Controls execution mode (mock vs real)</li>
 * </ul>
 * 
 * <h3>Initialization</h3>
 * <ul>
 *   <li>{@link io.github.jspinak.brobot.config.FrameworkInitializer} - 
 *       Core initialization service for image preprocessing and state setup</li>
 *   <li>{@link io.github.jspinak.brobot.config.FrameworkLifecycleManager} - 
 ...
 *   <li>{@link io.github.jspinak.brobot.config.LoggingConfiguration} - 
 *       Logging subsystem configuration</li>
 * </ul>
 * 
 * <h2>Initialization Process</h2>
 * 
 * <p>The framework follows a carefully orchestrated initialization sequence:</p>
 * <ol>
 *   <li><b>Spring Context Creation</b> - Component scanning and dependency injection</li>
 ...
 * <ul>
 *   <li>{@code initProfilesForStaticImages} - Generate profiles for static images</li>
 *   <li>{@code initProfilesForDynamicImages} - Generate profiles for dynamic content</li>
 ...
 * 
 * <p>The configuration package embodies key architectural principles:</p>
 * <ul>
 *   <li><b>Separation of Concerns</b> - Clear distinction between framework and domain</li>
 *   <li><b>Dependency Injection</b> - Spring-managed component lifecycle</li>
 *   <li><b>Environment Adaptation</b> - Automatic adjustment to runtime capabilities</li>
 *   <li><b>Performance Optimization</b> - Preprocessing during initialization</li>

 ...
 * lifecycle management, execution control, and state handling integration.</p>
 * 
 * <p>Key features:
 * <ul>
 *   <li><b>Lifecycle Management</b>: Full execution control with pause/resume/stop</li>
 *   <li><b>State Handler Integration</b>: Direct access to state-based automation patterns</li>
 *   <li><b>Thread Safety</b>: Thread-safe execution control for multi-threaded operation</li>
 *   <li><b>Pause Points</b>: Built-in support for pause/resume functionality</li>
 ...
 *   <li>Regular calls to {@code checkPausePoint()} for pause/stop functionality</li>
...
public abstract class BaseAutomation implements AutomationScript {
     ...
     * <p>
     * Provides thread-safe execution control with support for pausing,
     * resuming, and stopping automation execution.
     */
     ...
     * A default ThreadSafeExecutionController is created for execution control.
     *
     ...
     * <p>
     * This constructor allows for dependency injection of a custom execution controller,
     * useful for testing or when sharing execution control across components.
     *
     * @param stateHandler Handler for managing GUI state transitions
     ...
     * <p>
     * Sets the execution state to RUNNING and updates the deprecated
     * running flag for backward compatibility.
     *
     ...
     * <p>
     * The automation will pause when it next calls checkPausePoint().
     ...
     * completion. Subclasses should check pause points in their
     * automation loops and exit gracefully when stopped.
     *
     ...
     * <p>
     * Thread-safe check of the execution state.
     *
     ...
     * <p>
     * Subclasses should call this method regularly in their automation
     * loops to enable pause/resume functionality.
     *
     ...
     * <p>
     * Should be called after execution completes or when preparing
     * for a new execution cycle.
     */
    @Override
    public void reset() {

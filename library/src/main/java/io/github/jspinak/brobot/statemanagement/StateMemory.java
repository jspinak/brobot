...
public class StateMemory {
     ...
     * Side effects:
     * <ul>
     *   <li>Adds states to active list based on found matches</li>
     *   <li>Updates state probabilities and visit counts</li>
     *   <li>Ignores matches without valid state ownership data</li>
     * </ul>
     *
     ...
     * <p>
     * Public convenience method that delegates to the private implementation
     * without forcing a newline in the report output.
     *
     ...
     * <p>
     * NULL states are special states representing stateless objects and
     * should not be tracked in the active state list.
     *
     ...
     * <p>
     * Marks a state as currently active in the GUI. Performs several operations:
     * <ul>
     *   <li>Checks for duplicate additions (idempotent)</li>
     *   <li>Filters out NULL states</li>
     *   <li>Reports the addition to logs</li>
     *   <li>Sets state probability to 100%</li>
     *   <li>Increments state visit counter</li>
     * </ul>
     * <p>
     * Side effects:
     * <ul>
     *   <li>Modifies active state set</li>
     *   <li>Updates state probability to 100</li>
     *   <li>Increments state visit count</li>
     *   <li>Prints to Report</li>
     * </ul>
     *
     * @param activeState ID of the state to mark as active
    ...
    public void addActiveState(Long activeState, boolean newLine) {
        ...
        ConsoleReporter.print("+ add state "+stateService.getStateName(activeState)+" to active states ");
     ...
     * <p>
     * Batch operation for removing states that are no longer active.
     * Delegates to removeInactiveState for each state in the set.
     *
     ...
     * <p>
     * Marks a state as no longer active. Updates the state's probability
     * to 0 and reports the removal. Idempotent - removing an already
     * inactive state has no effect.
     * <p>
     * Side effects:
     * <ul>
     *   <li>Removes state from active set</li>
     *   <li>Sets state probability to 0</li>
     *   <li>Prints removal to Report</li>
     * </ul>
     *
     ...
     * Used when the automation needs to start fresh or when all states
     * become invalid. Does not update individual state probabilities.
     * <p>
     * Side effects:
     * <ul>
     *   <li>Replaces active state set with empty set</li>
     *   <li>Does NOT update state probabilities</li>
     * </ul>
     */

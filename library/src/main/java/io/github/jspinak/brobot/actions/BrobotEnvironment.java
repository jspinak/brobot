 ...
 */
@Component
public class BrobotEnvironment {
    
    private static BrobotEnvironment instance = new BrobotEnvironment();
     ...
     * 
     * @return the BrobotEnvironment instance
     */
    public static BrobotEnvironment getInstance() {
        return instance;
    }
     ...
     */
    public static void setInstance(BrobotEnvironment newInstance) {
    ...
    public String getEnvironmentInfo() {
        return String.format(
            "BrobotEnvironment[mockMode=%s, hasDisplay=%s, canCaptureScreen=%s, useRealFiles=%s]",
    ...
    public static class Builder {
         ...
         * 
         * @return configured BrobotEnvironment
         */
        public BrobotEnvironment build() {
            BrobotEnvironment env = new BrobotEnvironment();
            ...
            if (env.verboseLogging) {
                System.out.println("BrobotEnvironment configured: " + env.getEnvironmentInfo());
            }

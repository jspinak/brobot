 ...
 *
 * <p>This class provides a modern, Spring-based approach to framework configuration, replacing
 * static fields with configurable properties that can be set via application.properties,
 * application.yml, or environment variables.
 *
 * <p>Default values are loaded from brobot-defaults.properties in the library. Applications can
 * override any of these defaults in their own configuration files.
 *
 * <p>Properties are organized into logical groups:
 *
 * <ul>
 *   <li><b>Core</b>: Essential framework settings like image paths and mock mode
 *   <li><b>Mouse</b>: Mouse action timing and behavior configuration
 *   <li><b>Mock</b>: Simulated execution timings for testing
 *   <li><b>Screenshot</b>: Screen capture and history settings
 *   <li><b>Illustration</b>: Visual feedback and annotation settings
 *   <li><b>Analysis</b>: Color profiling and k-means clustering settings
 *   <li><b>Recording</b>: Screen recording configuration
 *   <li><b>Dataset</b>: AI training data generation settings
 *   <li><b>Testing</b>: Test execution configuration
 * </ul>
 *
...
public class BrobotProperties {
    ...
    public static class Core {
        /**
         * Path to image resources. Supports: - Classpath: "classpath:images/" - Absolute:
         * "/home/user/images/" - Relative: "images/"
         */
    ...
    public static class Monitor {
        /**
         * Monitor index to use for automation (0 = primary, 1 = secondary, etc.) Default: -1 (use
         * primary monitor)
         */

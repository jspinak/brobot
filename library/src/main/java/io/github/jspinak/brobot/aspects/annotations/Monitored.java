 ...
 * 
 * <p>Methods annotated with @Monitored will have detailed performance
 * metrics collected by the PerformanceMonitoringAspect, including
 * custom thresholds and alerting.</p>
 * 
 * <p>Example usage:</p>
 * <pre>
 * {@code

 ...
 * This configuration breaks circular dependencies by defining beans explicitly.
 * 
 * When running with the "test" profile, additional optimizations are applied
 * to speed up test execution and provide deterministic behavior.
 */
@Configuration
@Slf4j
public class MockConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    public MockFind mockFind(ActionDurations actionDurations, 
    ...
    @Bean
    public FindWrapper findWrapper(ExecutionMode executionMode,
                                  MockFind mockFind,
    ...
    @Bean
    public TextWrapper textWrapper(ExecutionMode executionMode,
                                  MockText mockText,
    ...
    @Bean
    public HistogramWrapper histogramWrapper(ExecutionMode executionMode,
    ...
    @Bean
    public ExecutionModeController executionModeController(FindWrapper findWrapper,
    ...
    /**
     * Test profile configuration that optimizes settings for fast test execution.
     * This configuration automatically activates when running with the "test" profile.
     */
    @Configuration
    @Profile("test")

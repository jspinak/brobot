 ...
 * <p>
 * This statement provides branching control flow based on a boolean condition.
 * If the condition evaluates to true, the statements in the "then" branch are
 * executed; otherwise, the statements in the "else" branch are executed (if present).
 * <p>
 * The condition expression must evaluate to a boolean value. Both branches
 * create new scopes for variable declarations.
 * <p>
 * Example in JSON:
 * <pre>
 * {
...
public class IfStatement extends Statement {
     ...
     * This expression must evaluate to a boolean value (true or false).
     * Common condition expressions include comparisons and logical operations.
     */
    private Expression condition;
    
    /**
     * The list of statements to execute when the condition evaluates to true.
     * These statements are executed in order within a new scope.
     ...
     * If null or empty, no action is taken when the condition is false.
     * When present, these statements are executed in order within a new scope.
     */

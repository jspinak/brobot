 ...
 * Tests various theories about the 0.8 scaling factor.
 */
public class CaptureScalingAnalyzer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("   Ratio to 1920x1080: " + String.format("%.3f", (double)capture0.getWidth() / 1920));
        ...
        System.out.println("   Ratio to 1920x1080: " + String.format("%.3f", (double)capture1.getWidth() / 1920));
        ...
        System.out.println("   Ratio to 1920x1080: " + String.format("%.3f", (double)capture125.getWidth() / 1920));

 ...
 *
 * <ul>
 *   <li>Checks for pause points regularly
 *   <li>Can be paused, resumed, and stopped from external control
 *   <li>Handles ExecutionStoppedException gracefully
 * </ul>
 *
 * <p>Usage example:
 *
...
public class PausableAutomationExample extends BaseAutomation {
    ...
    private void runAutomation() {
        ...
        try {
            ...
            for (int i = 0; i < 100; i++) {
                ...
                // Create a mock button object (in real code, this would be an actual StateImage or
                // Region)
                ObjectCollection buttonCollection = new ObjectCollection.Builder().build();
    ...
    private void performStateActions(String stateName)
            throws ExecutionStoppedException, InterruptedException {

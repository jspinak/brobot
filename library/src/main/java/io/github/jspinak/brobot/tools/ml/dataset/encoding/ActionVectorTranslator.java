 ...
 * <p>
 * This interface defines the contract for converting GUI automation actions into numerical
 * vectors suitable for machine learning, and vice versa. Different implementations can
 * provide various encoding strategies (e.g., one-hot encoding, continuous encoding) based
 * on the specific requirements of the ML model being used.
 * <p>
 * Implementations should ensure that the translation is as lossless as possible, preserving
 * all relevant information needed to reconstruct the original action from its vector
 * representation.
 *
...
public interface ActionVectorTranslator {
     ...
     * <p>
     * This method extracts relevant information from the ActionResult, including
     * the action configuration and execution results (such as matched coordinates),
     * and encodes them into a fixed-size numerical vector suitable for ML processing.
     *

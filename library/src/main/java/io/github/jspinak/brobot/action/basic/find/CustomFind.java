 ...
 *
 * <p>This class allows for implementing specialized find logic that doesn't fit into the standard
 * pattern-matching or color-based find operations. It provides a way to inject custom behavior
 * while still integrating with the Brobot action framework.
 *
 * <p>Common use cases include:
 *
 * <ul>
 *   <li>Complex multi-stage find operations
 *   <li>Finds that require external data or services
 *   <li>Temporary or experimental find algorithms
 *   <li>Finds with dynamic behavior based on runtime conditions
 * </ul>
 *
 * <p><b>Example usage:</b>
 *
...
public class CustomFind implements ActionInterface {
     ...
     *
     * <p>This method delegates the actual find logic to the provided BiConsumer, which receives the
     * ActionResult to populate and the list of ObjectCollections to search within.
     *
    ...
    public void perform(
            ...
            BiConsumer<ActionResult, List<ObjectCollection>> findStrategy,
    ...
    public void perform(ActionResult actionResult, ObjectCollection... objectCollections) {
        throw new UnsupportedOperationException(
                "CustomFind requires a find strategy. Use perform(ActionResult, BiConsumer,"
                        + " ObjectCollection...) instead.");
    }
}

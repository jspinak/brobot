 ...
 *
 * <ul>
 *   <li>Accuracy is more important than speed
 *   <li>You need to find the best match among similar elements
 *   <li>The target element has subtle visual differences from similar elements
 *   <li>False positives must be minimized
 * </ul>
 *
 * <p>Default settings:
 *
 * <ul>
 *   <li>Strategy: BEST (searches all possibilities and returns highest scoring match)
 *   <li>Similarity: 0.9 (high threshold to ensure accurate matches)
 *   <li>Capture Image: true (captures screenshots for verification and debugging)
 *   <li>Match Fusion: enabled with conservative settings
 * </ul>
 *
 * <p>Example usage:
 *
...
public final class PreciseFindOptions {
    ...
    /**
     * The default similarity threshold for precise finds. Higher than standard to ensure accurate
     * matches.
     */
    public static final double DEFAULT_SIMILARITY = 0.9;

    /**
     * The default maximum distance for match fusion. Conservative value to avoid merging unrelated
     * matches.
     */
     ...
     *
     * <p>The builder starts with optimized defaults for precision but allows customization of any
     * setting if needed.
     *

 ...
 * 
 * <p>This executor handles the actual click mechanics after elements
 * have been located. It depends only on MouseController, completely
 * breaking the circular dependency with Find.</p>
 * 
 * <p>Key characteristics:
 * <ul>
 *   <li>NO dependency on Find or any Action classes</li>
 *   <li>Depends only on core services (MouseController)</li>
 *   <li>Handles click execution, not element location</li>
...
public class ClickExecutor {
    ...
    public static class ClickOptions {
        ...
        public MouseController.MouseButton getButton() { return button; }
        public void setButton(MouseController.MouseButton button) { this.button = button; }
        
        public int getDelayBetweenClicks() { return delayBetweenClicks; }
        public void setDelayBetweenClicks(int delayBetweenClicks) { 
            this.delayBetweenClicks = delayBetweenClicks; 
        }
        
        public boolean isMoveBeforeClick() { return moveBeforeClick; }
     ...
     * 
     * <p>This method performs the actual click operation on a located element.
     * It handles multiple clicks if configured.</p>
     * 
     ...
     * 
     * <p>This method performs the actual click operation at the specified
    ...
    public boolean executeClick(Location location, ClickOptions options) {
        ...
        if (success) {
            ConsoleReporter.println("[ClickExecutor] Successfully clicked " + 
                options.getClickCount() + " time(s)");
        }
     ...
     * 
     * <p>Convenience method for the most common click operation.</p>
     * 
     * @param location The location to click at
     * @return true if click was successful, false otherwise
     */
    ...
    public boolean executeRightClick(Location location) {
        ClickOptions options = new ClickOptions.Builder()
            .withButton(MouseController.MouseButton.RIGHT)
            .build();
     ...
     * 
     * <p>Convenience method for double-clicking.</p>
     * 

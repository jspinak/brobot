 ...
 * This diagnostic answers the critical question: Do screen captures and patterns use the same pixel dimensions?
 */
public class StandaloneDPIDiagnostic {
    ...
    private static void verifyCriticalAssumption() {
        ...
        System.out.println("   Monitor resolution (logical): " + dm.getWidth() + "x" + dm.getHeight());
        ...
        System.out.println("   Expected physical pixels: " + expectedPhysicalWidth + "x" + expectedPhysicalHeight);
        ...
        System.out.println("   Actual capture dimensions: " + capture.getWidth() + "x" + capture.getHeight());
        ...
        if (capturesLogical) {
            ...
            System.out.println("   - Screen captures: " + capture.getWidth() + "x" + capture.getHeight() + " (logical)");
            System.out.println("   - This matches the display resolution reported by Windows");
            System.out.println("   - Patterns captured by SikuliX IDE will also be in logical pixels");
            ...
            System.out.println("   - Screen captures: " + capture.getWidth() + "x" + capture.getHeight() + " (physical)");
            System.out.println("   - This is " + (int)(displayScale * 100) + "% of logical resolution");
    ...
    private static void testPhysicalResolutionCaptures() {
        ...
        for (String patternName : testPatterns) {
            ...
            try {
                ...
                System.out.println("   Captured dimensions: " + capturedRegion.getWidth() + "x" + 
                ...
                System.out.println("   Size ratio to original: " + String.format("%.3f", widthRatio));
                ...
                if (Math.abs(widthRatio - 1.0) < 0.05) {
                    ...
                    System.out.println("   → Captured at logical resolution (1/" + 
                                     String.format("%.2f", displayScale) + ")");
                } else {
                    System.out.println("   → Unexpected ratio: " + String.format("%.3f", widthRatio));
                }
                
                // Save the captured region
                File captureFile = saveCapture(capturedRegion, "captured_" + patternName.replace(".png", ""));
                ...
                if (reverseMatch != null) {
                    System.out.println("   ✓ Captured pattern matches at: " + 
                                     String.format("%.1f%%", reverseMatch.getScore() * 100));
                    
                    if (reverseMatch.getScore() > 0.95) {
                        System.out.println("   🎯 PERFECT match! Screen capture = pattern capture method");
    ...
    private static void testResizedCapture(File captureFile, BufferedImage captured, 
                                          double displayScale, Screen screen) {
        try {
            ...
            if (Math.abs(physicalWidth - captured.getWidth()) > 5) {
                System.out.println("   Testing capture resized to physical (" + 
                                 physicalWidth + "x" + physicalHeight + "):");
                
                BufferedImage resizedPhysical = resizeImage(captured, physicalWidth, physicalHeight);
            ...
            if (Math.abs(logicalWidth - captured.getWidth()) > 5) {
                System.out.println("   Testing capture resized to logical (" + 
                ...
                if (logicalMatch != null) {
                    System.out.println("     Logical size: " + 
            ...
            System.out.println("   Testing capture at 80% size (" + 
                             scaled80Width + "x" + scaled80Height + "):");
    ...
    private static void testClaudeAutomatorPatterns() {
        ...
        for (String patternName : patterns) {
            ...
            try {
                ...
                System.out.println("   Dimensions: " + patternImage.getWidth() + "x" + patternImage.getHeight());
                System.out.println("   Type: " + getImageTypeString(patternImage.getType()));
                
                // Analyze pattern source
                DPIScalingStrategy.PatternSource source = analyzePatternSource(
                ...
                for (float dpi : dpiSettings) {
                    ...
                    try {
                        ...
                        if (match != null) {
                            ...
                            System.out.printf("     DPI %.2f: %.1f%%%s%n", dpi, score * 100, marker);
                        } else {

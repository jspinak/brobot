 ...
 * 
 * <p>
 * This runner executes after Spring context initialization and performs
 * initial state verification based on configuration. It's enabled by setting
 * {@code brobot.startup.verify-initial-states=true}.
 * </p>
 * 
 * <p>
 * The runner respects the configured startup delay and initial states list,
 ...
 */
@Component
@ConditionalOnProperty(prefix = "brobot.startup", name = "verify-initial-states", havingValue = "true")

 ...
 *
 * <p>This component maintains an in-memory collection of {@link TrainingExample} objects and
 * provides functionality to serialize them to a binary file. The data is saved in a custom format
 * that handles the serialization of BufferedImage objects as PNG-encoded byte arrays.
 *
 * <p>Training data is accumulated through the {@link #addData} method and can be persisted all at
 * once using {@link #saveAllDataToFile}. The output file is created in the current working
 * directory with the configured filename (default: "trainingdata.dat").
 *
 * <p>The file format consists of:
 *
 * <ol>
 *   <li>An integer indicating the number of TrainingExample objects
 *   <li>The serialized TrainingExample objects in sequence
 * </ol>
 *
 * @see TrainingExample
...
public class TrainingExampleWriter {
     ...
     *
     * <p>This method creates a new {@link TrainingExample} instance from the provided components
     * and adds it to the internal list. The data is not immediately persisted to disk; call {@link
     * #saveAllDataToFile} to write all accumulated data.
     *
     ...
     */
    public void addData(
            ActionVector actionVector, String actionText, ArrayList<BufferedImage> screenshots) {
     ...
     *
     * <p>This method writes the entire collection of training data to the configured file in the
     * current working directory. The file is created or overwritten if it already exists.
     *
     * <p>The serialization format includes:
     *
     * <ul>
     *   <li>The count of TrainingExample objects as an integer
     *   <li>Each TrainingExample object serialized in sequence
     * </ul>
     *
     * <p>Side effects:
     *
     * <ul>
     *   <li>Creates or overwrites the configured file in the current directory
     *   <li>Prints success message to stdout
     *   <li>Prints stack trace to stderr if an error occurs
     * </ul>
     */

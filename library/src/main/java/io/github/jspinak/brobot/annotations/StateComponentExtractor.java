 ...
 * 
 * <p>This class is responsible solely for extracting state components through reflection.
 * It does not handle state building or registration, following the Single Responsibility Principle.</p>
 * 
 * <p>The extractor looks for fields of the following types:
 * <ul>
 *   <li>StateImage - Visual elements used for pattern matching</li>
 *   <li>StateString - Text elements for typing or verification</li>
 *   <li>StateObject - Generic state objects</li>
 * </ul>
 * </p>
 * 
 * @since 1.1.0
...
public class StateComponentExtractor {
    ...
    public static class StateComponents {
        ...
        public List<StateString> getStateStrings() { return stateStrings; }
        public List<StateObject> getStateObjects() { return stateObjects; }
    ...
    public StateComponents extractComponents(Object stateInstance) {
        ...
        log.debug("Extracted {} total components from {}", 
                components.getTotalComponents(), stateClass.getSimpleName());
    ...
    private void extractField(Field field, Object instance, StateComponents components) {
        try {
            ...
            log.warn("Failed to access field {} in class {}", 

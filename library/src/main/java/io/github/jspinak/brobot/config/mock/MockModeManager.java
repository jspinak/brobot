...
import io.github.jspinak.brobot.config.environment.ExecutionEnvironment.Builder;
 ...
 * 
 * <p>
 * This class provides a single source of truth for mock mode status and ensures
 * consistency across all components that need to check or set mock mode.
 * </p>
 * 
 * <p>
 * Mock mode is used to:
 * <ul>
 * <li>Enable testing in headless/CI environments</li>
 * <li>Use dummy images instead of real screen captures</li>
 * <li>Simulate user interactions without actual mouse/keyboard events</li>
 * <li>Provide predictable timing for test assertions</li>
 * </ul>
 * </p>
 * 
 * <p>
 * The manager synchronizes mock mode across:
 * <ul>
 * <li>System properties (for configuration loading)</li>
 * <li>ExecutionEnvironment (for runtime behavior)</li>
 * <li>FrameworkSettings (for SikuliX compatibility)</li>
 * </ul>
 * </p>
 * 
 * @since 1.0
...
public class MockModeManager {
     ...
     * 
     * <p>
     * This method checks ExecutionEnvironment as the authoritative source,
     * falling back to system properties if ExecutionEnvironment is not initialized.
     * </p>
     * 
     ...
     * 
     * <p>
     * This method ensures consistency by updating:
     * <ul>
     * <li>All relevant system properties</li>
     * <li>ExecutionEnvironment configuration</li>
     * <li>FrameworkSettings (if available)</li>
     * </ul>
     * </p>
     * 
    ...
    public static void setMockMode(boolean enable) {
        ...
        try {
            ExecutionEnvironment.Builder envBuilder = ExecutionEnvironment.builder()
                    .mockMode(enable);

            // In mock mode, typically also want headless and no screen capture
            if (enable) {
                envBuilder.forceHeadless(true)
    ...
    public static void logMockModeState() {
        ...
        state.append("    ").append(MOCK_MODE_PROPERTY).append(" = ")
                .append(System.getProperty(MOCK_MODE_PROPERTY)).append("\n");
        state.append("    ").append(FRAMEWORK_MOCK_PROPERTY).append(" = ")
                .append(System.getProperty(FRAMEWORK_MOCK_PROPERTY)).append("\n");
        state.append("    ").append(CORE_MOCK_PROPERTY).append(" = ")
                .append(System.getProperty(CORE_MOCK_PROPERTY)).append("\n");
     ...
     * mock mode is consistently set based on configuration.
     * </p>
     */
    public static void initializeMockMode() {
        boolean shouldEnableMock = "true".equalsIgnoreCase(System.getProperty(MOCK_MODE_PROPERTY)) ||
                "true".equalsIgnoreCase(System.getProperty(FRAMEWORK_MOCK_PROPERTY)) ||
                "true".equalsIgnoreCase(System.getProperty(CORE_MOCK_PROPERTY));

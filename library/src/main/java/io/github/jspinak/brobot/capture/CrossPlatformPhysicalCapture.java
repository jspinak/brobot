 ...
 * 
 * Automatically detects and uses the best available tool for physical resolution capture:
 * 1. FFmpeg (preferred - most reliable)
 * 2. ImageMagick
 * 3. Platform-specific tools (screencapture, scrot, etc.)
 * 4. Java Robot with scaling (fallback)
 * 
 * @since 1.1.0
 */
@Component
public class CrossPlatformPhysicalCapture {
    ...
    private static void detectBestMethod() {
        ...
        preferredMethod = available.stream()
    ...
    private static String getTempFile(String prefix) {
        return System.getProperty("java.io.tmpdir") + 
               File.separator + "brobot_" + prefix + "_" + 
    ...
    private static BufferedImage readAndDelete(String file) throws IOException {
        ...
        f.delete();
        System.out.println("[PhysicalCapture] Captured: " + 

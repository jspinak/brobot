 ...
 * 
 * <p>This interface defines the contract for mouse control implementations,
 * completely decoupled from any higher-level components like Find or Actions.
 * It represents pure mouse control functionality with no dependencies on
 ...
 *   <li>Sikuli's mouse control capabilities</li>
 ...
 *   <li>Pure mouse control - no pattern matching or element finding</li>
 *   <li>Support for all standard mouse operations</li>
...
public interface MouseController {
     ...
     * 
     * <p>This method moves the mouse cursor to the absolute screen
     * coordinates specified. The movement may be instantaneous or
     * animated depending on the implementation.</p>
     * 
     ...
     * 
     * <p>This method moves the mouse to the specified location
     * and performs a click with the specified button.</p>
     * 
     ...
     * 
     * <p>Convenience method for left-clicking, which is the most
     * common mouse operation.</p>
     * 
     * @param x X coordinate to click at
     * @param y Y coordinate to click at
     * @return true if the click was successful, false otherwise
     ...
     * 
     * <p>This method performs two rapid clicks at the specified
     * location with the specified button.</p>
     * 
     ...
     * 
     * <p>Convenience method for left double-clicking.</p>
     * 
     * @param x X coordinate to double-click at
     * @param y Y coordinate to double-click at
     * @return true if the double-click was successful, false otherwise
     ...
     * 
     * <p>Convenience method for right-clicking.</p>
     * 
     ...
     * 
     * <p>This method presses the button without releasing it,
     * useful for drag operations.</p>
     * 
     ...
     * 
     * <p>This method releases a previously pressed button.</p>
     * 
     ...
     * 
     * <p>This method presses the button at the start location,
     * moves to the end location, and releases the button.</p>
     * 
     ...
     * 
     * <p>Convenience method for dragging with the left button.</p>
     * 
     * @param startX Starting X coordinate
     * @param startY Starting Y coordinate
     * @param endX Ending X coordinate
     ...
     * 
     * <p>Positive values scroll up/forward, negative values scroll down/backward.</p>
     * 
     ...
     * 
     * <p>Returns the current screen coordinates of the mouse cursor.</p>
     * 
     ...
     * 
     * <p>This method can be used to verify that mouse control

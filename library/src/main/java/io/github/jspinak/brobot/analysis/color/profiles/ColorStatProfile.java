 ...
 * 
 * <p>This class encapsulates color statistics (such as mean, min, max, or standard deviation)
 * for each channel of a color space. Despite the field name 'means', it can represent any
 * statistical measure as specified by the ColorStat type. The profile provides a quantitative
 * description of color characteristics that can be used for comparison and matching.</p>
 * 
 * <p>Common uses include:
 * <ul>
 *   <li>Storing mean color values for color-based matching</li>
 *   <li>Defining color ranges using min/max statistics</li>
 *   <li>Measuring color variance with standard deviation</li>
 *   <li>Creating color signatures for state identification</li>
 * </ul>
 * </p>
 * 
...
public class ColorStatProfile {
     ...
     * 
     * <p>This method assumes the profile contains HSV values and creates a 4-channel
     * Scalar with the fourth channel set to 0. This is useful for OpenCV operations
     * that require color values in Scalar format.</p>
     * 
     ...
     * 
     * <p>Outputs the statistic type and all channel values in a formatted manner
     * for debugging and analysis purposes.</p>
     */
    public void print() {

 ...
 * Initialized once during application startup based on the capture provider.
 * All Region and pattern matching operations use these dimensions.
 */
@Slf4j
public class ScreenDimensions {
    ...
    public static String getInfo() {
        return String.format("%dx%d (provider: %s, initialized: %s)", 

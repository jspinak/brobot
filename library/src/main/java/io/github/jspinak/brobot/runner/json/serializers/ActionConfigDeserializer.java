...
/**
 * Custom deserializer for ActionConfig hierarchy that handles polymorphic deserialization. Uses a
 * type discriminator field (@type or type) to determine the concrete class.
 */
@Component
    ...
    public ActionConfig deserialize(JsonParser p, DeserializationContext ctxt)
        ...
        if (type == null) {
            throw new JsonProcessingException(
                    "Missing type discriminator (@type or type) for ActionConfig") {};
        }

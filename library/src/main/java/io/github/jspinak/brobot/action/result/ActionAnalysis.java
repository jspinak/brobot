 ...
 * Includes scene analysis, masks, and custom analysis results.
 * 
 * This class encapsulates analysis functionality that was
...
public class ActionAnalysis {
    ...
    public int getSceneAnalysisCount() {
        return sceneAnalyses != null && sceneAnalyses.getSceneAnalyses() != null ? 
               sceneAnalyses.getSceneAnalyses().size() : 0;
    }
     ...
     * Note: Does not release OpenCV Mat resources - caller must handle that.
     */
    public void clear() {

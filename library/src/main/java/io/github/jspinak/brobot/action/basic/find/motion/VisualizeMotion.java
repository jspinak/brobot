 ...
 * This class overlays motion information onto scene images, highlighting
 * areas of movement with colored masks and bounding boxes.
 * 
 * <p>Visualization features include:
 * <ul>
 * <li>Colored overlay on pixels that have changed</li>
 * <li>Bounding boxes around motion regions</li>
 * <li>Saving illustrations to history for review</li>
 * <li>Customizable colors for different visualization needs</li>
 * </ul></p>
 * 
 * <p>The default motion color is a light orange (254, 183, 146),
 * which provides good visibility against most backgrounds.</p>
 * 
 * @see DrawMatch
...
public class VisualizeMotion {
     ...
     */
    public VisualizeMotion(DrawMatch drawMatch, MatrixVisualizer matVisualize, ColorMatrixUtilities matOps3d) {
     ...
     * The illustration shows the scene with motion areas highlighted and
     * is saved to history for debugging purposes.
     * 
     * <p>Side effects:
     * <ul>
     * <li>Sets the motion mask in the scene's illustrations</li>
     * <li>Writes the motion visualization to history as "motionWithMatches"</li>
     * </ul></p>
     * 
     ...
     */
    public void setMotionMatAndWriteIllustration(SceneAnalyses sceneAnalysisCollection, int index,
                                                 Mat motionMask) {
        Visualization illustrations = sceneAnalysisCollection.getSceneAnalyses().get(index).getIllustrations();
     ...
     * Uses the motion mask and contours from the scene analysis collection
     * to highlight areas of movement.
     * 
     ...
     * Overlays a colored mask on motion areas and draws bounding boxes

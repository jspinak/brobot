 ...
 * This helps configure pattern scaling to match screen capture resolution.
 * 
 * Part of the Brobot library - available to all Brobot applications.
 */
@Component
public class BrobotDPIAutoDetector {
    ...
    /**
     * Alternative detection method based on common resolutions.
     * Assumes standard physical resolutions and detects scaling by logical size.
     */
    private float detectScalingByResolution(int logicalWidth, int logicalHeight) {
        ...
        System.out.println("  No DPI scaling detected (resolution: " + logicalWidth + "x" + logicalHeight + ")");

 ...
 * 
 * <p>This package contains specialized exception types that provide detailed
 * error information for JSON parsing failures, configuration problems, and
 * validation errors. These exceptions support comprehensive error reporting
 * with context and suggestions.</p>
 * 
 * <h2>Exception Types</h2>
 * 
 * <ul>
 *   <li>{@link io.github.jspinak.brobot.runner.json.parsing.exception.ConfigurationException} - 
 *       General configuration and parsing errors</li>
 * </ul>
 * 
 * <h2>Error Information</h2>
 * 
 * <p>ConfigurationException provides:</p>
 * <ul>
 *   <li>Detailed error messages</li>
 *   <li>Root cause exceptions</li>
 *   <li>JSON path context when available</li>
 *   <li>Suggestions for resolution</li>
 * </ul>
 * 
 ...
 *   <li>Preserve root cause for debugging</li>
 *   <li>Add context (file name, path, line)</li>
 *   <li>Suggest fixes when possible</li>

 ...
 * 
 * <p>This interface defines the contract for locating GUI elements on screen,
 * orchestrating pattern matching and screen capture operations. It sits at a
 * higher level than PatternMatcher but lower than Find/Actions, providing
 * element location services without any circular dependencies.</p>
 * 
 * <p>ElementLocator is the key abstraction that breaks the circular dependency
 * between Find and other actions. Actions that need to find elements use
 * ElementLocator directly instead of depending on Find.</p>
 * 
 * <p>Key design principles:
 * <ul>
 *   <li>Depends ONLY on core services (PatternMatcher, ScreenCaptureService)</li>
 *   <li>NO dependencies on Find or any Action classes</li>
 *   <li>Provides element location without action semantics</li>
...
public interface ElementLocator {
     ...
     * This encapsulates all parameters needed for locating elements,
     * providing a clean and extensible API.
     */
    class LocateRequest {
        ...
        public List<StateImage> getStateImages() { return stateImages; }
        public void setStateImages(List<StateImage> stateImages) { this.stateImages = stateImages; }
        
        public List<Region> getSearchRegions() { return searchRegions; }
        public void setSearchRegions(List<Region> searchRegions) { this.searchRegions = searchRegions; }
        
        public FindStrategy getStrategy() { return strategy; }
        public void setStrategy(FindStrategy strategy) { this.strategy = strategy; }
     ...
     * This lightweight class contains the found element without
    ...
    class Element {
        ...
        public void setSourcePattern(Pattern sourcePattern) { this.sourcePattern = sourcePattern; }
        
        public StateImage getSourceStateImage() { return sourceStateImage; }
        public void setSourceStateImage(StateImage sourceStateImage) { this.sourceStateImage = sourceStateImage; }
     ...
     * 
     * <p>This is the main method that orchestrates screen capture and
     * pattern matching to locate GUI elements. The behavior is controlled
     * by the FindStrategy in the request.</p>
     * 
     ...
     * 
     * <p>This method optimizes the search by limiting it to a specific
     * screen region, improving performance for targeted searches.</p>
     * 
     * @param request The location request containing patterns and parameters
     ...
     * 
     * <p>This method performs a quick verification to see if an element
     * is still visible at the same location, useful for wait operations.</p>
     * 
     ...
     * 
     * <p>This method repeatedly searches for elements until found or
     ...
     * 
     * <p>This method repeatedly checks if elements are still present
     * until they disappear or timeout is reached.</p>
     * 

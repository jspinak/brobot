...
public class MockFind {
     ...
     * If no history exists, generates a default successful match to support testing.
    ...
    /**
     * Generates a default mock match when no history is configured.
     * This ensures mock mode works for testing without extensive setup.
    ...
    private List<Match> generateDefaultMockMatch(Pattern pattern) {
        Match defaultMatch = new Match.Builder()

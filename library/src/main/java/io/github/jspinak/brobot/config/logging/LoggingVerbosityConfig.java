 ...
 *
 * <p>This configuration controls the amount of detail included in log output. Normal mode provides
 * concise logging with essential information only, while verbose mode includes all available
 * details for debugging.
 *
 * <p>Configuration can be set via properties:
 *
 * <pre>
...
public class LoggingVerbosityConfig {
    ...
    public enum VerbosityLevel {
        /**
         * Quiet logging - minimal single-line output: - Single line per action with result -
         * Format: ✓/✗ Action State.Object • timing - No START/COMPLETE separation
         */
        QUIET,

        /**
         * Normal logging - shows only essential information: - Action type (CLICK, FIND, TYPE,
         * etc.) - State and object acted on - Results (success/failure) - Match coordinates (if
         * configured)
         */
        NORMAL,

        /**
         * Verbose logging - shows all available information: - Everything from NORMAL - Detailed
         * timing information - Search regions - Match scores - Performance metrics - Additional
         * metadata
         */
        VERBOSE
    }

    /** The verbosity level for logging. Default: NORMAL */
    ...
    public static class NormalModeConfig {
        ...
        /** Whether to show timing information in normal mode. Default: false */
        private boolean showTiming = false;

        /** Whether to show match coordinates in normal mode. Default: true */
        private boolean showMatchCoordinates = true;

        /** Whether to show match count in normal mode. Default: true */
        private boolean showMatchCount = true;

        /** Whether to use compact formatting in normal mode. Default: true */
        private boolean useCompactFormat = true;

        /** Maximum length for object names before truncation. Default: 30 */
    ...
    public static class VerboseModeConfig {
        ...
        /** Whether to show search regions in verbose mode. Default: true */
        private boolean showSearchRegions = true;

        /** Whether to show match scores in verbose mode. Default: true */
        ...
        /** Whether to show metadata in verbose mode. Default: true */
        private boolean showMetadata = true;

        /** Whether to show stack traces for errors in verbose mode. Default: true */

 ...
 * 
 * <p>This class provides simulated highlight functionality for use in mock mode,
 * allowing tests to run without actual screen interaction. It logs highlight
 * operations without performing actual screen highlighting.</p>
 * 
 * <p>Key features:
 * <ul>
 *   <li>Simulates highlight operations without screen interaction</li>
 *   <li>Records highlight requests for verification in tests</li>
 *   <li>Returns success for all valid highlight requests</li>
 *   <li>Provides consistent behavior for test automation</li>
 * </ul>
 * </p>
 * 
 * @since 1.1.0
...
public class MockHighlight {
    ...
    public int highlightRegions(List<Region> regions, double duration, String color) {
        log.debug("Mock highlight: {} regions, duration={}, color={}", regions.size(), duration, color);

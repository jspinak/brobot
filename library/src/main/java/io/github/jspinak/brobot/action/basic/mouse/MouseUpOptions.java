 ...
 * button release operations. Following the composition pattern, it reuses MousePressOptions but
 * only utilizes the relevant timing parameters (pauseBeforeMouseUp and pauseAfterMouseUp).
 *
...
public final class MouseUpOptions extends ActionConfig {
    ...
    public static class Builder extends ActionConfig.Builder<Builder> {
        ...
        /**
         * Creates a new Builder instance pre-populated with values from an existing MouseUpOptions
         * object.
         *
        ...
        /**
         * Configures the mouse press options. Only the button, pauseBeforeMouseUp, and
         * pauseAfterMouseUp from MousePressOptions are relevant for this action.
         *

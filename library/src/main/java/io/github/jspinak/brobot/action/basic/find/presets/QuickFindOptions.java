 ...
 * <ul>
 *   <li>You need to quickly verify if an element exists on screen</li>
 *   <li>Performance is more important than precision</li>
 *   <li>The target element has distinct visual characteristics</li>
 *   <li>You only need the first occurrence of an element</li>
 * </ul>
 * </p>
 * 
 * <p>Default settings:
 * <ul>
 *   <li>Strategy: FIRST (stops after finding one match)</li>
 *   <li>Similarity: 0.7 (allows more variation for faster matching)</li>
 *   <li>Capture Image: false (skips screenshot capture for performance)</li>
 *   <li>Max Matches: 1 (only processes the first match)</li>
 * </ul>
 * </p>
 * 
 * <p>Example usage:
...
public final class QuickFindOptions {
     ...
     * Lower than standard to prioritize speed over precision.
     */
     ...
     * 
     * <p>The builder starts with optimized defaults but allows customization
     * of any setting if needed.</p>
     * 

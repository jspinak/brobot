 ...
 * <p>
 * Each strategy determines how matches are selected and returned:
 * <ul>
 *   <li>Pattern matching strategies (FIRST, ALL, BEST) for image-based searches</li>
 *   <li>Text recognition strategies (ALL_WORDS) for OCR operations</li>
 *   <li>Analysis strategies (HISTOGRAM, COLOR, MOTION) for advanced detection</li>
 *   <li>State detection strategies for model-based automation</li>
 * </ul>
 *
 * @since 2.0
 */
public enum FindStrategy {
    ...
    /** User-defined custom find strategy. Must provide a BiConsumer<ActionResult, List<ObjectCollection>>. */
    CUSTOM,

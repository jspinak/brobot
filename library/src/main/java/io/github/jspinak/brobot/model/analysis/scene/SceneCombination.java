 ...
 *
 * <p>A scene combination identifies which images are common between two scenes, helping to
 * determine state transitions and image persistence across different application states. The
 * dynamic pixels matrix captures areas of change between the two scenes, which can be used for
 * motion detection and state change analysis.
 *
...
public class SceneCombination {
    ...
    @com.fasterxml.jackson.annotation.JsonIgnore private Mat dynamicPixels;
    private int scene1;
    private int scene2;
     ...
     *
     * @param dynamicPixels A matrix representing pixels that changed between the two scenes. Can be
     *     used for motion analysis and state change detection.
     ...
     *
     * <p>The added image represents an element that appears in both scenes of this combination.
     *

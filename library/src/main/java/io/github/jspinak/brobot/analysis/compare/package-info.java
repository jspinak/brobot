 ...
 * 
 * <p>This package provides utilities for comparing images, extracting contours,
 * and analyzing visual differences. These tools support advanced matching
 * operations by enabling detailed comparison of visual elements beyond simple
 * template matching.</p>
 * 
 * <h2>Core Components</h2>
 * 
 * <ul>
 *   <li>{@link io.github.jspinak.brobot.analysis.compare.ImageComparer} - 
 *       Comprehensive image comparison with multiple metrics</li>
 *   <li>{@link io.github.jspinak.brobot.analysis.compare.ContourExtractor} - 
 *       Extracts and analyzes object contours from images</li>
 *   <li>{@link io.github.jspinak.brobot.analysis.compare.SizeComparator} - 
 *       Compares dimensions and sizes of visual elements</li>
 * </ul>
 * 
 ...
 * 
 * <ul>
 *   <li><b>Structural Similarity (SSIM)</b> - Perceptual similarity metric</li>
 *   <li><b>Mean Squared Error (MSE)</b> - Pixel-wise difference measurement</li>
 *   <li><b>Histogram Comparison</b> - Statistical color distribution analysis</li>
 *   <li><b>Edge Comparison</b> - Structural element matching</li>
 *   <li><b>Contour Matching</b> - Shape-based similarity</li>
 * </ul>
 * 
 * <h2>Use Cases</h2>
 * 
 ...
 * <ul>
 *   <li>High: Detect pixel-level changes</li>
 *   <li>Medium: Ignore minor variations</li>
 *   <li>Low: Major structural changes only</li>
 * </ul>
 * 
 * <h3>Contour Extraction</h3>
 * <ul>
 *   <li>External only: Outer boundaries</li>
 *   <li>Hierarchical: Nested contours</li>
 *   <li>Simple: Compressed contours</li>
 * </ul>
 * 
 * <h2>Performance Considerations</h2>
 * 
 * <ul>
 *   <li>Full image comparison is computationally expensive</li>
 *   <li>Consider region-of-interest comparison for speed</li>
 *   <li>Contour extraction benefits from binary input</li>
 *   <li>Cache comparison results when possible</li>
 * </ul>
 * 
 * @since 1.0

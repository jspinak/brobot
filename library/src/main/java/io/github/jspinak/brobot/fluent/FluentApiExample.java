...
/**
 * Example demonstrating how to use the Brobot fluent API to create
 * DSL-compatible automation sequences.
 * 
 * This class shows various ways to build automation workflows using
 * the fluent API, which internally creates the same DSL structures
 * that would be loaded from JSON.
 */
public class FluentApiExample {
    ...
    public static InstructionSet createDragDropSequence(
            StateImage sourceItem,
            StateImage targetLocation) {

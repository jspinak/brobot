 ...
 * 
 * <p>This configuration suppresses debug messages from native libraries like JavaCV/FFmpeg
 * that print directly to stdout/stderr, bypassing the Java logging system.</p>
 * 
 * <p>Examples of messages that are suppressed:</p>
 * <ul>
 *   <li>"Debug: Loading library nppig64_12"</li>
 *   <li>"Debug: Failed to load for nppig64_12: java.lang.UnsatisfiedLinkError"</li>
 *   <li>"Debug: Collecting org.bytedeco.javacpp.Pointer$NativeDeallocator"</li>
 * </ul>
 * 
 * @since 1.0
 */
...
public class NativeLibraryLoggingConfig {
     ...
     * This must run very early in the application lifecycle.
     */
    @PostConstruct

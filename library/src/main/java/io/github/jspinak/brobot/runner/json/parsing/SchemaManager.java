 ...
 *
 * <p>This class provides centralized schema management for validating JSON configurations against
 * predefined schemas. It supports JSON Schema draft v7 and provides efficient caching to avoid
 * repeated schema loading from resources.
 *
 * <p>Key features:
 *
 * <ul>
 *   <li>Schema caching - Schemas are loaded once and cached for performance
 *   <li>Multiple schema support - Manages different schemas for various config types
 *   <li>Validation utilities - Provides both boolean and detailed error validation
 *   <li>Resource-based loading - Schemas are loaded from classpath resources
 * </ul>
 *
 * <p>Supported schemas:
 *
 * <ul>
 *   <li>Project schema - Validates project configuration structure
 *   <li>Automation DSL schema - Validates automation workflow definitions
 * </ul>
 *
...
public class SchemaManager {
     ...
     *
     * <p>This method implements lazy loading with caching. The first request for a schema triggers
     * loading from the classpath, and subsequent requests return the cached instance.
     *
     * @param schemaPath The classpath path to the schema resource (e.g.,
    ...
    public JsonSchema getSchema(String schemaPath) throws ConfigurationException {
        ...
        try {
            ...
            throw new ConfigurationException(
                    "Failed to load schema " + schemaPath + ": " + e.getMessage(), e);
        }
    }
     ...
     *
     * <p>This method returns the complete set of validation messages, allowing callers to inspect
     * all validation errors in detail. An empty set indicates valid JSON.
     *
     ...
     */
    public Set<ValidationMessage> validate(JsonNode json, String schemaPath)
     ...
     *
     * <p>This is a convenience method that returns a simple boolean result. Use {@link
     * #validate(JsonNode, String)} for detailed error information.
     *
     * @param json The JSON node to validate
     * @param schemaPath The classpath path to the schema to validate against
     ...
     *
     * <p>This method is useful when you want validation to halt execution on failure. All
     * validation errors are collected into a single, formatted error message for clear problem
     * identification.
     *
     * @param json The JSON node to validate
     * @param schemaPath The classpath path to the schema to validate against
     * @param configName A descriptive name for the configuration being validated (used in error
     *     messages)
     * @throws ConfigurationException containing all validation errors if validation fails
     */
    public void validateWithErrors(JsonNode json, String schemaPath, String configName)
            throws ConfigurationException {
     ...
     *
     * <p>Schemas must be available as classpath resources. This method handles resource loading and
     * converts the schema JSON into a JsonSchema instance using the configured schema factory.
     *
     ...
     *
     * <p>This method is useful during development or when schemas may have changed. In production,
     * schemas are typically static and clearing the cache is unnecessary.
     */
     ...
     *
     * <p>The project schema defines the structure for project-level configurations including
     * metadata, dependencies, and project settings.
     *
     ...
     *
     * <p>The automation DSL schema defines the structure for automation workflows, including
     * states, transitions, actions, and other automation primitives.
     *

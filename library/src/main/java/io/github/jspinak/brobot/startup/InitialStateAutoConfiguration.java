 ...
 * 
 * <p>This configuration automatically handles states marked with @State(initial = true)
...
public class InitialStateAutoConfiguration {
     ...
     * Applications can override this by providing their own BrobotStartupConfiguration bean.
     * 
     ...
     * This listener is triggered after all beans are initialized and the application is fully started.
     * 
     * <p>The activation includes a configurable delay for real mode to allow the GUI to stabilize
     * before attempting to find states on the screen.</p>
     * 
    ...
    public static class TestInitialStateConfiguration {
        ...
        @Bean
        @ConditionalOnMissingBean
        public BrobotStartupConfiguration testBrobotStartupConfiguration(InitialStates initialStates) {

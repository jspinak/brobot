 ...
 * press and release events, including which button to press and timing
 * parameters.
 * It is designed to be a reusable component, composed within higher-level
 * action
 * configurations like {@code ClickOptions}, {@code DragOptions},
 * {@code MouseDownOptions},

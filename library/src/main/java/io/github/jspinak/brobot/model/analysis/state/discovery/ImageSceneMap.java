 ...
 *
 * <p>This class maintains a mapping between an image and the set of scene identifiers where that
 * image has been found. It's used during scene analysis to track which images appear in which
 * scenes, facilitating scene-based image matching strategies.
 *
...
public class ImageSceneMap {
     ...
     *
     * <p>If the scene is already associated with this image, this method has no effect (as the
     * underlying collection is a Set).
     *
     ...
     *
     * <p>This is a convenience method that internally calls {@link #addScene(int)} for each scene
     * in the provided set. Duplicate scenes are automatically handled by the underlying Set
     * implementation.
     *

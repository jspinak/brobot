 ...
 * 
 * <p>This class provides a single source of truth for mock mode status and ensures
 * consistency across all components that need to check or set mock mode.</p>
 * 
...
public class MockModeManager {
     ...
     * 
     * <p>This method checks ExecutionEnvironment as the authoritative source,
     * falling back to system properties if ExecutionEnvironment is not initialized.</p>
     * 
     ...
     * mock mode is consistently set based on configuration.</p>
     */

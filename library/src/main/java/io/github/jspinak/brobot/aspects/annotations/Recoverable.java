 ...
 * 
 * <p>Methods annotated with @Recoverable will be automatically retried
 * by the ErrorRecoveryAspect when they throw exceptions. The retry behavior
 * can be customized using the annotation parameters.</p>
 * 
 * <p>Example usage:</p>
 * <pre>
 * {@code
...
public @interface Recoverable {
     ...
     * Default is 2.0 (doubling delay each time).
     */
     ...
     * Empty array means retry on any exception.
     */
     ...
     * Method must have the same parameters as the annotated method.

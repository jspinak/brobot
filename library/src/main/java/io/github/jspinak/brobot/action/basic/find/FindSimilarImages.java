...
/**
 * The image to compare is in ObjectCollections #1 (0), in the list of StateImage objects. The
 * images to compare with are in ObjectCollections #2 (1), in the list of StateImage objects.
 */
@Component
public class FindSimilarImages {
    ...
    public void find(ActionResult actionResult, List<ObjectCollection> objectCollections) {
        ...
        if (objectCollections.get(0).getStateImages().isEmpty()
                || objectCollections.get(1).getStateImages().isEmpty()) return;
        /*

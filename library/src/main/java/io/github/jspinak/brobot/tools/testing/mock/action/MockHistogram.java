 ...
 * This class generates simulated histogram matches without performing actual
 * image analysis, useful for unit tests and prototyping.
 * 
 * <p>Mock matches are created with random similarity scores between 0 and 99,
 * allowing tests to verify histogram matching workflows without requiring
 * actual image processing.</p>
 * 
 * @see Match
 * @see StateImage
 * @see Region
...
public class MockHistogram {
     ...
     * Creates one {@link Match} object for each search region with a random
     * similarity score between 0 and 99. This method simulates the behavior
     * of actual histogram matching without performing image analysis.
     * 

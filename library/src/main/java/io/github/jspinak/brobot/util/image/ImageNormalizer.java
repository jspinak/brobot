 ...
 * <ul>
 *   <li>Different bit depths (24-bit RGB vs 32-bit ARGB)</li>
 *   <li>Inconsistent alpha channel handling</li>
 *   <li>Format variations between captured and saved images</li>
 *   <li>Color space differences affecting pattern matching</li>
 * </ul>
 * </p>
 * 
 * <p>The normalizer provides methods to:
 * <ul>
 *   <li>Convert images to standard RGB (24-bit) or ARGB (32-bit) formats</li>
 *   <li>Handle transparent areas consistently</li>
 *   <li>Diagnose format compatibility issues</li>
 *   <li>Save and load images with consistent formatting</li>
 * </ul>
 * </p>
 * 
 * <p>This is particularly useful when working with:
 * <ul>
 *   <li>Screenshots from different capture methods</li>
 *   <li>Pattern images created in different tools</li>
 *   <li>Cross-platform pattern matching</li>
 *   <li>DPI-scaled environments</li>
 * </ul>
 * </p>
 * 
 * @since 1.0
...
public class ImageNormalizer {
    ...
    /**
     * Normalizes an image to consistent RGB format (24-bit) without alpha channel,
     * using a specified background color for transparent areas.
     * 
     * @param source The source image
    ...
    public static String getImageTypeName(int type) {
        switch (type) {
            ...
            case BufferedImage.TYPE_BYTE_INDEXED: return "INDEXED (8-bit)";
            case BufferedImage.TYPE_USHORT_GRAY: return "GRAY (16-bit)";
            case BufferedImage.TYPE_USHORT_565_RGB: return "RGB 565 (16-bit)";
            case BufferedImage.TYPE_USHORT_555_RGB: return "RGB 555 (15-bit)";

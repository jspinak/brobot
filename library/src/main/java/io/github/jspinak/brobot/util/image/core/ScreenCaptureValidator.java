 ...
 * validates captured images, and provides diagnostics.
 */
@Component
public class ScreenCaptureValidator {
    ...
    public static class ValidationResult {
        ...
        public boolean hasNonBlackPixels() {
            return hasNonBlackPixels;
        }
    }
    ...
    public ValidationResult validateScreenCapture() {
        ...
        if (isHeadless) {
            return new ValidationResult(
                    false, "Screen capture not available in headless mode", null, true, false);
        }
        ...
        try {
            ...
            if (capturedImage == null) {
                return new ValidationResult(
                        false, "Screen capture returned null", null, isHeadless, false);
            }
            ...
            return new ValidationResult(
                    true, "Screen capture validated successfully", capturedImage, isHeadless, true);

 ...
 *
 * <p>This class offers convenience methods that simplify the creation and execution of {@link
 * SelectActionObject} instances. It wraps the more complex setup required by the {@link Select}
...
public class CommonSelect {
     ...
     *
     * <p>This convenience method creates a {@link SelectActionObject} with the provided parameters
     * and executes the selection operation. The operation will swipe in the specified direction up
     * to maxSwipes times, looking for the target images. When found, it will click on them the
     ...
     */
    public SelectActionObject select(
            Region swipeRegion,
            PatternFindOptions.Strategy findStrategy,
            int clicksPerImage,
     ...
     *
     * <ul>
     *   <li>Swipe locations based on the region and direction
     *   <li>Drag action with a 0.5 second pause before mouse up
     *   <li>Find action with the specified find type
     *   <li>Click action with the specified number of clicks and 0.7 second pause between clicks
     *   <li>Confirmation find action (if confirmation images are provided)
     * </ul>
     *
     * @param images The target images to search for during swiping
     ...
     * @param swipeDirection The direction to swipe (e.g., TOP, BOTTOM, LEFT, RIGHT)
     * @param maxSwipes Maximum number of swipes to perform before giving up
     * @return The {@link SelectActionObject} containing the operation results, including success
     *     status and total swipes performed
     */
    public SelectActionObject select(
            List<StateImage> images,
            List<StateImage> confirmationImages,
            Region swipeRegion,
            PatternFindOptions.Strategy findStrategy,
            int clicksPerImage,
            Position swipeDirection,
        ...
        ObjectCollection swipeFromObjColl =
        ...
        ClickOptions clickActionConfig =
                new ClickOptions.Builder()
                        ...
                        .setPressOptions(
                                MousePressOptions.builder().setPauseAfterMouseUp(0.7).build())
                        .build();
        ...
        PatternFindOptions confirmActionConfig =
                new PatternFindOptions.Builder()
                        ...
                        .build();
        SelectActionObject selectActionObject =
     ...
     *
     * <p>This method provides the same functionality as the legacy select method but uses the
     * modern ActionConfig implementations (PatternFindOptions, ClickOptions, DragOptions) for
     ...
     * @return The {@link SelectActionObject} containing the operation results and state
     */
    public SelectActionObject selectWithConfig(
            Region swipeRegion,
            PatternFindOptions.Strategy findStrategy,
            int clicksPerImage,
            Position swipeDirection,
     ...
     *
     * <p>This method provides the same functionality as the legacy select method but uses the
     * modern ActionConfig implementations for better type safety and cleaner code. It constructs
     * DragOptions for swiping, PatternFindOptions for finding images, and ClickOptions for clicking
     * on matches.
     *
     * @param images The target images to search for during swiping
     * @param confirmationImages Images to find after clicking to confirm success (can be empty)
    ...
    public SelectActionObject selectWithConfig(
        ...
        SelectActionObject.Builder builder =
                new SelectActionObject.Builder()
                        .setSwipeFromObjColl(swipeFromObjColl)
                        .setSwipeToObjColl(swipeToObjColl)

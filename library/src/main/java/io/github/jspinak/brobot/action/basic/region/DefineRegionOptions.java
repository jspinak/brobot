 ...
 *
 * <p>This class encapsulates all parameters for defining a new region on the screen based on
 * various strategies, such as using anchors, existing matches, or the focused window. It is an

 ...
 * Each implementation handles a specific verbosity level (QUIET, NORMAL, VERBOSE).
 * 
 * <p>Formatters are responsible for:
 * <ul>
 *   <li>Determining if an action should be logged at their verbosity level</li>
 *   <li>Extracting relevant data from ActionResult</li>
 *   <li>Formatting the data into appropriate string representation</li>
 *   <li>Handling edge cases (missing data, null values, etc.)</li>
 * </ul>
 * </p>
 * 
 * <p>Design principles:
 * <ul>
 *   <li>Formatters are stateless - can be safely used by multiple threads</li>
 *   <li>Formatters only read data - never modify ActionResult</li>
 *   <li>Each formatter is responsible for one verbosity level only</li>
 *   <li>Null return values indicate the action should not be logged</li>
 * </ul>
 * </p>
 */

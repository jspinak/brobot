 ...
 * 
 * This wrapper class provides a stable API for find operations while allowing
 * the underlying implementation to switch between mock and live execution modes.
 * It breaks the circular dependency by not being referenced by the mock implementations.
 */
@Component
public class FindWrapper {
    ...
    public FindWrapper(ExecutionMode executionMode, 
                      MockFind mockFind,

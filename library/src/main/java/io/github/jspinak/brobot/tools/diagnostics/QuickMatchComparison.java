...
/**
 * Quick comparison tool to test the hypothesis that SikuliX loads patterns differently when using
 * Pattern(String) vs Pattern(BufferedImage).
 *
 * <p>Run this with: java -cp <classpath> QuickMatchComparison <pattern-path>
 */

 ...
 *
 * <p>Produces minimal single-line output in the format: ✓ Find Working.ClaudeIcon • 234ms ✗ Find
 * Working.ClaudeIcon • 234ms
 *
 * <p>Only logs completed actions (success or failure), skips start events.
 */
@Component

 ...
 *
 * <p>This class provides practical examples of migrating from older composite action patterns (like
 * MultipleActionsObject, ActionResultCombo) to the modern ActionChainOptions approach. Each example
 * shows both the old way and the new way to help developers migrate their code.
 *
 * <p>Key benefits of ActionChainOptions:
 *
 * <ul>
 *   <li>Unified API for all action compositions
 *   <li>Better type safety with ActionConfig
 *   <li>Clear chaining strategies (NESTED, CONFIRM)
 *   <li>Proper result flow between actions
 * </ul>
 *
...
public class ActionChainExamples {
     ...
     *
     * <p>Shows how to chain multiple actions that execute in sequence. Common for form filling,
     * multi-step operations.
     */
    public ActionResult fillLoginForm(
        ...
        // ObjectCollection.Builder().withStrings(username).build()));
        // ...

        // New way with ActionChainOptions:
        ActionChainOptions loginChain =
                new ActionChainOptions.Builder(
                        ...
                        .then(new ClickOptions.Builder().setPauseAfterEnd(0.2).build())
                        // Then: Type password
                        .then(new TypeOptions.Builder().setTypeDelay(0.05).build())
                        // Finally: Click login button
                        .then(new ClickOptions.Builder().setPauseAfterEnd(1.0).build())
                        .build();
     ...
     *
     * <p>Shows how to click something and verify the result appears. Common for testing UI
     * interactions.
     */
    public ActionResult clickAndVerify(StateImage buttonToClick, StateImage expectedResult) {
        ...
        // New way with ActionChainOptions:
        ActionChainOptions clickVerifyChain =
                new ActionChainOptions.Builder(
                                new ClickOptions.Builder().setPauseAfterEnd(0.5).build())
                        .then(
     ...
     *
     * <p>Shows how to use NESTED strategy to find elements within other elements. Common for
    ...
    public ActionResult findButtonInDialog(StateImage dialog, StateImage button) {
        ...
        ActionChainOptions nestedSearch =
                new ActionChainOptions.Builder(
                                new PatternFindOptions.Builder()
                                        .setStrategy(PatternFindOptions.Strategy.FIRST)
                                        .build())
     ...
     *
     * <p>Shows how to use CONFIRM strategy to validate matches. Useful for reducing false
     * positives.
     */
    public ActionResult findAndConfirm(StateImage primaryImage, StateImage confirmationImage) {
        ...
        ActionChainOptions confirmChain =
                new ActionChainOptions.Builder(
                                new PatternFindOptions.Builder()
     ...
     *
     * <p>Shows how to build more complex workflows with multiple action types. This example: Find
     * element → Move to it → Click → Verify result
     */
    public ActionResult complexWorkflow(StateImage target, StateImage expectedResult) {

        ActionChainOptions workflow =
                new ActionChainOptions.Builder(
                        ...
                        .then(new ClickOptions.Builder().setPauseAfterEnd(0.3).build())
     ...
     *
     * <p>Shows how to create reusable chain patterns for common operations.
     */
    public static class ChainPatterns {
        ...
        public static ActionChainOptions clickAndVerify(double verifyTimeout) {
            return new ActionChainOptions.Builder(new ClickOptions.Builder().build())
                    .then(
                            new PatternFindOptions.Builder()
        ...
        public static ActionChainOptions typeAndVerify(double typeDelay, double verifyTimeout) {
            return new ActionChainOptions.Builder(
                            new TypeOptions.Builder().setTypeDelay(typeDelay).build())
                    .then(
                            new PatternFindOptions.Builder()
                                    .setPauseBeforeBegin(verifyTimeout)
                                    .build())
        ...
        public static ActionChainOptions dismissElement() {
            return new ActionChainOptions.Builder(
                            new PatternFindOptions.Builder()
                                    ...
                                    .build())
                    .then(new ClickOptions.Builder().setPauseAfterEnd(0.3).build())
                    .then(new VanishOptions.Builder().setTimeout(2.0).build())
                    .build();
        }
    }
     ...
     *
     * <p>Shows how to build chains dynamically based on conditions.
     */
    public ActionChainOptions buildDynamicChain(
            boolean needsAuthentication, boolean needsConfirmation) {

        ActionChainOptions.Builder builder =
                new ActionChainOptions.Builder(new PatternFindOptions.Builder().build());
        ...
        if (needsConfirmation) {
            builder.then(new PatternFindOptions.Builder().setPauseBeforeBegin(3.0).build());
        }

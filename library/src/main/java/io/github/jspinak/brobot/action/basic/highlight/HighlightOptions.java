 ...
 *
 * <p>This class encapsulates all parameters for highlighting regions on the screen, including the
 * duration, color, and whether to highlight all matches simultaneously. It is an immutable object
...
public final class HighlightOptions extends ActionConfig {
    ...
    public static class Builder extends ActionConfig.Builder<Builder> {
        ...
        /**
         * If true, all found matches will be highlighted simultaneously. If false, each match will
         * be highlighted sequentially.
         *
        ...
        /**
         * Sets the color of the highlight. The color can be specified by name (e.g., "red", "blue")
         * or as a hex code. Refer to SikuliX documentation for supported color formats.
         *

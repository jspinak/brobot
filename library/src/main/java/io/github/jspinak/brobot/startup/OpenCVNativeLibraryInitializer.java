 ...
 * 
 * <p>This class ensures that native OpenCV libraries are properly loaded
 * before any OpenCV operations are performed. It runs very early in the
 * application lifecycle to prevent UnsatisfiedLinkError exceptions.</p>
 * 
 * <p>The initialization happens in multiple places to ensure libraries are
 * loaded regardless of how the application starts:</p>
 * <ul>
 *   <li>Static initializer block - runs when class is first loaded</li>
 *   <li>ApplicationContextInitializer - runs during Spring Boot startup</li>
 *   <li>@PostConstruct - runs after bean creation as a fallback</li>
 * </ul>
 * 
 * @since 1.0
 */
...
public class OpenCVNativeLibraryInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    
    private static final AtomicBoolean initialized = new AtomicBoolean(false);
    
    /**
     * Static initializer to load libraries as early as possible.
     * This runs when the class is first loaded by the JVM.
     */
    static {
     ...
     * This ensures libraries are loaded even if the ApplicationContextInitializer

 ...
 * 
 * This agent must be loaded with: -javaagent:brobot.jar
 * 
 * @since 1.1.0
 */
public class DPIAgent {
     ...
     * This is the earliest possible point to set system properties.
     */
    ...
    public static void agentmain(String args, Instrumentation inst) {
        System.err.println("[Brobot Agent] WARNING: Setting DPI properties after JVM start may not work!");
        premain(args, inst);
    }
}
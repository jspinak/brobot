 ...
 * displayed in the console during automation execution.
 * 
 * <p>This configuration can be set via properties files using the prefix
 * "brobot.console.actions". For example:</p>
 * <pre>
...
public class ConsoleActionConfig {
    ...
    /**
     * Whether to show detailed match information (location, score).
     * Only applies when level is VERBOSE.
     * Default: true
     */
     ...
     * Actions taking longer than this will trigger a warning.
     * Default: 1000ms
     */
    private long performanceWarnThreshold = 1000;
    
    /**
     * Threshold in milliseconds for performance errors.
     * Actions taking longer than this will be highlighted as errors.
     * Default: 5000ms
     */

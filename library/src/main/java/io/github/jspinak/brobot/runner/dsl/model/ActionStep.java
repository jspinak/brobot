 ...
 * <p>
 * An ActionStep combines action configuration with target objects, forming the basic
 * unit of execution in an {@link TaskSequence}. Each step specifies what action
 * to perform (via ActionOptions) and what to perform it on (via ObjectCollection).
 * <p>
 * This class is designed for serialization, allowing automation sequences to be
 * defined in configuration files and loaded dynamically at runtime.
 * <p>
 * Example usage:
 * <pre>
...
public class ActionStep {
     ...
     * Contains the visual elements (images, regions, etc.) that the action
     * will operate on.
     */
     ...
     * Shows the action type and details about the target state images

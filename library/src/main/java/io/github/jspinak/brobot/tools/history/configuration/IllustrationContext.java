 ...
 *
 * <p>This class provides comprehensive context about the current action execution environment,
 * enabling sophisticated illustration filtering and optimization decisions. The context includes:
 *
 * <ul>
 *   <li>Current action details and configuration
 *   <li>Historical action execution data
 *   <li>System performance metrics
 *   <li>Current state information
 *   <li>Resource utilization data
 * </ul>
 *
 * <p>Used by context filters to make intelligent decisions about when illustrations should be
 * generated based on current conditions.
 *
...
public class IllustrationContext {
    ...
    @Builder.Default private final Priority priority = Priority.NORMAL;
    ...
    public <T> T getActionConfig(Class<T> configType) {
        if (currentActionConfig != null
                && configType.isAssignableFrom(currentActionConfig.getClass())) {

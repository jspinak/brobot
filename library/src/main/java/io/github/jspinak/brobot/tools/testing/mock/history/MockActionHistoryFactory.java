 ...
 *
 * <p>This factory provides convenient methods for creating ActionHistory instances for common UI
 * testing scenarios. It includes presets for screen positions, reliability patterns, and custom
 * configurations.
 *
 * <p>Example usage:
 *
...
public class MockActionHistoryFactory {
    ...
    /**
     * Creates ActionHistory for a reliable UI button. High success rate with quick response times.
     *
    ...
    /**
     * Creates ActionHistory for a dynamic text field. Lower similarity due to changing content.
     *
    ...
    /**
     * Creates ActionHistory for a loading indicator. Variable success rate as it
     * appears/disappears.
     *
    ...
    /**
     * Creates ActionHistory for a menu item. High reliability when visible, but may be hidden
     * initially.
     *
    ...
    /**
     * Creates ActionHistory for a modal dialog. Very reliable when present, with high similarity.
     *
     ...
     * notifications, or chat interfaces.
     *
    ...
    /**
     * Creates a cached ActionHistory that can be reused. Useful for elements that appear frequently
     * across tests.
     *
    ...
    /** Clears the preset cache. Should be called between test suites to ensure isolation. */

 ...
 * While {@link io.github.jspinak.brobot.runner.dsl.expressions.MethodCallExpression} is used
 * when the return value is needed, this statement is used when only the method's
 * side effects are desired (e.g., logging, UI interactions, state modifications).
 * <p>

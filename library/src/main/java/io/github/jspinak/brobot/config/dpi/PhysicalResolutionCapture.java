 ...
 * 
 * This is a workaround for when DPI awareness cannot be disabled at JVM startup.
 * 
 * @since 1.1.0
 */
public class PhysicalResolutionCapture {
    
    private static final boolean DPI_AWARE = !"false".equals(System.getProperty("sun.java2d.dpiaware"));
    ...
    public static BufferedImage capturePhysical(Screen screen) {
        ...
        System.out.println(String.format(
            ...
            logicalCapture.getWidth(), logicalCapture.getHeight(),
            physicalWidth, physicalHeight, scaleFactor
        ));
    ...
    public static String getCaptureMode() {
        ...
        return String.format("Logical resolution with %.0f%% scaling (will scale up captures)", scale * 100);
    }
}
 ...
 * 
 * <p>This interface defines the contract for keyboard control implementations,
 * completely decoupled from any higher-level components like Find or Actions.
 * It represents pure keyboard control functionality with no dependencies on
 * the Brobot action framework.</p>
 * 
 * <p>Implementations can use various technologies for keyboard control:
 * <ul>
 *   <li>AWT Robot for Java-based control</li>
 *   <li>Sikuli's keyboard control capabilities</li>
 ...
 *   <li>Pure keyboard control - no pattern matching or element finding</li>
 *   <li>Support for text typing and special key combinations</li>
...
public interface KeyboardController {
     ...
     * 
     * <p>This method simulates typing the given text as if typed
     * on a physical keyboard. The typing speed may vary based on
     ...
     * 
     * <p>This method allows control over typing speed by specifying
     * a delay in milliseconds between each character.</p>
     * 
     * @param text The text to type
     ...
     * 
     * <p>This method simulates pressing a special key like Enter,
     * Tab, or function keys.</p>
     * 
     ...
     * 
     * <p>This method is useful for key combinations where a modifier
     * key needs to be held while other keys are pressed.</p>
     * 
     ...
     * 
     * <p>This method releases a key that was pressed with keyDown.</p>
     * 
     ...
     * 
     * <p>This method handles common shortcuts like Ctrl+C, Ctrl+V, etc.</p>
     * 
     ...
     * 
     * <p>This method handles complex shortcuts like Ctrl+Shift+S.</p>
     * 
     ...
     * 
     * <p>This method handles shortcuts like Alt+Tab, Ctrl+Home, etc.</p>
     * 
     ...
     * 
     * <p>This method first selects all text (Ctrl+A), then types
     * the new text, effectively replacing any existing content.</p>
     * 
     ...
     * 
     * <p>Convenience method for the copy shortcut.</p>
     * 
     ...
     * 
     * <p>Convenience method for the paste shortcut.</p>
     * 
     ...
     * 
     * <p>Convenience method for the cut shortcut.</p>
     * 
     ...
     * 
     * <p>Convenience method for the select all shortcut.</p>
     * 
     ...
     * 
     * <p>This method can be used to verify that keyboard control
     * is possible in the current environment.</p>
     * 

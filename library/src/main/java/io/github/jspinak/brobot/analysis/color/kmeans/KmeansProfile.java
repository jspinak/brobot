...
/**
 * KmeansProfile represents a k-means analysis for one number of means and one color schema (BGR,
 * HSV, etc.). It holds a list of clusters, each of which describes, for each channel, the points
 * associated with one of the centers.
 */
@Getter
public class KmeansProfile {
     ...
     *
     * <p>This method identifies the cluster that contains the highest percentage of pixels across
     * all color channels. The dominant cluster typically represents the primary color theme of the
     * image and is useful for color-based matching and classification tasks.
     *
     * <p>Note: This method sorts the clusters list as a side effect, which modifies the internal
     * state of the object.
     *

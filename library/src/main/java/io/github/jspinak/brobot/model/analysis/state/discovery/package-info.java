 ...
 * 
 * <p>This package contains specialized models that support the automated
 * discovery of application states and their relationships. These models
 * enable Brobot to learn application structure through exploration and
 * observation, building state models dynamically.</p>
 * 
 * <h2>Core Components</h2>
 * 
 * <ul>
 *   <li>{@link io.github.jspinak.brobot.model.analysis.state.discovery.ProvisionalState} - 
 *       Candidate state under evaluation before formal acceptance</li>
 *   <li>{@link io.github.jspinak.brobot.model.analysis.state.discovery.ImageSceneMap} - 
 *       Mapping between discovered images and their scene contexts</li>
 * </ul>
 * 
 ...
 * 
 * <p>ProvisionalState represents a potential state that hasn't been
 * confirmed yet. Key features:</p>
 * <ul>
 *   <li><b>Element Collection</b> - Accumulates discovered elements</li>
 *   <li><b>Confidence Tracking</b> - Measures state stability</li>
 *   <li><b>Validation Logic</b> - Tests against new observations</li>
 *   <li><b>Conversion</b> - Transforms to formal State when ready</li>
 * </ul>
 * 
 ...
 * 
 * <p>ImageSceneMap tracks where images appear across different scenes:</p>
 * <ul>
 *   <li>One-to-many: Image can appear in multiple scenes</li>
 *   <li>Many-to-one: Scene contains multiple images</li>
 *   <li>Temporal: Track when images appear/disappear</li>
 *   <li>Contextual: Understand image roles in different contexts</li>
 * </ul>
 * 
 ...
 * 
 * <p>The discovery process learns application structure:</p>
 * <ol>
 *   <li>Observe application behavior</li>
 *   <li>Identify recurring visual patterns</li>
 *   <li>Group patterns into provisional states</li>
 *   <li>Validate state uniqueness and stability</li>
 *   <li>Discover transitions between states</li>
 *   <li>Build complete state model</li>
 * </ol>
 * 
 ...
 * 
 * <ol>
 *   <li>Require multiple confirmations before accepting states</li>
 *   <li>Track negative evidence (elements that should NOT appear)</li>
 *   <li>Consider dynamic content when validating states</li>
 *   <li>Use image-scene maps to identify state indicators</li>
 *   <li>Combine automated discovery with manual verification</li>
 *   <li>Version discovered models for change tracking</li>
 * </ol>
 * 
 * @since 1.0

...
/**
 * JavaCV FFmpeg-based capture provider that uses bundled FFmpeg libraries. No external FFmpeg
 * installation required.
 *
 * <p>This provider captures at physical resolution (1920x1080) bypassing DPI scaling. It's ideal
 * for matching patterns created with Windows or SikuliX IDE.
 *
 * @since 1.1.0
 */
@Component

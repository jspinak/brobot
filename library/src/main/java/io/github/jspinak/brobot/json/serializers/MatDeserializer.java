 ...
 * 
 * Reconstructs Mat from JSON representation containing matrix metadata and data.
 * Handles both complete matrix data and metadata-only representations.
 */
public class MatDeserializer extends JsonDeserializer<Mat> {
    
    @Override
    public Mat deserialize(JsonParser parser, DeserializationContext context) 
            throws IOException {

...
/**
 * Tracks state information discovered during action execution. Manages active states and
 * state-specific match associations.
 *
 * <p>This class encapsulates state tracking functionality that was previously embedded in
 * ActionResult.
 *
 * @since 2.0
 */
...
public class StateTracker {
    ...
    public int getTotalMatchCount() {
        return stateMatches.values().stream().mapToInt(List::size).sum();
    }

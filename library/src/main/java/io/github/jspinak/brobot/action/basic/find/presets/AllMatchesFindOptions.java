 ...
 *
 * <ul>
 *   <li>You need to find all instances of repeating elements (lists, grids, toolbars)
 *   <li>You're counting occurrences of an element
 *   <li>You need to process multiple similar items
 *   <li>You're working with dynamic content where element count varies
 * </ul>
 *
 * <p>Default settings:
 *
 * <ul>
 *   <li>Strategy: ALL (finds all matches across the screen)
 *   <li>Similarity: 0.8 (balanced threshold for reliable detection)
 *   <li>Capture Image: false (disabled by default for performance with many matches)
 *   <li>Match Fusion: enabled to combine adjacent matches
 *   <li>Max Matches: unlimited (-1)
 * </ul>
 *
 * <p>Example usage:
 *
...
public final class AllMatchesFindOptions {
    ...
    /**
     * The default similarity threshold for finding all matches. Balanced to avoid false positives
     * while catching variations.
     */
    public static final double DEFAULT_SIMILARITY = 0.8;

    /**
     * The default maximum distance for match fusion. Appropriate for combining adjacent UI
     * elements.
     */
     ...
     *
     * <p>The builder starts with optimized defaults for finding multiple matches but allows
     * customization of any setting if needed.
     *

 ...
 * 
 * <p>This package provides comprehensive scene analysis capabilities for
 * understanding and classifying screen content. Scenes represent complete
 * screen captures or regions that can be analyzed for state detection,
 * element identification, and visual changes.</p>
 * 
 * <h2>Core Components</h2>
 * 
 * <ul>
 *   <li>{@link io.github.jspinak.brobot.model.analysis.scene.SceneAnalysis} - 
 *       Single scene analysis with multi-image classification</li>
 *   <li>{@link io.github.jspinak.brobot.model.analysis.scene.SceneAnalyses} - 
 *       Collection of scene analyses for temporal tracking</li>
 *   <li>{@link io.github.jspinak.brobot.model.analysis.scene.SceneCombination} - 
 *       Combined analysis of multiple scenes</li>
 * </ul>
 * 
 * <h2>Scene Analysis Process</h2>
 * 
 * <p>Scene analysis follows a structured pipeline:</p>
 * <ol>
 *   <li><b>Capture</b> - Screenshot of screen or region</li>
 *   <li><b>Preprocessing</b> - Color space conversion, filtering</li>
 *   <li><b>Classification</b> - Pixel-by-pixel analysis against known patterns</li>
 *   <li><b>Aggregation</b> - Combine pixel results into regions</li>
 *   <li><b>Interpretation</b> - Determine states and elements present</li>
 * </ol>
 * 
 * <h2>Analysis Types</h2>
 * 
 * <p>SceneAnalysis stores multiple analysis results:</p>
 * <ul>
 *   <li><b>SCENE</b> - Original captured scene in BGR/HSV</li>
 *   <li><b>INDICES_3D</b> - Per-channel classification indices</li>
 *   <li><b>INDICES_2D</b> - Flattened classification results</li>
 *   <li><b>BGR_FROM_INDICES_2D</b> - Visualization of classification</li>
 *   <li><b>SCORES</b> - Confidence scores per pixel</li>
 * </ul>
 * 
 ...
 * 
 * <p>Multiple scenes can be combined for robust detection:</p>
 * <pre>{@code
 ...
 * 
 * <p>Scenes are primarily used for state detection:</p>
 * <pre>{@code
 ...
 * <p>Limit analysis to specific regions for performance:</p>
 * <pre>{@code
 ...
 * 
 * <h3>Caching</h3>
 * <p>Cache analysis results for static content:</p>
 * <pre>{@code
 ...
 * 
 * <ul>
 *   <li>State detection services use scene analysis</li>
 *   <li>Motion detection relies on scene comparison</li>
 *   <li>Color-based find operations use scene classification</li>
 *   <li>History tracking stores scene analyses</li>
 * </ul>
 * 
 * <h2>Best Practices</h2>
 * 
 * <ol>
 *   <li>Predefine pixel profiles for known UI elements</li>
 *   <li>Use appropriate color spaces for the content type</li>
 *   <li>Limit analysis regions when full-screen analysis isn't needed</li>
 *   <li>Cache results for static content</li>
 *   <li>Combine multiple analyses for robust detection</li>
 *   <li>Monitor analysis performance and optimize as needed</li>
 * </ol>
 * 
 * @since 1.0

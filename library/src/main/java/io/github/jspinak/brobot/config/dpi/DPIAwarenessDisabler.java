 ...
 * 
 * <p>This class must be initialized BEFORE any AWT/Swing classes are loaded.
 * The system properties it sets are only effective if set before the Java 2D
 * subsystem initializes.</p>
 * 
 * <p>When DPI awareness is disabled:
 * <ul>
 *   <li>Screen captures will be at physical resolution (e.g., 1920x1080)</li>
 *   <li>Pattern matching will work consistently with SikuliX IDE patterns</li>
 *   <li>No scaling compensation will be needed for high-DPI displays</li>
 * </ul>
 * </p>
 * 
 * @since 1.1.0
...
public class DPIAwarenessDisabler {
    ...
    /**
     * Static initializer block ensures this runs before any AWT classes are loaded.
     * This is critical for the system properties to take effect.
     */
    static {
        initializeEarly();
    }
    ...
    /**
     * Disables DPI awareness by setting appropriate system properties.
     * Must be called before any AWT/Swing classes are loaded.
     */
    private static void disableDPIAwareness() {
        try {
            ...
            System.out.println("[Brobot DPI] DPI awareness DISABLED - captures will be at physical resolution");
            ...
            System.err.println("[Brobot DPI] Warning: Could not set system properties: " + e.getMessage());
     ...
     * Useful for ensuring DPI settings are applied early.
     */

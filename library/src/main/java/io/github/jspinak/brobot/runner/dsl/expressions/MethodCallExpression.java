 ...
 * <p>
 * Method call expressions allow invoking methods on objects or calling static/global
 * functions. They consist of an optional object reference, a method name, and a list
 * of argument expressions. The expression evaluates to the return value of the method.
 * <p>
 * Examples in JSON:
 * <pre>
...
public class MethodCallExpression extends Expression {
     ...
     * Can be null for static methods or global function calls.
     * When non-null, this should reference a variable in the current scope.
     */

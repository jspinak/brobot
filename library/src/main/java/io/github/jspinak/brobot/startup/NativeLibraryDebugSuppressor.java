 ...
 * before beans are created, to ensure native library debug messages are
 * suppressed from the beginning.</p>
 * 
 * <p>This class is registered via META-INF/spring.factories.</p>
 * 
 * @since 1.0
 */
public class NativeLibraryDebugSuppressor implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    private void suppressNativeDebugOutput() {
        ...
        try {
            ...
            java.lang.reflect.Method setDebugMethod = loggerClass.getDeclaredMethod("setDebug", boolean.class);

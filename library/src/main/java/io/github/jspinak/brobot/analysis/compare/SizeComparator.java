...
public class SizeComparator {
     ...
     * <ul>
     * <li>Index 0: The smaller (enveloped) pattern</li>
     * <li>Index 1: The larger (enveloping) pattern</li>
     * </ul>
     * <p>
     * This ordering convention is relied upon by {@link ImageComparer} to set up
     * the search operation correctly.
     *
     * @param p1 The first Pattern to compare. Must not be null and must have a valid BufferedImage.
     * @param p2 The second Pattern to compare. Must not be null and must have a valid BufferedImage.
     * @return A list containing [smaller pattern, larger pattern] if one can contain the other,

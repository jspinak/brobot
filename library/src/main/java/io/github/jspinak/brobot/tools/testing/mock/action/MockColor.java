 ...
 * 
 * <p>
 * MockColor creates synthetic scenes by randomly placing pattern images
 * within a specified region. This enables unit testing of color matching
 * algorithms without requiring actual screenshots or pre-captured scenes.
 * </p>
 * 
 * <p>
 * The mock generation process creates realistic test scenarios by:
 * </p>
 * <ul>
 ...
 * 
 * <p>
 * This component is primarily used when BrobotSettings.mock is enabled,
 * allowing deterministic testing of color-based find operations.
 * </p>
 * 
 * @see ImageLoader
...
public class MockColor {
     ...
     * 
     * <p>
     * Generates a synthetic scene for testing by:
     * </p>
     * <ol>
     ...
     * 
     * <p>
     * The random placement simulates realistic scenarios where patterns
     * may appear multiple times at various locations within a scene.
     * </p>
     * 
     * <p>
     * Note: Current implementation may have edge case issues with pattern
     * placement near region boundaries.
     * </p>
     * 

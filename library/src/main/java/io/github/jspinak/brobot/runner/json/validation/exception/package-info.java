 ...
 * 
 * <p>This package contains specialized exceptions for validation failures,
 * providing detailed information about validation errors including severity,
 * location, and suggestions for resolution. These exceptions support
 * comprehensive error reporting for configuration problems.</p>
 * 
 * <h2>Exception Types</h2>
 * 
 * <ul>
 *   <li>{@link io.github.jspinak.brobot.runner.json.validation.exception.ConfigValidationException} - 
 *       Thrown when configuration validation fails</li>
 * </ul>
 * 
 ...
 * 
 * <ul>
 *   <li>Always include ValidationResult in exception</li>
 *   <li>Provide both summary and detailed messages</li>
 *   <li>Include error location (JSON path)</li>
 *   <li>Add suggestions when possible</li>
 *   <li>Support error grouping and filtering</li>
 *   <li>Enable programmatic error analysis</li>
 * </ul>
 * 
 * @since 1.0

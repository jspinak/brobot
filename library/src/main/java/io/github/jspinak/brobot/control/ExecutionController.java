 ...
 * 
 * <p>This interface is the core contract for implementing execution control
 * throughout the Brobot framework. It enables fine-grained control over
 * automation execution, allowing for interactive debugging, user intervention,
 * and graceful shutdown.</p>
 * 
 * <p>Key features:
 * <ul>
 *   <li>Thread-safe pause/resume mechanism</li>
 *   <li>Graceful stop with cleanup support</li>
 *   <li>State query methods for UI integration</li>
 *   <li>Checkpoint support for pause points</li>
 * </ul>
 * </p>
 * 
 ...
 *   <li>State transitions must be atomic</li>
 *   <li>Pause should block execution until resumed</li>
 *   <li>Stop should allow for cleanup operations</li>
 * </ul>
 * </p>
 */
public interface ExecutionController {
     ...
     * this method throws ExecutionStoppedException.
     * </p>
     * 

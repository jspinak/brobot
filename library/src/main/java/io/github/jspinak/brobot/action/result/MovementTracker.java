 ...
 * Manages drag operations and other movement-based actions.
 * 
 * This class encapsulates movement tracking functionality that was
...
public class MovementTracker {
     ...
     * Convenience method for simple, single-segment actions.
     * 
     ...
     * A path is closed if start and end locations are the same.
     * 
    ...
    public Optional<io.github.jspinak.brobot.model.element.Region> getBoundingBox() {
        ...
        return Optional.of(new io.github.jspinak.brobot.model.element.Region(
    ...
    public String format() {
        ...
        if (movements.size() == 1) {
            ...
            sb.append(String.format(" [(%d,%d)→(%d,%d)]",
                m.getStartLocation().getCalculatedX(), m.getStartLocation().getCalculatedY(),
                m.getEndLocation().getCalculatedX(), m.getEndLocation().getCalculatedY()));

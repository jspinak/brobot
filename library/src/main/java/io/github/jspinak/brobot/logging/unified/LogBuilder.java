 ...
 * 
 * <p>LogBuilder provides a fluent API for constructing detailed log entries with
 * custom metadata, performance metrics, and contextual information. It's designed
 * for scenarios where the simple logging methods in BrobotLogger are insufficient.</p>
 * 
 * <p>Usage example:
 * <pre>{@code
 * logger.log()
 ...
 * </p>
 * 
 * <p>The builder automatically includes context from LoggingContext (session ID,
 * current state, etc.) and validates the constructed event before logging.</p>
 * 
 * @since 2.0
 * @see BrobotLogger
 * @see LogEvent
...
public class LogBuilder {
     ...
     * Package-private as it should only be created by BrobotLogger.
     * 
     ...
     * 
     * <p>This method constructs the final LogEvent, adds all metadata,
     * and routes it through the logger's message router. The event is
     * logged to all configured handlers based on the routing rules.</p>
     */
    public void log() {

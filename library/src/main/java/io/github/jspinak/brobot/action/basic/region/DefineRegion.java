 ...
 * the {@link DefineRegionOptions.DefineAs} configuration. It maps each DefineAs option to its
 ...
 * <ul>
 *   <li>{@link DefineRegionOptions.DefineAs#FOCUSED_WINDOW} - Defines region as the active window bounds</li>
 *   <li>{@link DefineRegionOptions.DefineAs#MATCH} - Defines region as the match bounds</li>
 *   <li>{@link DefineRegionOptions.DefineAs#BELOW_MATCH} - Defines region below a match</li>
 *   <li>{@link DefineRegionOptions.DefineAs#ABOVE_MATCH} - Defines region above a match</li>
 *   <li>{@link DefineRegionOptions.DefineAs#LEFT_OF_MATCH} - Defines region to the left of a match</li>
 *   <li>{@link DefineRegionOptions.DefineAs#RIGHT_OF_MATCH} - Defines region to the right of a match</li>
 *   <li>{@link DefineRegionOptions.DefineAs#INSIDE_ANCHORS} - Defines smallest region containing all anchors</li>
 *   <li>{@link DefineRegionOptions.DefineAs#OUTSIDE_ANCHORS} - Defines largest region containing all anchors</li>
 *   <li>{@link DefineRegionOptions.DefineAs#INCLUDING_MATCHES} - Defines region including all matches</li>
 * </ul>
 * </p>
 * 
...
public class DefineRegion implements ActionInterface {
     ...
     * 
     * <p>This method extracts the DefineAs option from the DefineRegionOptions within the
    ...
    public void perform(ActionResult matches, ObjectCollection... objectCollections) {
        ...
        if (!(config instanceof DefineRegionOptions)) {
            throw new IllegalArgumentException("DefineRegion requires DefineRegionOptions configuration");
        }

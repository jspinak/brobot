 ...
 * 
 * <p>This configuration ensures that SikuliX's verbose internal logs don't 
 * interfere with Brobot's unified logging system. All relevant information
 * from SikuliX operations is captured and logged through Brobot's logging
 * framework instead.</p>
 * 
 * <p>SikuliX logs disabled:
 * <ul>
 *   <li>[log] messages - General SikuliX operation logs</li>
 *   <li>highlight messages - Region highlighting logs</li>
 *   <li>find/click/type action logs - Action execution logs</li>
 *   <li>Debug messages - SikuliX debug output</li>
 * </ul>
 * </p>
 * 
 * @since 2.0
...
public class SikuliXLoggingConfig {
    ...
    public static void enableSikuliXLoggingForDebugging(int level) {
        ...
        log.warn("SikuliX logging temporarily enabled at level {} - remember to disable for production", level);
    }

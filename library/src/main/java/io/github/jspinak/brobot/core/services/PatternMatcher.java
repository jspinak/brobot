 ...
 * 
 * <p>This interface defines the contract for pattern matching implementations,
 * completely decoupled from any higher-level components like Find or Actions.
 * It represents pure pattern matching functionality with no dependencies on
 * the Brobot action framework.</p>
 * 
 * <p>Implementations of this interface handle the low-level computer vision
 * operations, whether using OpenCV, Sikuli, or other pattern matching libraries.
 * This separation allows for easy swapping of pattern matching engines and
 * testing with mock implementations.</p>
 * 
 * <p>Key design principles:
 * <ul>
 *   <li>No dependencies on Find, Actions, or any higher-level components</li>
 *   <li>Pure pattern matching - input images, output matches</li>
 *   <li>Stateless operations for thread safety</li>
 *   <li>Technology agnostic (OpenCV, Sikuli, etc.)</li>
 * </ul>
 * </p>
 * 
 * @since 2.0.0
...
public interface PatternMatcher {
     ...
     * This class encapsulates all parameters needed for matching,
     * keeping the interface methods clean and extensible.
     */
    class MatchOptions {
        ...
        public boolean isFindAll() { return findAll; }
        public void setFindAll(boolean findAll) { this.findAll = findAll; }
     ...
     * This lightweight class contains only the essential match information,
     * without any dependencies on Brobot's Match class hierarchy.
     */
    class MatchResult {
        private final int x;
        private final int y;
         ...
         * This conversion happens at the boundary between core services
         * and the Brobot framework.
         */
     ...
     * 
     * <p>This method performs the core pattern matching operation,
     * searching for occurrences of the pattern within the screen image.
     * The implementation may use any pattern matching algorithm
     * (template matching, feature matching, etc.).</p>
     * 
     ...
     * 
     * <p>This method optimizes pattern matching by searching only
     * within a specified region of the screen image, improving
     * performance for targeted searches.</p>
     * 
     * @param screen The screen image to search within
     * @param pattern The pattern to search for
     ...
     * @return List of match results, empty if no matches found
     */
    List<MatchResult> findPatternsInRegion(BufferedImage screen, Pattern pattern, 
     ...
     * 
     * <p>This allows for specialized matchers that only handle
     * certain types of patterns (e.g., text patterns, color patterns).</p>
     * 

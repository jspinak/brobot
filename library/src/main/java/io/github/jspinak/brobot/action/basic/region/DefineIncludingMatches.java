 ...
 * 
 * <p>This class creates a single region that includes all matches found in the provided
 * object collections. Unlike anchor-based strategies that use specific points, this
 * approach considers the full bounds of each match to create an all-encompassing region.</p>
 * 
 * <p>The algorithm calculates the minimal bounding box by:
 * <ul>
 *   <li>Finding the leftmost x-coordinate among all matches</li>
 *   <li>Finding the topmost y-coordinate among all matches</li>
 *   <li>Finding the rightmost x-coordinate among all matches</li>
 *   <li>Finding the bottommost y-coordinate among all matches</li>
 * </ul>
 * </p>
 * 
 * <p>This strategy is particularly useful when:
 * <ul>
 *   <li>You need to capture a dynamic area containing multiple UI elements</li>
 *   <li>The exact positions of elements may vary but they form a logical group</li>
 *   <li>You want to ensure all matched elements are within the defined region</li>
 * </ul>
 * </p>
 * 
 * @see DefineRegion
...
public class DefineIncludingMatches implements ActionInterface {
     ...
     *                          from these collections are included in the bounding box.
     */
    @Override
     ...
     * 
     * <p>This method iterates through all matches to find the extreme coordinates
     * in each direction. It uses the top-left corner for minimum coordinates and
     * the top-right/bottom-left corners to find maximum x and y coordinates respectively.</p>
     * 
     * <p>The calculation ensures that the entire area of each match is included,
     * not just their center points or anchor positions.</p>
     * 

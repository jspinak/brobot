 ...
 * <p>
 * This module is the central configuration point for JSON processing of Brobot-specific classes
 ...
 * <li>{@link Image} - Serializes Brobot images with efficient handling of pixel data</li>
 * </ul>
 * <p>
 ...
 * </ul>
 * <p>
 * This module works in conjunction with the mixin classes in {@code io.github.jspinak.brobot.json.mixins}
 * to provide comprehensive JSON support for the entire Brobot object model.
 *
...
public class BrobotJsonModule extends SimpleModule {
     ...
     * <p>
     * This method sets up the type mappings between Brobot domain classes and their
     * corresponding JSON handlers. The registration order is not significant as Jackson

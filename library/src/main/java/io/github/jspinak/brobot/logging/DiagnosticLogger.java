...
public class DiagnosticLogger {
    ...
    public void logImageAnalysis(
            BufferedImage patternImg, BufferedImage sceneImg, String patternName) {
        VerbosityLevel level = getVerbosity();
        ...
        if (patternImg != null && sceneImg != null) {
            ...
            String typeComparison =
                    getImageType(patternImg.getType()).equals(getImageType(sceneImg.getType()))
    ...
    private void analyzeImageContentIfProblematic(
            BufferedImage patternImg, BufferedImage sceneImg) {
    ...
    private boolean isImageMostlyColor(
            BufferedImage img, int targetR, int targetG, int targetB, int threshold) {
    ...
    public void logSimilarityAnalysis(
            String patternName, double[] thresholds, Double foundThreshold, Double foundScore) {
        VerbosityLevel level = getVerbosity();

 ...
 * 
 * <p>This package provides helper utilities that simplify common JSON operations,
 * data transformations, and object manipulations used throughout the Brobot
 * JSON processing infrastructure. These utilities complement the serializers
 * and deserializers with reusable functionality.</p>
 * 
 * <h2>Utility Classes</h2>
 * 
 * <ul>
 *   <li>{@link io.github.jspinak.brobot.runner.json.utils.JsonUtils} - 
 *       General-purpose JSON manipulation utilities</li>
 *   <li>{@link io.github.jspinak.brobot.runner.json.utils.ActionOptionsJsonUtils} - 
 *       Utilities specific to ActionOptions processing</li>
 *   <li>{@link io.github.jspinak.brobot.runner.json.utils.MatchesJsonUtils} - 
 *       Utilities for match result handling</li>
 *   <li>{@link io.github.jspinak.brobot.runner.json.utils.ObjectCollectionJsonUtils} - 
 *       Helper methods for object collections</li>
 * </ul>
 * 
 ...
 * 
 * <p>Safe type conversion utilities:</p>
 * <pre>{@code
 * // String to enum
 ...
 * 
 * <p>Utilities provide consistent error handling:</p>
 * <ul>
 *   <li>Safe default values for missing fields</li>
 *   <li>Clear error messages with context</li>
 *   <li>Null-safe operations</li>
 *   <li>Type conversion validation</li>
 * </ul>
 * 
 * <h2>Performance Considerations</h2>
 * 
 * <ul>
 *   <li>Utilities are stateless and thread-safe</li>
 *   <li>Avoid repeated parsing of same data</li>
 *   <li>Use streaming for large collections</li>
 *   <li>Cache converted values when appropriate</li>
 * </ul>
 * 
 * @since 1.0

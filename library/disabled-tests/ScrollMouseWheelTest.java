...
/**
 * Comprehensive test suite for ScrollMouseWheel action - mouse wheel scrolling operation.
 * Tests scrolling directions, step counts, and configuration validation.
 */
...
class ScrollMouseWheelTest extends BrobotTestBase {
    ...
    public void setupTest() {
        ...
        scrollOptions = new ScrollOptions.Builder()
    ...
    class ScrollStepsTests {
        ...
        void shouldScrollSingleStep() {
            // Given
            ScrollOptions singleStep = new ScrollOptions.Builder()
                .setDirection(ScrollOptions.Direction.DOWN)
                .setScrollSteps(1)
                .build();
        ...
        void shouldScrollMultipleSteps() {
            // Given
            ScrollOptions multipleSteps = new ScrollOptions.Builder()
                .setDirection(ScrollOptions.Direction.DOWN)
                .setScrollSteps(10)
                .build();
        ...
        void shouldScrollLargeNumberOfSteps() {
            // Given
            ScrollOptions largeSteps = new ScrollOptions.Builder()
                .setDirection(ScrollOptions.Direction.UP)
                .setScrollSteps(100)
                .build();
    ...
    class ConfigurationValidationTests {
        ...
        void shouldRequireScrollOptionsConfiguration() {
            // Given
            when(actionResult.getActionConfig()).thenReturn(mock(io.github.jspinak.brobot.action.ActionConfig.class));
        ...
        void shouldAcceptValidScrollOptionsConfiguration() {
            // Given
            ScrollOptions validOptions = new ScrollOptions.Builder()
                .setDirection(ScrollOptions.Direction.DOWN)
                .setScrollSteps(3)
    ...
    class DirectionCombinationTests {
        ...
        void shouldHandleUpDirectionWithMinimalSteps() {
            // Given
            ScrollOptions upMinimal = new ScrollOptions.Builder()
                .setDirection(ScrollOptions.Direction.UP)
                .setScrollSteps(1)
                .build();
        ...
        void shouldHandleDownDirectionWithMaximalSteps() {
            // Given
            ScrollOptions downMaximal = new ScrollOptions.Builder()
                .setDirection(ScrollOptions.Direction.DOWN)
    ...
    class ErrorHandlingTests {
        ...
        void shouldPropagateExceptionFromScroller() {
            // Given
            when(mouseWheelScroller.scroll(any()))
    ...
    class ScrollOptionsBuilderTests {
        ...
        void shouldPreservePauseTimingConfiguration() {
            // Given
            ScrollOptions withPause = new ScrollOptions.Builder()
                .setDirection(ScrollOptions.Direction.UP)
                .setScrollSteps(5)
        ...
        void shouldHandleMinimalScrollSteps() {
            ...
            ScrollOptions minimalSteps = new ScrollOptions.Builder()
    ...
    class IntegrationScenarioTests {
        ...
        void shouldPerformRapidScrollDown() {
            ...
            ScrollOptions rapidScroll = new ScrollOptions.Builder()
                .setDirection(ScrollOptions.Direction.DOWN)
                .setScrollSteps(20)
        ...
        void shouldPerformPrecisionScrollUp() {
            ...
            ScrollOptions precisionScroll = new ScrollOptions.Builder()
                .setDirection(ScrollOptions.Direction.UP)
                .setScrollSteps(1)
        ...
        void shouldSupportZoomOperationPattern() {
            ...
            ScrollOptions zoomIn = new ScrollOptions.Builder()

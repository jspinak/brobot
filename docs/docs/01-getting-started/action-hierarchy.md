...
- **[Action Config Factory](../03-core-library/configuration/action-config-factory.md)** - Creating and managing action configurations
- **[Combining Finds](../03-core-library/finding-objects/combining-finds.md)** - Pattern and color combination strategies

...
For more details on declarative region definition, see the [Declarative Region Definition Guide](../../03-core-library/user-guides/declarative-region-definition.md).

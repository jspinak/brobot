...
With the new API, you use ColorFindOptions for color-based finding and HistogramFindOptions for histogram-based finding. A look under the hood at how Brobot assesses color can be found in the [Color Analysis Guide](../labeling/color-analysis.md).  

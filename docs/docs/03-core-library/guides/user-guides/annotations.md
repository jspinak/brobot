...
> 📖 **Try It Yourself**: [Tutorial Basics](../../tutorials/tutorial-basics/intro.md) provides hands-on practice with annotations
...
### Tutorials
- **[Tutorial Basics](../../tutorials/tutorial-basics/intro.md)** - Hands-on practice with annotations
- **[Claude Automator Tutorial](../../tutorials/tutorial-claude-automator/intro.md)** - Real-world annotation usage

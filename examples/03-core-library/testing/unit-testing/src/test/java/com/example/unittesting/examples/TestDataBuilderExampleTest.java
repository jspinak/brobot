...
class TestDataBuilderExampleTest {
    ...
    void testUserBuilder() {
        ...
        TestDataBuilder.TestUser customUser =
                new TestDataBuilder.UserBuilder()
    ...
    void testStateBuilder() {
        ...
        TestDataBuilder.TestState settingsState =
                new TestDataBuilder.StateBuilder()
                        .withName("settings")
    ...
    void testActionResultBuilder() {
        ...
        TestDataBuilder.TestActionResult successResult = TestDataBuilder.successfulClick();

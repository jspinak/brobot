...
class DashboardStateTest {
    ...
    void testRegionDefinitions() {
        assertThat(dashboardState.getMainContentArea()).isEqualTo("0,100,1920,900");

        assertThat(dashboardState.getSidebar()).isEqualTo("0,100,300,900");
    }
    ...
    void testStateObjectsHaveImageExtensions(String fieldName) throws Exception {
        ...
        assertThat(value).isNotNull().endsWith(".png");
    }

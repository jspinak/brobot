...
/**
 * Examples using custom Brobot assertions from documentation.
...
class CustomAssertionsTest {
    ...
    void testCustomBrobotAssertions() {
        ...
        StateImage testButton = new StateImage.Builder()
            .addPatterns("test_button.png")
            .build();
    ...
    void testCustomAssertionsEdgeCases() {
        ...
        StateImage precisePattern = new StateImage.Builder()
            .addPatterns("precise_pattern.png")
            .build();
        ...
        PatternFindOptions broadFind = new PatternFindOptions.Builder()
            .setStrategy(PatternFindOptions.Strategy.ALL)
            .setSimilarity(0.6)
            .build();
    ...
    void testRegionalSearches() {
        ...
        StateImage targetElement = new StateImage.Builder()
            .addPatterns("target_element.png")
            .build();

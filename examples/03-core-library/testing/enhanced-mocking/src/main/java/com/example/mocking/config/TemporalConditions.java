...
public class TemporalConditions {
    ...
    @Builder.Default private double randomVariation = 0.1;
    ...
    // Current state
    @Builder.Default private transient int actionCount = 0;
    @Builder.Default private transient Random random = new Random();

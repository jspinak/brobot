...
public class MockScenarioConfig {
    ...
    @Builder.Default private Map<String, Double> stateAppearanceProbabilities = new HashMap<>();
    ...
    // Temporal conditions
    @Builder.Default private Map<String, TemporalConditions> temporalConditions = new HashMap<>();

    // Maximum scenario duration
    private Duration maxDuration;

    // Enable cascading failures
    @Builder.Default private boolean cascadingFailures = false;

    // Enable performance tracking
    @Builder.Default private boolean trackPerformance = true;

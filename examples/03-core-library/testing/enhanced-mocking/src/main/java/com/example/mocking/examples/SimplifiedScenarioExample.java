...
public class SimplifiedScenarioExample {
    ...
    @Autowired private MockScenarioManager scenarioManager;
    ...
    public void runSimpleDegradingPerformance() {
        ...
        TemporalConditions degradation =
    ...
    public void runSimpleTimeBasedStates() {
        ...
        TemporalConditions morningState =
                TemporalConditions.builder()
        ...
        TemporalConditions afternoonState =
                TemporalConditions.builder()
        ...
        TemporalConditions eveningState =
                TemporalConditions.builder()
    ...
    private void checkTimeBasedState(String phase, String expectedState) {
        ...
        log.info("{}: {} state check (methods not available in v1.1.0)", phase, expectedState);
    }

    /**
     * Basic Scenario Setup - Example from documentation From:
     * /docs/03-core-library/testing/enhanced-mocking.md
     */
    public void testLoginUnderNetworkIssues() {
        ...
        try {
            ...
            for (int i = 1; i <= 5; i++) {
                ...
                log.info(
                        "  Attempt {}: LOGIN_STATE={}, DASHBOARD={}",
                        i,
                        loginStateVisible ? "VISIBLE" : "HIDDEN",
    ...
    /**
     * Advanced Failure Patterns - Example from documentation From:
     * /docs/03-core-library/testing/enhanced-mocking.md
     */
    ...
    /**
     * Temporal Conditions - Example from documentation From:
     * /docs/03-core-library/testing/enhanced-mocking.md
     */
    public void testPerformanceUnderLoad() {
        log.info("=== Temporal Conditions (Documentation Example) ===");

        TemporalConditions slowNetwork =
                TemporalConditions.builder()

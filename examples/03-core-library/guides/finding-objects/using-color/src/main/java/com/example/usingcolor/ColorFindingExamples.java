...
/**
 * Demonstrates color-based finding in Brobot Based on documentation from
 * /docs/03-core-library/guides/finding-objects/using-color.md
 */
@Component
...
public class ColorFindingExamples {
    ...
    public void demonstrateColorStrategies() {
        ...
        StateImage targetImage =
                new StateImage.Builder().addPatterns("color-target").setName("ColorTarget").build();

        // 1. KMEANS - Find dominant colors using k-means clustering
        log.info("\n1. KMEANS Strategy - Finding dominant colors");
        ColorFindOptions kmeansColor =
        ...
        ObjectCollection objects = new ObjectCollection.Builder().withImages(targetImage).build();
        ...
        ColorFindOptions meanColor =
                new ColorFindOptions.Builder()
                        .setColorStrategy(ColorFindOptions.Color.MU)
                        .setDiameter(5)
                        .setSimilarity(0.95)
                        .setAreaFiltering(
                                AreaFilteringOptions.builder()
        ...
        ColorFindOptions classification =
                new ColorFindOptions.Builder()
    ...
    public void findRedDotsOnMinimap() {
        ...
        ObjectCollection objects = new ObjectCollection.Builder().withImages(redDot).build();
    ...
    public void combineColorWithPattern() {
        ...
        StateImage buttonImage =
                new StateImage.Builder().addPatterns("button-shape").setName("ButtonShape").build();
        ...
        ActionChainOptions combineColorPattern =
    ...
    public void useHistogramFinding() {
        ...
        StateImage complexImage =
                new StateImage.Builder()
                        .addPatterns("landscape-image")
                        .setName("Landscape")
                        .build();

        HistogramFindOptions histogramFind =
        ...
        ObjectCollection complexImages =
                new ObjectCollection.Builder().withImages(complexImage).build();
    ...
    public void colorWithAreaFiltering() {
        ...
        StateImage colorRegion =
                new StateImage.Builder().addPatterns("color-region").setName("ColorRegion").build();

        // Find larger color regions only
        ColorFindOptions largeColorRegions =
                new ColorFindOptions.Builder()
                        .setColorStrategy(ColorFindOptions.Color.MU)
                        .setDiameter(10)
                        .setSimilarity(0.85)
                        .setAreaFiltering(
                                AreaFilteringOptions.builder().minArea(100).maxArea(5000).build())
                        .build();

        ObjectCollection objects = new ObjectCollection.Builder().withImages(colorRegion).build();
    ...
    public void colorFindAndClick() {
        ...
        ColorFindOptions findColoredButton =
                new ColorFindOptions.Builder()
                        .setColorStrategy(ColorFindOptions.Color.MU)
                        .setSimilarity(0.9)
        ...
        ActionChainOptions findAndClick =
                new ActionChainOptions.Builder(findColoredButton)
                        .setStrategy(ActionChainOptions.ChainingStrategy.NESTED)
                        .then(clickButton)
                        .build();

        ObjectCollection objects = new ObjectCollection.Builder().withImages(coloredButton).build();
    ...
    public void demonstrateAdjustableOptions() {
        ...
        StateImage target = new StateImage.Builder().addPatterns("adjustable-target").build();

        // Low similarity - more matches but possibly false positives
        ColorFindOptions lowSimilarity =
                new ColorFindOptions.Builder()
                        .setSimilarity(0.6)
                        .setDiameter(1) // Single pixel matches
                        .build();

        ActionResult lowSimResult =
                action.perform(
                        lowSimilarity, new ObjectCollection.Builder().withImages(target).build());
        log.info("Low similarity (0.6): {} matches", lowSimResult.getMatchList().size());

        // High similarity - fewer matches but more accurate
        ColorFindOptions highSimilarity =
                new ColorFindOptions.Builder()
                        .setSimilarity(0.95)
                        .setDiameter(5) // 5x5 pixel clusters must match
                        .build();

        ActionResult highSimResult =
                action.perform(
                        highSimilarity, new ObjectCollection.Builder().withImages(target).build());
        log.info("High similarity (0.95): {} matches", highSimResult.getMatchList().size());

        // K-means with multiple colors
        ColorFindOptions multiColorKmeans =
                new ColorFindOptions.Builder()
                        .setColorStrategy(ColorFindOptions.Color.KMEANS)

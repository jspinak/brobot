...
// StateMemory is not available in Brobot v1.1.0
 ...
 * 
 * Illustrations are controlled via application properties:
 * - brobot.illustration.draw-find=true/false
 * - brobot.illustration.draw-click=true/false
...
public class SimpleIllustrationExample {
    ...
    public void demonstrateIllustrations() {
        ...
        ActionResult findResult = action.perform(
            new io.github.jspinak.brobot.action.basic.find.PatternFindOptions.Builder().build(),
            loginCollection);

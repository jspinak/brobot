 ...
 * 
 * In v1.1.0, context-aware illustration is achieved through:
 * - ActionConfig.illustrate property (YES, NO, USE_GLOBAL)
 * - Custom wrappers around IllustrationController
 * - Application-level logic for filtering
 */
@Configuration
@Slf4j
public class ContextAwareConfig {
     ...
     */
    @Bean
    public FailureOnlyIllustrator failureOnlyIllustrator(IllustrationController illustrationController) {
     ...
     */
    @Bean
    public SmartSamplingIllustrator smartSamplingIllustrator(IllustrationController illustrationController) {
     ...
     */
    @Bean
    public PerformanceAwareIllustrator performanceAwareIllustrator(IllustrationController illustrationController) {
    ...
    public static class SmartSamplingIllustrator {
        ...
        public void illustrateWithSampling(ActionResult result, ActionConfig config, ObjectCollection collection) {
    ...
    public static class PerformanceAwareIllustrator {
        ...
        public void illustrateIfPerformanceAllows(ActionResult result, ActionConfig config, ObjectCollection collection) {

 ...
 *
 * <p>Run with different profiles: - java -jar app.jar --spring.profiles.active=dev (full
 * illustrations) - java -jar app.jar --spring.profiles.active=test (selective illustrations) - java
 * -jar app.jar --spring.profiles.active=prod (no illustrations)
 */

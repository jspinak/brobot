...
/**
 * Real-world login workflow example with comprehensive logging.
...
public class LoginWorkflow {
    ...
    public boolean login(String username, String password) {
        ...
        try {
            ...
            ActionResult loginButtonResult = action.perform(
                new PatternFindOptions.Builder()
                    .setSimilarity(0.9)
                    .setSearchDuration(5.0)
                    .build(),
    ...
    private boolean verifyLoginSuccess() {
        ...
        StateImage dashboardElement = new StateImage.Builder()
        ...
        ObjectCollection dashboardCollection = new ObjectCollection.Builder()
            .withImages(dashboardElement)
            .build();
            
        ActionResult successCheck = action.perform(
            new PatternFindOptions.Builder()
                .setSimilarity(0.8)
                .setSearchDuration(5.0)
                .build(),

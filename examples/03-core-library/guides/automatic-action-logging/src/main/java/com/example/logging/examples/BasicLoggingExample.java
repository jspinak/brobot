...
public class BasicLoggingExample {
    ...
    private void initializeObjects() {
        ...
        cancelButton = new StateImage.Builder()
        ...
        if (result.isSuccess()) {
            ...
            if (bestMatch.isPresent()) {
                log.info("Submit button found at {} (took {}ms)", 
                    bestMatch.get().getRegion(), duration);
            }
        } else {
    ...
    public void errorHandlingWithLogging() {
        ...
        try {
            ...
            if (!result.isSuccess()) {
                ...
                ObjectCollection cancelCollection = new ObjectCollection.Builder()
                    .withImages(cancelButton)
                    .build();
    ...
    public void structuredLogging() {
        ...
        log.info("action_start action={} target={} similarity={} searchDuration={}", 
            "find",
            searchField.getName(),
            0.85,
            3
        ...
        log.info("action_complete action={} target={} success={} matches={}", 
            "find",
            searchField.getName(),
            result.isSuccess(),
            result.getMatchList().size()
        ...
        if (result.isSuccess()) {
            ...
            if (bestMatch.isPresent()) {
                ...
                log.info("match_details best_score={} region_x={} region_y={} region_w={} region_h={}", 
                    match.getScore(),
                    match.getRegion().x(),
                    match.getRegion().y(),
                    match.getRegion().w(),

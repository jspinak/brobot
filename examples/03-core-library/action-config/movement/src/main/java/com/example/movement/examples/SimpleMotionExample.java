 ...
 * 
 * The real MotionFindOptions only supports maxMovement parameter.
 * Other options from the documentation don't exist in the actual API.
 */
@Component
public class SimpleMotionExample {
     ...
     * 
     * In the real API, MotionFindOptions only has maxMovement setting.
     * Features like minArea, maxArea, similarity, etc. don't exist.
     */
     ...
     * 
     * Shows how to use motion detection in practice,
     * even with the limited API options.
     */

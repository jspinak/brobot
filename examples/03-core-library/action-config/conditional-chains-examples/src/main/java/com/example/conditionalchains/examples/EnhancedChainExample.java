...
public class EnhancedChainExample {
    ...
    /**
     * Example 1: Login workflow with then() method
    ...
    public void handleErrors() {
        ...
        ActionResult result = EnhancedConditionalActionChain
            ...
            .stopIf(res -> res.getText() != null && !res.getText().isEmpty() && res.getText().get(0).contains("CRITICAL"))
            .then(new StateImage.Builder().addPattern("images/buttons/retry.png").build())
            .ifFoundClick()
    ...
    public void useKeyboardShortcuts() {
        ...
        ActionResult result = EnhancedConditionalActionChain
            ...
            .pressCtrlS()      // Save
            .then(new StateImage.Builder().addPattern("images/indicators/saved.png").build())
    ...
    public void retryOperation() {
        ...
        StateImage connectButton = new StateImage.Builder()

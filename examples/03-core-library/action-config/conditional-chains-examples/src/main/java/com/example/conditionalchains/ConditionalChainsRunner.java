...
/**
 * Runs examples that demonstrate both the simple working approach and the enhanced
 * ConditionalActionChain with all documentation features.
 */
@Component
public class ConditionalChainsRunner implements CommandLineRunner {
    ...
    public ConditionalChainsRunner(
            SimpleWorkingExample simpleExample,

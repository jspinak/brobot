 ...
 *
 * <p>This example shows: - Basic find → ifFoundClick → ifNotFoundLog patterns - Multi-step
 * workflows with error handling - Custom logic with lambdas using ifFoundDo/ifNotFoundDo -
 * Combining conditional chains with other patterns - Convenience methods for common operations
 * (ifFoundClick, ifFoundType, etc.)
 */

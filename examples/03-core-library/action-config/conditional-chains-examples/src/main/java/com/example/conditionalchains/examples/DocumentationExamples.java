...
public class DocumentationExamples {
    ...
    private void initializeImages() {
        buttonImage = new StateImage.Builder().addPattern("images/buttons/button.png").build();
        menuButton = new StateImage.Builder().addPattern("images/buttons/menu.png").build();
        searchField = new StateImage.Builder().addPattern("images/forms/search.png").build();
        ...
        saveButton = new StateImage.Builder().addPattern("images/buttons/save.png").build();
        nameField = new StateImage.Builder().addPattern("images/forms/name.png").build();
        phoneField = new StateImage.Builder().addPattern("images/forms/phone.png").build();
        editorField = new StateImage.Builder().addPattern("images/forms/editor.png").build();
        savedIndicator = new StateImage.Builder().addPattern("images/indicators/saved.png").build();
        errorDialog = new StateImage.Builder().addPattern("images/indicators/error.png").build();
        retryButton = new StateImage.Builder().addPattern("images/buttons/retry.png").build();
        loadingSpinner =
        ...
        navigationButton =
                new StateImage.Builder().addPattern("images/buttons/navigation.png").build();
    }
    ...
    public ActionResult clickWithRetry(StateImage target, int maxRetries) {
        return ConditionalActionChain.retry(new PatternFindOptions.Builder().build(), maxRetries)
                .ifFoundClick()
                .ifFoundLog("Successfully clicked after retries")
                .ifNotFoundLog("Failed after all attempts")
                .perform(action, new ObjectCollection.Builder().withImages(target).build());
    }
    ...
    public ActionResult useKeyboardShortcuts() {
        return ConditionalActionChain.find(editorField)
                .ifFoundClick()
    ...
    public ActionResult handleErrors() {
        return ConditionalActionChain.find(submitButton)
                .ifFoundClick()
                .then(errorDialog)
    ...
    public ActionResult debugWorkflow() {
        return ConditionalActionChain.find(targetElement)
    ...
    public void demonstrateNoExplicitWaits() {
        ...
        PatternFindOptions findWithDelay =
    ...
    public ActionResult navigateToState(StateImage targetStateImage) {
        ...
        return ConditionalActionChain.find(targetStateImage)

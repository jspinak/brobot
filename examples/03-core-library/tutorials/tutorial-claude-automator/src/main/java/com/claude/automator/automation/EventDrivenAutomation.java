...
/**
 * Event-Driven Approach example from documentation. From:
 * /docs/03-core-library/tutorials/tutorial-claude-automator/automation.md
 *
 * <p>This demonstrates how to react to state changes using Spring events.
 */
@Component
...
public class EventDrivenAutomation {
    ...
    /**
     * Example event class for state changes. In a real implementation, this would be part of the
     * Brobot framework.
     */
    ...
    /**
     * React to state changes using Spring's @EventListener. This is called automatically when
    ...
    /**
     * Programmatic event publishing example. In practice, these events would be published by the

...
/**
 * All transitions for the Prompt state using the new unified annotation format.
...
public class PromptTransitions {
     ...
     */
    @FromTransition(from = WorkingState.class, priority = 1, description = "Navigate from Working to Prompt")

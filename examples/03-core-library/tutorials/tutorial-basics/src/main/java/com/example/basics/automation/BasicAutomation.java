...
public class BasicAutomation {
    ...
    private void exploreWorld() {
        ...
        ObjectCollection castleCollection =
                new ObjectCollection.Builder().withImages(worldState.getCastle()).build();

        ActionResult castles = action.perform(findAllOptions, castleCollection);

        ObjectCollection minesCollection =
                new ObjectCollection.Builder().withImages(worldState.getMines()).build();
    ...
    private void exploreIsland() {
        ...
        ObjectCollection nameCollection =
    ...
    private void checkResources() {
        ...
        // Check gold
        ObjectCollection goldCollection =
                new ObjectCollection.Builder()
        ...
        // Check wood
        ObjectCollection woodCollection =
                new ObjectCollection.Builder()
        ...
        // Check stone
        ObjectCollection stoneCollection =
                new ObjectCollection.Builder()

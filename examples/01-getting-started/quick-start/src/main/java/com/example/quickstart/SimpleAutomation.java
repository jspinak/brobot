...
public class SimpleAutomation {
     ...
     * Code from: docs/docs/01-getting-started/quick-start.md lines 50-81
     */
     ...
     * Code from: docs/docs/01-getting-started/quick-start.md lines 96-108
     * 
     ...
     * Code from: docs/docs/01-getting-started/quick-start.md lines 123-136
     * 
     * Default values used:
    ...
    /**
     * Demonstrates type-safe configuration examples
     * Code from: docs/docs/01-getting-started/quick-start.md lines 201-217
     */
    ...
    /**
     * Demonstrates common action patterns
     * Code from: docs/docs/01-getting-started/quick-start.md lines 245-273
     */
    public void demonstrateCommonActions() {
        log.info("=== Common Action Patterns ===");
        
        StateImage targetImage = new StateImage.Builder()
                .addPatterns("target-image")
                .build();
    ...
    /**
     * Demonstrates proper pause usage in Brobot
     * Code from: docs/docs/01-getting-started/quick-start.md lines 375-396
     */

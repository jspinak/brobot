...
import static io.github.jspinak.brobot.app.stateStructureBuilders.buildFromNames.attributes.AttributeTypes.Attribute.APPEARS;
import static io.github.jspinak.brobot.app.stateStructureBuilders.buildFromNames.attributes.AttributeTypes.Tag.*;
...
public class SetAttributes {
    ...
    public void processName(ExtendedStateImageDTO image) {
    ...
    private void saveValues() {
        String str = getName();
        if (str.isEmpty()) { // the attribute is for all pages

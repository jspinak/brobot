...
public class BabyStateRepo {
    ...
    public void addImage(ExtendedStateImageDTO img) {
     ...
     */
    public Optional<ExtendedStateImageDTO> getBaseImage(ExtendedStateImageDTO newImg) {
        ...
        for (ExtendedStateImageDTO img : babyState.getImages()) {

...
public class PersistenceProviderFactory {
    ...
    public static PersistenceProvider create(PersistenceConfiguration configuration) {
        ...
        switch (configuration.getType()) {
            case FILE:
                log.info("Creating file-based persistence provider at: {}", 
            ...
            case DATABASE:
                log.warn("Database persistence requires Spring Data JPA repositories. " +
                        "Use Spring auto-configuration or provide repositories manually.");
                throw new UnsupportedOperationException(
                    "Database persistence requires Spring context with repositories. " +
                    "Use @Import(PersistenceAutoConfiguration.class) in your Spring application."
                );
            ...
            default:
                throw new IllegalArgumentException("Unknown persistence type: " + configuration.getType());
        }
    }

...
/**
 * Spring event listener that bridges Brobot library events to persistence. Listens for action
 * execution events and records them.
 */
...
public class PersistenceEventListener {
    ...
    /**
     * Handle action executed events from the Brobot library. Note: The library would need to
    ...
    /** Event class for action execution. This would ideally be defined in the library. */

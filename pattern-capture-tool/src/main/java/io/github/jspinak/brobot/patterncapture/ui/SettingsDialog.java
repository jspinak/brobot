...
public class SettingsDialog extends JDialog {
    ...
    private void initializeUI() {
        ...
        JRadioButton ffmpegRadio =
                new JRadioButton("JavaCV FFmpeg (Physical Resolution - Bundled)");
    ...
    private void loadSettings() {
        ...
        sb.append("Resolution Type: ")
                .append(captureConfig.isCapturingPhysicalResolution() ? "PHYSICAL" : "LOGICAL")
                .append("\n");
        sb.append("\n");

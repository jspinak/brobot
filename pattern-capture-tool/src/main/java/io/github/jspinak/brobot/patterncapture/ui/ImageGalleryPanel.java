 ...
 * 
 * Features:
 * - Thumbnail view of captured patterns
 * - Click to copy path
    ...
    private class ImageThumbnail extends JPanel {
        ...
        private void openInViewer() {
            try {
                ...
                JOptionPane.showMessageDialog(ImageGalleryPanel.this,
        ...
        private void deleteImage() {
            int result = JOptionPane.showConfirmDialog(ImageGalleryPanel.this,

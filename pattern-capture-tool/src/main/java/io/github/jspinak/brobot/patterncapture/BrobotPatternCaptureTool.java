 ...
 * 
 * This is a standalone Spring Boot application with Swing UI
 * that provides SikuliX-like image capture functionality using
 * Brobot's capture system.
 */
...
public class BrobotPatternCaptureTool {
    ...
    public static void main(String[] args) {
        ...
        ConfigurableApplicationContext context = SpringApplication.run(
            BrobotPatternCaptureTool.class, args);

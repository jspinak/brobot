 ...
 *
 * <p>Manages the capture overlay and handles the capture workflow: 1. Show overlay 2. User selects
 * region 3. Capture selected area 4. Return image to callback
 */
@Component
public class CaptureController {

    @Autowired private CaptureOverlay captureOverlay;
    ...
    private final CaptureOverlay.CaptureListener captureListener =
            new CaptureOverlay.CaptureListener() {
                @Override
